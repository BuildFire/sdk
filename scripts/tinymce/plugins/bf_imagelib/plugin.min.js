      ...
      editor.windowManager.openUrl({
        ...
        onMessage : (dialogApi, details) => {
          ...
          if (imageData.enablePreview) {
            image.setAttribute('onclick', 'buildfire.mediaPreviewer.show({media: [{imageSrc: this.src}]})');
          }
          if (imageData && mceAction === 'setImage') {
            if (isEditing) {
              ...
              if (imageData.enablePreview) {
                elementNode.setAttribute('onclick', 'buildfire.mediaPreviewer.show({media: [{imageSrc: this.src}]})');
              } else {
