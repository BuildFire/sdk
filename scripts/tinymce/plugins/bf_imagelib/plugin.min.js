  ...
  function changeImage() {
    ...
    buildfire.imageLib.showDialog(options, (err, results) => {
      ...
      if (imageProperties.resize) {
        widgetImageExpression = '${buildfire.imageLib.resizeImage(\'' + imageUrl + '\', { size: \'' + imageProperties.responsive + '\', aspect: \'1:1\' })}';
      } else {
        widgetImageExpression = '${buildfire.imageLib.cropImage(\'' + imageUrl + '\', { size: \'' + imageProperties.responsive + '\', aspect: \'' + imageProperties.crop + '\'' +  '})}';
      }
      ...
      if (imageProperties.responsive?.includes('_')) elementNode.setAttribute('class', imageProperties.responsive);
