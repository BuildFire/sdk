        ...
        buttons: [
          {
            ...
            onclick: function () {
              ...
              let val = getElementById('data_id').value;
              buildfire.getContext(function(err, result) {
                if(err) return console.error(err);
                val = val + '-' + result.instanceId;
                editor.insertContent(
                  `<img src="trigger_error" onerror="buildfire.rating.inject('${val}')" style="display: none">
                  <div id="${val}" class="rating-component">
                  <div class="reviews-container"><span>★</span><span>★</span><span>★</span><span>★</span><span>★</span></div>
                  </div><br>`
                );
                modal.close();
              });
