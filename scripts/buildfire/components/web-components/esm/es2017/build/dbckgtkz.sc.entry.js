...
class Grid {
    ...
    static get style() { return ".wrapper.sc-bf-grid{display:grid;grid-gap:2px}.box.sc-bf-grid{margin:2vh 0}.row-1.sc-bf-grid{grid-template-columns:100%}.row-2.sc-bf-grid{grid-template-columns:50% 50%}.row-3.sc-bf-grid{grid-template-columns:33% 33% 33%}.row-4.sc-bf-grid{grid-template-columns:25% 25% 25% 25%}.row-5.sc-bf-grid{grid-template-columns:20% 20% 20% 20% 20%}"; }
}
...
class Grid1 {
    ...
    static get style() { return ".wrapper.sc-bf-image-grid{display:grid;grid-gap:2px}.box.sc-bf-image-grid{margin:2vh 0}.row-1.sc-bf-image-grid{grid-template-columns:100%}.row-2.sc-bf-image-grid{grid-template-columns:50% 50%}.row-3.sc-bf-image-grid{grid-template-columns:33% 33% 33%}.row-4.sc-bf-image-grid{grid-template-columns:25% 25% 25% 25%}.row-5.sc-bf-image-grid{grid-template-columns:20% 20% 20% 20% 20%}"; }
}
...
class ImageList {
    ...
    static get style() { return ".box.sc-bf-image-list{margin:2vh 0;max-width:100%;overflow:hidden}"; }
}
