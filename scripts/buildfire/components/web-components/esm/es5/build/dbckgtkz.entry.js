...
var Grid = /** @class */ (function () {
    ...
    Object.defineProperty(Grid, "style", {
        get: function () { return ".wrapper{display:grid;grid-gap:2px}.box{margin:2vh 0}.row-1{grid-template-columns:100%}.row-2{grid-template-columns:50% 50%}.row-3{grid-template-columns:33% 33% 33%}.row-4{grid-template-columns:25% 25% 25% 25%}.row-5{grid-template-columns:20% 20% 20% 20% 20%}"; },
        enumerable: true,
        configurable: true
    });
    return Grid;
...
var ImageList = /** @class */ (function () {
    ...
    Object.defineProperty(ImageList, "style", {
        get: function () { return ".box{margin:2vh 0;max-width:100%;overflow:hidden}"; },
        enumerable: true,
        configurable: true
    });
    return ImageList;
