...
"use strict";function StripeAPI(e){if(this.context=e,!this.context)throw Error("stripeAPI: invalid context")}StripeAPI.prototype={_sendRequest:function(e,i,n,t,s){var o="",c=new XMLHttpRequest,a=window.siteConfig.endPoints.stripeHost+"/stripe/"+i;if("GET"===(e=e.toUpperCase())&&n){var u="?";for(var r in n)n.hasOwnProperty(r)&&void 0!==n[r]&&(u+=r+"="+encodeURIComponent(n[r])+"&");a+=u=u.slice(0,-1)}else o=JSON.stringify(n);if(c.open(e,a,!0),c.setRequestHeader("Content-Type","application/json"),t)for(var r in t)t.hasOwnProperty(r)&&c.setRequestHeader(r,t[r]);c.onreadystatechange=function(){var e=null;try{e=JSON.parse(c.responseText)}catch(e){}4==c.readyState&&(200===c.status?s&&s(null,e):s&&s(e))},c.send(o)},_loadScript:function(e,i){var n=document.createElement("script");if(n.type="text/javascript",n.readyState?n.onreadystatechange=function(){"loaded"!=n.readyState&&"complete"!=n.readyState||(n.onreadystatechange=null,i&&i())}:n.onload=function(){i&&i()},n.src=e.url,e.attr)for(var t in e.attr)n.setAttribute(t,e.attr[t]);for(var s=document.getElementsByTagName("script"),o=s.length;o--;)if(s[o].src==e.url)return i&&i(),!0;document.getElementsByTagName("head")[0].appendChild(n)},_guid:function(){function e(){return(65536*(1+Math.random())|0).toString(16).substring(1)}return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()},_openStripeCheckout:function(e,n){var i=e.items,t=e.successUrl,s=e.cancelUrl,o=e.submitType,c=e.customerEmail,a=e.sessionId,u=e.clientReferenceId,r=e.domain,l=e.events,p=this,d=null,m=!1,y=null,f=!1;function _(e){e||(e={}),clearInterval(d),(e.invokeDismiss||void 0===e.invokeDismiss)&&window.richModal&&window.richModal.close(),y&&y.close(),l&&"function"==typeof l.onClose&&l.onClose()}function w(){p._sendRequest("GET","checkout/sessions",{session_id:a,client_reference_id:u},{"x-api-key":p.context.apiKeys.awsApiPublicKey},function(e,i){if(i){if(f)return;f=!0,_(),n&&n(e,i)}})}var v=r+"/payments/checkout?stripeKey="+p.context.apiKeys.stripePublicKey;function K(){y=window.open(v,"_blank","location=no"),d=setInterval(function(){y&&y.closed&&_(),"visible"==window.document.visibilityState?w():m||(m=!0,setTimeout(function(){m=!1,w()},6e4))},5e3),setTimeout(function(){_()},9e5)}a&&(v+="&sessionId="+encodeURIComponent(a)),u&&(v+="&clientReferenceId="+encodeURIComponent(u)),t&&(v+="&successUrl="+encodeURIComponent(t)),s&&(v+="&cancelUrl="+encodeURIComponent(s)),o&&(v+="&submitType="+encodeURIComponent(o)),c&&(v+="&customerEmail="+encodeURIComponent(c)),i&&(v+="&items="+encodeURIComponent(JSON.stringify(i))),window.bfUtils.isApp&&window.richModal.display({title:"",showDismissButton:!1,richContent:"<div style='text-align:center;'>Payment in progress <br/> Please wait...</div>",action:{title:"Cancel",handler:function(){_({invokeDismiss:!1})}}}),l&&"function"==typeof l.onProgress&&l.onProgress(K),K()},_openStripeConnect:function(e,n){var i=e.accessToken,t=e.accountLinkUrl,s=e.events,o=this,c=null,a=!1,u=null,r=!1;function l(e){e||(e={}),clearInterval(c),(e.invokeDismiss||void 0===e.invokeDismiss)&&window.richModal&&window.richModal.close(),u&&u.close(),s&&"function"==typeof s.onClose&&s.onClose()}function p(){o._sendRequest("GET","connect/account",{access_token:i},{"x-api-key":o.context.apiKeys.awsApiPublicKey},function(e,i){if(i&&i.is_active){if(r)return;r=!0,l(),n&&n(e,i)}})}var d=t;function m(){u=window.open(d,"_blank","location=no"),c=setInterval(function(){u&&u.closed&&l(),"visible"==window.document.visibilityState?p():a||(a=!0,setTimeout(function(){a=!1,p()},6e4))},1e4),setTimeout(function(){l()},18e5)}s&&"function"==typeof s.onProgress&&s.onProgress(m),window.bfUtils.isApp&&window.richModal.display({title:"",showDismissButton:!1,richContent:"<div style='text-align:center;'>Stripe Connect in progress <br/> Please wait...</div>",action:{title:"Cancel",handler:function(){l({invokeDismiss:!1})}}}),!1===o.openPaymentWindow||m()},_checkApiKeys:function(n){var t=this;function e(){appApiKeys.get(function(e,i){t.context.apiKeys=i,n&&n()})}t.context.apiKeys&&t.context.apiKeys.awsApiPublicKey?n&&n():window.appContext.currentApp.apiKeys?0===Object.keys(window.appContext.currentApp.apiKeys).length&&window.appContext.currentApp.apiKeys.constructor===Object?e():(t.context.apiKeys=window.appContext.currentApp.apiKeys,n&&n()):e()},pay:function(e,n){var t=this;t._checkApiKeys(function(){t.context.apiKeys.stripePublicKey?t._loadScript({url:"https://checkout.stripe.com/checkout.js"},function(){var i=StripeCheckout.configure({key:t.context.apiKeys.stripePublicKey,image:"https://stripe.com/img/documentation/checkout/marketplace.png",locale:"auto",token:function(e){i.close(),n&&n(null,{sourceToken:e})}});i.open({}),window.addEventListener("popstate",function(){i.close()})}):n&&n("Missing stripePublicKey in context",null)})},charge:function(o,c){var a=this;a._checkApiKeys(function(){if(a.context.apiKeys.stripePublicKey)if(o)if(a.openPaymentWindow=o.openPaymentWindow,o.items&&0!=o.items.length){for(var e=[],i=0;i<o.items.length;i++){if(!o.items[i].name)return void(c&&c("Missing name in items index "+i,null));if(!o.items[i].amount)return void(c&&c("Missing amount in items index "+i,null));e.push({name:o.items[i].name,description:o.items[i].description||void 0,amount:o.items[i].amount,currency:o.items[i].currency||"usd",quantity:o.items[i].quantity||1})}var t=window.siteConfig.endPoints.appHost,s="app_id_"+a.context.appId+"_ref_id_"+a._guid(),n={type:"line_items",line_items:e,client_reference_id:s,success_url:t+"/payments/success",cancel_url:t+"/payments/cancel"};o.submitType&&(n.submit_type=o.submitType),o.customerId&&(n.customer_id=o.customerId),o.customerEmail&&(n.customer_email=o.customerEmail),o.captureMethod&&(n.payment_intent_data={capture_method:o.captureMethod}),a._sendRequest("POST","checkout/sessions",n,{"x-api-key":a.context.apiKeys.awsApiPublicKey},function(e,i){if(e)c&&c(e,i);else{var n=i.sessionId;a._openStripeCheckout({sessionId:n,clientReferenceId:s,domain:t,events:o.events},function(e,i){c&&c(e,i)})}})}else c&&c("Missing items",null);else c&&c("invalid params",null);else c&&c("Missing stripePublicKey in context",null)})},subscribe:function(o,c){var a=this;a._checkApiKeys(function(){if(a.context.apiKeys.stripePublicKey)if(a.context.apiKeys.awsApiPublicKey)if(o)if(a.openPaymentWindow=o.openPaymentWindow,o.items&&0!=o.items.length){for(var e=[],i=0;i<o.items.length;i++){if(!o.items[i].planId)return void(c&&c("Missing planId in items index "+i,null));e.push({plan_id:o.items[i].planId,quantity:o.items[i].quantity||1})}var t=window.siteConfig.endPoints.appHost,s="app_id_"+a.context.appId+"_ref_id_"+a._guid(),n={type:"subscription",subscription_data:e,client_reference_id:s,success_url:t+"/payments/success",cancel_url:t+"/payments/cancel"};o.trialPeriodDays&&(n.trial_period_days=o.trialPeriodDays),o.customerId&&(n.customer_id=o.customerId),o.customerEmail&&(n.customer_email=o.customerEmail),o.metaData&&(n.metadata=o.metaData),a._sendRequest("POST","checkout/sessions",n,{"x-api-key":a.context.apiKeys.awsApiPublicKey},function(e,i){if(e)c&&c(e,i);else{var n=i.sessionId;a._openStripeCheckout({sessionId:n,clientReferenceId:s,domain:t,events:o.events},function(e,i){c&&c(e,i)})}})}else c&&c("Missing items",null);else c&&c("invalid params",null);else c&&c("Missing awsApiPublicKey in context",null);else c&&c("Missing stripePublicKey in context",null)})},purchase:function(o,c){var a=this;a._checkApiKeys(function(){if(a.context.apiKeys.stripePublicKey)if(a.context.apiKeys.awsApiPublicKey)if(o)if(o.items&&0!=o.items.length){for(var e=[],i=0;i<o.items.length;i++){if(!o.items[i].sku)return void(c&&c("Missing sku in items index "+i,null));e.push({sku:o.items[i].sku,quantity:o.items[i].quantity||1})}var n=window.siteConfig.endPoints.appHost,t="app_id_"+a.context.appId+"_ref_id_"+a._guid();o.clientReferenceId&&(t=o.clientReferenceId);var s={items:e,clientReferenceId:t,successUrl:n+"/payments/success",cancelUrl:n+"/payments/cancel",submitType:o.submitType,customerEmail:o.customerEmail,domain:n,events:o.events};a._openStripeCheckout(s,function(e,i){c&&c(e,i)})}else c&&c("Missing items",null);else c&&c("invalid params",null);else c&&c("Missing awsApiPublicKey in context",null);else c&&c("Missing stripePublicKey in context",null)})},getSubscription:function(i,n){var t=this;t._checkApiKeys(function(){if(t.context.apiKeys.awsApiPublicKey)if(i)if(i.subscriptionId){var e={subscription_id:i.subscriptionId};t._sendRequest("GET","customer/subscription",e,{"x-api-key":t.context.apiKeys.awsApiPublicKey},function(e,i){n&&n(e,i)})}else n&&n("Missing params subscriptionId",null);else n&&n("invalid params",null);else n&&n("Missing awsApiPublicKey in context",null)})},cancelSubscription:function(i,n){var t=this;t._checkApiKeys(function(){if(t.context.apiKeys.awsApiPublicKey)if(i)if(i.subscriptionId)if(i.customerId){var e={subscription_id:i.subscriptionId,customer_id:i.customerId};t._sendRequest("DELETE","customer/subscription",e,{"x-api-key":t.context.apiKeys.awsApiPublicKey},function(e,i){n&&n(e,i)})}else n&&n("Missing params customerId",null);else n&&n("Missing params subscriptionId",null);else n&&n("invalid params",null);else n&&n("Missing awsApiPublicKey in context",null)})},addCustomerCard:function(o,c){var a=this;a._checkApiKeys(function(){if(a.context.apiKeys.stripePublicKey)if(a.context.apiKeys.awsApiPublicKey)if(o)if(o.customerId){var t=window.siteConfig.endPoints.appHost,s="app_id_"+a.context.appId+"_ref_id_"+a._guid(),e={mode:"setup",type:"setup",client_reference_id:s,success_url:t+"/payments/success",cancel_url:t+"/payments/cancel"};o.customerEmail&&(e.customer_email=o.customerEmail),a._sendRequest("POST","checkout/sessions",e,{"x-api-key":a.context.apiKeys.awsApiPublicKey},function(e,i){if(e)c&&c(e,i);else{var n=i.sessionId;a._openStripeCheckout({sessionId:n,clientReferenceId:s,domain:t},function(e,i){if(e)c&&c(e,null);else if(i){var n={customer_id:o.customerId,setup_intent:i.setup_intent};a._sendRequest("POST","customer/card",n,{"x-api-key":a.context.apiKeys.awsApiPublicKey},function(e,i){c&&c(e,i)})}else c&&c(null,null)})}})}else c&&c("Missing params customerId",null);else c&&c("invalid params",null);else c&&c("Missing awsApiPublicKey in context",null);else c&&c("Missing stripePublicKey in context",null)})},capturePayment:function(i,n){var t=this;t._checkApiKeys(function(){if(t.context.apiKeys.awsApiPublicKey)if(i)if(i.paymentIntentsId){var e={payment_intents_id:i.paymentIntentsId};i.amountToCapture&&(e.amount_to_capture=i.amountToCapture),t._sendRequest("POST","payment/capture",e,{"x-api-key":t.context.apiKeys.awsApiPublicKey},function(e,i){n&&n(e,i)})}else n&&n("Missing params paymentIntentsId",null);else n&&n("invalid params",null);else n&&n("Missing awsApiPublicKey in context",null)})},get connect(){var c=this;return{account:function(s,o){c._checkApiKeys(function(){if(c.context.apiKeys.awsApiPublicKey){var e=window.siteConfig.endPoints.appHost,t={return_url:e+"/stripe/connect/return",refresh_url:e+"/stripe/connect/reauth",account_type:"express"};window.authAPI.getCurrentUser(function(e,i){t.access_token=i&&i.accessToken?i.accessToken.toString():null,t.access_token?c._sendRequest("POST","connect/account",t,{"x-api-key":c.context.apiKeys.awsApiPublicKey},function(e,i){if(e)o&&o(e,i);else{if(!i)return void o("Something went wrong!");if(i.is_active)return void o(null,i);var n=i.account_link_url;c._openStripeConnect({accessToken:t.access_token,accountLinkUrl:n,events:s.events},function(e,i){e?o&&o(e,null):o&&o(null,i)})}}):o&&o({message:"no logged in user"})})}else o&&o("Missing awsApiPublicKey in context",null)})},deleteAccount:function(e,t){c._checkApiKeys(function(){if(c.context.apiKeys.awsApiPublicKey){window.siteConfig.endPoints.appHost;var n={};window.authAPI.getCurrentUser(function(e,i){n.access_token=i&&i.accessToken?i.accessToken.toString():null,n.access_token?c._sendRequest("DELETE","connect/account",n,{"x-api-key":c.context.apiKeys.awsApiPublicKey},function(e,i){t&&t(e,i)}):t&&t({message:"no logged in user"})})}else t&&t("Missing awsApiPublicKey in context",null)})}}}};
