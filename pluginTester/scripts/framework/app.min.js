...
"use strict";$app.controller("authCtrl",["$rootScope","$scope","Upload","$sce",function(a,c,s,r){c._appRoot=window._appRoot,c.registerClick=!1;var l,d=void 0;window.appContext.currentApp&&window.appContext.currentApp.config&&(void 0===window.appContext.currentApp.config.userLoginDomainSettings?"enterprise"==window.appContext.currentApp.config.type&&(d="enabled"):d=window.appContext.currentApp.config.userLoginDomainSettings);var n="Password must be at least 8 characters long, contains an upper case letter, a lower case letter, a number and a symbol.";c.loginTranslation="Log In",c.registerTranslation="Register",c.emailDoesNotExistTxt="Email does not exist in system.",c.updateLoginTranslations=function(e){e.passwordAtLeast8ComplexChars&&(n=e.passwordAtLeast8ComplexChars),e.loginTranslation&&(c.loginTranslation=e.loginTranslation),e.registerTranslation&&(c.registerTranslation=e.registerTranslation),e.emailDoesNotExist&&(c.emailDoesNotExistTxt=e.emailDoesNotExist)};window.authAPI.authCtrlScope=c,a.allowCancel=void 0===a.allowCancel||a.allowCancel,a.authShown=!1,c.secretCodeProvider=null,c.refWindow=null,c.errors={},c.invalidCredentials=!1,c.invalidReset=!1,c.invalidRegister=!1,c.msgError=null,c.msgSuccess=null,c.enableFacebook=!0,c.enableTwitter=!0,c.password="",c.userObj={username:"",email:""},c.loginCallback=null;var u="",i="",p="",w="",g="",f="",m="",C="",t=window.appContext.currentApp.appId,e=window.appContext.currentApp.keys.datastoreKey,o={appId:t,pluginId:"authSettings",instanceId:"authSettings",liveMode:window.appContext.liveMode,writeKey:e};function h(e){e&&(e=window.loginUI.convertToCss(e)||"*{}",localStorage.loginUI=e);var n=e||localStorage.getItem("loginUI_"+t),o=document.getElementById("custom-login-ui");if(!o){var r=document.getElementsByClassName("login-holder")[0];(o=document.createElement("style")).id="custom-login-ui",r.appendChild(o)}o.innerHTML=n}c.updateLoginCss=function(){h()},h();var S=new DatastoreAPI(o);function v(e){return"boolean"!=typeof e||e}function b(){var e=JSON.parse(window.localStorage.getItem("SSO_USER"));if(e){(new Date).getTime()/1e3>e.ssoExpiresAt&&(c.invalidCredentials=!0,a.allowCancel=!1,a.showMenu=!1,c.showLogin(function(e,n){authAPI._setCurrentUser(n),authAPI.triggerOnLogin(n),a.allowCancel=!0,a.showMenu=!0,c.hideLogin(),c.$$phase||c.$apply()}));var n=u;if("multipart/form-data"==C||"application/x-www-form-urlencoded"==C)var o={headers:{Authorization:"Bearer "+e.ssoUserToken,"Content-Type":"application/json"}};else{o={headers:{"Content-Type":"application/x-www-form-urlencoded"}};n=u+"?access_token="+e.ssoUserToken}window.bfUtils.http.get(n,o).success(function(e){console.log(e)}).error(function(e,n,o,r){c.invalidCredentials=!0,a.allowCancel=!1,a.showMenu=!1,c.showLogin(function(e,n){authAPI._setCurrentUser(n),authAPI.triggerOnLogin(n),a.allowCancel=!0,a.showMenu=!0,c.hideLogin(),c.$$phase||c.$apply()})})}}c.SSOLogin=!1,S.get({tag:"authSettings"},function(e,n){e?console.error(e):n&&n.data?("SSOLogin"==n.data.signOnStrategy&&(c.SSOLogin=!0,"application/x-www-form-urlencoded"==(C=n.data.contentType)||"multipart/form-data"==C?(u=window.siteConfig.endPoints.hopHost+n.data.accessTokenAPI,i=window.siteConfig.endPoints.hopHost+n.data.loginAPI):(u=n.data.accessTokenAPI,i=n.data.loginAPI),c.enableFacebook=n.data.enableFacebook,c.enableTwitter=n.data.enableTwitter,c.signOnStrategy=g=n.data.signOnStrategy,p=n.data.resetPasswordAPI,c.registerUrl=w=n.data.registerUrl,f=n.data.clientId,m=n.data.clientSecret,setInterval(b,9e5)),c.enableFacebook=v(n.data.enableFacebook),c.enableTwitter=v(n.data.enableTwitter),g=n.data.signOnStrategy,"enabled"==d&&(l=n.data.domain),c.emailInputType=l?"text":"email"):(c.enableFacebook=!0,c.enableTwitter=!0)}),c.closeLogin=function(){c.loginCallback&&c.loginCallback(),a.allowCancel?c.hideLogin():P()},c.reset=function(){c.errors={},c.showProgressMessage=!1,c.invalidCredentials=!1,c.invalidReset=!1,c.invalidRegister=!1,c.allowToRegister=!1,c.uploadFile=null,c.userObj.email=null,c.userObj.username=null,c.password=null,c.secretCode=null,c.newPassword=null,c.confirmPassword=null,c.msgError=null,c.msgSuccess=null,c.uploadFile=null,c.firstName=null,c.lastName=null,c.secretCodeProvider=null,c.refWindow=null,c.acceptTOS=null,c.acceptPP=null,c.acceptedAppTerms=null};var y=function(){c.successShown=!1,c.registrationShown=!1,c.loginShown=!1,c.forgetPasswordShown=!1,c.resetPasswordShown=!1,document.getElementById("frmExternalRegistrationForm").src="",c.externalRegister=!1};function P(){c.reset(),y(),a.allowCancel=!c.loginOptions||!1!==c.loginOptions.allowCancel,a.showMenuOnAuth=!c.loginOptions||!1!==c.loginOptions.showMenu,c.loginShown=!0,a.authShown=!0,c.$$phase||c.$apply()}function I(e,t){var n=JSON.parse(window.localStorage.getItem("SSO_USER"));if(n||(n={}),"string"==typeof e)try{e=JSON.parse(e)}catch(e){console.warn("Unexpected parsing issue",e)}e&&e.access_token?n.ssoUserToken=e.access_token:n.ssoUserToken=e.replace(/["]+/g,""),e&&e.expires_in&&e.issued_at?n.ssoExpiresAt=e.issued_at+e.expires_in:n.ssoExpiresAt=1902608081e3,window.localStorage.setItem("SSO_USER",JSON.stringify(n));var o=null;o="undefined"==typeof push?{}:push;var r=u.replace(window.siteConfig.endPoints.hopHost,""),s={id:1,method:"users/loginSSO",params:{accessToken:n.ssoUserToken,accessTokenAPI:r,deviceId:o.deviceId,osType:o.platform?o.platform.toLowerCase():"web",externalAppId:window.appContext.currentApp.appId,loginProviderType:"SSO",email:c.userObj.username,contentType:C}},i=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(s));window.bfUtils.http.jsonp(i,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result)authAPI._setCurrentUser(e.result),a.$broadcast("loginSuccessfully",e.result),t(null,e.result),bfUtils.isEmulatorCP&&cpSync.SSO.log("Succeed...");else{c.invalidRegister=!0;e&&e.error?(c.msgError=e.error.message,c.invalidCredentials=!0,console.error(e.error),bfUtils.isEmulatorCP&&cpSync.SSO.log(e.error)):(e="Could not retrieve profile info.")&&(c.msgError=e,c.invalidCredentials=!0,console.error(e),bfUtils.isEmulatorCP&&cpSync.SSO.log(e))}}).error(function(e,n,o,r){console.error(e),t&&t(e,null),bfUtils.isEmulatorCP&&cpSync.SSO.log("Error while testing SSO Login..")})}y(),c.openTermsAndConditions=function(){return window.open("https://support.appdocumentation.com/terms/","_system"),!1},c.registerUser=function(){if(c.registerClick=!0,!c.frmAuthRegister.$invalid)if(window.validator.validatePassword(c.password))c.register(),c.registerClick=!1;else{var e={data:{title:" ",body:n,disableCancel:!0}};window.openDialog(e,function(){})}},c.hideLogin=function(){c.reset(),y(),a.authShown=!1,c.loginCallback=null},c.showRegistration=function(e,r){if("SSOLogin"==g&&w){c.externalRegister=!0;var t=document.getElementById("frmExternalRegistrationForm");t.src=w,window.addEventListener("message",function e(n){if(n&&-1<w.indexOf(n.origin)&&n.data){var o=null;try{o=JSON.parse(n.data)}catch(e){}o&&("success"===o.status&&(o.user&&o.user.username&&(c.userObj.username=o.user.username),window.spinner&&window.spinner.show&&window.spinner.show(!0),I(o.user,function(e,n){e?(console.error(e),window.openDialog({data:{title:" ",body:"Invalid Login",disableCancel:!0}},function(){}),r&&r(e,null)):(r||(r=c.loginCallback),r&&r(null,n)),window.spinner&&window.spinner.hide&&window.spinner.hide(!0)})),window.removeEventListener("message",e,!1),t.src="",c.externalRegister=!1,c.$$phase||c.$apply())}},!1)}else c.reset(),y(),c.registrationShown=!0,a.authShown=!0},c.showForgetPassword=function(){c.reset(),y(),c.forgetPasswordShown=!0,a.authShown=!0},c.showSuccess=function(e){y(),c.msgSuccess=e,c.successShown=!0},c.showResetPassword=function(e){c.reset(),y(),c.resetPasswordShown=!0,a.authShown=!0,c.loginCallback=e},c.updateLogin=function(e){e&&"SSOForgetPassword"!=e&&h(e),c.loginCallback=function(e,n){n?(window.authAPI._setCurrentUser(n),window.authAPI.triggerOnLogin(n)):console.error("authCtrl loginCallback error",e),a.allowCancel=!0,a.showMenu=!0,c.hideLogin(),c.$$phase||c.$apply()},P(),e&&"SSOForgetPassword"==e&&(c.showForgetPassword(),c.$apply())},c.updateLoginAuth=function(e){c.enableFacebook=v(e.enableFacebook),c.enableTwitter=v(e.enableTwitter),e.domain&&"enabled"==d&&(l=e.domain),c.$$phase||c.$apply()},c.returnToLogin=function(){c.showLogin(c.loginCallback)},c.showLogin=function(e){c.loginCallback=e,P()},c.resetPassword=function(){if(c.invalidReset=!1,c.msgError=null,c.newPassword!=c.confirmPassword)return c.invalidReset=!1,void(c.msgError="Make sure new password and confirm password are equal");var e={id:1,method:"users/changePassword",params:{email:c.email,secretCode:c.secretCode,password:c.newPassword}},n=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));window.bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result){c.showSuccess("Password reset successfully");var n={data:{title:" ",body:"Password reset successfully",disableCancel:!0}};window.openDialog(n,function(){})}else if(e&&e.error){n={data:{title:" ",body:e.error.message,disableCancel:!0}};window.openDialog(n,function(){}),console.error(e.error)}}).error(function(e,n,o,r){c.invalidCredentials=!0,console.error(e),callback&&callback(e,null)})},c.forgotPassword=function(e){if("SSOLogin"!=g){c.invalidCredentials=!1;var n={email:c.email,sendSecretCode:!0};e&&(n.email=e.email);var o={id:1,method:"users/forgotPassword",params:n},r=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(o));window.bfUtils.http.jsonp(r,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result)c.showResetPassword();else{var n={data:{title:" ",body:c.emailDoesNotExistTxt,disableCancel:!0}};window.openDialog(n,function(){}),e&&console.warn(e)}}).error(function(e,n,o,r){c.invalidCredentials=!0,console.error(e)})}else{var t=-1===p.indexOf("?")?"?":"&",s=p+t+"email="+c.email;window.bfUtils.http.get(s,{headers:{"Content-Type":"application/x-www-form-urlencoded"}}).success(function(){c.showLogin(function(e,n){authAPI._setCurrentUser(n),authAPI.triggerOnLogin(n),a.allowCancel=!0,a.showMenu=!0,c.hideLogin(),c.$$phase||c.$apply()}),cpSync.SSO.log("Succeed...")}).error(function(e,n,o,r){e&&console.error(e),bfUtils.isEmulatorCP&&(e||"0"!=n?(n&&cpSync.SSO.log("Error status:"+n),e&&cpSync.SSO.log("Error details:"+JSON.stringify(e))):cpSync.SSO.log("Error while testing SSO Login , CORS policy .."))})}},c.showBackLogin=function(){authAPI.login()},c.login=function(e,t){window.spinner&&window.spinner.show&&window.spinner.show(!0),"SSOLogin"!=g?function(e,t){if(window.appContext&&window.appContext.currentApp){c.invalidCredentials=!1,t||(t=c.loginCallback);var n=null;n="undefined"==typeof push?{}:push;var o=c.userObj.email;"enabled"==d&&l&&!o.includes("@")&&(o+=l),console.warn("email",o);var r={email:o,password:c.password,deviceId:n.deviceId,osType:n.platform?n.platform.toLowerCase():"web",externalAppId:window.appContext.currentApp.appId};e&&(r.email=e.email,r.password=e.password);var s={id:1,method:"users/login",params:r},i=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(s));window.bfUtils.http.jsonp(i,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result&&e.result.userToken)authAPI._setCurrentUser(e.result),a.$broadcast("loginSuccessfully",e.result),t&&t(null,e.result);else{c.invalidCredentials=!0;var n=null;e&&e.error&&(console.warn("login error: ",e.error),n=e.error),n&&n.message?c.msgError=n.message:c.msgError="Invalid Email or Password",t&&t(n,null)}}).error(function(e,n,o,r){c.invalidCredentials=!0,console.error(e),t&&t(e,null)})}else console.error("invalid appContext")}(e,function(e,n){if(e||!n){var o=null;if(e)switch(e.code){case 1303:o=e.message;break;default:o="Invalid Login"}else o="To log in, please make sure you have a valid connection.";var r={data:{title:" ",body:o,disableCancel:!0}};window.openDialog(r,function(){}),console.error(e),t&&t(e,null)}else t||(t=c.loginCallback),t&&t(null,n);window.spinner&&window.spinner.hide&&window.spinner.hide(!0)}):function(e,t){var n={headers:{"Content-Type":"application/x-www-form-urlencoded"}},o=c.userObj.username;if("enabled"==d&&l&&!o.includes("@")&&(o+=l),"application/x-www-form-urlencoded"==C)var r=encodeURIComponent("grant_type")+"="+encodeURIComponent("password")+"&"+encodeURIComponent("username")+"="+encodeURIComponent(o)+"&"+encodeURIComponent("password")+"="+encodeURIComponent(c.password)+"&"+encodeURIComponent("client_id")+"="+encodeURIComponent(f)+"&"+encodeURIComponent("client_secret")+"="+encodeURIComponent(m);else"multipart/form-data"==C?(n={transformRequest:angular.identity,headers:{"Content-Type":void 0}},(r=new FormData).append("username",o),r.append("password",c.password)):r={grant_type:"password",username:o,password:c.password,client_id:f};window.bfUtils.http.post(i,r,n).success(function(e){I(e,t)}).error(function(e,n,o,r){c.invalidCredentials=!0,e&&e.error_description?(console.error(e),c.msgError=e.error_description):c.msgError="Login Failed",t&&t("Login Failed",null),bfUtils.isEmulatorCP&&(e||"0"!=n?(n&&cpSync.SSO.log("Error status:"+n),e&&cpSync.SSO.log("Error details:"+JSON.stringify(e))):cpSync.SSO.log("Error while testing SSO Login , CORS policy .."))})}(0,function(e,n){if(e){console.error(e);window.openDialog({data:{title:" ",body:"Invalid Login",disableCancel:!0}},function(){}),t&&t(e,null)}else t||(t=c.loginCallback),t(null,n);window.spinner&&window.spinner.hide&&window.spinner.hide(!0)})};c.loadGDPR=function(n){var e=c.userObj.email,o=siteConfig.endPoints.crmHost+"/documents/"+n+"/check?userKey="+encodeURIComponent(e)+"&withDetails=true";bfUtils.http.get(o).success(function(e){e&&(e[n].isAccepted||(c.GDPR_title=r.trustAsHtml(e[n].title),c.GDPR_subtitle=r.trustAsHtml(e[n].subtitle),c.GDPR_details=r.trustAsHtml(e[n].details),c.showGDPR=!0,a.$broadcast("hideNav"),c.$$phase||c.$apply()))}).error(function(e){console.error(e)})},c.hideGDPR=function(){a.$broadcast("displayNav"),c.showGDPR=!1,c.GDPR_title=null,c.GDPR_subtitle=null,c.GDPR_details=null},c.showTermsOfService=function(){c.loadGDPR("bf_terms_and_conditions")},c.showPrivacyPolicy=function(){c.loadGDPR("bf_privacy_policy")},c.showAppTerms=function(){window.open(appContext.currentApp.config.TermsOfUse,"_system")},c.shouldShowAppTerms=!!(appContext.currentApp&&appContext.currentApp.config&&appContext.currentApp.config.TermsOfUse)&&appContext.currentApp.config.TermsOfUse.indexOf("appdocumentation.com")<0&&appContext.currentApp.config.TermsOfUse.indexOf("buildfire.com")<0,c.saveGDPR=function(){var o;o=function(e,n){var o={};n&&(o=n),o.appId=appContext.currentApp.appId;var r=siteConfig.endPoints.crmHost+"/documents/bf_terms_and_conditions/accept",t=siteConfig.endPoints.crmHost+"/documents/bf_privacy_policy/accept";bfUtils.http.post(r,{userKey:c.userObj.email,info:o,source:"app"}).success(function(e){bfUtils.http.post(t,{userKey:c.userObj.email,info:o,source:"app"}).success(function(e){window.location.hash="htmlBody"}).error(function(e){console.error(e)})}).error(function(e){console.error(e)})},window.$http.get("https://ipapi.co/json/").success(function(e){if(e){var n={ipInfo:{city:e.city,country:e.country_name,countryCode:e.country,lat:e.latitude,lon:e.longitude,regionName:e.region,timezone:e.timezone,zip:e.postal,ip:e.ip}};o(null,n)}else o(null,null)}).error(function(e){o(null,null)})},c.register=function(e,l){if(window.appContext&&window.appContext.currentApp){c.invalidRegister=!1,l||(l=c.loginCallback);var n=null;n="undefined"==typeof push?{}:push;var d={firstName:c.firstName||c.userObj.email,lastName:c.lastName||"",email:c.userObj.email,password:c.password,deviceId:n.deviceId,osType:n.platform?n.platform.toLowerCase():"web",externalAppId:window.appContext.currentApp.appId};e&&(d.email=e.email,d.password=e.password,d.firstName=e.firstName,d.lastName=e.lastName,e.loginProviderType&&(d.loginProviderType=e.loginProviderType));var o={id:1,method:"users/register",params:d},r=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(o));window.bfUtils.http.jsonp(r,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result)c.saveGDPR(function(e){if(e)return console.error(e)}),c.login({email:d.email,password:d.password},function(e,n){n&&n.userToken&&(c.upload(c.uploadFile,function(e,n){if(e)l&&l(e,null);else{var o=authAPI.getCurrentUser();if(n){var r={userToken:o.userToken,firstName:d.firstName,lastName:d.lastName,displayName:d.firstName+" "+d.lastName,imageUrl:n.result};s=l,i={id:1,method:"users/update",params:t=r},a=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(i)),window.bfUtils.http.jsonp(a,{bypassInterceptorForStatus:404}).success(function(e){if(e.error){var n=null;e&&e.error&&(console.error(e.error),n=e.error),s&&s(n,null)}else{var o=authAPI.getCurrentUser();null!=o&&(o.firstName=t.firstName,o.lastName=t.lastName,o.displayName=t.displayName,o.imageUrl=t.imageUrl,authAPI._setCurrentUser(o)),s&&s(null,o)}}).error(function(e,n,o,r){console.error(e),s&&s(e,null)})}else l&&l(null,o)}var t,s,i,a}),authAPI.trackRegister(n))});else{c.invalidRegister=!0;if(e&&e.error){var n={data:{title:" ",body:e.error.message,disableCancel:!0}};window.openDialog(n,function(){}),console.warn(e.error),e.error}}}).error(function(e,n,o,r){console.error(e)})}else console.error("invalid appContext")},c.upload=function(e,t){var n=authAPI.getCurrentUser();if(null!=n){var o=window.siteConfig.endPoints.authHost+"/src/server.js?method=users/uploadImage";if(e&&1==e.length){var r=e[0];s.upload({url:o,fields:{userToken:n.userToken},file:r}).progress(function(e){c.progressMessage=!0;var n=parseInt(100*e.loaded/e.total);console.log("progress: "+n+"% "+e.config.file.name)}).success(function(e,n,o,r){console.log("file "+r.file.name+"uploaded."),t&&t(null,e)}).error(function(e){c.msgError="",c.invalidRegister=!0,t&&t(e,null)})}else t&&t(null,null)}else t&&t({message:"Invalid user"},null)},c.requestLoginProvider=function(n){var e=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify({id:1,method:"secretCode/request",params:{}}));c.refWindow&&!c.refWindow.closed||window.bfUtils.http.jsonp(e,{bypassInterceptorForStatus:404}).success(function(e){if(null!=e&&null!=e.result&&e.result.code){c.secretCodeProvider=e.result.code,c.refWindow=window.open(window.siteConfig.endPoints.authHost+"/website/index.html?v=2.0&code="+encodeURIComponent(c.secretCodeProvider)+"&loginProviderType="+n,"_blank","location=no,enableViewportScale=yes"),c.refWindow&&c.refWindow.addEventListener&&c.refWindow.addEventListener("exit",function(){c.refWindow=null});setTimeout(O,1e3,120)}},function(e){console.log(JSON.stringify(e))})};var O=function o(r){if(window.appContext&&window.appContext.currentApp)if(0<r){var e={id:1,method:"users/secretCodeLogin",params:{code:c.secretCodeProvider,deviceId:push.deviceId,osType:push.platform?push.platform.toLowerCase():"web",externalAppId:window.appContext.currentApp.appId}},n=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));window.bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){if(e.error){var n=!1;1300==e.error.code&&(n=!0),1303==e.error.code&&(n=!0),n&&(c.secretCodeProvider=null)!=c.refWindow&&(c.refWindow.close(),c.refWindow=null)}else null!=e.result&&null!=e.result.userToken?(authAPI._setCurrentUser(e.result),null!=c.refWindow&&(c.refWindow.close(),c.refWindow=null),c.loginCallback&&c.loginCallback(null,authAPI.getCurrentUser())):null!=c.refWindow&&c.refWindow.closed?(c.refWindow.close(),c.secretCodeProvider=null,c.refWindow=null):setTimeout(o,1e3,r-1)},function(e){console.log(JSON.stringify(e))})}else(c.secretCodeProvider=null)!=c.refWindow&&(c.refWindow.close(),c.refWindow=null),c.loginCallback&&(c.invalidCredentials=!0,c.msgError="Invalid Login",c.loginCallback(null,null));else console.error("invalid appContext")}}]);
