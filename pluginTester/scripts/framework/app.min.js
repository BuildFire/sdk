...
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function HealthAPI(e){this.context=e}HealthAPI.prototype={get mockMode(){return!(window.hasOwnProperty("navigator")&&navigator.health)},_authorizeQueries:function(e,t){function o(){return t(null,!0)}e=[{read:[e.dataType]}];if(!bfUtils.isAndroid)return o();navigator.health.requestAuthorization(e,o,t)},requestAuthorization:function(e,t){return"function"!=typeof t&&(t=console.error),e&&e.length?this.mockMode?t(null):void navigator.health.requestAuthorization(e,t,t):t("requestAuthorization:: dataTypes must be an array")},query:function(t,o){return"function"!=typeof o&&(o=console.error),t&&"object"===_typeof(t)?t.dataType&&"string"==typeof t.dataType?!t.startDate||["object","number"].indexOf(_typeof(t.startDate))<0?o("query:: options.startDate is required and must be an object or a number"):(t.endDate||(t.endDate=new Date),["object","number"].indexOf(_typeof(t.endDate))<0?o("query:: options.endDate must be an object or a number"):t.limit&&"number"!=typeof t.limit?o("query:: options.limit must be a number"):this.mockMode?o(null):void this._authorizeQueries(t,function(e){return e?o(e):void navigator.health.query(t,function(e){return o(null,e)},o)})):o("query:: options.dataType is required and must be a string"):o("query:: options are required")},queryAggregated:function(t,o){return"function"!=typeof o&&(o=console.error),t&&"object"===_typeof(t)?t.dataType&&"string"==typeof t.dataType?!t.startDate||["object","number"].indexOf(_typeof(t.startDate))<0?o("query:: options.startDate is required and must be an object or a number"):(t.endDate||(t.endDate=new Date),["object","number"].indexOf(_typeof(t.endDate))<0?o("query:: options.endDate must be an object or a number"):t.bucket&&"string"!=typeof t.bucket?o("query:: options.bucket must be a number"):t.bucket&&["hour","day","week","month","year"].indexOf(t.bucket)<0?o("query:: invalid value for options.bucket. Accepted values: hour day week month, year"):this.mockMode?o(null):void this._authorizeQueries(t,function(e){return e?o(e):void navigator.health.queryAggregated(t,function(e){return o(null,e)},o)})):o("query:: options.dataType is required and must be a string"):o("query:: options are required")}};
