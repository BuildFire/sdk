...
"use strict";var inputAPI={initialized:!1,currentStepData:{},currentStepOptions:{},init:function(){var t=this;this.inputDialog?this.inputDialog.innerHTML="":(this.inputDialog=document.createElement("div"),this.inputDialog.style.display="none"),window.addEventListener("keyboardWillShow",function(){t.actionFooter.style.display="none"}),window.addEventListener("keyboardDidHide",function(){t.actionFooter.style.display="flex"}),0<=window.location.pathname.indexOf("pluginTester")?(this.inputDialog.style.height=document.getElementById("app").offsetHeight+"px",this.inputDialog.style.position="absolute"):(this.inputDialog.style.height="100vh",this.inputDialog.style.position="fixed"),this.inputDialog.id="inputDialog",this.inputDialog.className="primaryBackgroundTheme",this.inputDialog.className="backgroundColorTheme",this.dialogNav=document.createElement("div"),this.dialogNav.className="inputapi-nav titleBarBackgroundTheme",this.inputDialog.appendChild(this.dialogNav),this.dialogNavFlex=document.createElement("div"),this.dialogNavFlex.className="inputapi-nav-flex",this.dialogNav.appendChild(this.dialogNavFlex),this.currentUserContainer=document.createElement("div"),this.currentUserContainer.className="inputapi-user-container",this.inputDialog.appendChild(this.currentUserContainer),this.textarea=document.createElement("textarea"),this.textarea.className="inputapi-textarea",this.textarea.addEventListener("input",function(e){t.currentStepData.textValue=e.target.value,t.doneButton.disabled=!(!t.currentStepOptions.required||t.currentStepData.textValue.length)}),this.textarea.onfocus=function(e){document.body.scrollTop=0},this.inputDialog.appendChild(this.textarea),this.imageGallery=document.createElement("div"),this.imageGallery.id="imageGallery",this.inputDialog.appendChild(this.imageGallery),this.cancelButton=document.createElement("button"),this.cancelButton.className="inputapi-cancel titleBarTextAndIcons",this.dialogNavFlex.appendChild(this.cancelButton),this.title=document.createElement("h1"),this.title.className="inputapi-nav-title titleBarTextAndIcons",this.dialogNavFlex.appendChild(this.title),this.doneButton=document.createElement("button"),this.doneButton.className="inputapi-done titleBarTextAndIcons",this.dialogNavFlex.appendChild(this.doneButton),this.actionFooter=document.createElement("div"),this.actionFooter.className="inputapi-footer",this.inputDialog.appendChild(this.actionFooter),this.cameraBtn=document.createElement("span"),this.cameraBtn.className="glyphicon glyphicon-camera",this.cameraBtn.onclick=function(e){return t.showFileDialog()},this.actionFooter.appendChild(this.cameraBtn),0<=window.location.pathname.indexOf("pluginTester")?document.getElementById("app").appendChild(this.inputDialog):document.body.appendChild(this.inputDialog),this.initialized=!0},showFileDialog:function(){var t=this,e=new PublicFilesAPI({appId:"testAppId"});e._onComplete=function(e){10<=t.currentStepData.images.length||(t.currentStepData.images.push(e.url),t.updateImageGallery())},e.showDialog({},function(e,t){})},updateImageGallery:function(){var i=this;this.imageGallery.innerHTML="",this.currentStepData.images.forEach(function(e,t){i.addImageToGallery(e,t)}),this.currentStepData.images.length&&this.currentStepData.images.length<10&&this.addPlusToGallery(),10<=this.currentStepData.images.length?this.cameraBtn.style.color="#555 !important":this.cameraBtn.style.color=""},addPlusToGallery:function(){var t=this,e=document.createElement("span");e.className="glyphicon glyphicon-plus",e.onclick=function(e){return t.showFileDialog()},this.imageGallery.appendChild(e)},addImageToGallery:function(e,t){var i=this,a=document.createElement("div");a.className="img-gallery-container";var n=document.createElement("span");n.className="galery-delete glyphicon glyphicon-remove-sign",n.onclick=function(){i.currentStepData.images.splice(t,1),i.updateImageGallery()},a.appendChild(n);var l=document.createElement("img");l.setAttribute("src","https://czi3m2qn.cloudimg.io/s/crop/100x100/"+e),l.className="img-gallery-item",a.appendChild(l),this.imageGallery.appendChild(a)},renderStep:function(e,t,i){var a=this;window.Keyboard&&window.Keyboard.shrinkView&&(window.Keyboard.shrinkView(!0),window.Keyboard.disableScrollingInShrinkView(!0)),this.currentStepData={images:[]},this.currentStepOptions=e,this.title.innerHTML=e.title||"",this.actionFooter.style.display=e.attachments?"flex":"none",!e.required||e.defaultValue&&0<e.defaultValue.length?this.doneButton.disabled=!1:this.doneButton.disabled=!0,this.cameraBtn.style.display=this.currentStepOptions.attachments&&this.currentStepOptions.attachments.image&&this.currentStepOptions.attachments.image.enable&&this.currentStepData.images.length<10?"block":"none",this.currentUserContainer.innerHTML="";var n=authAPI.getCurrentUser();console.log("Renering inputAPI for user",n),this.userImage=document.createElement("img"),n&&n.imageUrl?this.userImage.src=n.imageUrl:this.userImage.src="https://pluginserver.buildfire.com/styles/media/avatar-placeholder.png",this.userImage.className="inputapi-user-image",this.currentUserContainer.appendChild(this.userImage),this.userTitle=document.createElement("h1"),this.userTitle.className="inputapi-user-title",n&&n.displayName&&(this.userTitle.innerHTML=n.displayName),this.currentUserContainer.appendChild(this.userTitle),this.textarea.placeholder=e.placeholder||"Type something...",this.textarea.maxlength=e.maxLength||1e4,this.textarea.value=e.defaultValue||"",this.cancelButton.innerHTML=e.cancelText||"Cancel",this.doneButton.innerHTML=e.saveText?e.saveText:e._buffer.length?"Next":"Done",this.doneButton.onclick=function(e){return i(a.currentStepData)},this.cancelButton.onclick=function(e){return t()}},showTextDialog:function(e,a){var n=this;if(e&&a){this.initialized||this.init();var l=Array.isArray(e)?e:[e],s=[],t=!1,i=!1,o=!1;if(l.forEach(function(e){e.cancelText&&9<e.cancelText.length&&(o=!0),e.saveText&&9<e.saveText.length&&(i=!0),e.title&&14<e.title.length&&(t=!0)}),t)return a(new Error("Title too long, max 14 chars"));if(i)return a(new Error("saveText too long, max 9 chars"));if(o)return a(new Error("cancelText too long, max 9 chars"));var r=function(){n.inputDialog.classList.remove("active"),a(null,{cancelled:!0,results:s}),setTimeout(u,600),setTimeout(function(){n.inputDialog.style.display="none",n.init()},500)},c=l.shift();c._buffer=l,this.renderStep(c,r,function e(t){s.push(t);var i=l.shift();i?(i._buffer=l,n.renderStep(i,r,e)):(n.inputDialog.classList.remove("active"),a(null,{cancelled:!1,results:s}),setTimeout(u,600),setTimeout(function(){n.inputDialog.style.display="none",n.init()},500))}),this.inputDialog.style.display="flex",setTimeout(function(){n.inputDialog.classList.add("active")},10)}function u(){window.Keyboard&&window.Keyboard.shrinkView&&(window.Keyboard.shrinkView(!1),window.Keyboard.disableScrollingInShrinkView(!1))}}};setTimeout(function(){inputAPI.init()},5e3);
...
"use strict";function PublicFilesAPI(e){this.context=e}PublicFilesAPI.prototype={showDialog:function(l,o){l||(l={});var a=this,i=[],s=[],u=null;function r(s,r){return new Promise(function(n,e){var t=!0;if(l.filter&&!function(e,n){for(var t=0;t<=n.length;t++)if(n[t]==e.type)return!0;return!1}(s,l.filter)&&(r.status="failed",r.error="invalid File Format",a._onComplete&&a._onComplete(r),t=!1,n(r)),1e7<s.size&&(r.status="failed",r.error="invalid File Size",a._onComplete&&a._onComplete(r),t=!1,n(r)),t){var o=new FormData;o.append("file",s),o.append("pluginId",a.context.pluginId),o.append("instanceId",a.context.instanceId),o.append("appId",a.context.appId),u&&u.accessToken&&o.append("accessToken",u.accessToken);var i=new XMLHttpRequest;i.upload.addEventListener("progress",function(e){if(e.lengthComputable){var n=Math.round(100*e.loaded/e.total);r.percentage=n,a._onProgress&&a._onProgress(r)}},!1),i.onload=function(){window.spinner&&window.spinner.hide();var e=null;i.responseText&&(e=JSON.parse(i.responseText)),200==i.status?(r.url=e.url,r.status="success"):(r.status="failed",e.message?r.error=e.message:r.error="An error has occurred"),a._onComplete&&a._onComplete(r),n(r)},i.onerror=function(){window.spinner.hide(),r.status="failed",a._onComplete&&a._onComplete(r),n(r)},i.timeout=6e4,i.open("POST",window.siteConfig.endPoints.publicFilesHost+"/publicFiles/upload/"),i.send(o),window.spinner&&window.spinner.show()}})}function p(){!function(e){for(var n=0;n<e.length;n++){var t={fileId:n,filename:e[n].name};e[n].fileId=n,s.push(t),i.push(r(e[n],t))}Promise.all(i).then(function(e){console.log(e),o(null,e)})}(this.files)}window.authAPI.getCurrentUser(function(e,n){n&&(u=n);var t=document.createElement("input");t.setAttribute("type","file"),t.setAttribute("id","publicFilesHiddenInput"),l&&l.allowMultipleFilesUpload&&(t.setAttribute("multiple",""),t.setAttribute("name","files[]")),l&&l.filter&&(t.accept=l.filter.join(",")),t.addEventListener("change",p,!1),t.click()})},onProgress:function(e){this._onProgress=e},onComplete:function(e){this._onComplete=e}};