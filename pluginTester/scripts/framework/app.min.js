...
var inputAPI = {
  ...
  init: function init() {
    ...
    authAPI.getUserPictureUrl({ userId: user._id }, function (err, data) {
      console.log(data);
    });
    ...
    if (user.image) {} else {
      this.userImage.src = '../../../styles/media/avatar-placeholder.png';
    }
  ...
  renderStep: function renderStep(stepOptions, handleCancel, handleNext) {
    ...
    this.textarea.value = stepOptions.defaultText || '';
