...
"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}"undefined"==typeof AiAPI&&(window.AiAPI=function(t){this.context=t}),AiAPI.prototype.chat=function(t,o){(t=!t||"object"!=_typeof(t)?{}:t).appId=window.appContext.currentApp.appId;t={url:"".concat(window.siteConfig.endPoints.gatewayHost,"/ai/chat"),headers:{"Content-Type":"application/json"},body:JSON.stringify(t),method:"POST"};fetch(t.url,{method:t.method,headers:t.headers,body:t.body}).then(function(t){return t.json()}).then(function(t){o(null,t)}).catch(function(t){o(t,null)})};