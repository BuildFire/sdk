...
"use strict";function _typeof(i){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(i){return typeof i}:function(i){return i&&"function"==typeof Symbol&&i.constructor===Symbol&&i!==Symbol.prototype?"symbol":typeof i})(i)}var imageTools={get ENUMS(){return{SIZES:{xxs:32,xs:64,s:128,m:200,l:304,xl:416,xxl:600,720:720,1080:1080,1440:1440,1920:1920,2560:2560,3840:3840,get full_width(){return this.findNearest(1)},get half_width(){return this.findNearest(2)},get third_width(){return this.findNearest(3)},get fourth_width(){return this.findNearest(4)},get fifth_width(){return this.findNearest(5)},get sixth_width(){return this.findNearest(6)},findNearest:function(i){for(var t=null,e=0;e<this.VALID_SIZES.length;e++){var n=this.VALID_SIZES[e];if(window.innerWidth/i<this[n]){t=n;break}}return this[t]},VALID_SIZES:["xxs","xs","s","m","l","xl","xxl","720","1080","1440","1920","2560","3840","full_width","half_width","third_width","quarter_width","fifth_width","sixth_width"]},ASPECT_RATIOS:{"1:1":1,"4:3":.75,"16:9":.5625,"9:16":1.77777778,"11:5":.45454545,"4:1":.25,"2.39:1":.41841004,VALID_RATIOS:["1:1","4:3","16:9","9:16","11:5","4:1","2.39:1"]}}},resizeImage:function(i,t,e,n){if(!i)return null;if(i&&i.indexOf&&(-1<i.indexOf("://localhost:")||-1<i.indexOf("cdvfile://"))||-1<i.indexOf("file://"))return i;if(/\..{3,4}(?!.)/g.test(i)&&!/.(png|jpg|jpeg|gif|jfif|svg)(?!.)/gi.test(i)){var r=(/.{0,4}(?!.)/g.exec(i)||["Selected"])[0];return console.warn(r+" files are not supported by resizeImage. Returning original URL: "+i),i}if(t){if("object"!=_typeof(t))throw"options not an object"}else t={width:window.innerWidth};r=t.disablePixelRation?1:window.devicePixelRatio;if(r<1&&(r=1),"full"==t.width&&(t.width=window.innerWidth),"full"==t.height&&(t.height=window.innerHeight),window.forceImgix){if(!(o=imageTools.imgix._transformToImgix(i)))return i}else o=window.siteConfig.endPoints.cloudImageHost+"/"+i;var o=o+(-1!==i.indexOf("?")?"&":"?")+(window.forceImgix?"":"func=bound");if(t.size&&t.aspect){if(this.ENUMS.SIZES.VALID_SIZES.indexOf(t.size)<0){var s=this.ENUMS.SIZES.VALID_SIZES.join(", ");return console.warn("Inavlid size. Availible options are "+s+". Returning original url"),i}if(this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.indexOf(t.aspect)<0){s=this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.join(", ");return console.warn("Inavlid aspect ratio. Availible options are "+s+". Returning original url"),i}t.width=this.ENUMS.SIZES[t.size],t.height=t.width*this.ENUMS.ASPECT_RATIOS[t.aspect]}return t.width&&!t.height?o+="&width="+Math.floor(t.width*r):!t.width&&t.height?o+="&height="+Math.floor(t.height*r):t.width&&t.height?o+="&width="+Math.floor(t.width*r)+"&height="+Math.floor(t.height*r):o=i,this._handleElement(e,o,n),o},cropImage:function(i,t,e,n){if(!i)return null;if(i&&i.indexOf&&(-1<i.indexOf("://localhost:")||-1<i.indexOf("cdvfile://"))||-1<i.indexOf("file://"))return i;if(/\..{3,4}(?!.)/g.test(i)&&!/.(png|jpg|jpeg|gif|jfif|svg)(?!.)/gi.test(i)){var r=(/.{0,4}(?!.)/g.exec(i)||["Selected"])[0];return console.warn(r+" files are not supported by cropImage. Returning original URL: "+i),i}if("object"!=_typeof(t=t||{}))throw"options not an object";if(t.size&&t.aspect){if(this.ENUMS.SIZES.VALID_SIZES.indexOf(t.size)<0){r=this.ENUMS.SIZES.VALID_SIZES.join(", ");return console.warn("Inavlid size. Availible options are "+r+". Returning original url"),i}if(this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.indexOf(t.aspect)<0){var o=this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.join(", ");return console.warn("Inavlid aspect ratio. Availible options are "+o+". Returning original url"),i}t.width=this.ENUMS.SIZES[t.size],t.height=t.width*this.ENUMS.ASPECT_RATIOS[t.aspect]}if("full"==(t=!t.width&&!t.height?{width:"full",height:"full"}:t).width&&(t.width=window.innerWidth),"full"==t.height&&(t.height=window.innerHeight),!t.width||!t.height)return console.warn("cropImage doenst have width or height please fix. returning original url"),i+"?h="+t.height+"&w="+t.width;o=window.devicePixelRatio;if(t&&t.disablePixelRatio&&(o=t.disablePixelRatio),window.forceImgix){if(!(s=imageTools.imgix._transformToImgix(i)))return i}else s=window.siteConfig.endPoints.cloudImageHost+"/"+i;var s=s+(-1!==i.indexOf("?")?"&":"?")+(window.forceImgix?"fit=crop":"func=crop"),i=Math.floor(t.width*o),o=Math.floor(t.height*o);return this._handleElement(e,s+="&width="+i+"&height="+o,n),s},_handleElement:function(e,n,i){var t;e&&n&&(t=this._getLocalPath(n),"IMG"===e.tagName?(e.style.setProperty("opacity","0","important"),e.src=t,e.onload=function(){e.style.removeProperty("opacity"),i&&i(t)},e.onerror=function(){bfUtils.isApp&&imageCacheAPI.download(n,function(i,t){return i?e.src=n:void(e.src=t)})}):this._handleBgImage(e,t,n,i))},imgix:{imgixWhitelistedUrls:{"http://imageserver.prod.s3.amazonaws.com":"https://buildfire.imgix.net","http://s3-us-west-2.amazonaws.com/imageserver.prod":"https://buildfire.imgix.net","http://pluginserver.buildfire.com":"https://bfplugins.imgix.net","http://s3.amazonaws.com/Kaleo.DevBucket":"https://bflegacy.imgix.net","http://s3-us-west-2.amazonaws.com/imagelibserver":"https://buildfire-uat.imgix.net","http://s3-us-west-2.amazonaws.com/pluginserver.uat":"https://bfplugins-uat.imgix.net"},_transformToImgix:function(i){for(var t in i=i.replace(/^https:\/\//i,"http://"),this.imgixWhitelistedUrls)if(0===i.indexOf(t))return this.imgixWhitelistedUrls[t]+i.split(t)[1]}},_handleBgImage:function(e,i,n,r){o(e,i);var t=new Image;function o(i,t){if(!t)return i.style.removeProperty("background-image");i.style.setProperty("background-image",'url("'+t+'")',"important")}t.src=i,t.onload=function(){r&&r(i)},t.onerror=function(){if(o(e),!bfUtils.isApp)return o(e,n);imageCacheAPI.download(n,function(i,t){return i?(r&&r(n),o(e,n)):void window.requestAnimationFrame(function(){o(e,t),r&&r(t)})})}},_getLocalPath:function(i){if(!bfUtils.isApp)return i;var t=(t=(i=i.replace(/(http|https):\/\/\S{0,8}.cloudimg.io\//g,"")).match(/(png|jpg|jpeg|gif|jfif|svg)/g)[0]||"")?"."+t:"",e=0;if(!i.length)return e;for(var n=0;n<i.length;n++){e=(e<<5)-e+i.charCodeAt(n);e|=0}return"".concat(window._appRoot.replace("app","imageCache/images")).concat(e).concat(t)},isProdImageServer:function(i){return 0==i.indexOf("http://imageserver.prod.s3.amazonaws.com")||0==i.indexOf("https://imageserver.prod.s3.amazonaws.com")||0==i.indexOf("https://s3-us-west-2.amazonaws.com/imageserver.prod")}};
