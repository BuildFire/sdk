...
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}var richModal=function(){var g=document.createElement("div");g.id="richModal",g.className="hidden";var e=document.createElement("div");e.className="focus-screen hidden",g.appendChild(e),document.body.appendChild(g);var b=["default","primary","success","info","warning","danger"],v=null,C=[];function T(){try{if(v)return;var e=!(null==C||!C.length)&&C[0].options.forceShow;if(0<=window.location.hash.indexOf("accessCode")&&!e)return setTimeout(T,5e3);var t=document.getElementsByClassName("login-holder")[0];if(t&&-1===t.className.indexOf("ng-hide")&&!e)return setTimeout(T,5e3);var n=(v=C.shift()).options,o=v.callback,i=document.getElementById("richModal");i.querySelector(".detail-modal")&&(console.error("showing modal while another is in DOM"),i.querySelector(".detail-modal").remove()),i.className="";var a=document.getElementsByClassName("focus-screen")[0];a.className="focus-screen animated fadeInScreen",a.onclick=function(){n&&n.forceAction||(N(),a.onclick=function(){},o&&o(null,{buttonType:null}))};var l,c,s,r=document.createElement("div");r.className="detail-modal animated fadeInUp backgroundColorTheme",n.title&&((l=document.createElement("h1")).id="modalTitle",l.innerHTML=n.title,n.design&&(s="",n.design.title&&n.design.title.align&&(s+="text-align: "+n.design.title.align+" !important;"),n.design.textColor&&(s+="color: "+n.design.textColor+" !important;"),l.setAttribute("style",s)),r.appendChild(l)),n.subtitle&&((c=document.createElement("span")).className="subtitle",c.innerHTML=n.subtitle,n.design&&(s="",n.design.subtitle&&n.design.subtitle.align&&(s+="text-align: "+n.design.subtitle.align+" !important;"),n.design.textColor&&(s+="color: "+n.design.textColor+" !important;"),c.setAttribute("style",s)),r.appendChild(c));var d=document.createElement("div");d.className="rich-content bodyTextTheme",n.isContentHTML||void 0===n.isContentHTML?d.innerHTML=n.richContent||"":d.innerText=n.richContent||"",r.appendChild(d);var u,m=document.createElement("div");m.className="button-container",r.appendChild(m),!n.showDismissButton&&void 0!==n.showDismissButton||((u=document.createElement("button")).className=n.action?"dismiss-button primaryTheme":"dismiss-button dismiss-large primaryTheme",u.innerHTML=n.dismissButtonText||"Dismiss",u.onclick=function(){N(),u.onclick=function(){},o&&o(null,{buttonType:"dismiss"})},m.appendChild(u));var p="";n.design&&(n.design.fullScreen&&g.classList.add("fullScreen"),n.design.backgroundColor&&(p+="background : "+n.design.backgroundColor+" !important;"),n.design.textColor&&(p+="color : "+n.design.textColor+" !important"),r.setAttribute("style",p),u.setAttribute("style",p))}catch(e){console.error("Failed to render rich modal",e)}if(n.action&&!n.action.length&&(n.action=[n.action]),n.action)for(var f=0;f<n.action.length;f++){var h,y=function(e){var t=n.action[e];try{if(h=document.createElement("button"),t.type||(t.type="primary"),!b.includes(t.type))return{v:o("Invalid button type")};h.className="action-button ".concat(t.type,"Theme"),!1===n.showDismissButton&&(h.className="action-button ".concat(t.type,"Theme action-button-large")),h.innerHTML=t.title||"[ Click ]",h.onclick=function(){t.handler?t.handler():((new ActionItemsAPI).execute(t,function(e,t){}),o&&o(null,{buttonType:"action",value:t})),t.preventAutoClose||N()},n.design&&p&&h.setAttribute("style",p),m.appendChild(h)}catch(e){console.error("Failed to bind action to rich modal",e)}}(f);if("object"===_typeof(y))return y.v}document.getElementById("richModal").appendChild(r)}function N(){var e=document.getElementsByClassName("focus-screen")[0];e&&(e.className="focus-screen animated fadeOutScreen");var t=document.getElementsByClassName("detail-modal")[0];t&&(t.className="detail-modal animated fadeOut");var n=document.getElementById("richModal");setTimeout(function(){t&&t.remove(),v=null,0<C.length?setTimeout(T,300):n&&!n.querySelector(".detail-modal")&&(n.className="hidden")},700)}return{display:function(e,t){C.push({options:e,callback:t}),T()},close:function(){N()},isVisible:function(){return!(0<=document.getElementById("richModal").className.indexOf("hidden"))},clearAll:function(){C=[],N()}}}();
