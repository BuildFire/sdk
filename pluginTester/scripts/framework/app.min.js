...
"use strict";function StripeAPI(e){if(this.context=e,!this.context)throw Error("stripeAPI: invalid context");this.context.apiKeys||(this.context.apiKeys={})}StripeAPI.prototype={_sendRequest:function(e,i,t,s,n){var o="",c=new XMLHttpRequest,a=window.siteConfig.endPoints.stripeHost+"/stripe/"+i;if("GET"===(e=e.toUpperCase())&&t){var u="?";for(var l in t)t.hasOwnProperty(l)&&void 0!==t[l]&&(u+=l+"="+encodeURIComponent(t[l])+"&");a+=u=u.slice(0,-1)}else o=JSON.stringify(t);if(c.open(e,a,!0),c.setRequestHeader("Content-Type","application/json"),s)for(var l in s)s.hasOwnProperty(l)&&c.setRequestHeader(l,s[l]);c.onreadystatechange=function(){var e=null;try{e=JSON.parse(c.responseText)}catch(e){}4==c.readyState&&(200===c.status?n&&n(null,e):n&&n(e))},c.send(o)},_loadScript:function(e,i){var t=document.createElement("script");if(t.type="text/javascript",t.readyState?t.onreadystatechange=function(){"loaded"!=t.readyState&&"complete"!=t.readyState||(t.onreadystatechange=null,i&&i())}:t.onload=function(){i&&i()},t.src=e.url,e.attr)for(var s in e.attr)t.setAttribute(s,e.attr[s]);for(var n=document.getElementsByTagName("script"),o=n.length;o--;)if(n[o].src==e.url)return i&&i(),!0;document.getElementsByTagName("head")[0].appendChild(t)},_guid:function(){function e(){return(65536*(1+Math.random())|0).toString(16).substring(1)}return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()},_openStripeCheckout:function(e,t){var i=e.items,s=e.successUrl,n=e.cancelUrl,o=e.submitType,c=e.customerEmail,a=e.sessionId,u=e.clientReferenceId,l=e.domain,r=e.events,p=this,d=null,m=!1,y=null,f=!1;function _(e){e||(e={}),clearInterval(d),(e.invokeDismiss||void 0===e.invokeDismiss)&&window.richModal&&window.richModal.close(),y&&y.close(),r&&"function"==typeof r.onClose&&r.onClose()}function b(){p._sendRequest("GET","checkout/sessions",{session_id:a,client_reference_id:u},{"x-api-key":p.context.apiKeys.awsApiPublicKey},function(e,i){if(i){if(f)return;f=!0,_(),t&&t(e,i)}})}var h=l+"/payments/checkout?stripeKey="+p.context.apiKeys.stripePublicKey;function g(){y=window.open(h,"_blank","location=no"),d=setInterval(function(){y&&y.closed&&_(),"visible"==window.document.visibilityState?b():m||(m=!0,setTimeout(function(){m=!1,b()},6e4))},5e3),setTimeout(function(){_()},9e5)}a&&(h+="&sessionId="+encodeURIComponent(a)),u&&(h+="&clientReferenceId="+encodeURIComponent(u)),s&&(h+="&successUrl="+encodeURIComponent(s)),n&&(h+="&cancelUrl="+encodeURIComponent(n)),o&&(h+="&submitType="+encodeURIComponent(o)),c&&(h+="&customerEmail="+encodeURIComponent(c)),i&&(h+="&items="+encodeURIComponent(JSON.stringify(i))),window.richModal&&window.richModal.display({title:"",showDismissButton:!1,richContent:"<div style='text-align:center;'>Payment in progress <br/> Please wait...</div>",action:{title:"Cancel",handler:function(){_({invokeDismiss:!1})}}}),r&&"function"==typeof r.onProgress&&r.onProgress(g),!1===p.openPaymentWindow||g()},pay:function(e,t){var s=this;s.context.apiKeys.stripePublicKey?s._loadScript({url:"https://checkout.stripe.com/checkout.js"},function(){var i=StripeCheckout.configure({key:s.context.apiKeys.stripePublicKey,image:"https://stripe.com/img/documentation/checkout/marketplace.png",locale:"auto",token:function(e){i.close(),t&&t(null,{sourceToken:e})}});i.open({}),window.addEventListener("popstate",function(){i.close()})}):t&&t("Missing stripePublicKey in context",null)},charge:function(s,n){var o=this;if(o.context.apiKeys.stripePublicKey)if(o.context.apiKeys.awsApiPublicKey)if(s)if(o.openPaymentWindow=s.openPaymentWindow,s.items&&0!=s.items.length){for(var e=[],i=0;i<s.items.length;i++){if(!s.items[i].name)return void(n&&n("Missing name in items index "+i,null));if(!s.items[i].amount)return void(n&&n("Missing amount in items index "+i,null));e.push({name:s.items[i].name,description:s.items[i].description||void 0,amount:s.items[i].amount,currency:s.items[i].currency||"usd",quantity:s.items[i].quantity||1})}var c=window.siteConfig.endPoints.appHost,a="app_id_"+o.context.appId+"_ref_id_"+o._guid(),t={type:"line_items",line_items:e,client_reference_id:a,success_url:c+"/payments/success",cancel_url:c+"/payments/cancel"};s.submitType&&(t.submit_type=s.submitType),s.customerId&&(t.customer_id=s.customerId),s.customerEmail&&(t.customer_email=s.customerEmail),o._sendRequest("POST","checkout/sessions",t,{"x-api-key":o.context.apiKeys.awsApiPublicKey},function(e,i){if(e)n&&n(e,i);else{var t=i.sessionId;o._openStripeCheckout({sessionId:t,clientReferenceId:a,domain:c,events:s.events},function(e,i){n&&n(e,i)})}})}else n&&n("Missing items",null);else n&&n("invalid params",null);else n&&n("Missing awsApiPublicKey in context",null);else n&&n("Missing stripePublicKey in context",null)},subscribe:function(s,n){var o=this;if(o.context.apiKeys.stripePublicKey)if(o.context.apiKeys.awsApiPublicKey)if(s)if(o.openPaymentWindow=s.openPaymentWindow,s.items&&0!=s.items.length){for(var e=[],i=0;i<s.items.length;i++){if(!s.items[i].planId)return void(n&&n("Missing planId in items index "+i,null));e.push({plan_id:s.items[i].planId,quantity:s.items[i].quantity||1})}var c=window.siteConfig.endPoints.appHost,a="app_id_"+o.context.appId+"_ref_id_"+o._guid(),t={type:"subscription",subscription_data:e,client_reference_id:a,success_url:c+"/payments/success",cancel_url:c+"/payments/cancel"};s.trialPeriodDays&&(t.trial_period_days=s.trialPeriodDays),s.customerId&&(t.customer_id=s.customerId),s.customerEmail&&(t.customer_email=s.customerEmail),s.metaData&&(t.meta_date=s.metaData),o._sendRequest("POST","checkout/sessions",t,{"x-api-key":o.context.apiKeys.awsApiPublicKey},function(e,i){if(e)n&&n(e,i);else{var t=i.sessionId;o._openStripeCheckout({sessionId:t,clientReferenceId:a,domain:c,events:s.events},function(e,i){n&&n(e,i)})}})}else n&&n("Missing items",null);else n&&n("invalid params",null);else n&&n("Missing awsApiPublicKey in context",null);else n&&n("Missing stripePublicKey in context",null)},purchase:function(e,t){var i=this;if(i.context.apiKeys.stripePublicKey)if(i.context.apiKeys.awsApiPublicKey)if(e)if(e.items&&0!=e.items.length){for(var s=[],n=0;n<e.items.length;n++){if(!e.items[n].sku)return void(t&&t("Missing sku in items index "+n,null));s.push({sku:e.items[n].sku,quantity:e.items[n].quantity||1})}var o=window.siteConfig.endPoints.appHost,c={items:s,clientReferenceId:"app_id_"+i.context.appId+"_ref_id_"+i._guid(),successUrl:o+"/payments/success",cancelUrl:o+"/payments/cancel",submitType:e.submitType,customerEmail:e.customerEmail,domain:o,events:e.events};i._openStripeCheckout(c,function(e,i){t&&t(e,i)})}else t&&t("Missing items",null);else t&&t("invalid params",null);else t&&t("Missing awsApiPublicKey in context",null);else t&&t("Missing stripePublicKey in context",null)},getSubscription:function(e,t){if(this.context.apiKeys.stripePublicKey)if(this.context.apiKeys.awsApiPublicKey)if(e)if(e.subscriptionId){var i={subscription_id:e.subscriptionId};this._sendRequest("GET","customer/subscription",i,{"x-api-key":this.context.apiKeys.awsApiPublicKey},function(e,i){t&&t(e,i)})}else t&&t("Missing params subscriptionId",null);else t&&t("invalid params",null);else t&&t("Missing awsApiPublicKey in context",null);else t&&t("Missing stripePublicKey in context",null)},cancelSubscription:function(e,t){if(this.context.apiKeys.stripePublicKey)if(this.context.apiKeys.awsApiPublicKey)if(e)if(e.subscriptionId)if(e.customerId){var i={subscription_id:e.subscriptionId,customer_id:e.customerId};this._sendRequest("DELETE","customer/subscription",i,{"x-api-key":this.context.apiKeys.awsApiPublicKey},function(e,i){t&&t(e,i)})}else t&&t("Missing params customerId",null);else t&&t("Missing params subscriptionId",null);else t&&t("invalid params",null);else t&&t("Missing awsApiPublicKey in context",null);else t&&t("Missing stripePublicKey in context",null)},addCustomerCard:function(s,n){var o=this;if(o.context.apiKeys.stripePublicKey)if(o.context.apiKeys.awsApiPublicKey)if(s)if(s.customerId){var c=window.siteConfig.endPoints.appHost,a="app_id_"+o.context.appId+"_ref_id_"+o._guid(),e={mode:"setup",type:"setup",client_reference_id:a,success_url:c+"/payments/success",cancel_url:c+"/payments/cancel"};s.customerEmail&&(e.customer_email=s.customerEmail),o._sendRequest("POST","checkout/sessions",e,{"x-api-key":o.context.apiKeys.awsApiPublicKey},function(e,i){if(e)n&&n(e,i);else{var t=i.sessionId;o._openStripeCheckout({sessionId:t,clientReferenceId:a,domain:c},function(e,i){if(e)n&&n(e,null);else if(i){var t={customer_id:s.customerId,setup_intent:i.setup_intent};o._sendRequest("POST","customer/card",t,{"x-api-key":o.context.apiKeys.awsApiPublicKey},function(e,i){n&&n(e,i)})}else n&&n(null,null)})}})}else n&&n("Missing params customerId",null);else n&&n("invalid params",null);else n&&n("Missing awsApiPublicKey in context",null);else n&&n("Missing stripePublicKey in context",null)}};
"use strict";var richModal=function(){var e=document.createElement("div");e.id="richModal",e.className="hidden";var t=document.createElement("div");t.className="focus-screen hidden",e.appendChild(t),document.body.appendChild(e);var d=null,m=[];function r(){try{if(d)return;if(0<=window.location.hash.indexOf("accessCode"))return setTimeout(r,5e3);var e=document.getElementsByClassName("login-holder")[0];if(e&&-1===e.className.indexOf("ng-hide"))return setTimeout(r,5e3);var t=d=m.shift();document.getElementById("richModal").className="",document.getElementsByClassName("focus-screen")[0].className="focus-screen animated fadeInScreen";var n=document.createElement("div");n.className="detail-modal animated fadeInUp";var a=document.createElement("h1");if(30<t.title.length&&(t.title=t.title.substring(0,27).trim()+"..."),a.innerHTML=t.title,n.appendChild(a),t.subtitle){var i=document.createElement("span");i.className="subtitle",i.innerHTML=t.subtitle,n.appendChild(i)}var s=document.createElement("div");s.className="rich-content",s.innerHTML=t.richContent,n.appendChild(s);var c=document.createElement("div");if(c.className="button-container",n.appendChild(c),t.showDismissButton||void 0===t.showDismissButton){var o=document.createElement("button");o.className=t.action?"dismiss-button":"dismiss-button dismiss-large",o.innerHTML="Dismiss",o.onclick=u,c.appendChild(o)}}catch(e){console.error("Failed to render rich modal",e)}if(t.action)try{var l=document.createElement("button");!(l.className="action-button")===t.showDismissButton&&(l.className="action-button action-button-large"),11<t.action.title.length&&(t.action.title=t.action.title.substring(0,8).trim()+"..."),l.innerHTML=t.action.title,l.onclick=function(){u(),t.action.handler()},c.appendChild(l)}catch(e){console.error("Failed to bind action to rich modal",e)}document.getElementById("richModal").appendChild(n)}function u(){var e=document.getElementsByClassName("focus-screen")[0];e&&(e.className="focus-screen animated fadeOutScreen");var t=document.getElementsByClassName("detail-modal")[0];t&&(t.className="detail-modal animated fadeOut");var n=document.getElementById("richModal");setTimeout(function(){t&&t.remove(),d=null,0<m.length?setTimeout(r,300):n&&(n.className="hidden")},700)}return{display:function(e){m.push(e),r()},close:function(){u()}}}();
