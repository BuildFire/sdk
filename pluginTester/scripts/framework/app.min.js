...
"use strict";function PublicFilesAPI(e){this.context=e}PublicFilesAPI.prototype={showDialog:function(l,o){l||(l={});var a=this,i=[],s=[],u=null;function r(s,r){return new Promise(function(t,e){var n=!0;if(l.filter&&!function(e,t){for(var n=0;n<=t.length;n++)if(t[n]==e.type)return!0;return!1}(s,l.filter)&&(r.status="failed",r.error="invalid File Format",a._onComplete&&a._onComplete(r),n=!1,t(r)),1e7<s.size&&(r.status="failed",r.error="invalid File Size",a._onComplete&&a._onComplete(r),n=!1,t(r)),n){var o=new FormData;o.append("file",s),o.append("pluginId",a.context.pluginId),o.append("instanceId",a.context.instanceId),o.append("appId",a.context.appId),u&&u.accessToken&&o.append("accessToken",u.accessToken);var i=new XMLHttpRequest;i.upload.addEventListener("progress",function(e){if(e.lengthComputable){var t=Math.round(100*e.loaded/e.total);r.percentage=t,a._onProgress&&a._onProgress(r)}},!1),i.onload=function(){window.spinner.hide();var e=null;i.responseText&&(e=JSON.parse(i.responseText)),200==i.status?(r.url=e.url,r.status="success"):(r.status="failed",e.message?r.error=e.message:r.error="An error has occurred"),a._onComplete&&a._onComplete(r),t(r)},i.onerror=function(){window.spinner.hide(),r.status="failed",a._onComplete&&a._onComplete(r),t(r)},i.timeout=6e4,i.open("POST",window.siteConfig.endPoints.publicFilesHost+"/publicFiles/upload/"),i.send(o),window.spinner.show()}})}function p(){!function(e){for(var t=0;t<e.length;t++){var n={fileId:t,filename:e[t].name};e[t].fileId=t,s.push(n),i.push(r(e[t],n))}Promise.all(i).then(function(e){console.log(e),o(null,e)})}(this.files)}window.authAPI.getCurrentUser(function(e,t){t&&(u=t);var n=document.createElement("input");n.setAttribute("type","file"),n.setAttribute("id","publicFilesHiddenInput"),l&&l.allowMultipleFilesUpload&&(n.setAttribute("multiple",""),n.setAttribute("name","files[]")),l&&l.filter&&(n.accept=l.filter.join(",")),n.addEventListener("change",p,!1),n.click()})},onProgress:function(e){this._onProgress=e},onComplete:function(e){this._onComplete=e}};