...
"use strict";var Dynamic={_sendPacketToInstance:function(e,n){var t=e.instanceId,s=e.packet;t?null!==(e=postMaster.widgetPluginAPI)&&void 0!==e&&e.context&&postMaster.widgetPluginAPI.context.instanceId===t?postMaster.widgetPluginAPI.sendMessage(null,s,n):null!==(e=postMaster.launcherPluginAPI)&&void 0!==e&&e.context&&postMaster.launcherPluginAPI.context.instanceId===t?postMaster.launcherPluginAPI.sendMessage(null,s,n):console.error("Cannot find the required plugin"):n("Plugin's instanceId was not provided")},triggerRequestWidgetContext:function(e,n){e={packet:new Packet(null,"dynamic.onReceivedWidgetContextRequest",e),instanceId:null==e?void 0:e.instanceId};Dynamic._sendPacketToInstance(e,n)},expressions:{triggerRequestCustomExpressions:function(e,n){e={packet:new Packet(null,"dynamic.expressions.onReceivedCustomExpressionsRequest",e),instanceId:null==e?void 0:e.instanceId};Dynamic._sendPacketToInstance(e,n)}}};