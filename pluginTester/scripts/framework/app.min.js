...
"use strict";var bfUtils={get deviceOnline(){return!("undefined"==typeof window||!window.ignoreNavigatorOnline)||("undefined"==typeof navigator||(navigator.connection&&navigator.connection.type?"none"!=navigator.connection.type:void 0===navigator.onLine||navigator.onLine))},get isMobileDevice(){return window.location.protocol.indexOf("http")<0},get isAndroid(){return window.location.protocol.indexOf("http")<0&&"undefined"!=typeof device&&"Android"==device.platform},get isIOS(){return window.location.protocol.indexOf("http")<0&&"undefined"!=typeof device&&"iOS"==device.platform},get isPwaAndroid(){return!!navigator.userAgent.match(/Android/i)},get isPwaiOS(){return"standalone"in window.navigator&&!window.navigator.standalone},get isAppHtml5Version(){return window.self==window.top},get isEmulatorCP(){return window.top&&window.top!=window&&0==window.location.protocol.indexOf("http")},get isApp(){return!!window.siteConfig&&"app"===window.siteConfig.scope},tryParseJSON:function(n){try{return JSON.parse(n)}catch(i){return void console.error("Cannot parse data :: "+n,i.message,i.stack)}},get http(){return window.$http||window.httpClient},getIPAddress:function(n){bfUtils.http.get(siteConfig.endPoints.crmHost+"/ipinfo?ipOnly=true").success(function(i){n(null,i)}).error(function(i){n(i)})},sanitize:function(i,n){bfUtils.sanitizeCallbacks=bfUtils.sanitizeCallbacks||[];var t,e,o=i.data,s={onIgnoreTagAttr:function(i,n,t,e){if("class"===n||"style"===n||"src"===n||"id"===n)return n+'="'+t+'"'}};"undefined"==typeof filterXSS?bfUtils.isLoadingXSSLibrary?bfUtils.sanitizeCallbacks.push(function(){n(null,filterXSS(o,s))}):(bfUtils.isLoadingXSSLibrary=!0,bfUtils.sanitizeCallbacks.push(function(){n(null,filterXSS(o,s))}),t=function(){bfUtils.sanitizeCallbacks.forEach(function(i){i()})},e=document.createElement("script"),"sdk"==window.siteConfig.scope?e.src="scripts/lib/xss.min.js":"cp"==window.siteConfig.scope?e.src="/app/scripts/lib/xss/xss.min.js":e.src=window._appRoot+"scripts/lib/xss/xss.min.js",e.type="text/javascript",e.onload=function(){t&&t()},document.getElementsByTagName("head")[0].appendChild(e)):n(null,filterXSS(o,s))}};
