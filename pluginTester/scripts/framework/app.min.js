...
"use strict";function _typeof(i){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(i){return typeof i}:function(i){return i&&"function"==typeof Symbol&&i.constructor===Symbol&&i!==Symbol.prototype?"symbol":typeof i})(i)}var imageTools={get ENUMS(){return{SIZES:{xxs:32,xs:64,s:128,m:200,l:304,xl:416,xxl:600,720:720,1080:1080,1440:1440,1920:1920,2560:2560,3840:3840,get full_width(){return this.findNearest(1)},get half_width(){return this.findNearest(2)},get third_width(){return this.findNearest(3)},get fourth_width(){return this.findNearest(4)},get fifth_width(){return this.findNearest(5)},get sixth_width(){return this.findNearest(6)},findNearest:function(i){for(var e=null,t=0;t<this.VALID_SIZES.length;t++){var n=this.VALID_SIZES[t];if(window.innerWidth/i<this[n]){e=n;break}}return this[e]},VALID_SIZES:["xxs","xs","s","m","l","xl","xxl","720","1080","1440","1920","2560","3840","full_width","half_width","third_width","quarter_width","fifth_width","sixth_width"]},ASPECT_RATIOS:{"1:1":1,"4:3":.75,"16:9":.5625,"9:16":1.77777778,"11:5":.45454545,"4:1":.25,"2.39:1":.41841004,VALID_RATIOS:["1:1","4:3","16:9","9:16","11:5","4:1","2.39:1"]}}},_getIntermediateUrl:function(i,e){return-1<bfUtils.isIOS?new URL(window._appRoot).origin+"/intermediate-image-app?options=".concat(encodeURIComponent(JSON.stringify(i)),"&url=").concat(encodeURIComponent(e)):e},_handleImageReady:function(e){document.querySelectorAll('img[src="'.concat(e.currentImageUrl,'"]')).forEach(function(i){i.src=e.newImageUrl})},resizeImage:function(i,e,t,n){if(!i)return null;if(i&&i.indexOf&&(-1<i.indexOf("://localhost:")||-1<i.indexOf("cdvfile://"))||-1<i.indexOf("file://"))return i;var o=window.forceImgix?imageTools._imgix:imageTools._cloudImg;if(!o.isSupportedUrl(i))return console.warn("URL is not supported by resizeImage. Returning original URL: "+i),i;if(e){if("object"!=_typeof(e))throw"options not an object"}else e={width:window.innerWidth};var r,s,a=e.disablePixelRation?1:window.devicePixelRatio;if(a<1&&(a=1),"full"==e.width&&(e.width=window.innerWidth),"full"==e.height&&(e.height=window.innerHeight),e.size&&e.aspect){if(this.ENUMS.SIZES.VALID_SIZES.indexOf(e.size)<0){var h=this.ENUMS.SIZES.VALID_SIZES.join(", ");return console.warn("Invalid size. Available options are "+h+". Returning original url"),i}if(this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.indexOf(e.aspect)<0){h=this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.join(", ");return console.warn("Invalid aspect ratio. Available options are "+h+". Returning original url"),i}e.width=this.ENUMS.SIZES[e.size],e.height=e.width*this.ENUMS.ASPECT_RATIOS[e.aspect]}e.width&&!e.height?r=Math.floor(e.width*a):!e.width&&e.height?s=Math.floor(e.height*a):e.width&&e.height&&(r=Math.floor(e.width*a),s=Math.floor(e.height*a));i=o.constructUrl({width:r,height:s,url:i,method:"resize"});return this._handleElement(t,i,n),imageTools._getIntermediateUrl(e,i)},cropImage:function(i,e,t,n){if(!i)return null;if(i&&i.indexOf&&(-1<i.indexOf("://localhost:")||-1<i.indexOf("cdvfile://"))||-1<i.indexOf("file://"))return i;var o=window.forceImgix?imageTools._imgix:imageTools._cloudImg;if(!o.isSupportedUrl(i))return console.warn("URL is not supported by cropImage. Returning original URL: "+i),i;if("object"!=_typeof(e=e||{}))throw"options not an object";if(e.size&&e.aspect){if(this.ENUMS.SIZES.VALID_SIZES.indexOf(e.size)<0){var r=this.ENUMS.SIZES.VALID_SIZES.join(", ");return console.warn("invalid size, available options are "+r+". Returning original url"),i}if(this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.indexOf(e.aspect)<0){var s=this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.join(", ");return console.warn("invalid aspect ratio. available options are "+s+". Returning original url"),i}e.width=this.ENUMS.SIZES[e.size],e.height=e.width*this.ENUMS.ASPECT_RATIOS[e.aspect]}if("full"==(e=!e.width&&!e.height?{width:"full",height:"full"}:e).width&&(e.width=window.innerWidth),"full"==e.height&&(e.height=window.innerHeight),!e.width||!e.height)return console.warn("cropImage does not have width or height please fix. returning original url"),i;r=window.devicePixelRatio;e&&e.disablePixelRatio&&(r=e.disablePixelRatio);s=Math.floor(e.width*r),r=Math.floor(e.height*r),i=o.constructUrl({width:s,height:r,url:i,method:"crop"});return this._handleElement(t,i,n),imageTools._getIntermediateUrl(e,i)},isUsingCDN:function(i){return!!i&&(window.forceImgix?imageTools._imgix:imageTools._cloudImg).isUsingCDN(i)},isResized:function(i,e){return!!i&&(window.forceImgix?imageTools._imgix:imageTools._cloudImg).isResized(i,e)},isCropped:function(i,e){return!!i&&(window.forceImgix?imageTools._imgix:imageTools._cloudImg).isCropped(i,e)},_handleElement:function(t,n,i){var e;t&&n&&(e=this._getLocalPath(n),"IMG"===t.tagName?(t.style.setProperty("opacity","0","important"),t.src=e,t.onload=function(){t.style.removeProperty("opacity"),i&&i(e)},t.onerror=function(){bfUtils.isApp&&imageCacheAPI.download(n,function(i,e){return i?t.src=n:void(t.src=e)})}):this._handleBgImage(t,e,n,i))},_imgix:{isSupportedUrl:function(i){return!(/\..{3,4}(?!.)/g.test(i)&&!/.(png|jpg|jpeg|gif|jfif|svg|webp)(?!.)/gi.test(i))&&null!=this._transformToImgix(i)},constructUrl:function(i){var e=i.width,t=i.height,n=i.url,o=i.method,r=this._transformToImgix(n),i=-1!==n.indexOf("?");return e||t?r+(i?"&":"?")+("crop"==o?"fit=crop":"")+"&width="+e+"&height="+t:n},_imgixWhitelistedUrls:{"http://imageserver.prod.s3.amazonaws.com":"https://buildfire.imgix.net","http://s3-us-west-2.amazonaws.com/imageserver.prod":"https://buildfire.imgix.net","http://pluginserver.buildfire.com":"https://bfplugins.imgix.net","http://s3.amazonaws.com/Kaleo.DevBucket":"https://bflegacy.imgix.net","http://s3-us-west-2.amazonaws.com/imagelibserver":"https://buildfire-uat.imgix.net","http://s3-us-west-2.amazonaws.com/pluginserver.uat":"https://bfplugins-uat.imgix.net"},_transformToImgix:function(i){for(var e in i=i.replace(/^https:\/\//i,"http://"),this._imgixWhitelistedUrls)if(0===i.indexOf(e))return this._imgixWhitelistedUrls[e]+i.split(e)[1];return null},isUsingCDN:function(i){for(var e in this._imgixWhitelistedUrls)if(0===i.indexOf(this._imgixWhitelistedUrls[e]))return!0;return!1},isResized:function(i,e){var t,n,o=!0;return e&&"object"==_typeof(e)&&(t=imageTools.ENUMS.SIZES[e.size],n=imageTools.ENUMS.SIZES[e.size],e.aspect&&(n=t*imageTools.ENUMS.ASPECT_RATIOS[e.aspect]),o=-1<i.indexOf("width="+t)&&-1<i.indexOf("height="+n)),this.isUsingCDN(i)&&!this.isCropped(i)&&-1<i.indexOf("width")&&-1<i.indexOf("height")&&o},isCropped:function(i,e){var t,n,o=!0;return e&&"object"==_typeof(e)&&(t=imageTools.ENUMS.SIZES[e.size],n=imageTools.ENUMS.SIZES[e.size],e.aspect&&(n=t*imageTools.ENUMS.ASPECT_RATIOS[e.aspect]),o=-1<i.indexOf("width="+t)&&-1<i.indexOf("height="+n)),this.isUsingCDN(i)&&-1<i.indexOf("fit=crop")&&o}},_cloudImg:{isSupportedUrl:function(i){return!(/\..{3,4}(?!.)/g.test(i)&&!/.(png|jpg|jpeg|gif|jfif|svg|webp)(?!.)/gi.test(i))},constructUrl:function(i){var e=i.width,t=i.height,n=i.url,o=i.method,r=window.siteConfig.endPoints.cloudImageHost+"/"+n,i=-1!==n.indexOf("?");return e||t?r+(i?"&":"?")+("crop"==o?"func=crop":"func=bound")+"&width="+e+"&height="+t:n},isUsingCDN:function(i){return i.indexOf(!1)},isResized:function(i,e){var t,n,o=!0;return e&&"object"==_typeof(e)&&(t=imageTools.ENUMS.SIZES[e.size],n=imageTools.ENUMS.SIZES[e.size],e.aspect&&(n=t*imageTools.ENUMS.ASPECT_RATIOS[e.aspect]),o=-1<i.indexOf("width="+t)&&-1<i.indexOf("height="+n)),this.isUsingCDN(i)&&-1<i.indexOf("bound")&&o},isCropped:function(i,e){var t,n,o=!0;return e&&"object"==_typeof(e)&&(t=imageTools.ENUMS.SIZES[e.size],n=imageTools.ENUMS.SIZES[e.size],e.aspect&&(n=t*imageTools.ENUMS.ASPECT_RATIOS[e.aspect]),o=-1<i.indexOf("width="+t)&&-1<i.indexOf("height="+n)),this.isUsingCDN(i)&&-1<i.indexOf("crop")&&o}},_handleBgImage:function(t,i,n,o){r(t,i);var e=new Image;function r(i,e){if(!e)return i.style.removeProperty("background-image");i.style.setProperty("background-image",'url("'+e+'")',"important")}e.src=i,e.onload=function(){o&&o(i)},e.onerror=function(){if(r(t),!bfUtils.isApp)return r(t,n);imageCacheAPI.download(n,function(i,e){return i?(o&&o(n),r(t,n)):void window.requestAnimationFrame(function(){r(t,e),o&&o(e)})})}},_getLocalPath:function(i){if(!bfUtils.isApp)return i;var e=(e=(i=i.replace(/(http|https):\/\/\S{0,8}.cloudimg.io\//g,"")).match(/(png|jpg|jpeg|gif|jfif|svg)/g)[0]||"")?"."+e:"",t=0;if(!i.length)return t;for(var n=0;n<i.length;n++){t=(t<<5)-t+i.charCodeAt(n);t|=0}return"".concat(window._appRoot.replace("app","imageCache/images")).concat(t).concat(e)},isProdImageServer:function(i){return 0==i.indexOf("http://imageserver.prod.s3.amazonaws.com")||0==i.indexOf("https://imageserver.prod.s3.amazonaws.com")||0==i.indexOf("https://s3-us-west-2.amazonaws.com/imageserver.prod")}};
