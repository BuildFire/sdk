...
"use strict";var bfUtils={get deviceOnline(){return!("undefined"==typeof window||!window.ignoreNavigatorOnline)||("undefined"==typeof navigator||(navigator.connection&&navigator.connection.type?"none"!=navigator.connection.type:void 0===navigator.onLine||navigator.onLine))},get isMobileDevice(){return window.location.protocol.indexOf("http")<0},get isAndroid(){return window.location.protocol.indexOf("http")<0&&"undefined"!=typeof device&&"Android"==device.platform},get isIOS(){return window.location.protocol.indexOf("http")<0&&"undefined"!=typeof device&&"iOS"==device.platform},get isPwaAndroid(){return!!navigator.userAgent.match(/Android/i)},get isPwaiOS(){return"undefined"==typeof device&&"standalone"in window.navigator&&window.navigator.standalone},get isHtml5iOS(){return"undefined"==typeof device&&"standalone"in window.navigator&&!window.navigator.standalone},get isPwaOrHtml5iOS(){return"undefined"==typeof device&&"standalone"in window.navigator},get isAppHtml5Version(){return window.self==window.top},get osVersion(){return parseFloat(device.version)},get isEmulatorCP(){return!!window.parseQueryString().emulator},get isApp(){return!!window.siteConfig&&"app"===window.siteConfig.scope},get isDeviceInBackground(){return window.isDeviceInBackground},tryParseJSON:function(i){try{return JSON.parse(i)}catch(e){return void console.error("Cannot parse data :: "+i,e.message,e.stack)}},get http(){return window.$http||window.httpClient},get currentApp(){return window.appContext&&window.appContext.currentApp?window.appContext.currentApp:{}},getIPAddress:function(i){bfUtils.http.get(siteConfig.endPoints.crmHost+"/ipinfo?ipOnly=true").success(function(e){i(null,e)}).error(function(e){i(e)})},sanitize:function(e,i){bfUtils.sanitizeCallbacks=bfUtils.sanitizeCallbacks||[];var n,t,o=e.data,a={onIgnoreTagAttr:function(e,i,n,t){if("class"===i||"style"===i||"src"===i||"id"===i)return i+'="'+n+'"'}};"undefined"==typeof filterXSS?bfUtils.isLoadingXSSLibrary?bfUtils.sanitizeCallbacks.push(function(){i(null,filterXSS(o,a))}):(bfUtils.isLoadingXSSLibrary=!0,bfUtils.sanitizeCallbacks.push(function(){i(null,filterXSS(o,a))}),n=function(){bfUtils.sanitizeCallbacks.forEach(function(e){e()})},t=document.createElement("script"),"sdk"==window.siteConfig.scope?t.src="scripts/lib/xss.min.js":"cp"==window.siteConfig.scope?t.src="/app/scripts/lib/xss/xss.min.js":t.src=window._appRoot+"scripts/lib/xss/xss.min.js",t.type="text/javascript",t.onload=function(){n&&n()},document.getElementsByTagName("head")[0].appendChild(t)):i(null,filterXSS(o,a))},traceDevice:function(e){var i,n,t;devModeUI&&devModeUI.isEnabled()&&(bfUtils.isMobileDevice&&window.deviceIsInBackground?"undefined"!=typeof bridge&&bridge.capabilities&&bridge.capabilities.notification&&bridge.capabilities.notification.local?new LocalNotificationsAPI({}).schedule({title:"Debug Mode Enabled - LN",text:e.message},function(){}):(i="app-trace-"+ +new Date+Math.random(),n=new PushNotificationsAPI({instanceId:"app-trace"}),t={title:"Debug Mode Enabled - PN",text:e.message,groupName:i},n.subscribe({groupName:i},function(){n.schedule(t,function(){}),setTimeout(function(){n.unsubscribe({groupName:i},function(){})},12e4)})):(new DialogAPI).toast({message:e.message,duration:2e3}))}};
