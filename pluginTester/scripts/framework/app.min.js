...
"use strict";var notesAPI={notesCtrlScope:null,userToken:!1,openDialog:function(e,n){var i=this;this._getUser(function(t){i.userToken=t._id,e?(i.notesCtrlScope.tempNoteData=e,i.notesCtrlScope.instanceId=window.appContext&&window.appContext.currentPlugin?window.appContext.currentPlugin.instanceId:window.postMaster.launcherPluginAPI.context.instanceId,i.notesCtrlScope.pluginOpen=!0,i.notesCtrlScope.callback=n):i.notesCtrlScope.pluginOpen=!1,i._showModal()})},getByItemId:function(i,o){i||(i={}),i.itemId?this.getAllFromItem(i.itemId,function(t,e){if(t)o(t);else{var n={itemId:i.itemId,hasNotes:e&&0<e.length};o(null,n)}}):o("invalid params, missing itemId")},_showModal:function(){this.notesCtrlScope.notesShown=!0,notesAPI.notesCtrlScope.$$phase||notesAPI.notesCtrlScope.$apply()},add:function(a,d){var r=this,t={title:a.title||"New Note",hideUserData:!0,placeholder:"Note Text",saveText:"Save"};window.inputAPI.showTextDialog(t,function(t,e){if(t)throw t;a.noteText=e.cancelled?"":e.results[0].textValue,""!==a.noteText&&(a.id=Date.now(),r.notesCtrlScope.notes.push({id:a.id,noteText:a.noteText,timeIndex:a.timeIndex}),r.notesCtrlScope.$$phase||r.notesCtrlScope.$apply(),r._getUserData(function(t,e){if(t)throw t;if(a.userToken=r.userToken,e.id){var n=r._getIndex(e,a.instanceId,a.itemId),i=n.pluginIndex,o=n.itemIndex;if(-1<i)-1<o?r._addNote(e,a,i,o,d):r._addItem(e,a,i,d);else r._initPluginData(e,a,d)}else r._initUserData(a,d)}))})},_addNote:function(t,e,n,i,o){var a=e.id,d=e.noteText,r=e.timeIndex;t.data[n].content[i].notes.push({id:a,noteText:d,timeIndex:r}),this._updatePluginData(t,o)},_addItem:function(t,e,n,i){var o=e.title,a=e.itemId,d=e.imageUrl,r=e.payload,l=e.noteText,s=e.timeIndex,u=e.id;t.data[n].content.push({title:o,itemId:a,imageUrl:d,payload:r,notes:[{id:u,noteText:l,timeIndex:s}]}),this._updatePluginData(t,i)},edit:function(r,l,s,u){var c=this;this._getUserData(function(t,n){if(t)throw t;var e=c._getIndex(n,s,l,r),i=e.pluginIndex,o=e.itemIndex,a=e.noteIndex,d={title:n.data[i].content[o].title||"New Note",hideUserData:!0,placeholder:"",saveText:"Save",prefill:n.data[i].content[o].notes[a].noteText};window.inputAPI.showTextDialog(d,function(t,e){if(t)throw t;e.cancelled||""===e.results[0].textValue||(n.data[i].content[o].notes[a].noteText=e.results[0].textValue,c._updatePluginData(n,u))})})},delete:function(a,d,r,l){var s=this;this._getUserData(function(t,e){if(t)throw t;var n=s._getIndex(e,r,d),i=n.pluginIndex,o=n.itemIndex;(e.data[i].content[o].notes=e.data[i].content[o].notes.filter(function(t){return t.id!=a}),0===e.data[i].content[o].notes.length)&&(e.data[i].content.splice(o,1),0===e.data[i].content.length&&e.data.splice(i,1));s._updatePluginData(e,l)})},getAllFromItem:function(a,d){var r=this;this._getUserData(function(t,e){if(!t&&e.id&&e.data.length){var n=window.appContext&&window.appContext.currentPlugin?window.appContext.currentPlugin.instanceId:window.postMaster.launcherPluginAPI.context.instanceId,i=r._getIndex(e,n).pluginIndex,o=e.data[i].content.find(function(t){return t.itemId===a});d(null,o?o.notes:[])}else d(null,[])})},getAll:function(n){this._getUserData(function(t,e){if(t)throw t;n(null,e.data)})},loadNote:function(h,m,P,v){var _=this;this._getUserData(function(t,e){if(t)throw t;var n=P.pluginId,i=P.instanceId,o=P.title,a=P.folderName,d=_._getIndex(e,i,m,h),r=d.pluginIndex,l=d.itemIndex,s=d.noteIndex,u=e.data[r].content[l],c=!!h&&e.data[r].content[l].notes[s],p=!1;window.appContext&&window.appContext.currentPlugin&&document.getElementById(window.appContext.currentPlugin.pluginAPI.iFrameId)&&window.appContext.currentPlugin.instanceId===i&&(p=!0);var I=window.postMaster.launcherPluginAPI.navigation,g="";if(u.payload){var x=u.payload;c&&(x.timeIndex=c.timeIndex);var f=JSON.stringify(x);g="&dld="+f}else{var w=void 0;w=c?JSON.stringify({link:m,timeIndex:c.timeIndex}):JSON.stringify({link:m}),g="&dld="+w}"function"!=typeof v&&(v=Function.prototype),p?I.navigateHome({},function(){I.navigateTo({pluginId:n,instanceId:i,title:o,folderName:a,queryString:g},v)}):I.navigateTo({pluginId:n,instanceId:i,title:o,folderName:a,queryString:g},v)})},_getUserData:function(n){window.postMaster.controlPluginAPI.userData.get("notesDB.18",function(t,e){n(t,e)})},_initUserData:function(t,n){var e=t.id,i=t.title,o=t.noteText,a=t.timeIndex,d=t.instanceId,r=t.itemId,l=t.imageUrl,s=t.payload,u={tag:"notesDB.18",userToken:this.userToken,checkDuplicate:!0};u.obj=[{instanceId:d,content:[{title:i,itemId:r,imageUrl:l,payload:s,notes:[{id:e,noteText:o,timeIndex:a}]}]}],window.postMaster.controlPluginAPI.userData.insert(u,function(t,e){if(t)throw t;n(e)})},_initPluginData:function(t,e,n){var i=e.id,o=e.title,a=e.noteText,d=e.timeIndex,r=e.instanceId,l=e.itemId,s=e.imageUrl,u=e.payload;t.data.push({instanceId:r,content:[{title:o,itemId:l,imageUrl:s,payload:u,notes:[{id:i,noteText:a,timeIndex:d}]}]}),this._updatePluginData(t,n)},_updatePluginData:function(t,n){var e={id:t.id,tag:"notesDB.18",userToken:this.userToken};e.obj=t.data,window.postMaster.controlPluginAPI.userData.update(e,function(t,e){if(t)throw t;n(e)})},_getUser:function(n){var t=window.authAPI.getCurrentUser();t?n(t):authAPI.login({showMenu:!1},function(t,e){!t&&e&&n(e)})},_getIndex:function(t,e,n,i){var o={},a=t.data.findIndex(function(t){return t.instanceId===e});if((o.pluginIndex=a)<0||!n)return o;var d=t.data[a].content.findIndex(function(t){return t.itemId===n});if((o.itemIndex=d)<0||!i)return o;var r=t.data[a].content[d].notes.findIndex(function(t){return t.id===i});return o.noteIndex=r,o},seekTo:function(r,l,s,u){var c=this;this._getUserData(function(t,e){if(t)throw t;var n=c._getIndex(e,s,l,r),i=n.pluginIndex,o=n.itemIndex,a=n.noteIndex,d=!!r&&e.data[i].content[o].notes[a];d&&((window.appContext&&window.appContext.currentPlugin?window.appContext.currentPlugin.pluginAPI:window.postMaster.launcherPluginAPI).sendMessage(null,new Packet(null,"notes.triggerOnSeekTo",{time:d.timeIndex})),u())})}};
...
"use strict";function PublicFilesAPI(e){this.context=e,this.currentUser=null}PublicFilesAPI.prototype={showDialog:function(e,t){e||(e={});var n,i=this;(n=document.getElementById("publicFiles_input_form"))?n.innerHTML="":((n=document.createElement("form")).setAttribute("id","publicFiles_input_form"),document.body.appendChild(n));var o=document.createElement("input");o.setAttribute("type","file"),o.setAttribute("style","display:none"),o.setAttribute("id","publicFilesHiddenInput"+(new Date).toISOString()),n.appendChild(o),e&&e.allowMultipleFilesUpload&&(o.setAttribute("multiple",""),o.setAttribute("name","files[]")),e&&e.filter&&(o.accept=e.filter.join(",")),o.addEventListener("change",function(){i.uploadFiles(this.files,e,t)},!1),o.click()},uploadFiles:function(n,l,i){var o=[],r=[],a=this;i||"function"!=typeof l||(i=l,l={}),l||(l={});var u=new AnalyticsAPI(a.context.appId,a.context.pluginId,a.context.instanceId,window.appContext.liveMode);function s(r,s){return new Promise(function(n,e){var t=!0;if(l.filter&&!function(e,t){for(var n=0;n<=t.length;n++)if(t[n]==e.type)return!0;return!1}(r,l.filter)&&(s.status="failed",s.error="invalid File Format",a._onComplete&&a._onComplete(s),t=!1,n(s)),26214400<r.size&&(s.status="failed",s.error="invalid File Size",a._onComplete&&a._onComplete(s),t=!1,n(s)),t){var i=new FormData;i.append("file",r),i.append("pluginId",a.context.pluginId),i.append("instanceId",a.context.instanceId),i.append("appId",a.context.appId),a.currentUser&&a.currentUser.accessToken&&i.append("accessToken",a.currentUser.accessToken);var o=new XMLHttpRequest;o.upload.onprogress=function(e){if(e.lengthComputable){var t=Math.round(100*e.loaded/e.total);s.percentage=t,a._onProgress&&a._onProgress(s)}},o.onload=function(){var e=null;if(o.responseText)try{e=JSON.parse(o.responseText)}catch(e){}if(200==o.status){s.url=e.url,s.size=e.size,s.type=e.type,s.status="success";var t={data:{url:e.url,size:e.size,type:e.type},_buildfire:{aggregationValue:e.size}};"app"==window.siteConfig.scope?u.trackAction("app/publicFilesUpload",t):u.trackAction("cp/publicFilesUpload",t)}else s.status="failed",e.message?s.error=e.message:s.error="An error has occurred";a._onComplete&&a._onComplete(s),n(s)},o.onerror=function(){s.status="failed",a._onComplete&&a._onComplete(s),n(s)},o.timeout=6e4,o.open("POST",window.siteConfig.endPoints.publicFilesHost+"/publicFiles/upload/"),o.send(i)}})}authAPI.getCurrentUser(function(e,t){t&&(a.currentUser=t),function(e){for(var t=0;t<e.length;t++){var n={fileId:t,filename:e[t].name};e[t].fileId=t,r.push(n),o.push(s(e[t],n))}Promise.all(o).then(function(e){i(null,e)}).catch(function(){i(!0,null)})}(n)})},onProgress:function(e){this._onProgress=e},onComplete:function(e){this._onComplete=e}};
