...
"use strict";var imagePreviewerAPI={show:function(n,t){this.initialized||this.renderHTML();var i=document.querySelectorAll(".pswp")[0];t=t||Function.prototype;var s={index:0<=n.index?n.index:0,history:!1,counterEl:!1,captionEl:!1,fullscreenEl:!1,zoomEl:!1,arrowEl:!1,preloaderEl:!1,shareEl:!1,tapToToggleControls:!1,correctOrientation:!0},o=window.PhotoSwipeUI_Default;if(n&&n.images&&n.images.length){n.images[0]&&n.images[0].name&&(n.images=n.images.map(function(n){return n.name}));var e=[];n.images.forEach(function(t){var n=new Promise(function(n){var e=new Image;e.onload=function(){return n(e)},e.src=t});e.push(n)}),Promise.all(e).then(function(n){var e=[];n.forEach(function(t){e.push(new Promise(function(e){EXIF.getData(t,function(){var n=EXIF.getTag(this,"Orientation");e(3===n||6===n?{src:"https://czi3m2qn.cloudimg.io/crop/"+t.naturalHeight+"x"+t.naturalWidth+"/q100/"+t.src,w:t.naturalHeight,h:t.naturalWidth}:{src:"https://czi3m2qn.cloudimg.io/crop/"+t.naturalWidth+"x"+t.naturalHeight+"/q100/"+t.src,w:t.naturalWidth,h:t.naturalHeight})})}))}),Promise.all(e).then(function(n){window.pswp=new PhotoSwipe(i,o,n,s),window.pswp.listen("close",t),window.pswp.init()})})}},renderHTML:function(){var n=document.createElement("div");if(n.style.position="relative",n.style.zIndex=99999999,n.innerHTML='\n    \x3c!-- Root element of PhotoSwipe. Must have class pswp. --\x3e\n    <div class="pswp" tabindex="-1" role="dialog" aria-hidden="true">\n\n        \x3c!-- Background of PhotoSwipe.\n             It\'s a separate element as animating opacity is faster than rgba(). --\x3e\n        <div class="pswp__bg"></div>\n\n        \x3c!-- Slides wrapper with overflow:hidden. --\x3e\n        <div class="pswp__scroll-wrap">\n\n            \x3c!-- Container that holds slides.\n                PhotoSwipe keeps only 3 of them in the DOM to save memory.\n                Don\'t modify these 3 pswp__item elements, data is added later on. --\x3e\n            <div class="pswp__container">\n                <div class="pswp__item"></div>\n                <div class="pswp__item"></div>\n                <div class="pswp__item"></div>\n            </div>\n\n            \x3c!-- Default (PhotoSwipeUI_Default) interface on top of sliding area. Can be changed. --\x3e\n            <div class="pswp__ui pswp__ui--hidden">\n\n                <div class="pswp__top-bar" style="background: transparent !important; padding-top: env(safe-area-inset-top); padding-top: const(safe-area-inset-top);">\n\n                    \x3c!--  Controls are self-explanatory. Order can be changed. --\x3e\n\n                    <div class="pswp__counter"></div>\n\n                    <span class="glyphicon glyphicon-remove pswp__button pswp__button--close" title="Close (Esc)" style="color: #FFF !important;font-size: 20pt;padding: 15px;width:55px;height:55px">\n                    </span>\n\n                    <button class="pswp__button pswp__button--share" title="Share"></button>\n\n                    <button class="pswp__button pswp__button--fs" title="Toggle fullscreen"></button>\n\n                    <button class="pswp__button pswp__button--zoom" title="Zoom in/out"></button>\n\n                    \x3c!-- Preloader demo http://codepen.io/dimsemenov/pen/yyBWoR --\x3e\n                    \x3c!-- element will get class pswp__preloader--active when preloader is running --\x3e\n                    <div class="pswp__preloader">\n                        <div class="pswp__preloader__icn">\n                          <div class="pswp__preloader__cut">\n                            <div class="pswp__preloader__donut"></div>\n                          </div>\n                        </div>\n                    </div>\n                </div>\n\n                <div class="pswp__share-modal pswp__share-modal--hidden pswp__single-tap">\n                    <div class="pswp__share-tooltip"></div>\n                </div>\n\n                <button class="pswp__button pswp__button--arrow--left" title="Previous (arrow left)">\n                </button>\n\n                <button class="pswp__button pswp__button--arrow--right" title="Next (arrow right)">\n                </button>\n\n                <div class="pswp__caption">\n                    <div class="pswp__caption__center"></div>\n                </div>\n\n            </div>\n\n        </div>\n\n    </div>\n    ',0<=window.location.pathname.toLowerCase().indexOf("plugintester")){console.log("Creating imageViewer in pluginTester");var e=document.getElementById("app");e.appendChild(n),console.log(e)}else document.body.appendChild(n);this.initialized=!0}};