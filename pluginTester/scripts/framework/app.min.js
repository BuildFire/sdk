...
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function UserDatastoreAPI(e,t,r,n,i){var s;window.appContext&&window.appContext.currentApp?(this.enableCache=!1,this.dataStoreUrl=window.siteConfig.endPoints.datastoreHost,"object"==_typeof(e)?(this.appId=(s=e).appId,this.pluginId=s.pluginId,this.instanceId=s.instanceId,this.isAppUser="control"!=s.type,this.isAppUser?this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null:this.writeKey=s.writeKey||(window.appContext.currentApp?window.appContext.currentApp.keys.datastoreKey:null)):(this.appId=e,this.pluginId=t,this.instanceId=r,this.isAppUser=n,this.isAppUser?this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null:this.writeKey=i||(window.appContext.currentApp?window.appContext.currentApp.keys.datastoreKey:null)),"undefined"==typeof CustomEvent&&console.warn("Browser doesnt support CustomEvent")):console.error("invalid appCOntext in userstore")}UserDatastoreAPI.prototype={onUpdate:function(e){},triggerOnUpdate:function(e){this.onUpdate&&this.onUpdate(e)},onRefresh:function(e){document.addEventListener("userDataOnRefresh",e,!1)},triggerOnRefresh:function(e){e=new CustomEvent("userDataOnRefresh",{detail:e});document.dispatchEvent(e)},onDisableRefresh:function(e){document.addEventListener("userDatastoreOnDisableRefresh",e,!1)},disableRefresh:function(){document.dispatchEvent(new CustomEvent("userDatastoreOnDisableRefresh"))},resolveTag:function(e){return null==e||""==e?"primary":e},createReadUrl:function(e,t,r){return this.dataStoreUrl+"/user/"+this.appId+"/"+this.pluginId+"/"+this.instanceId+"/"+encodeURIComponent(this.resolveTag(e))+"/"+encodeURIComponent(t)+"/"+r},createSearchUrl:function(e){return this.dataStoreUrl+"/user/search/"+this.appId+"/"+this.pluginId+"/"+this.instanceId+"/"+encodeURIComponent(this.resolveTag(e))+"/"},createWriteUrl:function(e,t){return this.dataStoreUrl+"/user/insert/"+this.appId+"/"+this.pluginId+"/"+this.instanceId+"/"+encodeURIComponent(this.resolveTag(e))+"/"+encodeURIComponent(t)+"/"},createSearchAndUpdateUrl:function(e,t){return this.dataStoreUrl+"/user/searchAndUpdate/"+this.appId+"/"+this.pluginId+"/"+this.instanceId+"/"+encodeURIComponent(this.resolveTag(e))+"/"+encodeURIComponent(t)+"/"},createDeleteUrl:function(e,t,r){return this.dataStoreUrl+"/user/delete/"+this.appId+"/"+this.pluginId+"/"+this.instanceId+"/"+encodeURIComponent(this.resolveTag(e))+"/"+encodeURIComponent(r)+"/"+t},createBulkDeleteUrl:function(e,t){return this.dataStoreUrl+"/user/delete/"+this.appId+"/"+this.pluginId+"/"+this.instanceId+"/"+encodeURIComponent(this.resolveTag(e))+"/"+encodeURIComponent(t)+"/"},createSaveUrl:function(e,t){return this.dataStoreUrl+"/user/save/"+this.appId+"/"+this.pluginId+"/"+this.instanceId+"/"+encodeURIComponent(this.resolveTag(e))+"/"+encodeURIComponent(t)+"/"},createBulkInsertUrl:function(e,t){return this.dataStoreUrl+"/user/bulkInsert/"+this.appId+"/"+this.pluginId+"/"+this.instanceId+"/"+encodeURIComponent(this.resolveTag(e))+"/"+encodeURIComponent(t)+"/"},createAggregateUrl:function(e,t){return this.dataStoreUrl+"/user/aggregate/"+this.appId+"/"+this.pluginId+"/"+this.instanceId+"/"+encodeURIComponent(this.resolveTag(e))+"/"},_httpGet:function(r,n,i){"function"!=typeof n||i||(i=n,n=this),bfUtils.http.get(r).success(function(e){i.apply(n,[null,e])}).error(function(e,t){i.apply(n,[e=e||"http error with status: "+t]),console.error("user datastore GET Error: ",r,e)})},_httpPost:function(r,e,n){bfUtils.http.post(r,e).success(function(e){n(null,e)}).error(function(e,t){n(e=e||"http error with status: "+t),console.error("user datastore POST Result: ",r,e)})},_httpPut:function(r,e,n){bfUtils.http.put(r,e).success(function(e){n(null,e)}).error(function(e,t){n(e=e||"http error with status: "+t),console.error("user datastore PUT Result: ",r,e)})},get:function(e,i){if(console.log("user datastore: get "+JSON.stringify(e)),"function"==typeof i){if(this.isAppUser&&(this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null),!this.writeKey)return console.error("no write key has been provided"),void i("no logged in user found",null);var t,r="";"object"==_typeof(e)?(t="string"==typeof e.tag?e.tag:"",r="string"==typeof e.id?e.id:""):"string"==typeof e?t=e:null==t&&(t=""),"string"!=typeof t&&(t="");var n,s=!1,o=null;try{this.enableCache&&"undefined"!=typeof userDataDumpAPI&&(console.log("data cache: check for cache"),(o=userDataDumpAPI.getData(this.appId,this.pluginId,this.instanceId,this.resolveTag(t),e.id))&&(console.log("data cache: found cache"),(n=o).tag=e.tag,n.obj=e.obj,i(null,n),s=!0))}catch(e){console.error("dataDump error: "+e)}var a=Date.now();return this._httpGet(this.createReadUrl(t,this.writeKey,r,!1),{ds:this,isCallBackDone:s,obj:e,userDataDumpAPI:window.userDataDumpAPI},function(e,t){var r=this,n=Date.now()-a;if(console.log("user datastore: response time "+n),e)r.isCallBackDone||i(e);else if(404==e)r.isCallBackDone||i(null,null);else try{null==t?r.isCallBackDone||i(null,null):(r.ds.enableCache&&void 0!==r.userDataDumpAPI&&r.userDataDumpAPI.setData(r.ds.appId,r.ds.pluginId,r.ds.instanceId,r.ds.resolveTag(r.obj.tag),r.obj.id,t),t.tag=r.obj.tag,r.isCallBackDone?o&&o.lastUpdated!=t.lastUpdated&&(console.log("data cache: send updated object onUpdate"),r.ds.triggerOnUpdate(t)):i(null,t))}catch(e){s||i(e)}}),this}},save:function(r,n){if(window.toast&&window.toast("saving..."),this.isAppUser&&(this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null),!this.writeKey)return console.error("no write key has been provided"),void(n&&n("no logged in user found",null));var i=r.tag,s=r.obj,e=r.userToken||this.writeKey;"object"==_typeof(s)&&(s="undefined"!=typeof angular?this.isAppUser?angular.toJson({data:s,userToken:this.writeKey,id:r.id}):angular.toJson({data:s,writeKey:this.writeKey,id:r.id}):this.isAppUser?JSON.stringify({data:s,userToken:this.writeKey,id:r.id}):JSON.stringify({data:s,writeKey:this.writeKey,id:r.id}));var o=this;return this._httpPost(this.createSaveUrl(i,e),s,function(e,t){404==e?(window.toast&&window.toast("404","danger"),n(null,null)):e?(window.toast&&window.toast("error saving","danger"),n(e)):(e={id:r.id,data:r.obj,tag:i},n(null,e),o.triggerOnUpdate(e),o._analyze(s))}),this},insert:function(r,n){if(this.isAppUser&&(this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null),!this.writeKey)return console.error("no write key has been provided"),void(n&&n("no logged in user found",null));var i=r.tag,s=r.obj,e=r.checkDuplicate,t=r.userToken||this.writeKey;"object"==_typeof(s)&&(s=this.isAppUser?{data:s,userToken:this.writeKey}:{data:s,writeKey:this.writeKey},e&&(s.checkDuplicate=e),s=JSON.stringify(s));var o=this;return this._httpPost(this.createWriteUrl(i,t),s,function(e,t){404==e?n(null,null):e?n(e):(r.id=t.id,t={id:t.id,data:r.obj,tag:i},n(null,t),o.triggerOnUpdate(t),o._analyze(s))}),this},bulkInsert:function(r,n){if(this.isAppUser&&(this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null),!this.writeKey)return console.error("no write key has been provided"),void(n&&n("no logged in user found",null));var i=r.tag,s=r.obj,e=r.userToken||this.writeKey;"object"==_typeof(s)&&(s=this.isAppUser?JSON.stringify({data:s,userToken:this.writeKey,checkDuplicate:!1}):JSON.stringify({data:s,writeKey:this.writeKey,checkDuplicate:!1}));var o=this;return this._httpPost(this.createBulkInsertUrl(i,e),s,function(e,t){404==e?n(null,null):e?n(e):(e={data:r.obj,tag:i},n(null,e),o.triggerOnUpdate(e),o._analyze(s))}),this},update:function(r,n){if(window.toast&&window.toast("saving..."),this.isAppUser&&(this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null),!this.writeKey)return console.error("no write key has been provided"),void(n&&n("no logged in user found",null));var e=r.tag,i=r.obj,t=r.userToken||this.writeKey;"object"==_typeof(i)&&(i=this.isAppUser?JSON.stringify({id:r.id,data:i,userToken:this.writeKey}):JSON.stringify({id:r.id,data:i,writeKey:this.writeKey}));var s=this;return this._httpPut(this.createWriteUrl(e,t),i,function(e,t){404==e?(window.toast&&window.toast("404"),n(null,null)):e?(window.toast&&window.toast("error updating"),n(e)):(t.record.tag=r.tag,n(null,t.record),s.triggerOnUpdate(t.record),s._analyze(i))}),this},searchAndUpdate:function(e,r){if(window.toast&&window.toast("saving..."),this.isAppUser&&(this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null),!this.writeKey)return console.error("no write key has been provided"),void(r&&r("no logged in user found",null));var t=e.tag,n=e.obj,i=e.userToken||this.writeKey;"object"==_typeof(n)&&(n=this.isAppUser?JSON.stringify({search:e.search,data:n,userToken:this.writeKey}):JSON.stringify({search:e.search,data:n,writeKey:this.writeKey}));var s=this;return this._httpPost(this.createSearchAndUpdateUrl(t,i),n,function(e,t){404==e?(window.toast&&window.toast("404"),r(null,null)):e?(window.toast&&window.toast("error updating"),r(e)):(r(null,t),s.triggerOnUpdate(t),s._analyze(n))}),this},delete:function(r,n){if(this.isAppUser&&(this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null),!this.writeKey)return console.error("no write key has been provided"),void(n&&n("no logged in user found",null));var e={},t=r.tag,i=r.userToken||this.writeKey,e=this.isAppUser?JSON.stringify({userToken:this.writeKey}):JSON.stringify({writeKey:this.writeKey}),s=this;return this._httpPost(this.createDeleteUrl(t,r.id,i),e,function(e,t){404==e?n(null,null):e?n(e):(n(null,t),s.triggerOnUpdate(r))}),this},bulkDelete:function(o,t){var a=this;if(this.isAppUser&&(this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null),!this.writeKey)return console.error("no write key has been provided"),void(t&&t("no logged in user found",null));for(var u=o.tag,l=o.userToken||this.writeKey,r=o.ids,n=[],d=50,e=0;e<r.length;e+=d)!function(e){var t=r.slice(e,e+d),i={},s=a,e=new Promise(function(r,n){i=s.isAppUser?JSON.stringify({userToken:s.writeKey,ids:t}):JSON.stringify({writeKey:s.writeKey,ids:t}),a._httpPost(a.createBulkDeleteUrl(u,l),i,function(e,t){404==e?r(null):e?n(e):(r(t),s.triggerOnUpdate(o))})});n.push(e)}(e);return Promise.all(n).then(function(e){t(null,{status:"deleted"})}).catch(function(e){t("all or some records were not deleted",null)}),this},search:function(e,r){if(this.isAppUser&&(this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null),!this.writeKey)return console.error("no write key has been provided"),void(r&&r("no logged in user found",null));var t=e.tag,e=e.obj;return"function"==typeof r?("string"!=typeof t&&(t=""),"string"==typeof e&&(e=JSON.parse(e)),this.isAppUser?e.userToken=this.writeKey:e.writeKey=this.writeKey,"object"==_typeof(e)&&(e=JSON.stringify(e)),this._httpPost(this.createSearchUrl(t),e,function(e,t){404==e?r(null,null):e?r(e):r(null,null==t?null:"string"==typeof t?bfUtils.tryParseJSON(t):t)}),this):void 0},aggregate:function(e,r){if(this.isAppUser&&(this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null),!this.writeKey)return console.error("no write key has been provided"),void(r&&r("no logged in user found",null));var t=e.tag,n=e.obj,e=e.userToken||this.writeKey;return"function"==typeof r?("string"!=typeof t&&(t=""),"string"==typeof n&&(n=JSON.parse(n)),this.isAppUser?n.userToken=this.writeKey:n.writeKey=this.writeKey,"object"==_typeof(n)&&(n=JSON.stringify(n)),this._httpPost(this.createAggregateUrl(t,e),n,function(e,t){404==e?r(null,null):e?r(e):r(null,null==t?null:"string"==typeof t?bfUtils.tryParseJSON(t):t)}),this):void 0},dataDump:function(r){if(this.isAppUser&&(this.writeKey=authAPI.getCurrentUser()?authAPI.getCurrentUser()._id:null),!this.writeKey)return console.error("no write key has been provided"),void(r&&r("no logged in user found",null));var n=this;return this._httpget(this.createDataDumpUrl(),function(e,t){404==e?r(null,null):e?r(e):(r(null,bfUtils.tryParseJSON(t)),n.triggerOnUpdate(obj))}),this},_analyze:function(e){"string"==typeof e&&-1<e.indexOf(".cloudimg.io/")&&console.warn("Plugin CDN url detected in userData. Use imageLib directly on widget: https://sdk.buildfire.com/docs/imagelib/#buildfireimagelib")}};
