...
"use strict";var bfUtils={get deviceOnline(){return!("undefined"==typeof window||!window.ignoreNavigatorOnline)||("undefined"==typeof navigator||(navigator.connection&&navigator.connection.type?"none"!=navigator.connection.type:void 0===navigator.onLine||navigator.onLine))},get isMobileDevice(){return window.location.protocol.indexOf("http")<0},get isAndroid(){return window.location.protocol.indexOf("http")<0&&"undefined"!=typeof device&&"Android"==device.platform},get isIOS(){return window.location.protocol.indexOf("http")<0&&"undefined"!=typeof device&&"iOS"==device.platform},get isPwaAndroid(){return!!navigator.userAgent.match(/Android/i)},get isPwaiOS(){return"undefined"==typeof device&&"standalone"in window.navigator&&window.navigator.standalone},get isHtml5iOS(){return"undefined"==typeof device&&"standalone"in window.navigator&&!window.navigator.standalone},get isPwaOrHtml5iOS(){return"undefined"==typeof device&&"standalone"in window.navigator},get isAppHtml5Version(){return window.self==window.top},get isEmulatorCP(){return window.top&&window.top!=window&&0==window.location.protocol.indexOf("http")},get isApp(){return!!window.siteConfig&&"app"===window.siteConfig.scope},tryParseJSON:function(i){try{return JSON.parse(i)}catch(n){return void console.error("Cannot parse data :: "+i,n.message,n.stack)}},get http(){return window.$http||window.httpClient},getIPAddress:function(i){bfUtils.http.get(siteConfig.endPoints.crmHost+"/ipinfo?ipOnly=true").success(function(n){i(null,n)}).error(function(n){i(n)})},sanitize:function(n,i){bfUtils.sanitizeCallbacks=bfUtils.sanitizeCallbacks||[];var t,e,o=n.data,r={onIgnoreTagAttr:function(n,i,t,e){if("class"===i||"style"===i||"src"===i||"id"===i)return i+'="'+t+'"'}};"undefined"==typeof filterXSS?bfUtils.isLoadingXSSLibrary?bfUtils.sanitizeCallbacks.push(function(){i(null,filterXSS(o,r))}):(bfUtils.isLoadingXSSLibrary=!0,bfUtils.sanitizeCallbacks.push(function(){i(null,filterXSS(o,r))}),t=function(){bfUtils.sanitizeCallbacks.forEach(function(n){n()})},e=document.createElement("script"),"sdk"==window.siteConfig.scope?e.src="scripts/lib/xss.min.js":"cp"==window.siteConfig.scope?e.src="/app/scripts/lib/xss/xss.min.js":e.src=window._appRoot+"scripts/lib/xss/xss.min.js",e.type="text/javascript",e.onload=function(){t&&t()},document.getElementsByTagName("head")[0].appendChild(e)):i(null,filterXSS(o,r))}};
