...
"use strict";var richModal=function(){var g=document.createElement("div");g.id="richModal",g.className="hidden";var e=document.createElement("div");e.className="focus-screen hidden",g.appendChild(e),document.body.appendChild(g);var h=null,f=[];function p(){try{if(h)return;if(0<=window.location.hash.indexOf("accessCode"))return setTimeout(p,5e3);var e=document.getElementsByClassName("login-holder")[0];if(e&&-1===e.className.indexOf("ng-hide"))return setTimeout(p,5e3);var t=(h=f.shift()).options,n=h.callback;document.getElementById("richModal").className="";var i=document.getElementsByClassName("focus-screen")[0];i.className="focus-screen animated fadeInScreen",i.onclick=function(){b()};var a=document.createElement("div");if(a.className="detail-modal animated fadeInUp",t.title){var o=document.createElement("h1");if(30<t.title.length&&(t.title=t.title.substring(0,27).trim()+"..."),o.innerHTML=t.title,t.design){var s="";t.design.title&&t.design.title.align&&(s+="text-align: "+t.design.title.align+" !important;"),t.design.textColor&&(s+="color: "+t.design.textColor+" !important;"),o.setAttribute("style",s)}a.appendChild(o)}if(t.subtitle){var l=document.createElement("span");if(l.className="subtitle",l.innerHTML=t.subtitle,t.design){s="";t.design.subtitle&&t.design.subtitle.align&&(s+="text-align: "+t.design.subtitle.align+" !important;"),t.design.textColor&&(s+="color: "+t.design.textColor+" !important;"),l.setAttribute("style",s)}a.appendChild(l)}var c=document.createElement("div");c.className="rich-content",c.innerHTML=t.richContent,a.appendChild(c);var d=document.createElement("div");if(d.className="button-container",a.appendChild(d),t.showDismissButton||void 0===t.showDismissButton){var r=document.createElement("button");r.className=t.action?"dismiss-button":"dismiss-button dismiss-large",r.innerHTML="Dismiss",r.onclick=function(){b(),n&&n(null,{buttonType:"dismiss"})},d.appendChild(r)}var m="";t.design&&(t.design.fullScreen&&g.classList.add("fullScreen"),t.design.backgroundColor&&(m+="background : "+t.design.backgroundColor+" !important;"),t.design.textColor&&(m+="color : "+t.design.textColor+" !important"),a.setAttribute("style",m),r.setAttribute("style",m))}catch(e){console.error("Failed to render rich modal",e)}if(t.action)try{var u=document.createElement("button");!(u.className="action-button")===t.showDismissButton&&(u.className="action-button action-button-large"),t.action.title&&11<t.action.title.length&&(t.action.title=t.action.title.substring(0,8).trim()+"..."),u.innerHTML=t.action.title||"[ Click ]",u.onclick=function(){t.action.handler?t.action.handler():((new ActionItemsAPI).execute(t.action,function(e,t){}),n&&n(null,{buttonType:"action",value:t.action}));t.action.preventAutoClose||b()},t.design&&m&&u.setAttribute("style",m),d.appendChild(u)}catch(e){console.error("Failed to bind action to rich modal",e)}document.getElementById("richModal").appendChild(a)}function b(){var e=document.getElementsByClassName("focus-screen")[0];e&&(e.className="focus-screen animated fadeOutScreen");var t=document.getElementsByClassName("detail-modal")[0];t&&(t.className="detail-modal animated fadeOut");var n=document.getElementById("richModal");setTimeout(function(){t&&t.remove(),h=null,0<f.length?setTimeout(p,300):n&&(n.className="hidden")},700)}return{display:function(e,t){f.push({options:e,callback:t}),p()},close:function(){b()}}}();
