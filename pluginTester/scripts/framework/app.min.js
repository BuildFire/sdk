...
"use strict";$app.controller("userProfileCtrl",["Upload","$scope","StringResource",function(t,n,r){function o(e,r){new AnalyticsAPI(window.appContext.currentApp.appId,"user_profile","user_profile",window.appContext.liveMode).trackAction(e,r)}(window.authAPI.userProfileCtrlScope=n).user=null,n.userProfile=null,n.tempUser=null,n.tempUserProfile=null,n.editingProfile=!1,n.uploadProfileImage=null,n.uploadBackgroundImage=null,n._appRoot=window._appRoot;var i=window.appContext.currentApp.appId,s="appearance",e={appId:window.appContext.currentApp.appId,pluginId:s,instanceId:s},a=new AppDatastoreAPI(i),l=new window.DatastoreAPI(e);a.search({tag:"$$badges",obj:{sort:{rank:1}}},function(e,r){if(e)return console.error(e);n.badges=r,n.$$phase||n.$apply()});var u=function(e){var o=e.tags?e.tags[i]:[];if(!o.length)return[];var s=[];return n.badges.forEach(function(r){var e=o.find(function(e){return e.tagName===r.data.tag&&e.appliedCount>=r.data.tagCount});if(e){var t=Math.floor(e.appliedCount/r.data.tagCount);r.data.appliedCount=t,imageTools&&(r.data.imageUrl=imageTools.cropImage(r.data.imageUrl,{size:"xxs",aspect:"1:1",compression:80,disablePixelRatio:1})),s.push(r.data)}}),s},d=document.getElementsByClassName("profile-container")[0],p=function(){if(n.user.imageUrl)n.user.imageUrl=imageTools.cropImage(n.user.imageUrl,{size:"s",aspect:"1:1"});else{var e={id:1,method:"users/getUserImage",params:{userId:n.user._id,externalAppId:window.currentAppId}},r=window.siteConfig.endPoints.authHost+"/src/server.js?data="+encodeURIComponent(JSON.stringify(e));n.user.imageUrl=r}return n.user.imageUrl};n.getUserProfile=function(){var e={id:1,method:"users/getUserProfile",params:{userId:n.user._id}},r=window.siteConfig.endPoints.socialHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));window.bfUtils.http.jsonp(r,{bypassInterceptorForStatus:404}).success(function(e){e&&e.result&&(e.result.email=n.user.email,n.userProfile=e.result,o("app/user_profile_view",{userId:n.user._id}))}).error(function(e,r,t,o){n.invalidCredentials=!0,console.error(e)})},n.close=function(e){if(e||!n.busy){if(n.sideMenuScroll.enable(),n.tempUser=null,n.tempUserProfile=null,n.editingProfile=!1,n.uploadProfileImage=null,n.uploadBackgroundImage=null,n.busy=!1,e)return n.user=null,void(n.userProfile=null);d.addEventListener("animationend",function(){n.user=null,n.userProfile=null,n.$$phase||n.$apply(function(){d.classList.remove("closing")})},{once:!0}),requestAnimationFrame(function(){d.classList.add("closing")})}},n.openProfile=function(){return!(window.location.hash="/editUserProfile")},n.openUrl=function(e){return e&&(e.toLowerCase().indexOf("http")<0&&(e="https://"+e),window.open(e,"_blank","location=yes,enableViewportScale=yes")),!1};var c=function(e,s){var r={id:1,method:"users/getPublicUser",params:{userId:e,externalAppId:window.currentAppId}},t=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(r));window.bfUtils.http.jsonp(t,{bypassInterceptorForStatus:404}).success(function(e){e.result.badges=u(e.result),s(null,e)}).error(function(e,r,t,o){console.error(e),s(e,null)})},f=function(e,s){var r={id:1,method:"users/getUserByAccessToken",params:{accessToken:e,externalAppId:window.currentAppId}},t=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(r));window.bfUtils.http.jsonp(t,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.error)if(1311===e.error.code){window.openDialog({data:{title:"Login Required",body:"Please login again",disableCancel:!0}},function(){authAPI.logout()})}else 1309===e.error.code?authAPI.logout():(console.error(e.error),s(e.error,null));else e.result.badges=u(e.result),s(null,e)}).error(function(e,r,t,o){console.error(e),s(e,null)})},m=null,g=null;n.open=function(e){window.spinner.show(),m=e,g=authAPI.getCurrentUser(),n.sideMenuScroll.disable(),m||g&&g._id&&(m=g._id),m&&l.get({tag:s,withDynamicData:!0},function(e,t){if(e)return console.error(e),void callback(e);t&&t.data&&t.data.customRegistration&&t.data.customRegistration.active&&"enterprise"===window.appContext.currentApp.config.type?(n.showCustomUserProfile=!0,g&&g._id==m?f(g.accessToken,function(e,r){r&&(n.user=r.result,window.spinner.hide(),g&&g._id==n.user._id&&(n.user.userToken=g.userToken),p(),U(t.data.customRegistration,r.result),n.customUserProfile=r.result,n.getUserProfile())}):c(m,function(e,r){r&&(n.user=r.result,window.spinner.hide(),p(),U(t.data.customRegistration,r.result),n.customUserProfile=r.result,n.getUserProfile())})):g&&g._id==m?f(g.accessToken,function(e,r){r&&(n.user=r.result,window.spinner.hide(),g&&g._id==n.user._id&&(n.user.userToken=g.userToken),p(),n.getUserProfile())}):c(m,function(e,r){r&&(n.user=r.result,window.spinner.hide(),p(),n.getUserProfile())})})};var U=function(e,r){customRegistration.getFields({defaults:r,isProfileMode:!0,customRegistrationSettings:e,refreshUI:function(){if(n.customRegistrationFields&&n.customRegistrationFields.length){var e=n.customRegistrationFields.find(function(e){return"address"===e.name});e&&e.validate(e.value)}n.$$phase||n.$apply()}},function(e,r){r&&(r.fields&&r.fields.forEach(function(e){e&&"tel"===e.name&&(e.type="tel")}),n.customRegistrationFields=r.fields,n.customRegistration=r,n.initCustomRegistration=function(){r.initializers.forEach(function(e){e()})},n.initCustomRegistration(),n.$$phase||n.$apply())})};authAPI.onLogout(function(){n.user&&delete n.user.userToken,n.close(!0)}),n.tempUser=null,n.tempUserProfile=null,n.busy=!1,n.cancelEdit=function(){return n.tempUser=null,n.tempUserProfile=null,n.editingProfile=null,n.uploadBackgroundImage=null,n.uploadProfileImage=null,n.showCustomUserProfile&&n.open(n.user._id),n.$$phase||n.$apply(),!1},n.showInvalidFieldsErr=function(){r.getData().then(function(e){var r={richContent:'<p class="padding-top-fifteen">'+(e.editProfileInvalidFields||"One or more fields are invalid.")+"</p>",dismissButtonText:"OK"};richModal.display(r)})};var w=function(r,s){var e={id:1,method:"users/update",params:r},t=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(angular.toJson(e));window.bfUtils.http.jsonp(t).success(function(e){n.tempUser.lastUpdated=(new Date).toISOString(),userTags.setRegistrationTags(r.userProfile,!1,function(e,r){e&&console.log(e)}),s(null,e)}).error(function(e,r,t,o){console.error(e),n.busy=!1,s(e,null)}).finally()};n.update=function(){n.tempUserProfile||(n.tempUserProfile={}),n.busy=!0;var t={};n.tempUser.displayName=n.tempUser.firstName+" "+n.tempUser.lastName,n.uploadImage(n.uploadProfileImage,function(e,r){r&&(n.tempUser.imageUrl=r.result,t.imageUrl=n.tempUser.imageUrl),n.uploadImage(n.uploadBackgroundImage,function(e,r){r&&(n.tempUserProfile.backgroundImage=r.result,t.backgroundImage=n.tempUserProfile.backgroundImage),function(s){if(n.customRegistration)n.customRegistration.fetch({validateFields:!0,validateLinks:!1,mode:"edit"},function(e,r){if(e)return n.busy=!1,void n.showInvalidFieldsErr();for(var t in r.user)r.user.hasOwnProperty(t)&&(n.tempUser[t]=r.user[t]);var o=r.user;o._id=n.tempUser._id,o.userToken=n.tempUser.userToken,o.imageUrl=n.tempUser.imageUrl,o.externalAppId=window.appContext.currentApp.appId,w(o,s)});else{var e={};e._id=n.tempUser._id,e.email=n.tempUser.email,e.userToken=n.tempUser.userToken,e.firstName=n.tempUser.firstName,e.lastName=n.tempUser.lastName,e.displayName=n.tempUser.displayName,e.imageUrl=n.tempUser.imageUrl,e.externalAppId=window.appContext.currentApp.appId,w(e,s)}}(function(){!function(s){var e=JSON.parse(JSON.stringify(n.tempUserProfile));e||(e={}),e.userId=n.tempUser._id,e.userToken=n.tempUser.userToken,e.email=n.tempUser.email,e.firstName=n.tempUser.firstName,e.lastName=n.tempUser.lastName,e.displayName=n.tempUser.displayName;var r={id:1,method:"users/saveUserProfile",params:e},t=window.siteConfig.endPoints.socialHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(r));window.bfUtils.http.jsonp(t,{bypassInterceptorForStatus:404}).success(function(e){s(null,e)}).error(function(e,r,t,o){console.error(e),s(e,null)})}(function(){n.tempUser.badges=n.user.badges,n.user=n.tempUser,n.tempUser=null,n.userProfile=n.tempUserProfile,n.tempUserProfile=null,n.uploadBackgroundImage=null,n.uploadProfileImage=null,authAPI._setCurrentUser(n.user),authAPI.triggerOnUpdate(),n.editingProfile=!1,n.busy=!1,t.userId=n.user._id,o("app/user_profile_update",t)})})})})},n.uploadImage=function(e,s){if(e){var r=window.siteConfig.endPoints.authHost+"/src/server.js?method=users/uploadImage";t.upload({url:r,data:{file:e,userToken:n.user.userToken,externalAppId:window.currentAppId}}).progress(function(e){n.progressMessage=!0;var r=parseInt(100*e.loaded/e.total);console.log("progress: "+r+"%")}).success(function(e,r,t,o){console.log("file uploaded."),s&&s(null,e)}).error(function(e){s&&s(e,null)}).finally(function(){})}else s(null,null)},n.validateImage=function(e,o){if(!e)return!1;if(e.type&&["image/jpeg","image/png","image/jpg"].indexOf(e.type)<0)return r.getData().then(function(e){var r=("coverPhoto"===o?"Cover":"Profile")+" photo does not support this file type.",t={richContent:'<p class="padding-top-fifteen">'+(e["coverPhoto"===o?"coverImageTypeInvalid":"profileImageTypeInvalid"]||r)+"</p>",dismissButtonText:"OK"};richModal.display(t)}),!1;return!(e.size&&1e7<e.size)||(r.getData().then(function(e){var r=("coverPhoto"===o?"Cover":"Profile")+" photo must be less than 10mb.",t={richContent:'<p class="padding-top-fifteen">'+(e["coverPhoto"===o?"coverPhotoLess10mb":"profilePhotoLess10mb"]||r)+"</p>",dismissButtonText:"OK"};richModal.display(t)}),!1)},n.editProfile=function(){null!=g&&g._id&&(n.tempUser=g,n.currentUserEmail=g.email,n.tempUserProfile=n.userProfile,n.editingProfile=!0,n.busy=!1,n.customRegistrationFields&&n.customRegistrationFields.forEach(function(e){delete e.error}),n.$$phase||n.$apply())},n.enforceMaxLength=function(e,r){e.value.length>r&&(e.value=e.value.substring(0,r)),e.change&&e.change(e.value),e.validate&&e.validate(e.value)},n.sideMenuScroll={enable:function(){var e=document.getElementsByClassName("menu-body-container")[0];e&&e.classList.remove("disable_overflow_scroll")},disable:function(){var e=document.getElementsByClassName("menu-body-container")[0];e&&e.classList.add("disable_overflow_scroll")}}}]),$app.filter("cropCoverImage",function(){return function(e){if(!e)return"";if(!imageTools||!/(https|http):\/\//g.test(e))return e;var r="full_width";return-1<window.location.href.indexOf("pluginTester")&&(r="xl"),imageTools.cropImage(e,{size:r,aspect:"16:9",compression:80})}});
