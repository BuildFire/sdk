...
"use strict";function _typeof(o){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(o){return typeof o}:function(o){return o&&"function"==typeof Symbol&&o.constructor===Symbol&&o!==Symbol.prototype?"symbol":typeof o})(o)}"undefined"==typeof AiAPI&&(window.AiAPI=function(o){this.context=o}),AiAPI.prototype.chat=function(o,t){(o=!o||"object"!=_typeof(o)?{}:o).appId=window.appContext.currentApp.appId;o={url:"".concat(window.siteConfig.endPoints.gatewayHost,"/ai/chat"),headers:{"Content-Type":"application/json"},body:JSON.stringify(o),method:"POST"};fetch(o.url,{method:o.method,headers:o.headers,body:o.body}).then(function(o){return o.ok?o.json().then(function(o){return o}).catch(function(o){throw{code:"unknownError",status:500,message:"response is not JSON",error:o}}):o.json().then(function(o){o=o.innerError||{};throw{code:o.code,status:o.status,message:o.message,error:o.error}}).catch(function(o){throw o&&o.code&&o.status&&o.message?o:{code:"unknownError",status:500,message:"error response is not JSON",error:o}})}).then(function(o){t(null,o)}).catch(function(o){o&&o.code&&o.status&&o.message?t(o,null):(o={code:"unknownError",status:504,message:"timeout error"},console.error(o),t(o,null))})};