...
>>>>>>> 4071961309f5857a21c0eca5a89ba28c3ffb2da5
...
"use strict";function ComponentUIAPI(e){this.context=e,this.DRAWER_UI_ID="bottomDrawerContainer",this.SNACKBAR_UI_ID="snackbarhero",this.timeOutId=null,this.init()}ComponentUIAPI.prototype={init:function(){},closeDrawer:function(e,t){e||(e={});var a=document.getElementById(this.DRAWER_UI_ID);a&&(e.force?a.remove():(a.classList.add("closing"),setTimeout(function(){a.remove()},300)))},openBottomDrawer:function(e,n){var t=this;e||(e={});var a=document.createElement("div");a.id=this.DRAWER_UI_ID,a.className="bottom-drawer-container",a.innerHTML='<div class="bottom-drawer-backdrop"></div>\n<div class="bottom-drawer-holder"><div class="bottom-drawer backgroundColorTheme"></div></div>\n';var s=a.querySelector(".backgroundColorTheme");if(a.querySelector(".bottom-drawer-backdrop").onclick=function(){t.closeDrawer()},e.header){var i=document.createElement("div");i.className="bottom-drawer-header primaryBackgroundTheme",i.innerHTML=e.header,s.appendChild(i)}function r(e){var t=document.createElement("ul");function a(e,t){e.onclick=function(){n(null,t)}}t.classList.add("action-list");for(var s=0;s<e.length;s++)if(e[s].text){var i=document.createElement("li");i.innerHTML='<div class="item-icon"><span class="icon hide"></span></div>\n<span>'+e[s].text+"</span>",a(i,e[s]),t.appendChild(i)}return t}if(e.content){var o=document.createElement("div");o.className="drawer-content",o.innerHTML=e.content,s.appendChild(o)}if(e.listItems)s.appendChild(r(e.listItems));else if(e.tabs&&e.tabs){var c=document.createElement("div");c.className="md-tabs-scroll";for(var d="",l=0;l<e.tabs.length;l++)d+='<button class="btn-tab-drawer-'+l+(0==l?" md-tab active":" md-tab")+'">\n'+e.tabs[l].text+'<div class="active-indicator primaryBackgroundTheme"></div></button>';d='<div class="md-tabs">'+d+"</div>",c.innerHTML=d;var m=0,u=[],h=c.querySelectorAll("button");h.forEach(function(t){t.setAttribute("data-tabindex",m),t.onclick=function(){h.forEach(function(e){e.classList.remove("active")}),t.classList.add("active");var e=t.getAttribute("data-tabindex");u.forEach(function(e){e.classList.add("hide")}),u[e].classList.remove("hide")},m++}),s.appendChild(c);for(var v=0;v<e.tabs.length;v++){if(e.tabs[v].listItems)u.push(r(e.tabs[v].listItems));else{var b=document.createElement("div");b.className="drawer-content",b.innerHTML=e.tabs[v].content,u.push(b)}0<v&&u[v].classList.add("hide"),s.appendChild(u[u.length-1])}}this.closeDrawer({force:!0}),(document.getElementById("appBody")||document.getElementById("app")).appendChild(a)},showToastMessage:function(e,t){var a=this;e||(e={});var s=document.getElementById(this.SNACKBAR_UI_ID);s.querySelector(".snackbar-message").innerText=e.text;var i=s.querySelector(".snackbar");e.type||(e.type="info"),i.className="snackbar "+e.type+"BackgroundTheme";var n=s.querySelector(".snackbar-actions"),r=n.querySelector(".snackbar-action");e.action&&e.action.title?(r.querySelector("span").innerText=e.action.title,r.classList.remove("hide"),r.onclick=function(){t&&t(null,e.action)}):r.classList.add("hide"),e.hideDismiss?n.querySelector(".dismiss").classList.add("hide"):(n.querySelector(".dismiss").classList.remove("hide"),n.querySelector(".dismiss").onclick=function(){a.closeToastMessage({force:!0})}),s.classList.remove("hide"),s.querySelector(".snackbar").classList.add("open"),this.closeToastMessage(e)},closeToastMessage:function(e,t){e||(e={}),e.duration||(e.duration=8e3);var a=document.getElementById(this.SNACKBAR_UI_ID);e.force?(a.querySelector(".snackbar").classList.remove("closing"),a.querySelector(".snackbar").classList.remove("open"),setTimeout(function(){a.classList.add("hide")},250)):(a.querySelector(".snackbar").classList.add("closing"),this.timeOutId&&clearTimeout(this.timeOutId),this.timeOutId=setTimeout(function(){a.querySelector(".snackbar").classList.remove("closing"),a.querySelector(".snackbar").classList.remove("open"),setTimeout(function(){a.classList.add("hide")},250),this.timeOutId=null},e.duration))}};
