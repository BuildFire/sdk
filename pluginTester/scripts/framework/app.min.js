...
"use strict";function StripeAPI(e){if(this.context=e,!this.context)throw Error("stripeAPI: invalid context")}StripeAPI.prototype={_sendRequest:function(e,t,n,i,s){var c="",o=new XMLHttpRequest,t=window.siteConfig.endPoints.stripeHost+"/stripe/"+t;if("GET"===(e=e.toUpperCase())&&n){var a="?";for(u in n)n.hasOwnProperty(u)&&void 0!==n[u]&&(a+=u+"="+encodeURIComponent(n[u])+"&");t+=a=a.slice(0,-1)}else c=JSON.stringify(n);if(o.open(e,t,!0),o.setRequestHeader("Content-Type","application/json"),i)for(var u in i)i.hasOwnProperty(u)&&o.setRequestHeader(u,i[u]);o.onreadystatechange=function(){var e=null;try{e=JSON.parse(o.responseText)}catch(e){}4==o.readyState&&(200===o.status?s&&s(null,e):s&&s(e))},o.send(c)},_loadScript:function(e,t){var n=document.createElement("script");if(n.type="text/javascript",n.readyState?n.onreadystatechange=function(){"loaded"!=n.readyState&&"complete"!=n.readyState||(n.onreadystatechange=null,t&&t())}:n.onload=function(){t&&t()},n.src=e.url,e.attr)for(var i in e.attr)n.setAttribute(i,e.attr[i]);for(var s=document.getElementsByTagName("script"),c=s.length;c--;)if(s[c].src==e.url)return t&&t(),!0;document.getElementsByTagName("head")[0].appendChild(n)},_guid:function(){function e(){return(65536*(1+Math.random())|0).toString(16).substring(1)}return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()},_openStripeCheckout:function(e,n){var t=e.items,i=e.successUrl,s=e.cancelUrl,c=e.submitType,o=e.customerEmail,a=e.sessionId,u=e.clientReferenceId,r=e.domain,p=e.events,l=this,d=null,m=!1,y=null,f=!1;function _(){window.richModal&&window.richModal.close()}function w(e){e=e||{},clearInterval(d),!e.invokeDismiss&&void 0!==e.invokeDismiss||_(),y&&y.close(),p&&"function"==typeof p.onClose&&p.onClose()}function K(){l._sendRequest("GET","checkout/sessions",{session_id:a,client_reference_id:u},{"x-api-key":l.context.apiKeys.awsApiPublicKey},function(e,t){t&&(f||(f=!0,w(),n&&n(e,t)))})}var v=r+"/payments/checkout?stripeKey="+l.context.apiKeys.stripePublicKey;function x(){(y=window.open(v,"_blank","location=no")).addEventListener("exit",function(){_()}),y.addEventListener("close",function(){_()}),d=setInterval(function(){y&&y.closed&&w(),"visible"==window.document.visibilityState?K():m||(m=!0,setTimeout(function(){m=!1,K()},6e4))},5e3),setTimeout(function(){w()},9e5)}a&&(v+="&sessionId="+encodeURIComponent(a)),u&&(v+="&clientReferenceId="+encodeURIComponent(u)),i&&(v+="&successUrl="+encodeURIComponent(i)),s&&(v+="&cancelUrl="+encodeURIComponent(s)),c&&(v+="&submitType="+encodeURIComponent(c)),o&&(v+="&customerEmail="+encodeURIComponent(o)),t&&(v+="&items="+encodeURIComponent(JSON.stringify(t))),window.bfUtils.isApp&&window.richModal.display({title:"",showDismissButton:!1,richContent:"<div style='text-align:center;'>Payment in progress <br/> Please wait...</div>",action:{title:"Cancel",handler:function(){w({invokeDismiss:!1})}}}),p&&"function"==typeof p.onProgress&&p.onProgress(x),x()},_openStripeConnect:function(e,n){var t=e.accessToken,i=e.accountLinkUrl,s=e.events,c=this,o=null,a=!1,u=null,r=!1;function p(e){e=e||{},clearInterval(o),(e.invokeDismiss||void 0===e.invokeDismiss)&&window.richModal&&window.richModal.close(),u&&u.close(),s&&"function"==typeof s.onClose&&s.onClose()}function l(){c._sendRequest("GET","connect/account",{access_token:t},{"x-api-key":c.context.apiKeys.awsApiPublicKey},function(e,t){t&&t.is_active&&(r||(r=!0,p(),n&&n(e,t)))})}var d=i;function m(){u=window.open(d,"_blank","location=no"),o=setInterval(function(){u&&u.closed&&p(),"visible"==window.document.visibilityState?l():a||(a=!0,setTimeout(function(){a=!1,l()},6e4))},1e4),setTimeout(function(){p()},18e5)}s&&"function"==typeof s.onProgress&&s.onProgress(m),window.bfUtils.isApp&&window.richModal.display({title:"",showDismissButton:!1,richContent:"<div style='text-align:center;'>Stripe Connect in progress <br/> Please wait...</div>",action:{title:"Cancel",handler:function(){p({invokeDismiss:!1})}}}),!1===c.openPaymentWindow||m()},_checkApiKeys:function(n){var i=this;function e(){appApiKeys.get(function(e,t){i.context.apiKeys=t,n&&n()})}i.context.apiKeys&&i.context.apiKeys.awsApiPublicKey?n&&n():!window.appContext.currentApp.apiKeys||0===Object.keys(window.appContext.currentApp.apiKeys).length&&window.appContext.currentApp.apiKeys.constructor===Object?e():(i.context.apiKeys=window.appContext.currentApp.apiKeys,n&&n())},pay:function(e,n){var i=this;i._checkApiKeys(function(){i.context.apiKeys.stripePublicKey?i._loadScript({url:"https://checkout.stripe.com/checkout.js"},function(){var t=StripeCheckout.configure({key:i.context.apiKeys.stripePublicKey,image:"https://stripe.com/img/documentation/checkout/marketplace.png",locale:"auto",token:function(e){t.close(),n&&n(null,{sourceToken:e})}});t.open({}),window.addEventListener("popstate",function(){t.close()})}):n&&n("Missing stripePublicKey in context",null)})},charge:function(o,a){var u=this;u._checkApiKeys(function(){if(u.context.apiKeys.stripePublicKey)if(o)if(u.openPaymentWindow=o.openPaymentWindow,o.items&&0!=o.items.length){for(var e=[],t=0;t<o.items.length;t++){if(!o.items[t].name)return void(a&&a("Missing name in items index "+t,null));if(!o.items[t].amount)return void(a&&a("Missing amount in items index "+t,null));var n={name:o.items[t].name,description:o.items[t].description||void 0,amount:o.items[t].amount,currency:o.items[t].currency||"usd",quantity:o.items[t].quantity||1};o.items[t].taxBehavior&&(n.tax_behavior=o.items[t].taxBehavior),e.push(n)}var i=window.siteConfig.endPoints.appHost,s="app_id_"+u.context.appId+"_ref_id_"+u._guid(),c={type:"line_items",mode:"payment",line_items:e,client_reference_id:s,success_url:i+"/payments/success",cancel_url:i+"/payments/cancel"};o.submitType&&(c.submit_type=o.submitType),o.customerId&&(c.customer_id=o.customerId),o.customerEmail&&(c.customer_email=o.customerEmail),o.captureMethod&&(c.payment_intent_data={capture_method:o.captureMethod}),o.automaticTax&&(c.automatic_tax={enabled:o.automaticTax}),u._sendRequest("POST","checkout/sessions",c,{"x-api-key":u.context.apiKeys.awsApiPublicKey},function(e,t){e?a&&a(e,t):(t=t.sessionId,u._openStripeCheckout({sessionId:t,clientReferenceId:s,domain:i,events:o.events},function(e,t){a&&a(e,t)}))})}else a&&a("Missing items",null);else a&&a("invalid params",null);else a&&a("Missing stripePublicKey in context",null)})},subscribe:function(c,o){var a=this;a._checkApiKeys(function(){if(a.context.apiKeys.stripePublicKey)if(a.context.apiKeys.awsApiPublicKey)if(c)if(a.openPaymentWindow=c.openPaymentWindow,c.items&&0!=c.items.length){for(var e=[],t=0;t<c.items.length;t++){if(!c.items[t].planId)return void(o&&o("Missing planId in items index "+t,null));e.push({plan_id:c.items[t].planId,quantity:c.items[t].quantity||1})}var n=window.siteConfig.endPoints.appHost,i="app_id_"+a.context.appId+"_ref_id_"+a._guid(),s={type:"subscription",subscription_data:e,client_reference_id:i,success_url:n+"/payments/success",cancel_url:n+"/payments/cancel"};c.trialPeriodDays&&(s.trial_period_days=c.trialPeriodDays),c.customerId&&(s.customer_id=c.customerId),c.customerEmail&&(s.customer_email=c.customerEmail),c.metadata&&(s.metadata=c.metadata),c.automaticTax&&(s.automatic_tax={enabled:c.automaticTax}),a._sendRequest("POST","checkout/sessions",s,{"x-api-key":a.context.apiKeys.awsApiPublicKey},function(e,t){e?o&&o(e,t):(t=t.sessionId,a._openStripeCheckout({sessionId:t,clientReferenceId:i,domain:n,events:c.events},function(e,t){o&&o(e,t)}))})}else o&&o("Missing items",null);else o&&o("invalid params",null);else o&&o("Missing awsApiPublicKey in context",null);else o&&o("Missing stripePublicKey in context",null)})},purchase:function(r,p){var l=this;l._checkApiKeys(function(){if(l.context.apiKeys.stripePublicKey)if(l.context.apiKeys.awsApiPublicKey)if(r)if(r.items&&0!=r.items.length){for(var e=[],t=!1,n=!1,i=0;i<r.items.length;i++)r.items[i].sku?t=!0:r.items[i].price&&(n=!0);if(t||n)if(t&&n)p&&p("You can't use sku and price together in a request",null);else{for(var s=0;s<r.items.length;s++){if(!r.items[s].sku&&!r.items[s].price)return void(p&&p("Missing property, one of sku or price is required in items index "+s,null));var c={quantity:r.items[s].quantity||1};t?c.sku=r.items[s].sku:c.price=r.items[s].price,e.push(c)}var o=window.siteConfig.endPoints.appHost,a="app_id_"+l.context.appId+"_ref_id_"+l._guid();r.clientReferenceId&&(a=r.clientReferenceId);var u={};n?(u={type:"purchase",mode:"payment",line_items:e,client_reference_id:a,success_url:o+"/payments/success",cancel_url:o+"/payments/cancel"},r.submitType&&(u.submit_type=r.submitType),r.customerId&&(u.customer_id=r.customerId),r.customerEmail&&(u.customer_email=r.customerEmail),r.automaticTax&&(u.automatic_tax={enabled:r.automaticTax}),l._sendRequest("POST","checkout/sessions",u,{"x-api-key":l.context.apiKeys.awsApiPublicKey},function(e,t){e?p&&p(e,t):l._openStripeCheckout({sessionId:t.sessionId,clientReferenceId:a,domain:o,events:r.events},function(e,t){p&&p(e,t)})})):(u={items:e,clientReferenceId:a,successUrl:o+"/payments/success",cancelUrl:o+"/payments/cancel",submitType:r.submitType,customerEmail:r.customerEmail,domain:o,events:r.events},l._openStripeCheckout(u,function(e,t){p&&p(e,t)}))}else p&&p("One of sku or price field is required for items",null)}else p&&p("Missing items",null);else p&&p("invalid params",null);else p&&p("Missing awsApiPublicKey in context",null);else p&&p("Missing stripePublicKey in context",null)})},getSubscription:function(t,n){var i=this;i._checkApiKeys(function(){var e;i.context.apiKeys.awsApiPublicKey?t?t.subscriptionId?(e={subscription_id:t.subscriptionId},i._sendRequest("GET","customer/subscription",e,{"x-api-key":i.context.apiKeys.awsApiPublicKey},function(e,t){n&&n(e,t)})):n&&n("Missing params subscriptionId",null):n&&n("invalid params",null):n&&n("Missing awsApiPublicKey in context",null)})},cancelSubscription:function(t,n){var i=this;i._checkApiKeys(function(){var e;i.context.apiKeys.awsApiPublicKey?t?t.subscriptionId?t.customerId?(e={subscription_id:t.subscriptionId,customer_id:t.customerId},i._sendRequest("DELETE","customer/subscription",e,{"x-api-key":i.context.apiKeys.awsApiPublicKey},function(e,t){n&&n(e,t)})):n&&n("Missing params customerId",null):n&&n("Missing params subscriptionId",null):n&&n("invalid params",null):n&&n("Missing awsApiPublicKey in context",null)})},addCustomerCard:function(s,c){var o=this;o._checkApiKeys(function(){var n,i,e;o.context.apiKeys.stripePublicKey?o.context.apiKeys.awsApiPublicKey?s?s.customerId?(n=window.siteConfig.endPoints.appHost,e={mode:"setup",type:"setup",client_reference_id:i="app_id_"+o.context.appId+"_ref_id_"+o._guid(),success_url:n+"/payments/success",cancel_url:n+"/payments/cancel"},s.customerEmail&&(e.customer_email=s.customerEmail),o._sendRequest("POST","checkout/sessions",e,{"x-api-key":o.context.apiKeys.awsApiPublicKey},function(e,t){e?c&&c(e,t):(t=t.sessionId,o._openStripeCheckout({sessionId:t,clientReferenceId:i,domain:n},function(e,t){e?c&&c(e,null):t?(t={customer_id:s.customerId,setup_intent:t.setup_intent},o._sendRequest("POST","customer/card",t,{"x-api-key":o.context.apiKeys.awsApiPublicKey},function(e,t){c&&c(e,t)})):c&&c(null,null)}))})):c&&c("Missing params customerId",null):c&&c("invalid params",null):c&&c("Missing awsApiPublicKey in context",null):c&&c("Missing stripePublicKey in context",null)})},capturePayment:function(t,n){var i=this;i._checkApiKeys(function(){var e;i.context.apiKeys.awsApiPublicKey?t?t.paymentIntentsId?(e={payment_intents_id:t.paymentIntentsId},t.amountToCapture&&(e.amount_to_capture=t.amountToCapture),i._sendRequest("POST","payment/capture",e,{"x-api-key":i.context.apiKeys.awsApiPublicKey},function(e,t){n&&n(e,t)})):n&&n("Missing params paymentIntentsId",null):n&&n("invalid params",null):n&&n("Missing awsApiPublicKey in context",null)})},cancelPayment:function(t,n){var i=this;i._checkApiKeys(function(){var e;i.context.apiKeys.awsApiPublicKey?t?t.paymentIntentsId?(e={payment_intents_id:t.paymentIntentsId},t.cancellationReason&&(e.cancellation_reason=t.cancellationReason),i._sendRequest("POST","payment/cancel",e,{"x-api-key":i.context.apiKeys.awsApiPublicKey},function(e,t){n&&n(e,t)})):n&&n("Missing params paymentIntentsId",null):n&&n("invalid params",null):n&&n("Missing awsApiPublicKey in context",null)})},refundPayment:function(t,n){var i=this;i._checkApiKeys(function(){var e;i.context.apiKeys.awsApiPublicKey?t?t.paymentIntentsId?(e={payment_intents_id:t.paymentIntentsId},t.amount&&(e.amount=t.amount),t.reason&&(e.reason=t.reason),t.metadata&&(e.metadata=t.metadata),i._sendRequest("POST","payment/refund",e,{"x-api-key":i.context.apiKeys.awsApiPublicKey},function(e,t){n&&n(e,t)})):n&&n("Missing params paymentIntentsId",null):n&&n("invalid params",null):n&&n("Missing awsApiPublicKey in context",null)})},get connect(){var c=this;return{account:function(i,s){c._checkApiKeys(function(){var e,n;c.context.apiKeys.awsApiPublicKey?(e=window.siteConfig.endPoints.appHost,n={return_url:e+"/stripe/connect/return",refresh_url:e+"/stripe/connect/reauth",account_type:"express"},i.email&&(n.email=i.email),i.metadata&&(n.metadata=i.metadata),window.authAPI.getCurrentUser(function(e,t){n.access_token=t&&t.accessToken?t.accessToken.toString():null,n.access_token?c._sendRequest("POST","connect/account",n,{"x-api-key":c.context.apiKeys.awsApiPublicKey},function(e,t){e?s&&s(e,t):t?t.is_active?s(null,t):(t=t.account_link_url,c._openStripeConnect({accessToken:n.access_token,accountLinkUrl:t,events:i.events},function(e,t){e?s&&s(e,null):s&&s(null,t)})):s("Something went wrong!")}):s&&s({message:"no logged in user"})})):s&&s("Missing awsApiPublicKey in context",null)})},deleteAccount:function(e,i){c._checkApiKeys(function(){var n;c.context.apiKeys.awsApiPublicKey?(window.siteConfig.endPoints.appHost,n={},window.authAPI.getCurrentUser(function(e,t){n.access_token=t&&t.accessToken?t.accessToken.toString():null,n.access_token?c._sendRequest("DELETE","connect/account",n,{"x-api-key":c.context.apiKeys.awsApiPublicKey},function(e,t){i&&i(e,t)}):i&&i({message:"no logged in user"})})):i&&i("Missing awsApiPublicKey in context",null)})}}}};
...
"use strict";function ComponentUIAPI(e){this.context=e,this.DRAWER_UI_ID="bottomDrawerContainer",this.SNACKBAR_UI_ID="snackbarhero",this.timeOutId=null,this.init()}ComponentUIAPI.prototype={init:function(){},sanitize:function(e,n,i){window.bfUtils.sanitize({data:e},function(e,t){return e?(i&&i(e,null),console.error(e)):(n.innerHTML+=t,void(i&&i(null,null)))})},closeDrawer:function(e,t){e=e||{};var n=document.getElementById(this.DRAWER_UI_ID);n&&(this.scrollBooster&&(this.scrollBooster.destroy(),this.scrollBooster=null),e.force?n.remove():(n.classList.add("closing"),setTimeout(function(){n.remove()},300)))},openDrawer:function(l,o){var e=this,a=this,r=!0,d=!1,u=[],m=[],h=(l=l||{}).multiSelection?"block":"none",c=[],p=null,b=null;l.isHTML=!1!==l.isHTML,l.multiSelectionActionButton=l.multiSelectionActionButton||{},l.multiSelectionActionButton.text=l.multiSelectionActionButton.text||"OK",l.multiSelectionActionButton.type=l.multiSelectionActionButton.type||"primary",l.allowSelectAll=!1!==l.allowSelectAll,l.enableFilter=!1!==l.enableFilter,l.autoUseImageCdn=!1!==l.autoUseImageCdn;var t=document.createElement("div");t.id=this.DRAWER_UI_ID,t.className="bottom-drawer-container",t.innerHTML='<div class="bottom-drawer-backdrop"></div><div class="bottom-drawer-holder"><div class="bottom-drawer backgroundColorTheme"></div></div>';var y=t.querySelector(".bottom-drawer");t.querySelector(".bottom-drawer-backdrop").onclick=function(){e.closeDrawer(),l.triggerCallbackOnUIDismiss&&o(null,null)},"undefined"!=typeof globalEvents&&(window.addEventListener(globalEvents.TABCHANGE.CONTENT,function(){e.closeDrawer()}),window.addEventListener(globalEvents.TABCHANGE.PURCHASE,function(){e.closeDrawer()}));var n,i,s,v,f,S,g,T=function(e){return r?-1<u.indexOf(e):-1===m.indexOf(e)};l.listItems&&l.listItems.forEach(function(e){e.selected&&u.push(e)}),l.header&&((n=document.createElement("div")).className="bottom-drawer-header titleBarBackgroundTheme",n.innerHTML='<div id="headerText" class="titleBarTextAndIcons"></div><div id="selectAllDiv" class="titleBarTextAndIcons">\n\t\t\t<span id="closeSearch" class="material-icons titleBarTextAndIcons">close</span>\n\t\t\t<div id="checkboxSelectAll" class="checkbox margin-top-zero">\n\t\t\t<input id="selectAllCheckbox" type="checkbox">\n\t\t\t<label style="padding:0" for="selectAllCheckbox"></label>\n\t\t    </div>\n\t\t\t<div id="drawerSearch" class="form-outline"><input type="search" class="form-control titleBarTextAndIcons" placeholder="'.concat("Search",'" aria-label="Search" disabled></div>\n\t\t\t<span id="searchIcon" class="material-icons titleBarTextAndIcons">search</span>\n\t\t\t</div>'),l.isHTML?this.sanitize(l.header,n.children[0]):n.children[0].innerText=l.header,l.multiSelection&&l.allowSelectAll&&(n.querySelector("#checkboxSelectAll").style.display="block",(i=n.querySelector("#selectAllCheckbox")).onclick=function(){var e=y.querySelectorAll("input[type=checkbox]");r=!i.checked,u=[],m=[],i.checked?l.listItems&&(u=l.listItems.slice(),x(l.listItems.length),e.forEach(function(e){e.checked=!0})):(u=[],x(),e.forEach(function(e){e.checked=!1}))}),l.enableFilter&&(s={},v=n.querySelector("#closeSearch"),f=n.querySelector("#searchIcon"),S=n.querySelector("#drawerSearch"),g=S.children[0],f.style.display="block",f.onclick=function(){S.classList.add("show-drawer-search"),S.classList.remove("hide-drawer-search"),g.disabled=!1,g.focus(),n.querySelector("#checkboxSelectAll").style.display="none",n.children[0].classList.add("hide-header-text"),n.children[0].classList.remove("show-header-text"),v.style.display="block"},v.onclick=function(){S.classList.add("hide-drawer-search"),S.classList.remove("show-drawer-search"),n.children[0].classList.remove("hide-header-text"),n.children[0].classList.add("show-header-text"),n.querySelector("#checkboxSelectAll").style.display=l.allowSelectAll&&l.multiSelection?"block":"none",n.children[0].style.display="block",v.style.display="none",S.children[0].value&&(L({target:{value:""}}),g.value=""),g.disabled=!0},g.onkeydown=function(e){var t=e.target;s&&clearTimeout(s),s=setTimeout(function(){return L({target:t})},500)}),y.appendChild(n)),window.stringResource&&l.header&&window.stringResource.getData().then(function(e){y.querySelector("#drawerSearch").children[0].placeholder=e.appSearch||"Search"});var k,L=function(e){var i,s,t,n=e.target;c&&p&&(e=[],s=!(i=!0),n=n.value,0<(t=n?n.toLowerCase().split(/[\s-_():,/\\|]+/g):[]).length?(e=c.filter(function(e){s=!(i=!0);var n=(e.text+" "+(e.secondaryText||"")).toLowerCase().split(/<[^>]+>|[\s-_():,/\\|]+/g);return t.forEach(function(t){t&&(n.forEach(function(e){e.startsWith(t)&&(s=!0)}),i=!(!s||!i),s=!1)}),i}),p.innerHTML="",p.scrollTop=0,w(e,p),N(e)):(p.innerHTML="",p.scrollTop=0,w(c,p),N(c)))};function x(e){var t=y.querySelector("#drawerButton");e?(y.querySelector("#buttonBadge").innerHTML=e,t.classList.remove("disabled-drawer-button"),t.disabled=!1):(y.querySelector("#buttonBadge").innerHTML="",t.classList.add("disabled-drawer-button"),t.disabled=!0)}function w(i,e){var s={};e?s=e:((s=document.createElement("ul")).classList.add("action-list"),s.onclick=function(e){for(var t,n=e.target;"LI"!==n.nodeName;){if("UL"===n.nodeName)return void console.log("Wrong Click");n=n.parentElement}l.multiSelection?(t=n.querySelector("input[type=checkbox]"),"checkbox"!=e.target.type&&(t.checked=!t.checked),function(e,t){{var n;t?(r?u.push(e):(n=m.indexOf(e),m.splice(n,1)),x(Number(y.querySelector("#buttonBadge").innerHTML)+1)):(r?(n=u.indexOf(e),u.splice(n,1)):m.push(e),x(Number(y.querySelector("#buttonBadge").innerHTML)-1))}}(n.item,t.checked)):o(null,n.item)});var c=0;function t(){for(var e,t,n=c;n<c+50&&!(i.length-1<n);n++)i[n]&&i[n].text&&(e=document.createElement("li"),t="",t=!l.autoUseImageCdn||!i[n].imageUrl||i[n].imageUrl.includes("cloudimg.io")||0!==i[n].imageUrl.indexOf("http")||i[n].imageUrl.includes("localhost")?i[n].imageUrl:imageTools.cropImage(i[n].imageUrl,{size:"xs",aspect:"1:1"}),e.innerHTML='<div class="item-icon">\n\t\t\t\t\t\t<img style="display:'.concat(t?"block":"none",'" src="').concat(t||"",'" onerror="this.style.display=\'none\'"></div>\n\t\t\t\t\t\t<div class="action-item-texts">\n\t\t\t\t\t\t<div style="font-weight: bold"></div>\n\t\t\t\t\t\t<div></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style="display: ').concat(h,' ; margin-left: auto" class="checkbox checkbox-primary margin-top-zero ').concat(i[n].secondaryText?"drawer-checkboxes":"",'"><input type="checkbox"><label style="padding:0"></label></div>'),l.isHTML?(a.sanitize(i[n].text,e.children[1].children[0]),a.sanitize(i[n].secondaryText,e.children[1].children[1])):(e.children[1].children[0].innerText=i[n].text,e.children[1].children[1].innerText=i[n].secondaryText||""),l.multiSelection&&(e.querySelector("input[type=checkbox]").checked=T(i[n])||!1),e.item=i[n],s.appendChild(e));c+=50,console.log("Load Other Items")}if(b&&s.removeEventListener("scroll",b),b=function(){s.scrollTop+s.clientHeight+1e3>=s.scrollHeight&&t()},s.addEventListener("scroll",b),t(),!e){for(var n=0;n<i.length;n++)if(i[n].imageUrl){d=!0;break}return d&&s.classList.add("has-images"),s}}if(l.content&&((k=document.createElement("div")).className="drawer-content",l.listItems||l.tabs||k.classList.add("scrollable-content"),l.isHTML?this.sanitize(l.content,k,function(){l.onContentRender&&setTimeout(function(){l.onContentRender()},0)}):k.innerText=l.content,y.appendChild(k)),l.listItems)c=l.listItems,p=w(l.listItems),y.appendChild(p);else if(l.tabs&&!l.multiSelection){var I=document.createElement("div");I.className="md-tabs-scroll";var B=document.createElement("div");B.classList.add("md-tabs");for(var A=0;A<l.tabs.length;A++){var q=document.createElement("div"),E=document.createElement("div");E.classList.add("active-indicator","titleBarBackgroundTheme"),q.classList.add("btn-tab-drawer-"+A,"md-tab"),0===A&&q.classList.add("active"),l.isHTML?this.sanitize(l.tabs[A].text,q):q.innerText=l.tabs[A].text,q.appendChild(E),B.appendChild(q)}I.appendChild(B);var C=0,M=[],H=I.querySelectorAll(".md-tab");H.forEach(function(t){t.setAttribute("data-tabindex",C),t.onclick=function(){H.forEach(function(e){e.classList.remove("active")}),t.classList.add("active");var e=t.getAttribute("data-tabindex");M.forEach(function(e){e.classList.add("hide")}),M[e].classList.remove("hide"),M[e].items?(c=M[e].items,p=M[e],l.header&&L({target:{value:document.querySelector("#drawerSearch").children[0].value}})):(p=c=null,y.querySelector(".empty-items")&&(y.querySelector(".empty-items").style.display="none"))},C++}),y.appendChild(I);for(var D,U=0;U<l.tabs.length;U++)l.tabs[U].listItems?((D=w(l.tabs[U].listItems)).items=l.tabs[U].listItems,0===U&&(c=l.tabs[U].listItems,p=D),M.push(D)):((D=document.createElement("div")).className="drawer-content",l.isHTML?this.sanitize(l.tabs[U].content,D):D.innerText=l.tabs[U].content,M.push(D)),0<U&&M[U].classList.add("hide"),y.appendChild(M[M.length-1])}function N(e){var t;y.querySelector(".empty-items")||((t=document.createElement("IMG")).src=window._appRoot+"media/ic_bookmark_empty.svg",t.classList.add("empty-items"),y.appendChild(t)),e&&0===e.length?y.querySelector(".empty-items").style.display="block":y.querySelector(".empty-items").style.display="none"}(l.listItems||l.tabs&&l.tabs[0]&&l.tabs[0].listItems)&&N(l.listItems||l.tabs&&l.tabs[0]&&l.tabs[0].listItems),l.multiSelection&&((k=document.createElement("DIV")).id="drawerButtonDiv",(I=document.createElement("BUTTON")).id="drawerButton",I.type="button",I.classList.add("btn","btn-".concat(l.multiSelectionActionButton.type)),I.innerHTML='<span class="btn-'.concat(l.multiSelectionActionButton.type,'"></span><span id="buttonBadge" class="badge btn-').concat(l.multiSelectionActionButton.type,'"></span>'),l.isHTML?this.sanitize(l.multiSelectionActionButton.text,I.children[0]):I.children[0].innerText=l.multiSelectionActionButton.text,k.appendChild(I),y.appendChild(k),y.querySelector("#drawerButton").onclick=function(){e.closeDrawer(),o(null,(r||m.forEach(function(e){e=u.indexOf(e);u.splice(e,1)}),u))},x(u.length)),this.closeDrawer({force:!0}),(document.getElementById("appBody")||document.getElementById("app")).appendChild(t),!l.tabs||l.multiSelection||l.listItems||setTimeout(function(){e.scrollBooster=new ScrollBooster({viewport:t.querySelector(".md-tabs-scroll"),content:t.querySelector(".md-tabs"),scrollMode:"native",direction:"horizontal"}),setTimeout(function(){e.scrollBooster&&e.scrollBooster.updateMetrics()},1e3),setTimeout(function(){e.scrollBooster&&e.scrollBooster.updateMetrics()},3e3)},0)},showToastMessage:function(e,t){var n=this;e=e||{};var i=document.getElementById(this.SNACKBAR_UI_ID);i.querySelector(".snackbar-message").innerText=e.text;var s=i.querySelector(".snackbar");e.type||(e.type="info"),s.className="snackbar ".concat(e.type+"BackgroundTheme");var c=i.querySelector(".snackbar-actions"),s=c.querySelector(".snackbar-action");e.action&&e.action.title?(s.querySelector("span").innerText=e.action.title,s.classList.remove("hide"),s.onclick=function(){t&&t(null,e.action)}):s.classList.add("hide"),e.hideDismiss?c.querySelector(".dismiss").classList.add("hide"):(c.querySelector(".dismiss").classList.remove("hide"),c.querySelector(".dismiss").onclick=function(){n.closeToastMessage({force:!0})}),i.classList.remove("hide"),i.querySelector(".snackbar").classList.add("open"),this.closeToastMessage(e)},closeToastMessage:function(e,t){(e=e||{}).duration||(e.duration=8e3);var n=document.getElementById(this.SNACKBAR_UI_ID);e.force?(n.querySelector(".snackbar").classList.remove("closing"),n.querySelector(".snackbar").classList.remove("open"),setTimeout(function(){n.classList.add("hide")},250)):(n.querySelector(".snackbar").classList.add("closing"),this.timeOutId&&clearTimeout(this.timeOutId),this.timeOutId=setTimeout(function(){n.querySelector(".snackbar").classList.remove("closing"),n.querySelector(".snackbar").classList.remove("open"),setTimeout(function(){n.classList.add("hide")},250),this.timeOutId=null},e.duration))}};
