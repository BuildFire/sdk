...
"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}var imageTools={get ENUMS(){return{SIZES:{xxs:32,xs:64,s:128,m:200,l:304,xl:416,xxl:600,720:720,1080:1080,1440:1440,1920:1920,2560:2560,3840:3840,get full_width(){return this.findNearest(1)},get half_width(){return this.findNearest(2)},get third_width(){return this.findNearest(3)},get fourth_width(){return this.findNearest(4)},get fifth_width(){return this.findNearest(5)},get sixth_width(){return this.findNearest(6)},findNearest:function(t){for(var i=null,e=0;e<this.VALID_SIZES.length;e++){var n=this.VALID_SIZES[e];if(window.innerWidth/t<this[n]){i=n;break}}return this[i]},VALID_SIZES:["xxs","xs","s","m","l","xl","xxl","720","1080","1440","1920","2560","3840","full_width","half_width","third_width","quarter_width","fifth_width","sixth_width"]},ASPECT_RATIOS:{"1:1":1,"4:3":.75,"16:9":.5625,"9:16":1.77777778,"11:5":.45454545,"4:1":.25,"2.39:1":.41841004,VALID_RATIOS:["1:1","4:3","16:9","9:16","11:5","4:1","2.39:1"]}}},_getIntermediateUrl:function(t,i){return-1<bfUtils.isIOS?new URL(window._appRoot).origin+"/intermediate-image-sdk?options=".concat(encodeURIComponent(JSON.stringify(t)),"&url=").concat(encodeURIComponent(i)):i},_handleImageReady:function(i){document.querySelectorAll('img[src="'.concat(i.currentImageUrl,'"]')).forEach(function(t){t.src=i.newImageUrl})},resizeImage:function(t,i,e,n){if(!t)return null;if(t&&t.indexOf&&(-1<t.indexOf("://localhost:")||-1<t.indexOf("cdvfile://"))||-1<t.indexOf("file://"))return t;var r=window.forceImgix?imageTools._imgix:imageTools._cloudImg;if(!r.isSupportedUrl(t))return console.warn("URL is not supported by resizeImage. Returning original URL: "+t),t;if(i){if("object"!=_typeof(i))throw"options not an object"}else i={width:window.innerWidth};var o,a,s=i.disablePixelRation?1:window.devicePixelRatio;if(s<1&&(s=1),"full"==i.width&&(i.width=window.innerWidth),"full"==i.height&&(i.height=window.innerHeight),i.size&&i.aspect){if(this.ENUMS.SIZES.VALID_SIZES.indexOf(i.size)<0){var h=this.ENUMS.SIZES.VALID_SIZES.join(", ");return console.warn("Invalid size. Available options are "+h+". Returning original url"),t}if(this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.indexOf(i.aspect)<0){h=this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.join(", ");return console.warn("Invalid aspect ratio. Available options are "+h+". Returning original url"),t}i.width=this.ENUMS.SIZES[i.size],i.height=i.width*this.ENUMS.ASPECT_RATIOS[i.aspect]}i.width&&!i.height?o=Math.floor(i.width*s):!i.width&&i.height?a=Math.floor(i.height*s):i.width&&i.height&&(o=Math.floor(i.width*s),a=Math.floor(i.height*s));t=r.constructUrl({width:o,height:a,url:t,method:"resize"});return this._handleElement(e,t,n),imageTools._getIntermediateUrl(i,t)},cropImage:function(t,i,e,n){if(!t)return null;if(t&&t.indexOf&&(-1<t.indexOf("://localhost:")||-1<t.indexOf("cdvfile://"))||-1<t.indexOf("file://"))return t;var r=window.forceImgix?imageTools._imgix:imageTools._cloudImg;if(!r.isSupportedUrl(t))return console.warn("URL is not supported by cropImage. Returning original URL: "+t),t;if("object"!=_typeof(i=i||{}))throw"options not an object";if(i.size&&i.aspect){if(this.ENUMS.SIZES.VALID_SIZES.indexOf(i.size)<0){var o=this.ENUMS.SIZES.VALID_SIZES.join(", ");return console.warn("invalid size, available options are "+o+". Returning original url"),t}if(this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.indexOf(i.aspect)<0){var a=this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.join(", ");return console.warn("invalid aspect ratio. available options are "+a+". Returning original url"),t}i.width=this.ENUMS.SIZES[i.size],i.height=i.width*this.ENUMS.ASPECT_RATIOS[i.aspect]}if("full"==(i=!i.width&&!i.height?{width:"full",height:"full"}:i).width&&(i.width=window.innerWidth),"full"==i.height&&(i.height=window.innerHeight),!i.width||!i.height)return console.warn("cropImage does not have width or height please fix. returning original url"),t;o=window.devicePixelRatio;i&&i.disablePixelRatio&&(o=i.disablePixelRatio);a=Math.floor(i.width*o),o=Math.floor(i.height*o),t=r.constructUrl({width:a,height:o,url:t,method:"crop"});return this._handleElement(e,t,n),imageTools._getIntermediateUrl(i,t)},_handleElement:function(e,n,t){var i;e&&n&&(i=this._getLocalPath(n),"IMG"===e.tagName?(e.style.setProperty("opacity","0","important"),e.src=i,e.onload=function(){e.style.removeProperty("opacity"),t&&t(i)},e.onerror=function(){bfUtils.isApp&&imageCacheAPI.download(n,function(t,i){return t?e.src=n:void(e.src=i)})}):this._handleBgImage(e,i,n,t))},_imgix:{isSupportedUrl:function(t){return!(/\..{3,4}(?!.)/g.test(t)&&!/.(png|jpg|jpeg|gif|jfif|svg)(?!.)/gi.test(t))&&null!=this._transformToImgix(t)},constructUrl:function(t){var i=t.width,e=t.height,n=t.url,r=t.method,o=this._transformToImgix(n),t=-1!==n.indexOf("?");return i||e?o+(t?"&":"?")+("crop"==r?"fit=crop":"")+"&width="+i+"&height="+e:n},_imgixWhitelistedUrls:{"http://imageserver.prod.s3.amazonaws.com":"https://buildfire.imgix.net","http://s3-us-west-2.amazonaws.com/imageserver.prod":"https://buildfire.imgix.net","http://pluginserver.buildfire.com":"https://bfplugins.imgix.net","http://s3.amazonaws.com/Kaleo.DevBucket":"https://bflegacy.imgix.net","http://s3-us-west-2.amazonaws.com/imagelibserver":"https://buildfire-uat.imgix.net","http://s3-us-west-2.amazonaws.com/pluginserver.uat":"https://bfplugins-uat.imgix.net"},_transformToImgix:function(t){for(var i in t=t.replace(/^https:\/\//i,"http://"),this._imgixWhitelistedUrls)if(0===t.indexOf(i))return this._imgixWhitelistedUrls[i]+t.split(i)[1];return null}},_cloudImg:{isSupportedUrl:function(t){return!(/\..{3,4}(?!.)/g.test(t)&&!/.(png|jpg|jpeg|gif|jfif|svg)(?!.)/gi.test(t))},constructUrl:function(t){var i=t.width,e=t.height,n=t.url,r=t.method,o=window.siteConfig.endPoints.cloudImageHost+"/"+n,t=-1!==n.indexOf("?");return i||e?o+(t?"&":"?")+("crop"==r?"func=crop":"func=bound")+"&width="+i+"&height="+e:n}},_handleBgImage:function(e,t,n,r){o(e,t);var i=new Image;function o(t,i){if(!i)return t.style.removeProperty("background-image");t.style.setProperty("background-image",'url("'+i+'")',"important")}i.src=t,i.onload=function(){r&&r(t)},i.onerror=function(){if(o(e),!bfUtils.isApp)return o(e,n);imageCacheAPI.download(n,function(t,i){return t?(r&&r(n),o(e,n)):void window.requestAnimationFrame(function(){o(e,i),r&&r(i)})})}},_getLocalPath:function(t){if(!bfUtils.isApp)return t;var i=(i=(t=t.replace(/(http|https):\/\/\S{0,8}.cloudimg.io\//g,"")).match(/(png|jpg|jpeg|gif|jfif|svg)/g)[0]||"")?"."+i:"",e=0;if(!t.length)return e;for(var n=0;n<t.length;n++){e=(e<<5)-e+t.charCodeAt(n);e|=0}return"".concat(window._appRoot.replace("app","imageCache/images")).concat(e).concat(i)},isProdImageServer:function(t){return 0==t.indexOf("http://imageserver.prod.s3.amazonaws.com")||0==t.indexOf("https://imageserver.prod.s3.amazonaws.com")||0==t.indexOf("https://s3-us-west-2.amazonaws.com/imageserver.prod")}};
