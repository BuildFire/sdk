...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(n){return typeof n}:function(n){return n&&"function"==typeof Symbol&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n};setTimeout(function(){if(sessionStorage.getItem("notification"))try{var n=JSON.parse(sessionStorage.getItem("notification"));LocalNotificationsAPI.navToPlugin(n)}finally{sessionStorage.removeItem("notification")}},2e3);var LocalNotificationsAPI=function(){var c={},a="Cordova notification plugin not installed";function l(n){this.context=n}function s(n){return c.hasOwnProperty(n)}function r(n){s(n)&&(clearTimeout(c[n]),delete c[n])}function o(){return"undefined"!=typeof cordova}return l.prototype={schedule:function(n,t){var a=Math.floor(1e9*Math.random()),o=new Date;if(l.isPluginAvailable())n.badge=0,n.at?n.at=Date.parse(n.at):n.at=new Date(o.getTime()+250),n.id=a,n.data={actionItem:n.actionItem,pluginData:n.data,returnInstanceId:n.returnToPluginInstanceId||this.context.instanceId,launchInstanceId:this.context.instanceId,pluginId:this.context.pluginId,analyticsData:n.analyticsData},cordova.plugins.notification.local.schedule(n),t(null,{id:n.id});else{var i=Math.abs(Date.parse(n.at)-Date.now());if(i<-2e3)return;n.data={actionItem:n.actionItem,pluginData:n.data,returnInstanceId:n.returnToPluginInstanceId||this.context.instanceId,launchInstanceId:this.context.instanceId,pluginId:this.context.pluginId,analyticsData:n.analyticsData};var e=setTimeout(function(){s(a)&&(l.notificationModal(n),r(a))},i);c[a]=e,t(null,{id:a})}},cancel:function(n,t){l.isPluginAvailable()?(cordova.plugins.notification.local.cancel(n),t(null,{id:n})):o()?t(new Error(a),null):(r(n),t(null,{id:n}))},checkPermission:function(n,t){if(o())return l.isPluginAvailable()?void cordova.plugins.notification.local.hasPermission(function(n){t&&t(null,n)}):(t&&t(new Error(a),!1),void console.warn(a));t&&t(null,!0)},requestPermission:function(n,t){if(o())return l.isPluginAvailable()?void cordova.plugins.notification.local.hasPermission(function(n){n?t&&t(null,!0):cordova.plugins.notification.local.registerPermission(function(n){n?t&&t(null,!0):(console.warn("Permission not granted for local notifications"),t&&t(null,!1))})}):(t&&t(new Error(a),!1),void console.warn(a));t&&t(null,!0)}},l.isPluginAvailable=function(){var n=!0;return"undefined"!=typeof cordova&&cordova.plugins&&cordova.plugins.notification&&cordova.plugins.notification.local||(n=!1),n},l.getPlatform=function(){return device.platform?device.platform.toLowerCase():""},l.notificationModal=function(t){var n={data:{title:t.title,body:t.text}};window.openDialog(n,function(n){n&&l.navToPlugin(t)})},l.navToPlugin=function(i){var n=postMaster.launcherPluginAPI?0:1500;setTimeout(function(){var n,t,a,o;postMaster.launcherPluginAPI&&(t=2e3,o=(a={doNothing:0,sendToLauncher:1,sendToPlugin:2}).sendToPlugin,"object"!==_typeof(i.data)&&(i.data=JSON.parse(i.data)),i.data.actionItem&&ActionItemsAPI.prototype.execute(i.data.actionItem,function(n,t){}),"home"==(n=i.data.returnInstanceId?i.data.returnInstanceId.toLowerCase():"")||"none"==n?o=a.doNothing:postMaster.launcherPluginAPI&&postMaster.launcherPluginAPI.context&&postMaster.launcherPluginAPI.context.instanceId==n&&(o=a.sendToLauncher),o!==a.doNothing&&(a===a.sendToLauncher?(t=500,postMaster.launcherPluginAPI.navigation.navigateHome()):(o=a.sendToPlugin,postMaster.widgetPluginAPI&&postMaster.widgetPluginAPI.context&&postMaster.widgetPluginAPI.context.instanceId==i.data.returnInstanceId?t=500:postMaster.launcherPluginAPI.navigation.navigateToPluginInstance({instanceId:i.data.returnInstanceId})),setTimeout(function(){var n=new Packet(null,"notifications.localNotification.onClick",i.data.pluginData);o===a.sendToLauncher?postMaster.launcherPluginAPI.sendMessage(null,n):postMaster.widgetPluginAPI.sendMessage(null,n)},t)))},n)},l.sendAnalytics=function(n){n&&n.data&&("object"!==_typeof(n.data)&&(n.data=JSON.parse(n.data)),n.data&&n.data.analyticsData&&n.data.analyticsData.eventName&&new AnalyticsAPI(window.appContext.currentApp.appId,n.data.pluginId,n.data.launchInstanceId,window.appContext.liveMode).trackAction(n.data.analyticsData.eventName,n.data.analyticsData.metaData))},l}();document.addEventListener("deviceready",function(){LocalNotificationsAPI.isPluginAvailable()&&(cordova.plugins.notification.local.on("trigger",function(n){console.log("*** notification trigger ***"),LocalNotificationsAPI.sendAnalytics(n),"ios"==LocalNotificationsAPI.getPlatform()&&LocalNotificationsAPI.notificationModal(n)}),cordova.plugins.notification.local.on("click",function(n){console.log("*** notification click ***"),LocalNotificationsAPI.sendAnalytics(n),LocalNotificationsAPI.navToPlugin(n)}))});
