...
"use strict";function LocalStorageAPI(e){this.instanceId=e.instanceId,this.collectionKey=this.instanceId+"-storage";var t=localStorage.getItem(this.collectionKey);if(t)try{this.collection=JSON.parse(t)}catch(e){console.error(e),this.collection={}}else this.collection={}}LocalStorageAPI.prototype={setItem:function(e,t){if(e&&e.key&&e.value){void 0===e.value?delete this.collection[e.key]:this.collection[e.key]=e.value;var o=JSON.stringify(this.collection);if(o&&2048<o.length){var l="localStorage for a plugin instance may not exceed 2048 characters. consider using other buildfire storage options";return console.error(l),void t(new Error(l))}localStorage.setItem(this.collectionKey,o),t(null,!0)}else t(new Error("invalid parameters. Expected Key/Value object"))},getItem:function(e,t){(e&&e.key&&(e=e.key),e&&t)?t(null,this.collection[e]):t(new Error("invalid parameters. Expected Key and Callback"))},removeItem:function(e,t){e&&e.key&&(e=e.key),e&&t?(delete this.collection[e],localStorage.setItem(this.collectionKey,JSON.stringify(this.collection)),t(null,!0)):t(new Error("invalid parameters. Expected Key and Callback"))},getCollection:function(e,t){t(null,this.collection)}};
