...
"use strict";var richModal=function(){var g=document.createElement("div");g.id="richModal",g.className="hidden";var e=document.createElement("div");e.className="focus-screen hidden",g.appendChild(e),document.body.appendChild(g);var p=null,f=[];function b(){try{if(p)return;var e=!(null==f||!f.length)&&f[0].options.forceShow;if(0<=window.location.hash.indexOf("accessCode")&&!e)return setTimeout(b,5e3);var t=document.getElementsByClassName("login-holder")[0];if(t&&-1===t.className.indexOf("ng-hide")&&!e)return setTimeout(b,5e3);var n=(p=f.shift()).options,i=p.callback;document.getElementById("richModal").className="";var a=document.getElementsByClassName("focus-screen")[0];a.className="focus-screen animated fadeInScreen",a.onclick=function(){v()};var o=document.createElement("div");if(o.className="detail-modal animated fadeInUp backgroundColorTheme",n.title){var s=document.createElement("h1");if(s.id="modalTitle",s.innerHTML=n.title,n.design){var l="";n.design.title&&n.design.title.align&&(l+="text-align: "+n.design.title.align+" !important;"),n.design.textColor&&(l+="color: "+n.design.textColor+" !important;"),s.setAttribute("style",l)}o.appendChild(s)}if(n.subtitle){var c=document.createElement("span");if(c.className="subtitle",c.innerHTML=n.subtitle,n.design){l="";n.design.subtitle&&n.design.subtitle.align&&(l+="text-align: "+n.design.subtitle.align+" !important;"),n.design.textColor&&(l+="color: "+n.design.textColor+" !important;"),c.setAttribute("style",l)}o.appendChild(c)}var d=document.createElement("div");d.className="rich-content",d.innerHTML=n.richContent||"",o.appendChild(d);var r=document.createElement("div");if(r.className="button-container",o.appendChild(r),n.showDismissButton||void 0===n.showDismissButton){var m=document.createElement("button");m.className=n.action?"dismiss-button primaryTheme":"dismiss-button dismiss-large primaryTheme",m.innerHTML=n.dismissButtonText||"Dismiss",m.onclick=function(){v(),i&&i(null,{buttonType:"dismiss"})},r.appendChild(m)}var u="";n.design&&(n.design.fullScreen&&g.classList.add("fullScreen"),n.design.backgroundColor&&(u+="background : "+n.design.backgroundColor+" !important;"),n.design.textColor&&(u+="color : "+n.design.textColor+" !important"),o.setAttribute("style",u),m.setAttribute("style",u))}catch(e){console.error("Failed to render rich modal",e)}if(n.action)try{var h=document.createElement("button");!(h.className="action-button primaryTheme")===n.showDismissButton&&(h.className="action-button primaryTheme action-button-large"),h.innerHTML=n.action.title||"[ Click ]",h.onclick=function(){n.action.handler?n.action.handler():((new ActionItemsAPI).execute(n.action,function(e,t){}),i&&i(null,{buttonType:"action",value:n.action}));n.action.preventAutoClose||v()},n.design&&u&&h.setAttribute("style",u),r.appendChild(h)}catch(e){console.error("Failed to bind action to rich modal",e)}document.getElementById("richModal").appendChild(o)}function v(){var e=document.getElementsByClassName("focus-screen")[0];e&&(e.className="focus-screen animated fadeOutScreen");var t=document.getElementsByClassName("detail-modal")[0];t&&(t.className="detail-modal animated fadeOut");var n=document.getElementById("richModal");setTimeout(function(){t&&t.remove(),p=null,0<f.length?setTimeout(b,300):n&&(n.className="hidden")},700)}return{display:function(e,t){f.push({options:e,callback:t}),b()},close:function(){v()},isVisible:function(){return!(0<=document.getElementById("richModal").className.indexOf("hidden"))},clearAll:function(){f=[],v()}}}();
