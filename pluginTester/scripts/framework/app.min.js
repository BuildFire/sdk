...
"use strict";var customRegistration={googleMapServices:{},get wl_name(){var e="Full ";return e=appContext&&appContext.currentApp&&appContext.currentApp.config?appContext.currentApp.config.whitlabelName+" ":e},getFields:function(l,e){var o,t,r,s=l.customRegistrationSettings;s&&s.singlePage&&s.singlePage.formControls?(o=[],t={},r=[],s.singlePage.formControls.forEach(function(a,e){switch(a.id){case"fullName":a.active&&(a.settings.displayNameEnabled&&o.push({type:"text",viewType:"none",name:"displayName",order:e,label:a.options.fieldsLabels.displayName,iconClass:a.icon||"glyphicon glyphicon-font",validate:function(e){this.error=null,e&&e.trim().length||!a.settings.required||(this.error=a.options.errorMessages.fullNameRequired)},touch:function(e){this.validate(e)},messages:a.options.errorMessages,value:l.defaults?l.defaults.displayName:void 0}),a.settings.firstNameEnabled&&o.push({type:"text",viewType:"text",name:"firstName",order:e,label:a.options.fieldsLabels.firstName,iconClass:a.icon||"glyphicon glyphicon-font",validate:function(e){this.error=null,e&&e.trim().length||!a.settings.required||(this.error=a.options.errorMessages.fullNameRequired)},touch:function(e){this.validate(e)},messages:a.options.errorMessages,value:l.defaults?l.defaults.firstName:void 0}),a.settings.lastNameEnabled&&o.push({type:"text",viewType:"text",name:"lastName",order:e,label:a.options.fieldsLabels.lastName,iconClass:a.icon||"glyphicon glyphicon-font",validate:function(e){this.error=null,e&&e.trim().length||!a.settings.required||(this.error=a.options.errorMessages.fullNameRequired)},touch:function(e){this.validate(e)},messages:a.options.errorMessages,value:l.defaults?l.defaults.lastName:void 0}));break;case"email":o.push({type:"email",viewType:"email",name:"email",autocorrect:"off",autocapitalize:"none",order:e,label:a.options.fieldsLabels.email,info:a.options.infoMessages?a.options.infoMessages.assistiveText:void 0,iconClass:a.icon||"glyphicon glyphicon-send",validate:function(e){this.error=null,e&&e.trim().length?window.validator.validateEmail(e)?e&&e.trim().length||(this.error=a.options.errorMessages.emailAlreadyInUse):this.error=a.options.errorMessages.emailInvalidFormat:this.error=a.options.errorMessages.emailRequired},touch:function(e,s){!e&&s&&s.target&&(e=s.target.value),this.validate(e)},messages:a.options.errorMessages,value:l.defaults?l.defaults.email:void 0});break;case"address":var s;a.active&&(s=a.options.addressGoogleApiKey,a.options.addressGoogleApiKey&&r.push(function(){setTimeout(function(){var e=document.getElementById("customRegistrationScript");e&&document.getElementsByTagName("head")[0].removeChild(e),customRegistration.googleMapServices.mapsApiKeyError=null,(e=document.createElement("script")).id="customRegistrationScript",e.src="https://maps.googleapis.com/maps/api/js?key=".concat(s,"&libraries=places&callback=googleMapsInitCallback"),e.type="text/javascript",document.getElementsByTagName("head")[0].appendChild(e),window.googleMapsInitCallback=function(){customRegistration.googleMapServices.autoAddressCompleteService=new google.maps.places.AutocompleteService,customRegistration.googleMapServices.addressGeocoder=new google.maps.Geocoder},l.refreshUI&&l.refreshUI()},0)}),a.settings.showFullAddress&&(o.push({type:"text",viewType:"text",name:"address",order:e,label:a.options.fieldsLabels.address,iconClass:a.icon||"glyphicon glyphicon-pushpin",change:function(e){var i=this;i.extra=null,customRegistration.googleMapServices.mapsApiKeyError&&(i.error=customRegistration.googleMapServices.mapsApiKeyError),customRegistration.googleMapServices.autoAddressCompleteService?(customRegistration.googleMapServices.checkMapsApiKeyErrors=!0,setTimeout(function(){customRegistration.googleMapServices.checkMapsApiKeyErrors=!1},3e3),customRegistration.googleMapServices.autoAddressCompleteService.getPlacePredictions({input:e},function(e,s){s!==google.maps.places.PlacesServiceStatus.OK&&(i.error=a.options.errorMessages.invalidGoogleAddress),i.suggestions=e,l.refreshUI&&l.refreshUI()})):i.error=a.options.errorMessages.invalidGoogleAddress},selectSuggestion:function(o){var r=this;r.error=null,r.suggestions=null,r.value=o.description,customRegistration.googleMapServices.addressGeocoder.geocode({placeId:o.place_id},function(e,s){var i,t;e&&e[0]&&e[0]?(i=e[0].geometry.location.lat(),t=e[0].geometry.location.lng(),a.settings.required&&(e[0].address_components.find(function(e){return e.types&&e.types.find(function(e){return"street_number"===e})})||(r.error=a.options.errorMessages.invalidGoogleAddress)),r.extra={lat:i,lng:t,place:o,addressComponents:e[0].address_components}):r.error=a.options.errorMessages.invalidGoogleAddress,l.refreshUI&&l.refreshUI()})},validate:function(e){this.error=null,e&&e.trim().length||!a.settings.required?this.extra||(this.error=a.options.errorMessages.invalidGoogleAddress):this.error=a.options.errorMessages.addressRequired},touch:function(e){this.suggestions||this.suggestions.length||this.validate(e)},messages:a.options.errorMessages,value:l.defaults&&l.defaults.userProfile&&l.defaults.userProfile.address?l.defaults.userProfile.address.fullAddress:void 0,extra:l.defaults&&l.defaults.userProfile&&l.defaults.userProfile.address?l.defaults.userProfile.address.geoLocation:void 0}),a.settings.showAptNo&&o.push({type:"text",viewType:"text",name:"aptNo",order:e,label:a.options.fieldsLabels.aptNo,iconClass:a.icon||"glyphicon glyphicon-pushpin",containerClass:"small-login-field",validate:function(e){this.error=null,e&&e.trim().length||!a.settings.required||(this.error=a.options.errorMessages.addressRequired)},touch:function(e){this.validate(e)},messages:a.options.errorMessages,value:l.defaults&&l.defaults.userProfile&&l.defaults.userProfile.address&&l.defaults.userProfile.address.customFields?l.defaults.userProfile.address.customFields.aptNo:void 0})),a.settings.showZipCode&&o.push({type:"text",viewType:"text",name:"zipCode",order:e,label:a.options.fieldsLabels.zipCode,iconClass:a.icon||"glyphicon glyphicon-pushpin",validate:function(e){this.error=null,e&&e.trim().length||!a.settings.required||(this.error=a.options.errorMessages.addressRequired)},touch:function(e){this.validate(e)},messages:a.options.errorMessages,value:l.defaults&&l.defaults.userProfile&&l.defaults.userProfile.address&&l.defaults.userProfile.address.customFields?l.defaults.userProfile.address.customFields.zipCode:void 0}));break;case"password":l.isProfileMode||(o.push({type:"password",name:"password",order:e,label:a.options.fieldsLabels.password,iconClass:a.icon||"glyphicon glyphicon-lock",togglePasswordVisibility:"showHidePassword"===a.settings.validation,info:"simple"===a.settings.passwordStrength?a.options.infoMessages.passwordSimpleRules:a.options.infoMessages.passwordRules,validate:function(e){this.error=null,"retypePassword"===a.settings.validation&&(o.find(function(e){return"retypePassword"===e.name}).error=null),e&&e.trim().length?window.validator.validatePassword(e,{simplePasswordValidation:"simple"===a.settings.passwordStrength})||(this.error="simple"===a.settings.passwordStrength?a.options.errorMessages.invalidPasswordSimpleRules:a.options.errorMessages.invalidPasswordRules):this.error=a.options.errorMessages.passwordRequired},touch:function(e){this.validate(e)},messages:a.options.errorMessages}),"retypePassword"===a.settings.validation&&o.push({type:"password",name:"retypePassword",order:e,label:a.options.fieldsLabels.retypePassword,iconClass:a.icon||"glyphicon glyphicon-lock",togglePasswordVisibility:"showHidePassword"===a.settings.validation,validate:function(e){var s=o.find(function(e){return"password"===e.name});this.error=null,e&&e.trim().length?s.value!==e&&(this.error=a.options.errorMessages.passwordsDontMatch):this.error=a.options.errorMessages.passwordRequired},touch:function(e){this.validate(e)},messages:a.options.errorMessages})),t.passwordStrength=a.settings.passwordStrength;break;case"bio":a.active&&o.push({type:"textarea",viewType:"multiline",name:"bio",order:e,label:a.options.fieldsLabels.bio,info:a.options.infoMessages?a.options.infoMessages.assistiveText:void 0,iconClass:a.icon||"glyphicon glyphicon-list-alt",validate:function(e){this.error=null,e&&e.trim().length||!a.settings.required||(this.error=a.options.errorMessages.bioRequired)},touch:function(e){this.validate(e)},messages:a.options.errorMessages,value:l.defaults&&l.defaults.userProfile?l.defaults.userProfile.bio:void 0});break;case"telephone":a.active&&o.push({type:"text",viewType:"text",name:"tel",order:e,label:a.options.fieldsLabels.tel,iconClass:a.icon||"glyphicon glyphicon-earphone",validate:function(e){this.error=null,e&&e.trim().length||!a.settings.required?e&&(/^(?:(?:\(?(?:00|\+)([1-4]\d\d|[1-9]\d?)\)?)?[\-\.\ \\\/]?)?((?:\(?\d{1,}\)?[\-\.\ \\\/]?){0,})(?:[\-\.\ \\\/]?(?:#|ext\.?|extension|x)[\-\.\ \\\/]?(\d+))?$/i.test(e)||(this.error=a.options.errorMessages.invalidEntry)):this.error=a.options.errorMessages.invalidEntry},info:a.settings.showReasonForTelephone?a.options.infoMessages.reasonForTelephone:null,touch:function(e){this.validate(e)},messages:a.options.errorMessages,value:l.defaults&&l.defaults.userProfile?l.defaults.userProfile.tel:void 0});break;case"birthDate":var i;a.active&&(i=function(e){return e?moment(e).format("L"):null},o.push({type:"date",viewType:"text",name:"birthDate",order:e,label:a.options.fieldsLabels.dateBirth,info:a.options.infoMessages?a.options.infoMessages.assistiveText:void 0,minDate:a.settings.maxAgeIsRequired&&a.settings.maxAgeRequired?moment().subtract(a.settings.maxAgeRequired,"years").toDate():void 0,maxDate:a.settings.minAgeIsRequired&&a.settings.minAgeRequired?moment().subtract(a.settings.minAgeRequired,"years").toDate():void 0,iconClass:a.icon||"glyphicon glyphicon-calendar",displayValue:i(l.defaults&&l.defaults.userProfile?l.defaults.userProfile.birthDate:void 0),validate:function(e){this.error=null,e?(e=moment(e),e=moment().diff(e,"years"),a.settings.maxAgeIsRequired&&a.settings.maxAgeRequired&&e>a.settings.maxAgeRequired?this.error=a.options.errorMessages.maxAge+" "+a.settings.maxAgeRequired:a.settings.minAgeIsRequired&&a.settings.minAgeRequired&&e<a.settings.minAgeRequired&&(this.error=a.options.errorMessages.minAge+" "+a.settings.minAgeRequired)):a.settings.required&&(this.error=a.options.errorMessages.birthRequired)},change:function(e){this.validate(e),this.displayValue=i(e)},touch:function(e){this.validate(e)},messages:a.options.errorMessages,value:l.defaults&&l.defaults.userProfile?l.defaults.userProfile.birthDate?new Date(l.defaults.userProfile.birthDate):null:void 0}));break;case"profilePicture":a.active&&o.push({type:"image",name:"profilePicture",order:e,label:a.options.fieldsLabels.profilePicture,info:a.options.infoMessages?a.options.infoMessages.assistiveText:void 0,iconClass:a.icon||"icon icon-camera2",resetImage:function(){this.value=null},validate:function(e){this.error=null,!e&&a.settings.required&&(this.error=a.options.errorMessages.required)},messages:a.options.errorMessages})}}),e(null,{fields:o,rules:t,initializers:r,fetch:function(s,e){var i=!1,t={};s&&s.validateFields&&o.forEach(function(e){"edit"!==s.mode||"email"!==e.name&&"profilePicture"!==e.name?e.validate(e.value):e.error=null,e.error&&(i=!0),t[e.name]={value:e.value,extra:e.extra,messages:e.messages}}),i?e(!0,null):e(null,{user:{email:t.email.value,password:t.password?t.password.value:void 0,firstName:t.firstName?t.firstName.value:void 0,lastName:t.lastName?t.lastName.value:void 0,displayName:t.displayName?t.displayName.value:void 0,userProfile:{address:{fullAddress:t.address?t.address.value:void 0,customFields:{aptNo:t.aptNo?t.aptNo.value:void 0,zipCode:t.zipCode?t.zipCode.value:void 0},geoLocation:t.address&&t.address.extra?t.address.extra:void 0},bio:t.bio?t.bio.value:void 0,birthDate:t.birthDate?t.birthDate.value?new Date(t.birthDate.value):null:void 0,tel:t.tel?t.tel.value:void 0}},messages:{emailAlreadyInUse:t.email.messages.emailAlreadyInUse},profilePictureFile:t.profilePicture?t.profilePicture.value:void 0})}})):e(null,null)}};function gm_authFailure(){customRegistration.googleMapServices.checkMapsApiKeyErrors&&(customRegistration.googleMapServices.mapsApiKeyError="There seems to be an issue with google maps key")}
"use strict";var userTags={get isUserTaggingEnabled(){return window.appContext&&window.appContext.currentApp&&window.appContext.currentApp.config&&window.appContext.currentApp.config.userTagging&&"hidden"!=window.appContext.currentApp.config.userTagging&&"disabled"!=window.appContext.currentApp.config.userTagging},init:function(){},checkPluginAccessSettings:function(e,a){var o=e.accessSettings;!bfUtils.isEmulatorCP&&e.requiresLogin?authAPI.getCurrentUser(function(e,s){if(e)return console.error(e),void a(e,null);if(s)if(userTags.isUserTaggingEnabled&&"enabled"==window.appContext.currentApp.config.advancedPluginAccessSettings)if(o)if(o.requiresTags)if(o.requiredTags&&0!=o.requiredTags.length)if(o.giveAccessWhen)if(s.tags&&s.tags[window.appContext.currentApp.appId]&&0<s.tags[window.appContext.currentApp.appId].length){var n=s.tags[window.appContext.currentApp.appId];if("matchAllTags"==o.giveAccessWhen){for(var r=0;r<o.requiredTags.length;r++){for(var t=!1,i=0;i<n.length;i++)if(n[i].tagName==o.requiredTags[r].name&&o.requiredTags[r].appliedCount<=n[i].appliedCount){t=!0;break}if(!t)return void a(null,!1)}a(null,!0)}else{for(r=0;r<o.requiredTags.length;r++)for(i=0;i<n.length;i++)if(n[i].tagName==o.requiredTags[r].name&&o.requiredTags[r].appliedCount<=n[i].appliedCount)return void a(null,!0);a(null,!1)}}else a(null,!1);else a(null,!1);else a(null,!0);else a(null,!0);else a(null,!0);else a(null,!0);else a(null,!1)}):a(null,!0)},setBehavioralTags:function(n){!bfUtils.isEmulatorCP&&bfUtils.deviceOnline&&userTags.isUserTaggingEnabled&&authAPI.getCurrentUser(null,function(e,s){e?console.log(e):s&&bfUtils.http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/app/"+window.appContext.currentApp.appId+"/user/assignBehavioralTag",{instanceId:n,accessToken:s.accessToken}).success(function(e){authAPI.refreshAndTriggerUpdate({updateType:"user_tags_updated"})}).error(function(e){console.log(e)})})},removeProfileTags:function(n){userTags.unassignUserTags(["$$profile_birth_year:","$$profile_birth_month:","$$profile_zip:","$$profile_city:","$$profile_state:","$$profile_town:","$$profile_country:","$$profile_picture"],{isPrefix:!0,removeTag:!0},function(e,s){e?n(e,null):n(null,!0)})},setRegistrationTags:function(e,s,n){function r(e,s){for(var n=0;n<e.length;n++)if(e[n].types[0]==s)return e[n].short_name}var t,i,a=e?e.userProfile:null;userTags.isUserTaggingEnabled&&(t=[],s&&(i=new Date,t.push("$$registered"),t.push("$$registered_year:"+i.getFullYear()),t.push("$$registered_month:"+(i.getMonth()+1))),a&&(a.birthDate&&(t.push("$$profile_birth_year:"+a.birthDate.getFullYear()),t.push("$$profile_birth_month:"+(a.birthDate.getMonth()+1))),a.address&&a.address.customFields&&a.address.customFields.zipCode&&t.push("$$profile_zip:"+a.address.customFields.zipCode),a.address&&a.address.geoLocation&&a.address.geoLocation.addressComponents&&((i=r(a.address.geoLocation.addressComponents,"country"))&&t.push("$$profile_country:"+i.replace(/ /g,"_")),(i=r(a.address.geoLocation.addressComponents,"administrative_area_level_1"))&&t.push("$$profile_state:"+i.replace(/ /g,"_")),(i=r(a.address.geoLocation.addressComponents,"administrative_area_level_2"))&&t.push("$$profile_city:"+i.replace(/ /g,"_")),(a=r(a.address.geoLocation.addressComponents,"locality"))&&t.push("$$profile_town:"+a.replace(/ /g,"_")))),e&&e.imageUrl&&t.push("$$profile_picture"),s?userTags.assignUserTags(t,n):userTags.removeProfileTags(function(e,s){e?n(e):userTags.assignUserTags(t,n)}))},assignUserTags:function(n,r){"string"==typeof n&&(n=n.split(",")),authAPI.getCurrentUser(function(e,s){e?(console.log(e),r(e,null)):s&&bfUtils.http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/app/"+window.appContext.currentApp.appId+"/user/assign",{tags:n,accessToken:s.accessToken}).success(function(e){authAPI.refreshAndTriggerUpdate({updateType:"user_tags_updated"}),r(null,!0)}).error(function(e){console.log(e),r(e)})})},unassignUserTags:function(n,r,t){"string"==typeof n&&(n=n.split(",")),authAPI.getCurrentUser(function(e,s){e?(console.log(e),t(e,null)):s&&bfUtils.http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/app/"+window.appContext.currentApp.appId+"/user/unassign",{tags:n,isPrefix:r.isPrefix||!1,accessToken:s.accessToken,removeTag:r.removeTag||!1}).success(function(e){authAPI.refreshAndTriggerUpdate({updateType:"user_tags_updated"}),t(null,!0)}).error(function(e){console.log(e),t(e,null)})})}};userTags.init();
