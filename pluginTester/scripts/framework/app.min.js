...
"use strict";var Dynamic={triggerRequestWidgetContext:function(e,s){e=new Packet(null,"dynamic.onReceivedWidgetContextRequest",e);postMaster.widgetPluginAPI?postMaster.widgetPluginAPI.sendMessage(null,e,s):postMaster.launcherPluginAPI?postMaster.launcherPluginAPI.sendMessage(null,e,s):console.error("No plugin was found")},expressions:{showDialog:function(e,s){ExpressionBuilderAPI.prototype.showDialog(e,s)}}};