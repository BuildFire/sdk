...
"use strict";function LocalStorageAPI(e){function t(e){var t=localStorage.getItem(e),l={};if(t)try{l=JSON.parse(t)}catch(e){console.error(e)}return l}this.instanceId=e.instanceId,this.collectionKey=this.instanceId+"-storage",this.collection=t(this.collectionKey),this.syncCollectionKey=this.instanceId+"-sync-storage",this.syncCollection=t(this.syncCollectionKey)}LocalStorageAPI.prototype={setItem:function(e,t){e&&e.key&&e.value?(void 0===e.value?delete this.collection[e.key]:this.collection[e.key]=e.value,localStorage.setItem(this.collectionKey,JSON.stringify(this.collection)),t(null,!0)):t(new Error("invalid parameters. Expected Key/Value object"))},getItem:function(e,t){(e&&e.key&&(e=e.key),e&&t)?t(null,this.collection[e]):t(new Error("invalid parameters. Expected Key and Callback"))},removeItem:function(e,t){e&&e.key&&(e=e.key),e&&t?(delete this.collection[e],localStorage.setItem(this.collectionKey,JSON.stringify(this.collection)),t(null,!0)):t(new Error("invalid parameters. Expected Key and Callback"))},syncSetItem:function(e,t){e&&e.key&&e.value?(void 0===e.value?delete this.syncCollection[e.key]:this.syncCollection[e.key]=e.value,localStorage.setItem(this.syncCollectionKey,JSON.stringify(this.syncCollection)),t(null,!0)):t(new Error("invalid parameters. Expected Key/Value object"))},syncGetItem:function(e,t){(e&&e.key&&(e=e.key),e&&t)?t(null,this.syncCollection[e]):t(new Error("invalid parameters. Expected Key and Callback"))},syncRemoveItem:function(e,t){e&&e.key&&(e=e.key),e&&t?(delete this.syncCollection[e],localStorage.setItem(this.syncCollectionKey,JSON.stringify(this.syncCollection)),t(null,!0)):t(new Error("invalid parameters. Expected Key and Callback"))},getCollection:function(e,t){t(null,this.collection)},getSyncCollection:function(e,t){t(null,this.syncCollection)}};
