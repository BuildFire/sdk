...
"use strict";function StripeAPI(t){if(this.context=t,!this.context)throw Error("invalid stripe context");this.context.apiKeys||(this.context.apiKeys={}),this.stripePublicKey=this.context.apiKeys.stripePublicKey}StripeAPI.prototype={_loadScript:function(t,e){var i=document.createElement("script");if(i.type="text/javascript",i.readyState?i.onreadystatechange=function(){"loaded"!=i.readyState&&"complete"!=i.readyState||(i.onreadystatechange=null,e&&e())}:i.onload=function(){e&&e()},i.src=t.url,t.attr)for(var n in t.attr)i.setAttribute(n,t.attr[n]);for(var c=document.getElementsByTagName("script"),o=c.length;o--;)if(c[o].src==t.url)return e&&e(),!0;document.getElementsByTagName("head")[0].appendChild(i)},pay:function(t,i){var n=this;n.stripePublicKey?n._loadScript({url:"https://checkout.stripe.com/checkout.js"},function(){var e=StripeCheckout.configure({key:n.stripePublicKey,image:"https://stripe.com/img/documentation/checkout/marketplace.png",locale:"auto",token:function(t){e.close(),i&&i(null,{sourceToken:t})}});e.open({}),window.addEventListener("popstate",function(){e.close()})}):i&&i("Missing stripePublicKey in context",null)}};