...
"use strict";var customRegistration={googleMapServices:{},get wl_name(){var e="Full ";return e=appContext&&appContext.currentApp&&appContext.currentApp.config?appContext.currentApp.config.whitlabelName+" ":e},getFields:function(i,e){var r,o,a,s=i.customRegistrationSettings;s&&s.singlePage&&s.singlePage.formControls?(r=[],o={},a=[],s.singlePage.formControls.forEach(function(e,s){var t;"custom"!=e.type?(t={control:e,controlIndex:s,fields:r,rules:o,initializers:a,isProfileMode:i.isProfileMode,defaults:i.defaults,refreshUI:i.refreshUI},customRegistration.preparePresetField(t)):(s={control:e,controlIndex:s,fields:r,defaults:i.defaults},customRegistration.prepareCustomField(s))}),e(null,{fields:r,rules:o,initializers:a,fetch:function(s,e){var t=!1,i={},o=[];s&&s.validateFields&&r.forEach(function(e){if("edit"!==s.mode||"email"!==e.name&&"profilePicture"!==e.name?"multipleSelect"===e.type?e.validate(e.values):e.validate(e.value):e.error=null,e.error&&(t=!0),e.isCustom){if(e.value||e.values&&0<e.values.length)switch(e.type){case"singleSelect":o.push({id:e.id,type:e.type,value:e.value,displayValue:e.displayValue});break;case"multipleSelect":o.push({id:e.id,type:e.type,values:e.values});break;case"text":case"number":case"textarea":o.push({id:e.id,type:e.type,value:e.value})}}else i[e.name]={value:e.value,extra:e.extra,messages:e.messages}}),t?e(!0,null):e(null,{user:{email:i.email.value,password:i.password?i.password.value:void 0,firstName:i.firstName?i.firstName.value:void 0,lastName:i.lastName?i.lastName.value:void 0,displayName:i.displayName?i.displayName.value:void 0,userProfile:{address:{fullAddress:i.address?i.address.value:void 0,customFields:{aptNo:i.aptNo?i.aptNo.value:void 0,zipCode:i.zipCode?i.zipCode.value:void 0},geoLocation:i.address&&i.address.extra?i.address.extra:void 0},bio:i.bio?i.bio.value:void 0,birthDate:i.birthDate?i.birthDate.value?new Date(i.birthDate.value):null:void 0,tel:i.tel?i.tel.value:void 0,customTypeFields:o}},messages:{emailAlreadyInUse:i.email.messages.emailAlreadyInUse},profilePictureFile:i.profilePicture?i.profilePicture.value:void 0})}})):e(null,null)},preparePresetField:function(a){var s,t,n=a.control,e=a.controlIndex,i=a.fields,o=a.rules,r=a.initializers;switch(n.id){case"fullName":n.active&&(n.settings.displayNameEnabled&&i.push({type:"text",viewType:"none",name:"displayName",maxLength:150,order:e,label:n.options.fieldsLabels.displayName,iconClass:n.icon||"glyphicon glyphicon-font",validate:function(e){this.error=null,e&&e.trim().length||!n.settings.required||(this.error=n.options.errorMessages.fullNameRequired)},touch:function(e){this.validate(e)},enforceMaxLength:function(){customRegistration.enforceMaxLength(this)},messages:n.options.errorMessages,value:a.defaults?a.defaults.displayName:void 0}),n.settings.firstNameEnabled&&i.push({type:"text",viewType:"text",name:"firstName",maxLength:150,order:e,label:n.options.fieldsLabels.firstName,iconClass:n.icon||"glyphicon glyphicon-font",validate:function(e){this.error=null,e&&e.trim().length||!n.settings.required||(this.error=n.options.errorMessages.fullNameRequired)},touch:function(e){this.validate(e)},enforceMaxLength:function(){customRegistration.enforceMaxLength(this)},messages:n.options.errorMessages,value:a.defaults?a.defaults.firstName:void 0}),n.settings.lastNameEnabled&&i.push({type:"text",viewType:"text",name:"lastName",maxLength:150,order:e,label:n.options.fieldsLabels.lastName,iconClass:n.icon||"glyphicon glyphicon-font",validate:function(e){this.error=null,e&&e.trim().length||!n.settings.required||(this.error=n.options.errorMessages.fullNameRequired)},touch:function(e){this.validate(e)},enforceMaxLength:function(){customRegistration.enforceMaxLength(this)},messages:n.options.errorMessages,value:a.defaults?a.defaults.lastName:void 0}));break;case"email":i.push({type:"email",viewType:"email",name:"email",order:e,label:n.options.fieldsLabels.email,info:n.options.infoMessages?n.options.infoMessages.assistiveText:void 0,iconClass:n.icon||"glyphicon glyphicon-send",validate:function(e){this.error=null,e&&e.trim().length?window.validator.validateEmail(e)?e&&e.trim().length||(this.error=n.options.errorMessages.emailAlreadyInUse):this.error=n.options.errorMessages.emailInvalidFormat:this.error=n.options.errorMessages.emailRequired},touch:function(e,s){!e&&s&&s.target&&(e=s.target.value),this.validate(e)},messages:n.options.errorMessages,value:a.defaults?a.defaults.email:void 0});break;case"address":n.active&&(s=n.options.addressGoogleApiKey,n.options.addressGoogleApiKey&&r.push(function(){setTimeout(function(){var e=document.getElementById("customRegistrationScript");e&&document.getElementsByTagName("head")[0].removeChild(e),customRegistration.googleMapServices.mapsApiKeyError=null,(e=document.createElement("script")).id="customRegistrationScript",e.src="https://maps.googleapis.com/maps/api/js?key=".concat(s,"&libraries=places&callback=googleMapsInitCallback"),e.type="text/javascript",document.getElementsByTagName("head")[0].appendChild(e),window.googleMapsInitCallback=function(){customRegistration.googleMapServices.autoAddressCompleteService=new google.maps.places.AutocompleteService,customRegistration.googleMapServices.addressGeocoder=new google.maps.Geocoder},a.refreshUI&&a.refreshUI()},0)}),n.settings.showFullAddress&&(i.push({type:"text",viewType:"text",name:"address",maxLength:150,order:e,label:n.options.fieldsLabels.address,iconClass:n.icon||"glyphicon glyphicon-pushpin",change:function(e){var t=this;t.extra=null,customRegistration.googleMapServices.mapsApiKeyError&&(t.error=customRegistration.googleMapServices.mapsApiKeyError),customRegistration.googleMapServices.autoAddressCompleteService?(customRegistration.googleMapServices.checkMapsApiKeyErrors=!0,setTimeout(function(){customRegistration.googleMapServices.checkMapsApiKeyErrors=!1},3e3),customRegistration.googleMapServices.autoAddressCompleteService.getPlacePredictions({input:e},function(e,s){s!==google.maps.places.PlacesServiceStatus.OK&&(t.error=n.options.errorMessages.invalidGoogleAddress),t.suggestions=e,a.refreshUI&&a.refreshUI()})):t.error=n.options.errorMessages.invalidGoogleAddress},selectSuggestion:function(o){var r=this;r.error=null,r.suggestions=null,r.value=o.description,customRegistration.googleMapServices.addressGeocoder.geocode({placeId:o.place_id},function(e,s){var t,i;e&&e[0]&&e[0]?(t=e[0].geometry.location.lat(),i=e[0].geometry.location.lng(),n.settings.required&&(e[0].address_components.find(function(e){return e.types&&e.types.find(function(e){return"street_number"===e})})||(r.error=n.options.errorMessages.invalidGoogleAddress)),r.extra={lat:t,lng:i,place:o,addressComponents:e[0].address_components}):r.error=n.options.errorMessages.invalidGoogleAddress,a.refreshUI&&a.refreshUI()})},validate:function(e){this.error=null,e&&e.trim().length||!n.settings.required?this.extra||(this.error=n.options.errorMessages.invalidGoogleAddress):this.error=n.options.errorMessages.addressRequired},touch:function(e){this.suggestions||this.suggestions.length||this.validate(e)},enforceMaxLength:function(){customRegistration.enforceMaxLength(this),this.change(this.value)},messages:n.options.errorMessages,value:a.defaults&&a.defaults.userProfile&&a.defaults.userProfile.address?a.defaults.userProfile.address.fullAddress:void 0,extra:a.defaults&&a.defaults.userProfile&&a.defaults.userProfile.address?a.defaults.userProfile.address.geoLocation:void 0}),n.settings.showAptNo&&i.push({type:"text",viewType:"text",name:"aptNo",maxLength:150,order:e,label:n.options.fieldsLabels.aptNo,iconClass:n.icon||"glyphicon glyphicon-pushpin",containerClass:"small-login-field",validate:function(e){this.error=null,e&&e.trim().length||!n.settings.required||(this.error=n.options.errorMessages.addressRequired)},touch:function(e){this.validate(e)},enforceMaxLength:function(){customRegistration.enforceMaxLength(this)},messages:n.options.errorMessages,value:a.defaults&&a.defaults.userProfile&&a.defaults.userProfile.address&&a.defaults.userProfile.address.customFields?a.defaults.userProfile.address.customFields.aptNo:void 0})),n.settings.showZipCode&&i.push({type:"text",viewType:"text",name:"zipCode",maxLength:150,order:e,label:n.options.fieldsLabels.zipCode,iconClass:n.icon||"glyphicon glyphicon-pushpin",validate:function(e){this.error=null,e&&e.trim().length||!n.settings.required||(this.error=n.options.errorMessages.addressRequired)},touch:function(e){this.validate(e)},enforceMaxLength:function(){customRegistration.enforceMaxLength(this)},messages:n.options.errorMessages,value:a.defaults&&a.defaults.userProfile&&a.defaults.userProfile.address&&a.defaults.userProfile.address.customFields?a.defaults.userProfile.address.customFields.zipCode:void 0}));break;case"password":a.isProfileMode||(i.push({type:"password",name:"password",order:e,label:n.options.fieldsLabels.password,iconClass:n.icon||"glyphicon glyphicon-lock",togglePasswordVisibility:"showHidePassword"===n.settings.validation,info:"simple"===n.settings.passwordStrength?n.options.infoMessages.passwordSimpleRules:n.options.infoMessages.passwordRules,validate:function(e){this.error=null,"retypePassword"===n.settings.validation&&(i.find(function(e){return"retypePassword"===e.name}).error=null),e&&e.trim().length?window.validator.validatePassword(e,{simplePasswordValidation:"simple"===n.settings.passwordStrength})||(this.error="simple"===n.settings.passwordStrength?n.options.errorMessages.invalidPasswordSimpleRules:n.options.errorMessages.invalidPasswordRules):this.error=n.options.errorMessages.passwordRequired},touch:function(e){this.validate(e)},messages:n.options.errorMessages}),"retypePassword"===n.settings.validation&&i.push({type:"password",name:"retypePassword",order:e,label:n.options.fieldsLabels.retypePassword,iconClass:n.icon||"glyphicon glyphicon-lock",togglePasswordVisibility:"showHidePassword"===n.settings.validation,validate:function(e){var s=i.find(function(e){return"password"===e.name});this.error=null,e&&e.trim().length?s.value!==e&&(this.error=n.options.errorMessages.passwordsDontMatch):this.error=n.options.errorMessages.passwordRequired},touch:function(e){this.validate(e)},messages:n.options.errorMessages})),o.passwordStrength=n.settings.passwordStrength;break;case"bio":n.active&&i.push({type:"textarea",viewType:"multiline",name:"bio",maxLength:1024,order:e,label:n.options.fieldsLabels.bio,info:n.options.infoMessages?n.options.infoMessages.assistiveText:void 0,iconClass:n.icon||"glyphicon glyphicon-list-alt",validate:function(e){this.error=null,e&&e.trim().length||!n.settings.required||(this.error=n.options.errorMessages.bioRequired)},touch:function(e){this.validate(e)},enforceMaxLength:function(){customRegistration.enforceMaxLength(this)},messages:n.options.errorMessages,value:a.defaults&&a.defaults.userProfile?a.defaults.userProfile.bio:void 0});break;case"telephone":n.active&&i.push({type:"tel",viewType:"text",name:"tel",maxLength:150,order:e,label:n.options.fieldsLabels.tel,info:n.settings.showReasonForTelephone?n.options.infoMessages.reasonForTelephone:null,iconClass:n.icon||"glyphicon glyphicon-earphone",validate:function(e){this.error=null,e&&e.trim().length||!n.settings.required?e&&(/^(?:(?:\(?(?:00|\+)([1-4]\d\d|[1-9]\d?)\)?)?[\-\.\ \\\/]?)?((?:\(?\d{1,}\)?[\-\.\ \\\/]?){0,})(?:[\-\.\ \\\/]?(?:#|ext\.?|extension|x)[\-\.\ \\\/]?(\d+))?$/i.test(e)||(this.error=n.options.errorMessages.invalidEntry)):this.error=n.options.errorMessages.invalidEntry},touch:function(e){this.validate(e)},enforceMaxLength:function(){customRegistration.enforceMaxLength(this)},messages:n.options.errorMessages,value:a.defaults&&a.defaults.userProfile?a.defaults.userProfile.tel:void 0});break;case"birthDate":n.active&&(t=function(e){return e?moment(e).format("L"):null},i.push({type:"date",viewType:"text",name:"birthDate",order:e,label:n.options.fieldsLabels.dateBirth,info:n.options.infoMessages?n.options.infoMessages.assistiveText:void 0,minDate:n.settings.maxAgeIsRequired&&n.settings.maxAgeRequired?moment().subtract(n.settings.maxAgeRequired,"years").toDate():void 0,maxDate:n.settings.minAgeIsRequired&&n.settings.minAgeRequired?moment().subtract(n.settings.minAgeRequired,"years").toDate():void 0,iconClass:n.icon||"glyphicon glyphicon-calendar",displayValue:t(a.defaults&&a.defaults.userProfile?a.defaults.userProfile.birthDate:void 0),validate:function(e){this.error=null,e?(e=moment(e),e=moment().diff(e,"years"),n.settings.maxAgeIsRequired&&n.settings.maxAgeRequired&&e>n.settings.maxAgeRequired?this.error=n.options.errorMessages.maxAge+" "+n.settings.maxAgeRequired:n.settings.minAgeIsRequired&&n.settings.minAgeRequired&&e<n.settings.minAgeRequired&&(this.error=n.options.errorMessages.minAge+" "+n.settings.minAgeRequired)):n.settings.required&&(this.error=n.options.errorMessages.birthRequired)},change:function(e){this.validate(e),this.displayValue=t(e)},touch:function(e){this.validate(e)},messages:n.options.errorMessages,value:a.defaults&&a.defaults.userProfile?a.defaults.userProfile.birthDate?new Date(a.defaults.userProfile.birthDate):null:void 0}));break;case"profilePicture":n.active&&i.push({type:"image",name:"profilePicture",order:e,label:n.options.fieldsLabels.profilePicture,info:n.options.infoMessages.assistiveText,iconClass:n.icon||"icon icon-camera2",resetImage:function(){this.value=null},validate:function(e){this.error=null,!e&&n.settings.required&&(this.error=n.options.errorMessages.required)},messages:n.options.errorMessages})}},prepareCustomField:function(e){var s,t,i,o,r,a,n,l=e.control,u=e.controlIndex,d=e.fields;switch(l.customType){case"singleSelect":l.active&&(e.defaults&&e.defaults.userProfile&&e.defaults.userProfile.customTypeFields&&0<e.defaults.userProfile.customTypeFields.length&&((s=e.defaults.userProfile.customTypeFields.find(function(e){return e.id===l.id}))&&(i=l.selectOptions.find(function(e){return e.key===s.value})),o=s&&i?s.value:void 0,i=i?i.label:void 0),d.push({id:l.id,name:"singleSelect",type:"singleSelect",viewType:"multiline",isCustom:!0,order:u,display:l.settings.displayOption,label:l.options.fieldsLabels.singleSelect,info:l.options.infoMessages?l.options.infoMessages.assistiveText:void 0,iconClass:l.icon||"glyphicon glyphicon-th-list",selectOptions:l.selectOptions,value:o,displayValue:i,messages:l.options.errorMessages,validate:function(e){this.error=null,!e&&l.settings.required&&(this.error=l.options.errorMessages.required)},openDrawer:function(t){var i=this,o=new ComponentUIAPI,s=[];this.selectOptions.forEach(function(e){s.push({text:e.label,value:e.key})}),o.openDrawer({header:this.label,listItems:s},function(e,s){return e?console.error(e):(i.value=s.value,t.target.value=i.displayValue=s.text,i.validate(i.value),void o.closeDrawer())})}}));break;case"multipleSelect":l.active&&(t=function(e,i){var o="";return e.forEach(function(s,t){i.selectOptions.forEach(function(e){s.value===e.key&&(o+=0===t?e.label:", ".concat(e.label))})}),o},o=[],r="",e.defaults&&e.defaults.userProfile&&e.defaults.userProfile.customTypeFields&&0<e.defaults.userProfile.customTypeFields.length&&((o=(i=e.defaults.userProfile.customTypeFields.find(function(e){return e.id===l.id}))?i.values:[])&&0<o.length&&(o=o.filter(function(s){return void 0!==l.selectOptions.find(function(e){return e.key===s.value})}),r=t(o,l))),d.push({id:l.id,name:"multipleSelect",type:"multipleSelect",viewType:"multiline",isCustom:!0,order:u,display:l.settings.displayOption,label:l.options.fieldsLabels.multipleSelect,info:l.options.infoMessages?l.options.infoMessages.assistiveText:void 0,iconClass:l.icon||"glyphicon glyphicon-th-list",selectOptions:l.selectOptions,values:o,displayValue:r,messages:l.options.errorMessages,validate:function(e){this.error=null,e&&e.length<1&&l.settings.required&&(this.error=l.options.errorMessages.required)},updateCheckboxValue:function(s,e){e.target.checked?this.values.find(function(e){return e.value===s.key})||this.values.push({value:s.key,displayValue:s.label}):this.values=this.values.filter(function(e){return e.value!==s.key}),this.displayValue="",this.displayValue=t(this.values,l)},isSelected:function(s){return void 0!==this.values.find(function(e){return s.key===e.value})},openDrawer:function(o){var r=this,a=new ComponentUIAPI,e=[];this.selectOptions.forEach(function(s){r.values&&r.values.find(function(e){return s.key===e.value})?e.push({text:s.label,value:s.key,selected:!0}):e.push({text:s.label,value:s.key})}),a.openDrawer({header:this.label,listItems:e,multiSelection:!0},function(e,s){if(e)return console.error(e);var t=[],i="";s.forEach(function(e,s){i+=0===s?e.text:", ".concat(e.text),t.push({value:e.value,displayValue:e.text})}),r.values=t,o.target.value=r.displayValue=i,r.validate(r.values),a.closeDrawer()})}}));break;case"text":l.active&&(a=n="",e.defaults&&e.defaults.userProfile&&e.defaults.userProfile.customTypeFields&&0<e.defaults.userProfile.customTypeFields.length&&((r=e.defaults.userProfile.customTypeFields.find(function(e){return e.id===l.id}))&&(n=r.value)),"short"===l.settings.fieldLength?a="text":"long"===l.settings.fieldLength&&(a="textarea"),d.push({id:l.id,name:"customText",type:a,viewType:"multiline",isCustom:!0,maxLength:l.settings.maxCharRequired&&l.settings.maxCharEnabled?l.settings.maxCharRequired:void 0,order:u,label:l.options.fieldsLabels.text,info:l.options.infoMessages?l.options.infoMessages.assistiveText:void 0,iconClass:l.icon||"glyphicon glyphicon-font",value:n,messages:l.options.errorMessages,validate:function(e){this.error=null,!e&&l.settings.required?this.error=l.options.errorMessages.required:e&&l.settings.minCharEnabled&&e.length<l.settings.minCharRequired&&(this.error=l.options.errorMessages.minChar+" "+l.settings.minCharRequired)},touch:function(e){this.validate(e)},enforceMaxLength:function(){customRegistration.enforceMaxLength(this)}}));break;case"number":l.active&&(a="",e.defaults&&e.defaults.userProfile&&e.defaults.userProfile.customTypeFields&&0<e.defaults.userProfile.customTypeFields.length&&((n=e.defaults.userProfile.customTypeFields.find(function(e){return e.id===l.id}))&&(a=n.value)),d.push({id:l.id,name:"customNumber",type:"number",viewType:"multiline",inputMode:l.settings.decimalsEnabled?"decimal":"numeric",isCustom:!0,order:u,label:l.options.fieldsLabels.number,info:l.options.infoMessages?l.options.infoMessages.assistiveText:void 0,iconClass:l.icon,value:a,messages:l.options.errorMessages,validate:function(e){this.error=null,!e&&0!==e&&l.settings.required?this.error=l.options.errorMessages.required:e>l.settings.maxNumRequired&&l.settings.maxNumEnabled?this.error=l.options.errorMessages.maxNum+" "+l.settings.maxNumRequired:e<l.settings.minNumRequired&&l.settings.minNumEnabled&&(this.error=l.options.errorMessages.minNum+" "+l.settings.minNumRequired)},touch:function(e){this.validate(e)},change:function(e){l.settings.decimalsEnabled||(this.value=e||0===e?Math.round(e):void 0)}}))}},enforceMaxLength:function(e){e.value.length>e.maxLength&&(e.value=e.value.substring(0,e.maxLength))}};function gm_authFailure(){customRegistration.googleMapServices.checkMapsApiKeyErrors&&(customRegistration.googleMapServices.mapsApiKeyError="There seems to be an issue with google maps key")}
"use strict";var userTags={get isUserTaggingEnabled(){return window.appContext&&window.appContext.currentApp&&window.appContext.currentApp.config&&window.appContext.currentApp.config.userTagging&&"hidden"!=window.appContext.currentApp.config.userTagging&&"disabled"!=window.appContext.currentApp.config.userTagging},init:function(){},checkPluginAccessSettings:function(e,i){var o=e.accessSettings;!bfUtils.isEmulatorCP&&e.requiresLogin?authAPI.getCurrentUser(function(e,t){if(e)return console.error(e),void i(e,null);if(t)if(userTags.isUserTaggingEnabled&&"enabled"==window.appContext.currentApp.config.advancedPluginAccessSettings)if(o)if(o.requiresTags)if(o.requiredTags&&0!=o.requiredTags.length)if(o.giveAccessWhen)if(t.tags&&t.tags[window.appContext.currentApp.appId]&&0<t.tags[window.appContext.currentApp.appId].length){var n=t.tags[window.appContext.currentApp.appId];if("matchAllTags"==o.giveAccessWhen){for(var a=0;a<o.requiredTags.length;a++){for(var s=!1,r=0;r<n.length;r++)if(n[r].tagName==o.requiredTags[a].name&&o.requiredTags[a].appliedCount<=n[r].appliedCount){s=!0;break}if(!s)return void i(null,!1)}i(null,!0)}else{for(a=0;a<o.requiredTags.length;a++)for(r=0;r<n.length;r++)if(n[r].tagName==o.requiredTags[a].name&&o.requiredTags[a].appliedCount<=n[r].appliedCount)return void i(null,!0);i(null,!1)}}else i(null,!1);else i(null,!1);else i(null,!0);else i(null,!0);else i(null,!0);else i(null,!0);else i(null,!1)}):i(null,!0)},setBehavioralTags:function(n){!bfUtils.isEmulatorCP&&bfUtils.deviceOnline&&userTags.isUserTaggingEnabled&&authAPI.getCurrentUser(null,function(e,t){e?console.log(e):t&&bfUtils.http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/app/"+window.appContext.currentApp.appId+"/user/assignBehavioralTag",{instanceId:n,accessToken:t.accessToken}).success(function(e){authAPI.refreshAndTriggerUpdate({updateType:"user_tags_updated"})}).error(function(e){console.log(e)})})},removeProfileTags:function(e,n){e=["$$profile_birth_year:","$$profile_birth_month:","$$profile_zip:","$$profile_city:","$$profile_state:","$$profile_town:","$$profile_country:","$$profile_picture"].concat(e);userTags.unassignUserTags(e,{isPrefix:!0,removeTag:!0,preventRefresh:!0},function(e,t){e?n(e,null):n(null,t)})},setRegistrationTags:function(e,t,n){var s=[],r={},a=e?e.userProfile:null;AppearanceAPI.prototype.getAppearance(null,function(e,t){return e?console.error(e):void(t&&(r=t.customRegistration))});function i(e,t){for(var n=0;n<e.length;n++)if(e[n].types[0]==t)return e[n].short_name}var o,p,u,g;userTags.isUserTaggingEnabled&&(o=[],t&&(p=new Date,o.push("$$registered"),o.push("$$registered_year:"+p.getFullYear()),o.push("$$registered_month:"+(p.getMonth()+1))),a&&(a.birthDate&&(o.push("$$profile_birth_year:"+a.birthDate.getFullYear()),o.push("$$profile_birth_month:"+(a.birthDate.getMonth()+1))),a.address&&a.address.customFields&&a.address.customFields.zipCode&&o.push("$$profile_zip:"+a.address.customFields.zipCode),a.address&&a.address.geoLocation&&a.address.geoLocation.addressComponents&&((g=i(a.address.geoLocation.addressComponents,"country"))&&o.push("$$profile_country:"+g.replace(/ /g,"_")),(g=i(a.address.geoLocation.addressComponents,"administrative_area_level_1"))&&o.push("$$profile_state:"+g.replace(/ /g,"_")),(g=i(a.address.geoLocation.addressComponents,"administrative_area_level_2"))&&o.push("$$profile_city:"+g.replace(/ /g,"_")),(g=i(a.address.geoLocation.addressComponents,"locality"))&&o.push("$$profile_town:"+g.replace(/ /g,"_"))),a.customTypeFields&&0<a.customTypeFields.length&&(u=[],(g=authAPI.getCurrentUser())&&g.tags&&window.appContext&&window.appContext.currentApp&&window.appContext.currentApp.appId&&(u=g.tags[window.appContext.currentApp.appId]),a.customTypeFields.forEach(function(n){var a=r.singlePage.formControls.find(function(e){return e.id===n.id});if(a&&a.active)switch(a.customType){case"text":case"number":case"singleSelect":u.find(function(e){return e.tagName==="$$profile_".concat(a.uniqueId)})||o.push("$$profile_".concat(a.uniqueId)),n.value&&(u.find(function(e){return e.tagName==="$$profile_".concat(a.uniqueId,":").concat(n.value)})||o.push("$$profile_".concat(a.uniqueId,":").concat(n.value)));break;case"multipleSelect":u.find(function(e){return e.tagName==="$$profile_".concat(a.uniqueId)})||o.push("$$profile_".concat(a.uniqueId)),n.values.forEach(function(t){u.find(function(e){return e.tagName==="$$profile_".concat(a.uniqueId,":").concat(t.value)})||o.push("$$profile_".concat(a.uniqueId,":").concat(t.value))})}u.forEach(function(t){if(t.tagName.startsWith("$$profile_".concat(a.uniqueId,":")))switch(a.customType){case"text":case"number":case"singleSelect":t.tagName!=="$$profile_".concat(a.uniqueId,":").concat(n.value)&&s.push(t.tagName);break;case"multipleSelect":n.values.find(function(e){return t.tagName==="$$profile_".concat(a.uniqueId,":").concat(e.value)})||s.push(t.tagName)}})}))),e&&e.imageUrl&&o.push("$$profile_picture"),t?userTags.assignUserTags(o,{},n):userTags.removeProfileTags(s,function(e,t){e?n(e):userTags.assignUserTags(o,{overridingUser:t},n)}))},assignUserTags:function(n,s,r){"string"==typeof n&&(n=n.split(",")),s=s||{},authAPI.getCurrentUser(function(e,t){var a;t=s.overridingUser||t,e?(console.log(e),r(e,null)):t&&(a=!1,userTags.matchUserTags({tags:n,user:t},function(e,t){var n;a=t.isProfileTagUpdate,t.matchingTag?(t.matchingTag.appliedCount++,t.matchingTag.lastAssgined=(new Date).toISOString()):((n={}).tagName=t.tagName.toLowerCase().trim().replace(/ /g,"-"),n.appliedCount=1,n.firstAssgined=(new Date).toISOString(),n.lastAssgined=(new Date).toISOString(),t.appTags.push(n))},function(){authAPI._setCurrentUser(t)}),bfUtils.http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/app/"+window.appContext.currentApp.appId+"/user/assign",{tags:n,accessToken:t.accessToken}).success(function(e){authAPI.refreshAndTriggerUpdate({updateType:"user_tags_updated",isProfileTagUpdate:a}),r(null,!0)}).error(function(e){console.log(e),r(e)}))})},unassignUserTags:function(n,a,s){"string"==typeof n&&(n=n.split(",")),authAPI.getCurrentUser(function(e,t){e?(console.log(e),s(e,null)):t&&(userTags.matchUserTags({tags:n,user:t},function(e,t){var n;t.matchingTag&&(1<t.matchingTag.appliedCount&&!a.removeTag?(t.matchingTag.appliedCount--,t.matchingTag.lastAssgined=(new Date).toISOString()):(n=t.appTags.indexOf(t.matchingTag),t.appTags.splice(n,1)))},function(){a.preventRefresh||authAPI._setCurrentUser(t)}),bfUtils.http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/app/"+window.appContext.currentApp.appId+"/user/unassign",{tags:n,isPrefix:a.isPrefix||!1,accessToken:t.accessToken,removeTag:a.removeTag||!1}).success(function(e){a.preventRefresh||authAPI.refreshAndTriggerUpdate({updateType:"user_tags_updated"}),s(null,t)}).error(function(e){console.log(e),s(e,null)}))})},matchUserTags:function(e,t,n){var a=e.tags,s=e.user;if(a&&0<a.length&&window.appContext&&window.appContext.currentApp&&window.appContext.currentApp.appId){var r=!1,i=window.appContext.currentApp.appId;s.tags||(s.tags={}),s.tags[i]||(s.tags[i]=[]);for(var o=0;o<a.length;o++){var p=a[o],u=!1;!r&&p&&0==p.indexOf("$$profile_")&&(r=!0);for(var g=0;g<s.tags[i].length;g++){var c=s.tags[i][g];if(c.tagName.toLowerCase()==p.toLowerCase()||-1<c.tagName.toLowerCase().indexOf(p.toLowerCase())){t(null,{appTags:s.tags[i],tagName:p,matchingTag:c,isProfileTagUpdate:r}),u=!0;break}}u||t(null,{appTags:s.tags[i],tagName:p,matchingTag:null,isProfileTagUpdate:r})}n&&n()}}};userTags.init();
...
"use strict";function _createForOfIteratorHelper(e,t){var n="undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(!n){if(Array.isArray(e)||(n=_unsupportedIterableToArray(e))||t&&e&&"number"==typeof e.length){n&&(e=n);var a=0,t=function(){};return{s:t,n:function(){return a>=e.length?{done:!0}:{done:!1,value:e[a++]}},e:function(e){throw e},f:t}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var o,r=!0,p=!1;return{s:function(){n=n.call(e)},n:function(){var e=n.next();return r=e.done,e},e:function(e){p=!0,o=e},f:function(){try{r||null==n.return||n.return()}finally{if(p)throw o}}}}function _unsupportedIterableToArray(e,t){if(e){if("string"==typeof e)return _arrayLikeToArray(e,t);var n=Object.prototype.toString.call(e).slice(8,-1);return"Map"===(n="Object"===n&&e.constructor?e.constructor.name:n)||"Set"===n?Array.from(e):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(e,t):void 0}}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var n=0,a=new Array(t);n<t;n++)a[n]=e[n];return a}function AppearanceAPI(e){this.pluginAPI=e}function resetToDefaults(){postMaster.isLauncherPluginActive()&&AppearanceAPI.prototype.titlebar.hide(),AppearanceAPI.prototype.sideMenu.show(),AppearanceAPI.prototype.fullScreenMode.disable(),AppearanceAPI.prototype.navbar.show();var e=document.getElementById("launcherPlugin");AppearanceAPI.prototype.applyToScope(e,"disableAutomaticNavigationBar",!1)}AppearanceAPI.prototype={getCSSFiles:function(e,t){return t(null,["https://bootswatch.com/cerulean/bootstrap.css"]),this},autosizeContainer:function(e,t){this.autosizeContainerHandler(e.height),t(null,null)},autosizeContainerHandler:function(){},setHeaderVisibility:function(e){var t=document.getElementById("pluginControlHeader"),n=document.getElementById("pluginControlHeaderTabs");t&&(e?t.classList.remove("hidden"):t.classList.add("hidden")),n&&(e?n.classList.remove("hidden"):n.classList.add("hidden"))},beforeUpdate:function(e){document.addEventListener("appearanceBeforeUpdate",e,!1)},triggerBeforeUpdate:function(e){var t=new CustomEvent("appearanceBeforeUpdate");document.dispatchEvent(t)},onUpdate:function(e){document.addEventListener("appearanceOnUpdate",e,!1)},triggerOnUpdate:function(e){var t=new CustomEvent("appearanceOnUpdate");document.dispatchEvent(t)},applyToScope:function(e,t,n,a){if(!e)return a&&a();var o=void 0;(o=angular.element(e).scope())[t]=n,o.$$phase||(o.$apply(),a&&a())},getScope:function(e){return angular.element(e).scope()},applyScopeFunction:function(e,t,n){var a=void 0;"function"==typeof(a=angular.element(e).scope())[t]&&a[t](),n&&n()},applyToRootScope:function(e,t,n){var a=void 0;(a=angular.element(document.body).scope().$root)[e]=t,a.$$phase||(a.$apply(),n&&n())},getRootScope:function(){return angular.element(document.body).scope().$root},getFooterMenu:function(e,t){"function"==typeof e&&(t=e);var n=localStorage.getItem("footerMenu"),e={};t(null,e=n?JSON.parse(n):e)},getAppearance:function(e,n){if(AppearanceAPI._appearance)n(null,AppearanceAPI._appearance);else{if(!window.appContext||!window.appContext.currentApp||!window.appContext.currentApp.appId)return n("missing currentApp parameters");var t="appearance",a={appId:window.appContext.currentApp.appId,pluginId:t,instanceId:t};new window.DatastoreAPI(a).get({tag:t,withDynamicData:!0},function(e,t){return e?n(e,null):t&&t.data?(AppearanceAPI._appearance=t.data,n(null,t.data)):void n("No result",null)})}},updateCustomRegistration:function(e){AppearanceAPI._appearance&&(AppearanceAPI._appearance.customRegistration=e)},titlebar:{show:function(e,t){AppearanceAPI.prototype.titlebar.toggleVisibility(!0,"showNavigationBar",t)},hide:function(e,t){AppearanceAPI.prototype.titlebar.toggleVisibility(!1,"showNavigationBar",t)},toggleVisibility:function(e){function t(e){i+=e}function n(){0==--i&&o&&o()}var a=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"showNavigationBar",o=2<arguments.length?arguments[2]:void 0,r=document.getElementsByClassName("pluginFrame"),p=postMaster.isLauncherPluginActive(),i=0;if(p){p=document.getElementById("launcherPlugin");t(2),AppearanceAPI.prototype.applyToScope(p,"disableAutomaticNavigationBar",!0,n),AppearanceAPI.prototype.applyToScope(p,a,e,n)}else{t(2*r.length);for(var c=0;c<r.length;c++)AppearanceAPI.prototype.applyToScope(r[c],"disableAutomaticNavigationBar",!0,n),AppearanceAPI.prototype.applyToScope(r[c],a,e,n)}},reset:function(e,t){function n(e){p+=e}function a(){0==--p&&t&&t()}var o=document.getElementsByClassName("pluginFrame"),r=postMaster.isLauncherPluginActive(),p=0;if(r){var i=document.getElementById("launcherPlugin");n(2),AppearanceAPI.prototype.applyToScope(i,"disableAutomaticNavigationBar",!1,a),AppearanceAPI.prototype.applyToScope(i,e,!1,a);r=new HistoryAPI;r.historyItems&&1<r.historyItems.length&&AppearanceAPI.prototype.applyToScope(i,"showNavigationBar",!0,a)}else{n(2*o.length);var c,l=_createForOfIteratorHelper(o);try{for(l.s();!(c=l.n()).done;){var u=c.value;AppearanceAPI.prototype.applyToScope(u,"disableAutomaticNavigationBar",!1,a),AppearanceAPI.prototype.applyToScope(u,e,!1,a)}}catch(e){l.e(e)}finally{l.f()}}},isVisible:function(){var e=!postMaster.isWidgetPluginInactive()||!postMaster.isLauncherPluginActive(),t=document.getElementById("launcherPlugin"),n=angular.element(t).scope(),t=n.showNavigationBar;return!0===n.disableAutomaticNavigationBar?t:e}},navbar:{show:function(e,t){AppearanceAPI.prototype.navbar.toggleVisibility(!0,"isFooterMenuHidden",e,t)},hide:function(e,t){AppearanceAPI.prototype.navbar.toggleVisibility(!1,"isFooterMenuHidden",e,t)},toggleVisibility:function(e,t,n,a){function o(e){l+=e}function r(){0==--l&&a&&a()}var p=document.getElementsByClassName("pluginFrame"),i=postMaster.isLauncherPluginActive(),c=document.getElementById("footerMenuParent"),l=0;if(i){i=document.getElementById("launcherPlugin");o(2),AppearanceAPI.prototype.applyToScope(c,t,!e,r),AppearanceAPI.prototype.applyToScope(i,t,!e,r)}else{o(2*p.length);for(var u=0;u<p.length;u++)AppearanceAPI.prototype.applyToScope(c,t,!e,r),AppearanceAPI.prototype.applyToScope(p[u],t,!e,r)}},isVisible:function(){return AppearanceAPI.prototype.getRootScope().turnOnFooterMenu}},fullScreenMode:{enable:function(e,t){AppearanceAPI.prototype.fullScreenMode.toggle(!0,e,t)},disable:function(e,t){AppearanceAPI.prototype.fullScreenMode.toggle(!1,e,t)},toggle:function(e,t,n){function a(){0==--o&&n&&n()}var o=3,r=postMaster.isLauncherPluginActive(),p=document.getElementById("launcherPlugin");r&&AppearanceAPI.prototype.applyToScope(p,"isInFullScreenMode",!e);var i=AppearanceAPI.prototype.getScope(p)||{},c=i.showNavigationBar,l=i.disableAutomaticNavigationBar,i=i.previousState;e?(i||AppearanceAPI.prototype.applyToScope(p,"previousState",{showNavigationBar:c,disableAutomaticNavigationBar:l}),AppearanceAPI.prototype.titlebar.toggleVisibility(!e,"isInFullScreenMode",a)):r?i?(AppearanceAPI.prototype.applyToScope(p,"previousState",null),AppearanceAPI.prototype.applyToScope(p,"disableAutomaticNavigationBar",i.disableAutomaticNavigationBar,a),1<((new HistoryAPI).historyItems||[]).length&&AppearanceAPI.prototype.applyToScope(p,"showNavigationBar",!0,a)):l?AppearanceAPI.prototype.titlebar[c?"show":"hide"]({},a):AppearanceAPI.prototype.titlebar.reset("isInFullScreenMode",a):a(),AppearanceAPI.prototype.sideMenu.toggleIconVisibility(!e,"isInFullScreenMode",null,a),AppearanceAPI.prototype.navbar.toggleVisibility(!e,"isInFullScreenMode",null,a)}},sideMenu:{show:function(e,t){AppearanceAPI.prototype.sideMenu.toggleIconVisibility(!0,"isMenuIconHidden",e,t)},hide:function(e,t){AppearanceAPI.prototype.sideMenu.toggleIconVisibility(!1,"isMenuIconHidden",e,t)},toggleIconVisibility:function(e,t,n,a){var o,r=document.getElementById("menu-location");postMaster.isLauncherPluginActive()&&(o=document.getElementById("launcherPlugin"),AppearanceAPI.prototype.applyToScope(o,t,!e)),AppearanceAPI.prototype.applyToScope(r,t,!e,a)},open:function(e,t){cpSync.menu.showSideMenu(),t&&t()},close:function(e,t){var n=document.getElementById("sideMenuCloseButton");AppearanceAPI.prototype.applyScopeFunction(n,"closeMenu",t)},getStyles:function(e,a){e={appId:e.appId,pluginId:"sideMenu",instanceId:1,liveMode:e.liveMode,writeKey:e.writeKey};null==this.dataStore&&(this.dataStore=new DatastoreAPI(e)),this.dataStore.get({tag:"",withDynamicData:!0},function(e,t){var n;e?a(e):(e=(n=t.data&&t.data._buildfire?t.data._buildfire:{}).sideMenu,(e=(void 0===(e=void 0===(e=e)?{style:void 0}:e).style&&(e.style={alignLeft:!1,showIcon:!0,icon:"icon-menu",transparent:!1,floating:!1}),e)).id=t.id,e.styleUpdate=n.styleUpdate,a(null,e))})},reset:function(e){AppearanceAPI.prototype.sideMenu.getStyles(e,function(e,t){var n=t.style,a=postMaster&&postMaster.launcherPluginAPI&&postMaster.launcherPluginAPI.history&&postMaster.launcherPluginAPI.history.historyItems?postMaster.launcherPluginAPI.history.historyItems:null,o=!postMaster.isLauncherPluginActive()&&window.location.href.indexOf("#/pluginContainer")<0,r=!a||!a.length||1==a.length&&"home"==a[0].source,a=document.getElementById("faux-http-section");a&&((a=AppearanceAPI.prototype.getScope(a)).showIcon=n.showIcon,a.menuIcon=n.icon,a.isMenuLeftAligned=n.alignLeft,a.menuDisabled=!(!t||!t.content)&&t.content.turnOffSideMenu,a.menuDisabled||(a.menuDisabled=a.authShown&&!a.allowCancel&&!0!==a.showMenuOnAuth),n&&n.headerImage&&(a.headerImage=n.headerImage.replace("/width/21/","/width/78/")),t=a.showMenuIcon()?"":" ng-hide ",t+=!o&&r?n.alignLeft?" menu menu-left-align ":" menu menu-right-align ":n&&n.alignLeft?" menu menuLeft ":" menu ",n.transparent&&(t+=" translucent "),n.floating&&(n.alignLeft?t+=" floating-left ":t+=" floating-right "),a.menuClass=t,a.$$phase||a.$apply())})}},ready:function(){var e=document.getElementsByClassName("pluginFrame");if(postMaster.isLauncherPluginActive()){var t=document.getElementById("launcherPlugin");AppearanceAPI.prototype.applyToScope(t,"readyToShow",!0)}else for(var n=0;n<e.length;n++)AppearanceAPI.prototype.applyToScope(e[n],"readyToShow",!0);window.spinner&&window.spinner.hide()}},document.addEventListener("launcherOnReactivated",function(){var e=document.getElementById("launcherPlugin"),t=AppearanceAPI.prototype.getScope(e),n={};Object.assign(n,t);var a=n.isInFullScreenMode,o=n.isFooterMenuHidden,e=n.disableAutomaticNavigationBar,t=n.showNavigationBar;n.isMenuIconHidden?AppearanceAPI.prototype.sideMenu.hide():AppearanceAPI.prototype.sideMenu.show(),a?AppearanceAPI.prototype.fullScreenMode.enable():AppearanceAPI.prototype.fullScreenMode.disable(),o?AppearanceAPI.prototype.navbar.hide():AppearanceAPI.prototype.navbar.show(),e&&(t?AppearanceAPI.prototype.titlebar.show():AppearanceAPI.prototype.titlebar.hide())}),document.addEventListener("AUTH_CURRENT_USER_ON_LOGOUT",function(){resetToDefaults()},!1),document.addEventListener("pluginOnActivated",function(){AppearanceAPI.prototype.fullScreenMode.disable(),AppearanceAPI.prototype.navbar.show(),AppearanceAPI.prototype.sideMenu.show()});
...
"use strict";function _typeof(n){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(n){return typeof n}:function(n){return n&&"function"==typeof Symbol&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n})(n)}setTimeout(function(){if(sessionStorage.getItem("notification"))try{var n=JSON.parse(sessionStorage.getItem("notification"));LocalNotificationsAPI.navToPlugin(n)}finally{sessionStorage.removeItem("notification")}},2e3);var LocalNotificationsAPI=function(){var o={},i="Cordova notification plugin not installed";function e(n){var t=this;this.context=n,this.localNotificationChannel=null,"undefined"!=typeof cordova&&cordova.plugins&&cordova.plugins.firebase&&cordova.plugins.firebase.messaging&&bfUtils.isAndroid&&7<device.version&&cordova.plugins.firebase.messaging.listChannels().then(function(n){n=(n=n.find(function(n){return"local-notifications"===n.id}))||cordova.plugins.firebase.messaging.createChannel({id:"local-notifications",name:"Local Notifications",importance:5});t.localNotificationChannel=n})}function c(n){return o.hasOwnProperty(n)}function l(n){c(n)&&(clearTimeout(o[n]),delete o[n])}function a(){return"undefined"!=typeof cordova}return e.prototype={schedule:function(n,t){var i=Math.floor(1e9*Math.random()),a=new Date;e.isPluginAvailable()?(n.badge=0,n.at?n.at=Date.parse(n.at):n.at=new Date(a.getTime()+1e3),n.id=i,n.data={actionItem:n.actionItem,pluginData:n.data,returnInstanceId:n.returnToPluginInstanceId||this.context.instanceId,launchInstanceId:this.context.instanceId,pluginId:this.context.pluginId,analyticsData:n.analyticsData},this.localNotificationChannel&&this.localNotificationChannel.id&&(n.channel=this.localNotificationChannel.id),cordova.plugins.notification.local.schedule(n),t(null,{id:n.id})):(a=Math.abs(Date.parse(n.at)-Date.now()))<-2e3||(n.data={actionItem:n.actionItem,pluginData:n.data,returnInstanceId:n.returnToPluginInstanceId||this.context.instanceId,launchInstanceId:this.context.instanceId,pluginId:this.context.pluginId,analyticsData:n.analyticsData},a=setTimeout(function(){c(i)&&(e.notificationModal(n),l(i))},a),o[i]=a,t(null,{id:i}))},cancel:function(n,t){e.isPluginAvailable()?(cordova.plugins.notification.local.cancel(n),t(null,{id:n})):a()?t(new Error(i),null):(l(n),t(null,{id:n}))},checkPermission:function(n,t){if(a())return e.isPluginAvailable()?void cordova.plugins.notification.local.hasPermission(function(n){t&&t(null,n)}):(t&&t(new Error(i),!1),void console.warn(i));t&&t(null,!0)},requestPermission:function(n,t){if(a())return e.isPluginAvailable()?void cordova.plugins.notification.local.hasPermission(function(n){n?t&&t(null,!0):cordova.plugins.notification.local.registerPermission(function(n){n?t&&t(null,!0):(console.warn("Permission not granted for local notifications"),t&&t(null,!1))})}):(t&&t(new Error(i),!1),void console.warn(i));t&&t(null,!0)}},e.isPluginAvailable=function(){var n=!0;return n=!("undefined"!=typeof cordova&&cordova.plugins&&cordova.plugins.notification&&cordova.plugins.notification.local)?!1:n},e.getPlatform=function(){return device.platform?device.platform.toLowerCase():""},e.notificationModal=function(t){var n;t&&(t.title||t.text)&&(n={data:{title:t.title,body:t.text}},window.openDialog(n,function(n){n&&e.navToPlugin(t)}))},e.navToPlugin=function(o){var n=postMaster.launcherPluginAPI?0:1500;setTimeout(function(){var n,t,i,a;postMaster.launcherPluginAPI&&(t=2e3,a=(i={doNothing:0,sendToLauncher:1,sendToPlugin:2}).sendToPlugin,"object"!==_typeof(o.data)&&(o.data=JSON.parse(o.data)),o.data.actionItem&&ActionItemsAPI.prototype.execute(o.data.actionItem,function(n,t){}),"home"==(n=o.data.returnInstanceId?o.data.returnInstanceId.toLowerCase():"")||"none"==n?a=i.doNothing:postMaster.launcherPluginAPI&&postMaster.launcherPluginAPI.context&&postMaster.launcherPluginAPI.context.instanceId==n&&(a=i.sendToLauncher),a!==i.doNothing&&(i===i.sendToLauncher?(t=500,postMaster.launcherPluginAPI.navigation.navigateHome()):(a=i.sendToPlugin,postMaster.widgetPluginAPI&&postMaster.widgetPluginAPI.context&&postMaster.widgetPluginAPI.context.instanceId==o.data.returnInstanceId?t=500:postMaster.launcherPluginAPI.navigation.navigateToPluginInstance({instanceId:o.data.returnInstanceId})),setTimeout(function(){var n=new Packet(null,"notifications.localNotification.onClick",o.data.pluginData);(a===i.sendToLauncher?postMaster.launcherPluginAPI:postMaster.widgetPluginAPI).sendMessage(null,n)},t)))},n)},e.sendAnalytics=function(n){n&&n.data&&("object"!==_typeof(n.data)&&(n.data=JSON.parse(n.data)),n.data&&n.data.analyticsData&&n.data.analyticsData.eventName&&new AnalyticsAPI(window.appContext.currentApp.appId,n.data.pluginId,n.data.launchInstanceId,window.appContext.liveMode).trackAction(n.data.analyticsData.eventName,n.data.analyticsData.metaData))},e.onTrigger=function(n){console.log("*** notification trigger ***"),LocalNotificationsAPI.sendAnalytics(n),"ios"==LocalNotificationsAPI.getPlatform()&&LocalNotificationsAPI.notificationModal(n)},e.onClick=function(n){console.log("*** notification click ***"),LocalNotificationsAPI.sendAnalytics(n),LocalNotificationsAPI.navToPlugin(n)},e}();bfUtils.isMobileDevice&&appState.subscribe({state:appState.RUNNING},function(){LocalNotificationsAPI.isPluginAvailable()&&(cordova.plugins.notification.local.on("trigger",LocalNotificationsAPI.onTrigger),cordova.plugins.notification.local.on("click",LocalNotificationsAPI.onClick))});
...
"use strict";var _push;function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _defineProperty(e,n,i){return n in e?Object.defineProperty(e,n,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[n]=i,e}var push=(_defineProperty(_push={get instance(){return window.plugins&&window.plugins.pushNotification?_oldPush:"undefined"!=typeof cordova&&cordova.plugins&&cordova.plugins.firebase&&cordova.plugins.firebase.messaging?push_firebase:push_phonegap},init:function(){return window.push=this,window.plugins&&window.plugins.pushNotification?(console.log("running old plugin for push notification"),_oldPush.init()):"undefined"!=typeof cordova&&cordova.plugins&&cordova.plugins.firebase&&cordova.plugins.firebase.messaging?push_firebase.init():(console.log("running new plugin phonegap-plugin-push"),void push_phonegap.init())},get deviceId(){return this.instance.deviceId},get platform(){return"undefined"!=typeof device&&device.platform&&device.platform.toLowerCase()||""},get getBadgeNumber(){return this.instance.getBadgeNumber},get decrementBadge(){return this.instance.decrementBadge},get clearBadge(){return this.instance.clearBadge},get displayMessage(){return this.instance.displayMessage},getNotificationData:function(e,n,i,t){window.bfUtils.http.jsonp(e,n).success(function(e){e=e&&e.result[0]?e.result[0]:{actionItem:!1};i=Object.assign(i,e),t(null,i)}).catch(t)}},"displayMessage",function(e,n){var i=(n=n||{})._forceToDisplayMessage;push.trackPushNotifications({eventName:"push_notification/viewed",payload:e}),console.log("pushNotifications#displayMessage L152",e),localStorage.payload=JSON.stringify(e);try{var t=e._id||e.notificationId||e.additionalData.notificationId;if(console.log("Checking message type",e.messageType,e),e.additionalData&&"social"===e.additionalData.messageType)return e.title="Alert",e.richContent=e.message,richModal.display(e),void console.log("Got social notification",e);var o=window.siteConfig.endPoints.push+"/src/server.js?callback=JSON_CALLBACK",a={params:{data:{method:"notifications/get",params:{appID:window.appContext.currentApp.appId.toString(),notificationID:t}}}};push.getNotificationData(o,a,e,function(e,n){if(e)return console.error(e);e=Object.assign({},n);n.actionItem&&(e.action={title:n.actionItem&&n.actionItem.title?n.actionItem.title:"View",handler:function(){var e=new ActionItemsAPI;push.trackPushNotifications({eventName:"push_notification/clicked",payload:n}),window.closeSideMenu&&window.closeSideMenu(),e.execute(n.actionItem,function(e,n){console.info("Action Taken!")})}}),i||n.richMessage?(e.richContent=e.richMessage,e.subtitle="Sent "+moment(e.sendAfter).fromNow(),richModal.display(e)):e.action&&e.action.handler&&e.action.handler()})}catch(e){console.error("Failed to parse push notification",e)}}),_defineProperty(_push,"notificationsTracked",{}),_defineProperty(_push,"trackPushNotifications",function(e){var n,i,t;"undefined"!=typeof device&&"undefined"!=typeof AnalyticsAPI&&e&&e.payload&&e.eventName&&((n=e.payload._id||e.payload.notificationId||e.payload.additionalData.notificationId)&&(push.notificationsTracked||(push.notificationsTracked={}),(i=(i=push.notificationsTracked[n])||(push.notificationsTracked[n]={events:[]})).events||(i.events=[]),-1<i.events.indexOf(e.eventName)||(i.events.push(e.eventName),t=device.platform?device.platform.toLowerCase():"",new AnalyticsAPI(window.appContext.currentApp.appId,"push_notification",n,void 0,t).trackAction(e.eventName))))}),_push),push_firebase={deviceId:null,init:function(){var n=this;if("undefined"==typeof cordova||!cordova.plugins&&!cordova.plugins.firebase||!cordova.plugins.firebase.messaging)return console.error("FCM plugin not installed");cordova.plugins.firebase.messaging.requestPermission();var e=function(){return cordova.plugins.firebase.messaging.getToken().then(function(e){return n.registerToken(e)})};cordova.plugins.firebase.messaging.onTokenRefresh(e),e();e=function(){n.getBadgeNumber(function(e){document.dispatchEvent(new CustomEvent("appBadgeNumberUpdated",{detail:e}))})};e(),document.addEventListener("deviceAppResumed",e,!1),cordova.plugins.firebase.messaging.onMessage(function(e){return n.notificationTriggerHandler(e)}),cordova.plugins.firebase.messaging.onBackgroundMessage(function(e){return n.notificationClickHandler(e)})},registerToken:function(e){var n=this;if(console.log("registerToken: "+e),this.deviceId=e,!window.appContext||!window.appContext.currentApp)return console.error("invalid appContext cant register device");var i={params:{data:{method:"groups/subscriptions/add",params:{groupID:"",appID:window.appContext.currentApp.appId,deviceId:this.deviceId,os:device.platform?device.platform.toLowerCase():"",deliveryMethod:"FCM",device:device}}}},e=localStorage.getItem("currentPushDeviceID");e&&e!==this.deviceId&&(i.params.data.params.olddeviceId=e);function t(){bfUtils.http&&bfUtils.http.jsonp(window.siteConfig.endPoints.push+"/src/server.js?callback=JSON_CALLBACK",i).success(function(){console.log("device is now subscribed to PNs"),localStorage.setItem("currentPushDeviceID",n.deviceId)}).error(function(e){console.error(e)})}setTimeout(function(){PushNotificationsAPI._subscribe(null,function(e){e&&(console.error(e),setTimeout(t,2e3))})},2e3)},notificationTriggerHandler:function(e){var i=this;if(console.warn("***** notificationTriggerHandler *****"),e.meta)return LocalNotificationsAPI.onTrigger(e);var n=new CustomEvent("pushNotificationsOnReceived",{detail:e});document.dispatchEvent(n);var t=this.normalizePayload(e);t.count&&t.additionalData&&t.additionalData.foreground?cordova.plugins.firebase.messaging.getBadge().then(function(n){t.count!=n&&cordova.plugins.firebase.messaging.setBadge(parseInt(t.count)).then(function(){i.decrementBadge(),console.log("push badge updated from notification",{localCount:n,remoteCount:t.count})},function(e){i.decrementBadge(),console.log("push badge failed to update from notification",{err:e,localCount:n,remoteCount:t.count})})},function(e){console.log("failed getting local badge",{err:e,remoteCount:t.count})}):this.decrementBadge();e={};t.additionalData&&"social"==t.additionalData.messageType?e.buttons=["Dismiss"]:e.buttons=["Dismiss","Show Details"],push.displayMessage(t,e)},notificationClickHandler:function(e){return console.warn("***** notificationClickHandler *****"),e.meta?LocalNotificationsAPI.onClick(e):(e.foreground=!1,this.notificationTriggerHandler(e))},getBadgeNumber:function(e){if(!this.deviceId)return e("push_firebase not initialized");cordova.plugins.firebase.messaging.getBadge().then(e)},decrementBadge:function(n){var e,i;this.deviceId?(e=device.platform?device.platform.toLowerCase():"",i=window.siteConfig.endPoints.pushV2+"/api/app/"+window.appContext.currentApp.appId+"/subscriptions/badges/decrease",window.bfUtils.http.post(i,{deviceID:this.deviceId,os:e,value:1}).success(function(e){console.log("push badge decremented",e)}).error(function(e,n){console.error("error decrementing badge",{data:e,status:n})}),cordova.plugins.firebase.messaging.getBadge().then(function(e){e?cordova.plugins.firebase.messaging.setBadge(e-1).then(function(){document.dispatchEvent(new CustomEvent("appBadgeNumberUpdated",{detail:e-1})),n&&n(null,e-1)},function(e){n&&n(e)}):n&&n(null,e)},function(e){n&&n(e)})):n&&n("push not initialized")},clearBadge:function(n){if(!this.deviceId)return push._instance?push.clearBadge(n):n("push not initialized");var e=device.platform?device.platform.toLowerCase():"",i=window.siteConfig.endPoints.pushV2+"/api/app/"+window.appContext.currentApp.appId+"/subscriptions/badges/update";window.bfUtils.http.post(i,{deviceID:this.deviceId,os:e,value:0}).success(function(e){console.log("push badge decremented",e)}).error(function(e,n){console.error("error decrementing badge",{data:e,status:n})}),cordova.plugins.firebase.messaging.setBadge(0).then(function(){document.dispatchEvent(new CustomEvent("appBadgeNumberUpdated",{detail:0})),n&&n(null,0)},function(e){n&&n(e)})},normalizePayload:function(e){var n=e.aps||e,i=n.sound,t=n.badge,o=n.alert||e,a=o.title,s=o.body,n=e.notificationId,o=e.messageFrom;return{additionalData:{notificationId:n,messageType:e.messageType,messageFrom:o,foreground:!1!==e.foreground},title:a,sound:i,count:-1<["number","string"].indexOf(_typeof(t))?parseInt(t):null,message:s}}},push_phonegap={pushNotification:null,deviceId:null,platform:null,unseen:0,notificationHandler:null,_instance:null,init:function(){var e;try{if(!window.PushNotification)return void console.error("PushNotification plugin not installed");var n=(e={android:{},ios:{}},"android"==device.platform.toLowerCase()?e.android={senderID:"515869937012"}:e.ios={alert:"true",badge:"true",sound:"true"},e);push_phonegap._instance=PushNotification.init(n),push_phonegap._instance.on("registration",function(e){push_phonegap.registerToken(e.registrationId),console.log("push notification registered...")}),push_phonegap._instance.on("notification",function(i){var e=new CustomEvent("pushNotificationsOnReceived",{detail:i});document.dispatchEvent(e),i.count&&i.additionalData&&i.additionalData.foreground?push_phonegap._instance.getApplicationIconBadgeNumber(function(n){i.count!=n&&push_phonegap._instance.setApplicationIconBadgeNumber(function(){push_phonegap.decrementBadge(),console.log("push badge updated from notification",{localCount:n,remoteCount:i.count})},function(e){push_phonegap.decrementBadge(),console.log("push badge failed to update from notification",{err:e,localCount:n,remoteCount:i.count})},parseInt(i.count))},function(e){console.log("failed getting local badge",{err:e,remoteCount:i.count})}):push_phonegap.decrementBadge();e={};"social"==i.additionalData.messageType?e.buttons=["Dismiss"]:e.buttons=["Dismiss","Show Details"],push.displayMessage(i,e)}),push_phonegap._instance.on("error",function(e){console.error(e.message),push_phonegap.err=e;e=new CustomEvent("PUSH_ON_REGISTRATION",{detail:null});document.dispatchEvent(e)}),push_phonegap.getBadgeNumber(function(e,n){e||document.dispatchEvent(new CustomEvent("appBadgeNumberUpdated",{detail:n}))});var i=function(){push_phonegap.getBadgeNumber(function(e,n){e||document.dispatchEvent(new CustomEvent("appBadgeNumberUpdated",{detail:n}))})};document.addEventListener("deviceAppResumed",i,!1),i()}catch(e){console.error("There was an error on this page.\n\nError description: "+e.message+"\n\n")}},decrementBadge:function(n){var e,i;push_phonegap._instance?(e=device.platform?device.platform.toLowerCase():"",i=window.siteConfig.endPoints.pushV2+"/api/app/"+window.appContext.currentApp.appId+"/subscriptions/badges/decrease",window.bfUtils.http.post(i,{deviceID:push_phonegap.deviceId,os:e,value:1}).success(function(e){console.log("push badge decremented",e)}).error(function(e,n){console.error("error decrementing badge",{data:e,status:n})}),push_phonegap._instance.getApplicationIconBadgeNumber(function(e){e?push_phonegap._instance.setApplicationIconBadgeNumber(function(){document.dispatchEvent(new CustomEvent("appBadgeNumberUpdated",{detail:e-1})),n&&n(null,e-1)},function(e){n&&n(e)},e-1):n&&n(null,e)},function(e){n&&n(e)})):n&&n("push_phonegap not initialized")},getBadgeNumber:function(n){push_phonegap._instance?push_phonegap._instance.getApplicationIconBadgeNumber(function(e){n&&n(null,e)},function(e){n&&n(e)}):n&&n("push_phonegap not initialized")},clearBadge:function(n){var e,i;push_phonegap._instance?(e=device.platform?device.platform.toLowerCase():"",i=window.siteConfig.endPoints.pushV2+"/api/app/"+window.appContext.currentApp.appId+"/subscriptions/badges/update",window.bfUtils.http.post(i,{deviceID:push_phonegap.deviceId,os:e,value:0}).success(function(e){console.log("push badge cleared",e)}).error(function(e,n){console.error("error clearing badge",{data:e,status:n})}),push_phonegap._instance.setApplicationIconBadgeNumber(function(){document.dispatchEvent(new CustomEvent("appBadgeNumberUpdated",{detail:0})),n&&n(null,0)},function(e){n&&n(e)},0)):n&&n("push_phonegap not initialized")},registerToken:function(e){var n,i,t;console.log("registerToken: "+e),push_phonegap.deviceId=e,window.appContext&&window.appContext.currentApp?(i="undefined"!=typeof PushNotification&&void 0!==PushNotification.listChannels,i=device.platform&&"android"===device.platform.toLowerCase()&&i,n={params:{data:{method:"groups/subscriptions/add",params:{groupID:"",appID:window.appContext.currentApp.appId,deviceId:push_phonegap.deviceId,os:device.platform?device.platform.toLowerCase():"",deliveryMethod:i?"FCM":null,device:device}}}},(i=localStorage.getItem("currentPushDeviceID"))&&i!==e&&(n.params.data.params.oldDeviceID=i),t=function(){bfUtils.http&&bfUtils.http.jsonp(window.siteConfig.endPoints.push+"/src/server.js?callback=JSON_CALLBACK",n).success(function(){console.log("device is now subscribed to PNs"),localStorage.setItem("currentPushDeviceID",e)}).error(function(e){console.error(e)})},setTimeout(function(){PushNotificationsAPI._subscribe(null,function(e){e&&(console.error(e),setTimeout(t,2e3))})},2e3)):console.error("invalid appContext cant register device")}},_oldPush={pushNotification:null,unseen:0,notificationHandler:null,init:function(){console.warn("window.plugins.pushNotification is used for old builds, it's no longer used for new build");try{if(void 0===window.plugins||void 0===window.plugins.pushNotification)return void console.warn("window.plugins.pushNotification is not defined");_oldPush.pushNotification=window.plugins.pushNotification,push.platform=device.platform.toLowerCase(),push.prepareDOM(),"android"==device.platform.toLowerCase()?_oldPush.notificationHandler=new pushAndroidNotificationHandler(_oldPush.pushNotification):_oldPush.notificationHandler=new pushiOSNotificationHandler(_oldPush.pushNotification),_oldPush.notificationHandler.onRegistered=push.registerToken,_oldPush.notificationHandler.register()}catch(e){console.error("There was an error on this page.\n\nError description: "+e.message+"\n\n")}}};function pushAndroidNotificationHandler(e){this.pushNotification=e,this.androidSenderID="515869937012"}function pushiOSNotificationHandler(e){this.pushNotification=e}pushAndroidNotificationHandler.prototype={register:function(){navigator.onLine?this.pushNotification.register(this.successHandler,this.errorHandler,{senderID:this.androidSenderID,ecb:"_oldPush.notificationHandler.onNotification"}):console.warn("offline: not attempting to register push notifications")},onRegistered:function(e){push.deviceId=e},onNotification:function(e){var n=new CustomEvent("pushNotificationsOnReceived",{detail:e});switch(document.dispatchEvent(n),e.event){case"registered":0<e.regid.length&&this.onRegistered(e.regid);break;case"message":push.decrementBadge(),e.foreground||e.coldstart;var i={};"social"==e.payload.messageType?i.buttons=["Dismiss"]:i.buttons=["Dismiss","Show Details"],push.displayMessage(e.payload,i);break;case"error":console.error("An error occurred: "+e.msg);break;default:console.error("EVENT -> Unknown, an event was received and we do not know what it is")}},successHandler:function(e){},errorHandler:function(e){console.error("error:"+e)}},pushiOSNotificationHandler.prototype={onRegistered:function(e){push.deviceId=e},register:function(){if(navigator.onLine)try{this.pushNotification.register(this.onRegistered,this.errorHandler,{badge:"true",sound:"true",alert:"true",ecb:"_oldPush.notificationHandler.onNotification"})}catch(e){console.error("There was an error on this page.\n\nError description: "+e.message+"\n\n")}else console.warn("offline: not attempting to register push notifications")},onNotification:function(e){var n=new CustomEvent("pushNotificationsOnReceived",{detail:e});document.dispatchEvent(n),e?(n={},"social"==e.messageType?n.buttons=["Dismiss"]:n.buttons=["Dismiss","Show Details"],e.alert&&(push.decrementBadge(),push.displayMessage(e,n))):window.location.hash="/pushHistory",e.sound},tokenHandler:function(e){push.deviceId=e},successHandler:function(e){this.onRegistered(e)},errorHandler:function(e){console.error("ios error:"+e)}},bfUtils.isMobileDevice&&appState.subscribe({state:appState.RUNNING},function(){window.plugins&&window.plugins.pushNotification?(console.log("running old plugin for push notification"),_oldPush.init()):(console.log("running new plugin phonegap-plugin-push"),push.init())}),window.testNotification=function(){push.displayMessage({message:"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti officiis perferendis expedita rerum delectus dolor neque veniam necessitatibus fuga cum voluptatibus placeat, totam voluptate, nisi reprehenderit odio porro cumque ipsa.<br /><br />Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti officiis perferendis expedita rerum delectus dolor neque veniam necessitatibus fuga cum voluptatibus placeat, totam voluptate, nisi reprehenderit odio porro cumque ipsa.<br /><br />Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti officiis perferendis expedita rerum delectus dolor neque veniam necessitatibus fuga cum voluptatibus placeat, totam voluptate, nisi reprehenderit odio porro cumque ipsa.<br /><br />Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti officiis perferendis expedita rerum delectus dolor neque veniam necessitatibus fuga cum voluptatibus placeat, totam voluptate, nisi reprehenderit odio porro cumque ipsa.<br /><br />",title:"Notification Title",alert:"This is the alert, not sure what it means",messageType:null,additionalData:{notificationId:"5b5f9bbe39003904daa4f093",coldstart:!0,foreground:!0}},{buttons:["Dismiss","Show Details"]})};
...
"use strict";function ComponentUIAPI(e){this.context=e,this.DRAWER_UI_ID="bottomDrawerContainer",this.SNACKBAR_UI_ID="snackbarhero",this.timeOutId=null,this.init()}ComponentUIAPI.prototype={init:function(){},sanitize:function(e,i,n){window.bfUtils.sanitize({data:e},function(e,t){return e?(n&&n(e,null),console.error(e)):(i.innerHTML+=t,void(n&&n(null,null)))})},closeDrawer:function(e,t){e=e||{};var i=document.getElementById(this.DRAWER_UI_ID);i&&(this.scrollBooster&&(this.scrollBooster.destroy(),this.scrollBooster=null),e.force?i.remove():(i.classList.add("closing"),setTimeout(function(){i.remove()},300)))},openDrawer:function(l,o){var e=this,a=this,r=!0,d=!1,u=[],m=[],h=(l=l||{}).multiSelection?"block":"none",c=[],p=null,b=null;l.isHTML=!1!==l.isHTML,l.multiSelectionActionButton=l.multiSelectionActionButton||{},l.multiSelectionActionButton.text=l.multiSelectionActionButton.text||"OK",l.multiSelectionActionButton.type=l.multiSelectionActionButton.type||"primary",l.allowSelectAll=!1!==l.allowSelectAll,l.enableFilter=!1!==l.enableFilter,l.autoUseImageCdn=!1!==l.autoUseImageCdn;var t=document.createElement("div");t.id=this.DRAWER_UI_ID,t.className="bottom-drawer-container",t.innerHTML='<div class="bottom-drawer-backdrop"></div><div class="bottom-drawer-holder"><div class="bottom-drawer backgroundColorTheme"></div></div>';var y=t.querySelector(".bottom-drawer");t.querySelector(".bottom-drawer-backdrop").onclick=function(){e.closeDrawer(),l.triggerCallbackOnUIDismiss&&o(null,null)},l.height&&(y.style.height=l.height),"undefined"!=typeof globalEvents&&(window.addEventListener(globalEvents.TABCHANGE.CONTENT,function(){e.closeDrawer()}),window.addEventListener(globalEvents.TABCHANGE.PURCHASE,function(){e.closeDrawer()}));var i,n,s,v,f,S,g,k=function(e){return r?-1<u.indexOf(e):-1===m.indexOf(e)};l.listItems&&l.listItems.forEach(function(e){e.selected&&u.push(e)}),l.header&&((i=document.createElement("div")).className="bottom-drawer-header titleBarBackgroundTheme",i.innerHTML='<div id="headerText" class="titleBarTextAndIcons"></div><div id="selectAllDiv" class="titleBarTextAndIcons">\n\t\t\t<span id="closeSearch" class="material-icons titleBarTextAndIcons">close</span>\n\t\t\t<div id="checkboxSelectAll" class="checkbox margin-top-zero">\n\t\t\t<input id="selectAllCheckbox" type="checkbox">\n\t\t\t<label style="padding:0" for="selectAllCheckbox"></label>\n\t\t    </div>\n\t\t\t<div id="drawerSearch" class="form-outline"><input type="search" onclick="window.keyboardResize()"class="form-control titleBarTextAndIcons" placeholder="'.concat("Search",'" aria-label="Search" disabled></div>\n\t\t\t<span id="searchIcon" class="material-icons titleBarTextAndIcons">search</span>\n\t\t\t</div>'),l.isHTML?this.sanitize(l.header,i.children[0]):i.children[0].innerText=l.header,l.multiSelection&&l.allowSelectAll&&(i.querySelector("#checkboxSelectAll").style.display="block",(n=i.querySelector("#selectAllCheckbox")).onclick=function(){var e=y.querySelectorAll("input[type=checkbox]");r=!n.checked,u=[],m=[],n.checked?l.listItems&&(u=l.listItems.slice(),w(l.listItems.length),e.forEach(function(e){e.checked=!0})):(u=[],w(),e.forEach(function(e){e.checked=!1}))}),l.enableFilter&&(s={},v=i.querySelector("#closeSearch"),f=i.querySelector("#searchIcon"),S=i.querySelector("#drawerSearch"),g=S.children[0],f.style.display="block",f.onclick=function(){S.classList.add("show-drawer-search"),S.classList.remove("hide-drawer-search"),g.disabled=!1,window.keyboardResize(),g.focus(),i.querySelector("#checkboxSelectAll").style.display="none",i.children[0].classList.add("hide-header-text"),i.children[0].classList.remove("show-header-text"),v.style.display="block"},v.onclick=function(){S.classList.add("hide-drawer-search"),S.classList.remove("show-drawer-search"),i.children[0].classList.remove("hide-header-text"),i.children[0].classList.add("show-header-text"),i.querySelector("#checkboxSelectAll").style.display=l.allowSelectAll&&l.multiSelection?"block":"none",i.children[0].style.display="block",v.style.display="none",S.children[0].value&&(L({target:{value:""}}),g.value=""),g.disabled=!0},g.onkeydown=function(e){var t=e.target;s&&clearTimeout(s),s=setTimeout(function(){return L({target:t})},500)}),y.appendChild(i)),window.stringResource&&l.header&&window.stringResource.getData().then(function(e){y.querySelector("#drawerSearch").children[0].placeholder=e.appSearch||"Search"});var T,L=function(e){var n,s,t,i=e.target;c&&p&&(e=[],s=!(n=!0),i=i.value,0<(t=i?i.toLowerCase().split(/[\s-_():,/\\|]+/g):[]).length?(e=c.filter(function(e){s=!(n=!0);var i=(e.text+" "+(e.secondaryText||"")).toLowerCase().split(/<[^>]+>|[\s-_():,/\\|]+/g);return t.forEach(function(t){t&&(i.forEach(function(e){e.startsWith(t)&&(s=!0)}),n=!(!s||!n),s=!1)}),n}),p.innerHTML="",p.scrollTop=0,x(e,p),N(e)):(p.innerHTML="",p.scrollTop=0,x(c,p),N(c)))};function w(e){var t=y.querySelector("#drawerButton");e?(y.querySelector("#buttonBadge").innerHTML=e,t.classList.remove("disabled-drawer-button"),t.disabled=!1):(y.querySelector("#buttonBadge").innerHTML="",t.classList.add("disabled-drawer-button"),t.disabled=!0)}function x(n,e){var s={};e?s=e:((s=document.createElement("ul")).classList.add("action-list"),s.onclick=function(e){for(var t,i=e.target;"LI"!==i.nodeName;){if("UL"===i.nodeName)return void console.log("Wrong Click");i=i.parentElement}l.multiSelection?(t=i.querySelector("input[type=checkbox]"),"checkbox"!=e.target.type&&(t.checked=!t.checked),function(e,t){{var i;t?(r?u.push(e):(i=m.indexOf(e),m.splice(i,1)),w(Number(y.querySelector("#buttonBadge").innerHTML)+1)):(r?(i=u.indexOf(e),u.splice(i,1)):m.push(e),w(Number(y.querySelector("#buttonBadge").innerHTML)-1))}}(i.item,t.checked)):o(null,i.item)});var c=0;function t(){for(var e,t,i=c;i<c+50&&!(n.length-1<i);i++)n[i]&&n[i].text&&(e=document.createElement("li"),t="",t=!l.autoUseImageCdn||!n[i].imageUrl||n[i].imageUrl.includes("cloudimg.io")||0!==n[i].imageUrl.indexOf("http")||n[i].imageUrl.includes("localhost")?n[i].imageUrl:imageTools.cropImage(n[i].imageUrl,{size:"xs",aspect:"1:1"}),e.innerHTML='<div class="item-icon">\n\t\t\t\t\t\t<img style="display:'.concat(t?"block":"none",'" src="').concat(t||"",'" onerror="this.style.display=\'none\'"></div>\n\t\t\t\t\t\t<div class="action-item-texts">\n\t\t\t\t\t\t<div style="font-weight: bold"></div>\n\t\t\t\t\t\t<div></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style="display: ').concat(h,' ; margin-left: auto" class="checkbox checkbox-primary margin-top-zero ').concat(n[i].secondaryText?"drawer-checkboxes":"",'"><input type="checkbox"><label style="padding:0"></label></div>'),l.isHTML?(a.sanitize(n[i].text,e.children[1].children[0]),a.sanitize(n[i].secondaryText,e.children[1].children[1])):(e.children[1].children[0].innerText=n[i].text,e.children[1].children[1].innerText=n[i].secondaryText||""),l.multiSelection&&(e.querySelector("input[type=checkbox]").checked=k(n[i])||!1),e.item=n[i],s.appendChild(e));c+=50,console.log("Load Other Items")}if(b&&s.removeEventListener("scroll",b),b=function(){s.scrollTop+s.clientHeight+1e3>=s.scrollHeight&&t()},s.addEventListener("scroll",b),t(),!e){for(var i=0;i<n.length;i++)if(n[i].imageUrl){d=!0;break}return d&&s.classList.add("has-images"),s}}if(l.content&&((T=document.createElement("div")).className="drawer-content",l.listItems||l.tabs||T.classList.add("scrollable-content"),l.isHTML?this.sanitize(l.content,T,function(){l.onContentRender&&setTimeout(function(){l.onContentRender()},0)}):T.innerText=l.content,y.appendChild(T)),l.listItems)c=l.listItems,p=x(l.listItems),y.appendChild(p);else if(l.tabs&&!l.multiSelection){var I=document.createElement("div");I.className="md-tabs-scroll";var A=document.createElement("div");A.classList.add("md-tabs");for(var B=0;B<l.tabs.length;B++){var q=document.createElement("div"),E=document.createElement("div");E.classList.add("active-indicator","titleBarBackgroundTheme"),q.classList.add("btn-tab-drawer-"+B,"md-tab"),0===B&&q.classList.add("active"),l.isHTML?this.sanitize(l.tabs[B].text,q):q.innerText=l.tabs[B].text,q.appendChild(E),A.appendChild(q)}I.appendChild(A);var C=0,M=[],H=I.querySelectorAll(".md-tab");H.forEach(function(t){t.setAttribute("data-tabindex",C),t.onclick=function(){H.forEach(function(e){e.classList.remove("active")}),t.classList.add("active");var e=t.getAttribute("data-tabindex");M.forEach(function(e){e.classList.add("hide")}),M[e].classList.remove("hide"),M[e].items?(c=M[e].items,p=M[e],l.header&&L({target:{value:document.querySelector("#drawerSearch").children[0].value}})):(p=c=null,y.querySelector(".empty-items")&&(y.querySelector(".empty-items").style.display="none"))},C++}),y.appendChild(I);for(var D,U=0;U<l.tabs.length;U++)l.tabs[U].listItems?((D=x(l.tabs[U].listItems)).items=l.tabs[U].listItems,0===U&&(c=l.tabs[U].listItems,p=D),M.push(D)):((D=document.createElement("div")).className="drawer-content",l.isHTML?this.sanitize(l.tabs[U].content,D):D.innerText=l.tabs[U].content,M.push(D)),0<U&&M[U].classList.add("hide"),y.appendChild(M[M.length-1])}function N(e){var t;y.querySelector(".empty-items")||((t=document.createElement("IMG")).src=window._appRoot+"media/ic_bookmark_empty.svg",t.classList.add("empty-items"),y.appendChild(t)),e&&0===e.length?y.querySelector(".empty-items").style.display="block":y.querySelector(".empty-items").style.display="none"}(l.listItems||l.tabs&&l.tabs[0]&&l.tabs[0].listItems)&&N(l.listItems||l.tabs&&l.tabs[0]&&l.tabs[0].listItems),l.multiSelection&&((T=document.createElement("DIV")).id="drawerButtonDiv",(I=document.createElement("BUTTON")).id="drawerButton",I.type="button",I.classList.add("btn","btn-".concat(l.multiSelectionActionButton.type)),I.innerHTML='<span class="btn-'.concat(l.multiSelectionActionButton.type,'"></span><span id="buttonBadge" class="badge btn-').concat(l.multiSelectionActionButton.type,'"></span>'),l.isHTML?this.sanitize(l.multiSelectionActionButton.text,I.children[0]):I.children[0].innerText=l.multiSelectionActionButton.text,T.appendChild(I),y.appendChild(T),y.querySelector("#drawerButton").onclick=function(){e.closeDrawer(),o(null,(r||m.forEach(function(e){e=u.indexOf(e);u.splice(e,1)}),u))},w(u.length)),this.closeDrawer({force:!0}),(document.querySelector("#emulatorContainer #app")||document.body).appendChild(t),!l.tabs||l.multiSelection||l.listItems||setTimeout(function(){e.scrollBooster=new ScrollBooster({viewport:t.querySelector(".md-tabs-scroll"),content:t.querySelector(".md-tabs"),scrollMode:"native",direction:"horizontal"}),setTimeout(function(){e.scrollBooster&&e.scrollBooster.updateMetrics()},1e3),setTimeout(function(){e.scrollBooster&&e.scrollBooster.updateMetrics()},3e3)},0)},showToastMessage:function(e,t){var i=this;e=e||{};var n=document.getElementById(this.SNACKBAR_UI_ID);n.querySelector(".snackbar-message").innerText=e.text;var s=n.querySelector(".snackbar");e.type||(e.type="info"),s.className="snackbar ".concat(e.type+"BackgroundTheme");var c=n.querySelector(".snackbar-actions"),s=c.querySelector(".snackbar-action");e.action&&e.action.title?(s.querySelector("span").innerText=e.action.title,s.classList.remove("hide"),s.onclick=function(){t&&t(null,e.action)}):s.classList.add("hide"),e.hideDismiss?c.querySelector(".dismiss").classList.add("hide"):(c.querySelector(".dismiss").classList.remove("hide"),c.querySelector(".dismiss").onclick=function(){i.closeToastMessage({force:!0})}),n.classList.remove("hide"),n.querySelector(".snackbar").classList.add("open"),this.closeToastMessage(e)},closeToastMessage:function(e,t){(e=e||{}).duration||(e.duration=8e3);var i=document.getElementById(this.SNACKBAR_UI_ID);e.force?(i.querySelector(".snackbar").classList.remove("closing"),i.querySelector(".snackbar").classList.remove("open"),setTimeout(function(){i.classList.add("hide")},250)):(i.querySelector(".snackbar").classList.add("closing"),this.timeOutId&&clearTimeout(this.timeOutId),this.timeOutId=setTimeout(function(){i.querySelector(".snackbar").classList.remove("closing"),i.querySelector(".snackbar").classList.remove("open"),setTimeout(function(){i.classList.add("hide")},250),this.timeOutId=null},e.duration))}};
