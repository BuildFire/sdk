...
"use strict";function _objectDestructuringEmpty(e){if(null==e)throw new TypeError("Cannot destructure undefined")}function DiagnosticsAPI(){}DiagnosticsAPI.prototype={features:{Bluetooth:{cordovaPlugins:["cordova-plugin-bluetooth-serial"],dependencies:[],featureObject:!!(bfUtils.isMobileDevice&&window&&window.parent&&window.parent.bluetoothSerial),name:"Bluetooth"},iBeacon:{cordovaPlugins:["com.unarin.cordova.beacon"],dependencies:["BackgroundMode"],featureObject:!!("undefined"!=typeof bridge&&bridge&&bridge.capabilities&&bridge.capabilities.locationManager&&bridge.capabilities.locationManager.BeaconRegion),name:"iBeacon",test:function(e,n){var i=e.iBeaconUUID,e=e.beaconMonitoringSeconds,o={uuid:i,identifier:"testid"};n(null,"Created beacon region for uuid: "+o.uuid),iBeaconAPI.onRegionEntered=function(e){n(null,"Beacon region entered "+o.uuid)},iBeaconAPI.onRegionExited=function(e){n(null,"Beacon region exited "+o.uuid)},iBeaconAPI.startBeaconMonitor(o,function(e){return e?n("Error while starting beacon monitor "+String(e)):void n(null,"Started monitoring beacon region for UUID: "+o.uuid)}),setTimeout(function(){iBeaconAPI.stopBeaconMonitor(o,function(e){return e?n("Error while stopping beacon monitor "+String(e)):void n(null,"Stopped monitoring beacon region")})},1e3*e)}},BackgroundAudio:{cordovaPlugins:["nl.x-services.plugins.backgroundaudio"],dependencies:["BackgroundMode"],featureObject:!0,name:"Background Audio"},Geo:{cordovaPlugins:["cordova-plugin-geolocation"],dependencies:[],featureObject:navigator.geolocation,name:"Geolocation",test:function(e,n){n(null,"Fetching geolocation...");var i=!1;setTimeout(function(){i||n("Failed to fetch geolocation after 30 seconds!")},3e4),navigator.geolocation.getCurrentPosition(function(e){e="Latitude: "+e.coords.latitude+", Longitude: "+e.coords.longitude;n(null,e),n(null,"Test Successfull!"),i=!0},function(e){e="Code: "+e.code+", Message: "+e.message+", ";n(e)})}},BackgroundMode:{cordovaPlugins:["cordova-plugin-background-mode"],dependencies:[],featureObject:!!("undefined"!=typeof bridge&&bridge&&bridge.capabilities&&bridge.capabilities.backgroundMode),name:"Background Mode"},Calendar:{cordovaPlugins:["cordova-plugin-calendar"],dependencies:[],featureObject:!!(window&&window.capabilities&&window.capabilities.calendar),name:"Calendar"},LocalNotifications:{cordovaPlugins:["cordova-plugin-local-notification","@moodlehq/cordova-plugin-local-notification"],dependencies:[],featureObject:!!("undefined"!=typeof bridge&&bridge&&bridge.capabilities&&bridge.capabilities.notification&&bridge.capabilities.notification.local),name:"Local Notification",test:function(e,i){var o=new LocalNotificationsAPI({}),n={title:"Test notification",text:"Test notification"};i(null,"Checking permissions");function t(){i(null,"Sending local notification"),o.schedule(n,function(e,n){return e?i("Error while scheduling notification "):void i(null,"Sent local notification")})}o.checkPermission(null,function(e,n){return e?i("Error while checking permission "):n?(i(null,"Permissions granted!"),t()):(n||i(null,"Permission not granted, requesting..."),void o.requestPermission(null,function(e,n){return e?i("Error while requesting permission "):void(n&&(i(null,"Permissions granted!"),t()))}))})}},Sharing:{cordovaPlugins:["cordova-plugin-x-socialsharing"],dependencies:[],featureObject:!!(window&&window.capabilities&&window.capabilities.socialsharing),name:"Sharing"},BackgroundGeo:{cordovaPlugins:["cordova-plugin-background-geolocation","cordova-plugin-mauron85-background-geolocation"],dependencies:["BackgroundMode","Geo"],featureObject:!("undefined"==typeof BackgroundGeolocation||!BackgroundGeolocation),name:"Background Geolocation",test:function(e,n){var e={enableHighAccuracy:!0,timeout:e.backgroundTrackingSeconds},i=null;n(null,"Watching position ..."),geoAPI.watchPosition(e,function(e){e&&!i&&(i=e.watchId),n(null,JSON.stringify(e))});var o=setInterval(function(){var e;(e=geoAPI.currentPosition)||n(null,"Waiting for position.."),n(null,"Timestamp: ".concat(e.timestamp)),n(null,"Latitude: ".concat(e.coords.latitude)),n(null,"Longitude: ".concat(e.coords.longitude))},1e3);setTimeout(function(){i&&geoAPI.clearWatch(i),clearInterval(o),n(null,"Stopped watching position...")},1e3*e.timeout)}},BarCodeScanner:{cordovaPlugins:["phonegap-plugin-barcodescanner"],dependencies:[],featureObject:!!("undefined"!=typeof bridge&&bridge&&bridge.capabilities&&bridge.capabilities.barcodeScanner),name:"Barcode Scanner"},BLE:{cordovaPlugins:["cordova-plugin-ble-central"],dependencies:[],featureObject:!!window.ble,name:"BLE - Bluetooth Low Energy",test:function(e,i){var n=new BleCentralAPI;i(null,"Checking if bluetooth is enabled.."),n.isEnabled(function(e,n){e?i(e):n?(i(null,"Bluetooth is enabled"),o()):i("Bluetooth is disabled, please enable bluetooth!")});var o=function(){i(null,"Scanning for devices..."),n.startScan({services:[],seconds:5},function(e){i(e)}),setTimeout(function(){i(null,"Stopped scanning."),n.stopScan({services:[],seconds:5},function(e){i(e)})},15e3)};n.onDeviceDiscovered=function(e){i(null,"Device discovered - id: "+e.id)}}},IAP:{cordovaPlugins:["cordova-plugin-purchase","cc.fovea.cordova.purchase"],dependencies:[],featureObject:!("undefined"==typeof store),name:"In app purchases",test:function(e,t){_objectDestructuringEmpty(e);function a(i,o){inAppPurchaseAPI.checkIsPurchased({type:i,name:o.name},function(e,n){e?t(JSON.stringify(e)+" - "+o.name):t(null,{isPurchased:{name:o.name,result:n,type:i}})})}var r=!1,c=0;!function(){t(null,"Fetching products...");var e=setInterval(function(){inAppPurchaseAPI.getProducts({},function(e,n){if(0<c&&t(null,"Retrying..."),c++,e)t(JSON.stringify(e));else{t(null,{products:n});for(var i=0;i<n.length;i++){var o=n[i];a("product",o)}r=!0}}),r?clearInterval(e):10==c&&(clearInterval(e),t("Store not ready after 10 seconds!"))},1e3)}(),t(null,"Fetching subscriptions..."),inAppPurchaseAPI.getSubscriptions({},function(e,n){if(e)t(JSON.stringify(e));else{t(null,{subscription:n});for(var i=0;i<n.length;i++){var o=n[i];a("subscriptions",o)}}})}},PushNotifications:{cordovaPlugins:["cordova-plugin-firebase-messaging","phonegap-plugin-push"],dependencies:[],featureObject:!("undefined"==typeof PushNotification)||"undefined"!=typeof bridge&&bridge.capabilities&&bridge.capabilities.firebase&&bridge.capabilities.firebase.messaging,name:"Push Notifications",check:function(e,n){"undefined"!=typeof bridge&&bridge.capabilities&&bridge.capabilities.diagnostic?bridge.capabilities.diagnostic.isRemoteNotificationsEnabled(function(e){n(null,{hasPermission:e,canRequestPermission:!e})},function(){n(null,{hasPermission:null,canRequestPermission:!1})}):n(null,{hasPermission:null,canRequestPermission:!1})},requestPermission:function(e,n){"undefined"!=typeof bridge&&bridge.capabilities&&bridge.capabilities.diagnostic?bridge.capabilities.diagnostic.switchToSettings(function(e){n(null,!0)},function(){n(null,!1)}):n(null,!1)},test:function(e,i){var o="string"!=typeof(o=e.pushNotificationsSeconds)?5:Number(o),t="app-diagnostics-tool"+ +new Date+Math.random(),a=new PushNotificationsAPI({instanceId:"1ea16635-2d95-4632-a555-633ee1cf6b1e-1614118223290"});i(null,"Initiating Push Notifications API");var e=+new Date+1e3*o,r={title:"Test Notification",text:"Test Notification",groupName:t,at:e,inAppMessage:"Test Message"};a.subscribe({groupName:t},function(e,n){return e?i(e):(i(null,"Subscribed to group"),a.schedule(r,function(e,n){e&&i(e),i(null,"Scheduled a push notification in "+o+" seconds.")}),void setTimeout(function(){a.unsubscribe({groupName:t},function(e,n){return e?i(e):void i(null,"Unsubscribed from group")})},1e3*(o+10)))})}}},getPlugins:function(){if("undefined"==typeof bridge)return[];if(bridge.capabilitiesManifest){var e,n={},i=this.getBuildInfo().buildVersion;for(e in bridge.capabilitiesManifest)n[bridge.capabilitiesManifest[e].featureName]=i;return n}var o=bridge.require&&bridge.require("cordova/plugin_list");if(!o)return[];o=o.metadata;return o},checkFeature:function(e,o){if(!bfUtils.isMobileDevice)return o("diagnostics can be used on devices only");if(!e)return o("options not provided");if(!e.name)return o("options name not provided");var n=this.features[e.name];if(!n)return o("feature does not exist");this._checkFeaturePresence(e,function(e,i){return e?o(e):void(i.present?n.check?n.check(null,function(e,n){i.hasPermission=n.hasPermission,i.canRequestPermission=n.canRequestPermission,o(null,i)}):(i.hasPermission=null,i.canRequestPermission=!1,o(null,i)):(i.hasPermission=!1,i.canRequestPermission=!1,o(null,i)))})},_checkFeaturePresence:function(e,t){var n=this,i=this.features[e.name];if(!i)return t("feature does not exist");for(var a={name:e.name,present:null,dependencies:[]},o=0;o<i.cordovaPlugins.length;o++){var r=i.cordovaPlugins[o];if(a.enabled=this.checkBridgeCapability({pluginId:r,featureName:e.name}),a.enabled)break}if(a.present=!!i.featureObject,0<i.dependencies.length){var c=0;return function i(o){n.checkFeature({name:o[c]},function(e,n){return n.name=o[c],a.dependencies.push(n),++c<o.length?void i(o):t(null,a)})}(i.dependencies)}return t(null,a)},requestFeaturePermission:function(e,n){if(!bfUtils.isMobileDevice)return n("diagnostics can be used on devices only");if(!e)return n("options not provided");if(!e.name)return n("options name not provided");var i=this.features[e.name];return i?i.requestPermission?void i.requestPermission(e,n):n("feature does not have requestPermission"):n("feature does not exist")},checkBridgeCapability:function(e){var n=e.pluginId,i=e.featureName;if(bridge.capabilitiesManifest){for(var o in bridge.capabilitiesManifest)if(bridge.capabilitiesManifest[o].featureName==i)return!0;return!1}if(bfUtils.isAndroid&&"nl.x-services.plugins.backgroundaudio"==n)return!0;if("undefined"==typeof bridge)return!1;var t=bridge.require&&bridge.require("cordova/plugin_list");if(!t)return!1;if(t.metadata[n])return!0;for(var a=0;a<t.length;a++){var r=t[a];if(r&&r.pluginId==n)return!0}return!1},getBuildInfo:function(){var e={content:""};return{bundleId:(document.getElementsByName("bundle-id")[0]||e).content,release:(document.getElementsByName("release")[0]||e).content,buildVersion:(document.getElementsByName("universal-app-version")[0]||e).content,builderVersion:(document.getElementsByName("build-version")[0]||e).content,buildTime:(document.getElementsByName("build-time")[0]||e).content}}};