...
"use strict";function _typeof(i){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(i){return typeof i}:function(i){return i&&"function"==typeof Symbol&&i.constructor===Symbol&&i!==Symbol.prototype?"symbol":typeof i})(i)}var imageTools={get ENUMS(){return{SIZES:{xxs:32,xs:64,s:128,m:200,l:304,xl:416,xxl:600,720:720,1080:1080,1440:1440,1920:1920,2560:2560,3840:3840,get full_width(){return this.findNearest(1)},get half_width(){return this.findNearest(2)},get third_width(){return this.findNearest(3)},get fourth_width(){return this.findNearest(4)},get fifth_width(){return this.findNearest(5)},get sixth_width(){return this.findNearest(6)},findNearest:function(i){for(var e=null,t=0;t<this.VALID_SIZES.length;t++){var n=this.VALID_SIZES[t];if(window.innerWidth/i<this[n]){e=n;break}}return this[e]},VALID_SIZES:["xxs","xs","s","m","l","xl","xxl","720","1080","1440","1920","2560","3840","full_width","half_width","third_width","quarter_width","fifth_width","sixth_width"]},ASPECT_RATIOS:{"1:1":1,"4:3":.75,"16:9":.5625,"9:16":1.77777778,"11:5":.45454545,"4:1":.25,"2.39:1":.41841004,VALID_RATIOS:["1:1","4:3","16:9","9:16","11:5","4:1","2.39:1"]}}},resizeImage:function(i,e,t,n){if(!i)return null;if(i&&i.indexOf&&(-1<i.indexOf("://localhost:")||-1<i.indexOf("cdvfile://"))||-1<i.indexOf("file://"))return i;if(/\..{3,4}(?!.)/g.test(i)&&!/.(png|jpg|jpeg|gif|jfif|svg)(?!.)/gi.test(i)){var r=(/.{0,4}(?!.)/g.exec(i)||["Selected"])[0];return console.warn(r+" files are not supported by resizeImage. Returning original URL: "+i),i}if(e){if("object"!=_typeof(e))throw"options not an object"}else e={width:window.innerWidth};r=e.disablePixelRation?1:window.devicePixelRatio;if(r<1&&(r=1),"full"==e.width&&(e.width=window.innerWidth),"full"==e.height&&(e.height=window.innerHeight),window.forceImgix){if(!(o=imageTools._prepareImgixUrl(i)))return i}else o=window.siteConfig.endPoints.cloudImageHost+"/"+i;var o=o+(-1!==i.indexOf("?")?"&":"?")+(window.forceImgix?"":"func=bound");if(e.size&&e.aspect){if(this.ENUMS.SIZES.VALID_SIZES.indexOf(e.size)<0){var a=this.ENUMS.SIZES.VALID_SIZES.join(", ");return console.warn("Inavlid size. Availible options are "+a+". Returning original url"),i}if(this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.indexOf(e.aspect)<0){a=this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.join(", ");return console.warn("Inavlid aspect ratio. Availible options are "+a+". Returning original url"),i}e.width=this.ENUMS.SIZES[e.size],e.height=e.width*this.ENUMS.ASPECT_RATIOS[e.aspect]}return e.width&&!e.height?o+="&width="+Math.floor(e.width*r):!e.width&&e.height?o+="&height="+Math.floor(e.height*r):e.width&&e.height?o+="&width="+Math.floor(e.width*r)+"&height="+Math.floor(e.height*r):o=i,this._handleElement(t,o,n),o},cropImage:function(i,e,t,n){if(!i)return null;if(i&&i.indexOf&&(-1<i.indexOf("://localhost:")||-1<i.indexOf("cdvfile://"))||-1<i.indexOf("file://"))return i;if(/\..{3,4}(?!.)/g.test(i)&&!/.(png|jpg|jpeg|gif|jfif|svg)(?!.)/gi.test(i)){var r=(/.{0,4}(?!.)/g.exec(i)||["Selected"])[0];return console.warn(r+" files are not supported by cropImage. Returning original URL: "+i),i}if("object"!=_typeof(e=e||{}))throw"options not an object";if(e.size&&e.aspect){if(this.ENUMS.SIZES.VALID_SIZES.indexOf(e.size)<0){r=this.ENUMS.SIZES.VALID_SIZES.join(", ");return console.warn("Inavlid size. Availible options are "+r+". Returning original url"),i}if(this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.indexOf(e.aspect)<0){var o=this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.join(", ");return console.warn("Inavlid aspect ratio. Availible options are "+o+". Returning original url"),i}e.width=this.ENUMS.SIZES[e.size],e.height=e.width*this.ENUMS.ASPECT_RATIOS[e.aspect]}if("full"==(e=!e.width&&!e.height?{width:"full",height:"full"}:e).width&&(e.width=window.innerWidth),"full"==e.height&&(e.height=window.innerHeight),!e.width||!e.height)return console.warn("cropImage doenst have width or height please fix. returning original url"),i+"?h="+e.height+"&w="+e.width;o=window.devicePixelRatio;if(e&&e.disablePixelRatio&&(o=e.disablePixelRatio),window.forceImgix){if(!(a=imageTools._prepareImgixUrl(i)))return i}else a=window.siteConfig.endPoints.cloudImageHost+"/"+i;var a=a+(-1!==i.indexOf("?")?"&":"?")+(window.forceImgix?"fit=crop":"func=crop"),i=Math.floor(e.width*o),o=Math.floor(e.height*o);return this._handleElement(t,a+="&width="+i+"&height="+o,n),a},_handleElement:function(t,n,i){var e;t&&n&&(e=this._getLocalPath(n),"IMG"===t.tagName?(t.style.setProperty("opacity","0","important"),t.src=e,t.onload=function(){t.style.removeProperty("opacity"),i&&i(e)},t.onerror=function(){bfUtils.isApp&&imageCacheAPI.download(n,function(i,e){return i?t.src=n:void(t.src=e)})}):this._handleBgImage(t,e,n,i))},_prepareImgixUrl:function(i){var e;return 0==(i=i.replace(/^https:\/\//i,"http://")).indexOf("http://imageserver.prod.s3.amazonaws.com")?e="https://buildfire.imgix.net"+i.split("imageserver.prod.s3.amazonaws.com")[1]:0==i.indexOf("http://s3-us-west-2.amazonaws.com/imageserver.prod")?e="https://buildfire.imgix.net"+i.split("imageserver.prod")[1]:0==i.indexOf("http://pluginserver.buildfire.com")?e="https://bfplugins.imgix.net"+i.split("pluginserver.buildfire.com")[1]:0<i.indexOf("Kaleo.DevBucket/")?e="https://bflegacy.imgix.net"+i.split("Kaleo.DevBucket")[1]:0==i.indexOf("http://s3-us-west-2.amazonaws.com/imagelibserver")?e="https://buildfire-uat.imgix.net"+i.split("imagelibserver")[1]:0==i.indexOf("http://s3-us-west-2.amazonaws.com/pluginserver.uat")&&(e="https://bfplugins-uat.imgix.net"+i.split("pluginserver.uat")[1]),e},_handleBgImage:function(t,i,n,r){o(t,i);var e=new Image;function o(i,e){if(!e)return i.style.removeProperty("background-image");i.style.setProperty("background-image",'url("'+e+'")',"important")}e.src=i,e.onload=function(){r&&r(i)},e.onerror=function(){if(o(t),!bfUtils.isApp)return o(t,n);imageCacheAPI.download(n,function(i,e){return i?(r&&r(n),o(t,n)):void window.requestAnimationFrame(function(){o(t,e),r&&r(e)})})}},_getLocalPath:function(i){if(!bfUtils.isApp)return i;var e=(e=(i=i.replace(/(http|https):\/\/\S{0,8}.cloudimg.io\//g,"")).match(/(png|jpg|jpeg|gif|jfif|svg)/g)[0]||"")?"."+e:"",t=0;if(!i.length)return t;for(var n=0;n<i.length;n++){t=(t<<5)-t+i.charCodeAt(n);t|=0}return"".concat(window._appRoot.replace("app","imageCache/images")).concat(t).concat(e)},isProdImageServer:function(i){return 0==i.indexOf("http://imageserver.prod.s3.amazonaws.com")||0==i.indexOf("https://imageserver.prod.s3.amazonaws.com")||0==i.indexOf("https://s3-us-west-2.amazonaws.com/imageserver.prod")}};
