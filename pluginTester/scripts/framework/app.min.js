...
"use strict";function PublicFilesAPI(e){this.context=e,this.currentUser=null}PublicFilesAPI.prototype={getFileUrl:function(r,o){var a=this.context.appId;authAPI.getCurrentUser(function(e,t){if(e)return o(e);var n=void 0;t&&(n=t.accessToken);var i=r.fileId,s=new XMLHttpRequest;s.addEventListener("readystatechange",function(){4===this.readyState&&o(null,JSON.parse(this.responseText))}),s.addEventListener("error",function(e){o(e)}),s.open("GET",window.siteConfig.endPoints.publicFilesHost+"/file/"+i+"/?appId="+a+"&returnUrl=true"),s.setRequestHeader("Authorization",n),s.send()})},modifyPermissions:function(a,l){var u=this.context.appId;authAPI.getCurrentUser(function(e,t){if(e)return l(e);var n=void 0;t&&(n=t.accessToken);var i=a.fileId,s=a.permissions,r=JSON.stringify({permissions:s,appId:u}),o=new XMLHttpRequest;o.addEventListener("readystatechange",function(){4===this.readyState&&l(null,JSON.parse(this.responseText))}),o.addEventListener("error",function(e){l(e)}),o.open("PATCH",window.siteConfig.endPoints.publicFilesHost+"/file/"+i),o.setRequestHeader("Content-Type","application/json"),o.setRequestHeader("Authorization",n),o.send(r)})},deleteFile:function(r,o){authAPI.getCurrentUser(function(e,t){if(e)return o(e);var n=void 0;t&&(n=t.accessToken);var i=r.fileId,s=new XMLHttpRequest;s.addEventListener("readystatechange",function(){4===this.readyState&&o(null,JSON.parse(this.responseText))}),s.addEventListener("error",function(e){o(e)}),s.open("DELETE",window.siteConfig.endPoints.publicFilesHost+"/file/"+i),s.setRequestHeader("Authorization",n),s.send()})},showDialog:function(e,t){e||(e={});var n,i=this;(n=document.getElementById("publicFiles_input_form"))?n.innerHTML="":((n=document.createElement("form")).setAttribute("id","publicFiles_input_form"),document.body.appendChild(n));var s=document.createElement("input");s.setAttribute("type","file"),s.setAttribute("style","display:none"),s.setAttribute("id","publicFilesHiddenInput"+(new Date).toISOString()),n.appendChild(s),e&&e.allowMultipleFilesUpload&&(s.setAttribute("multiple",""),s.setAttribute("name","files[]")),e&&e.filter&&(s.accept=e.filter.join(",")),s.addEventListener("change",function(){i.uploadFiles(this.files,e,t)},!1),s.click()},uploadFilesManually:function(e,t){this.uploadFiles(e.files,e,t)},uploadFiles:function(n,l,i){var s=[],r=[],u=this;i||"function"!=typeof l||(i=l,l={}),l||(l={});var p=new AnalyticsAPI(u.context.appId,u.context.pluginId,u.context.instanceId,window.appContext.liveMode);function o(o,a){return new Promise(function(n,e){var t=!0;if(l.filter&&!function(e,t){for(var n=0;n<=t.length;n++)if(t[n]==e.type)return!0;return!1}(o,l.filter)&&(a.status="failed",a.error="invalid File Format",u._onComplete&&u._onComplete(a),t=!1,n(a)),262144e3<o.size&&(a.status="failed",a.error="invalid File Size",u._onComplete&&u._onComplete(a),t=!1,n(a)),t){var i=new FormData;i.append("pluginId",u.context.pluginId),i.append("instanceId",u.context.instanceId),i.append("appId",u.context.appId),l.permissions&&i.append("permissions",JSON.stringify(l.permissions)),u.currentUser&&u.currentUser.accessToken&&i.append("accessToken",u.currentUser.accessToken),i.append("file",o);var s=new XMLHttpRequest,r=function(e){if(e.lengthComputable){var t=Math.round(100*e.loaded/e.total);a.percentage=t,u._onProgress&&u._onProgress(a)}};bfUtils.isMobileDevice?s.upload.onprogress=r:s.upload.addEventListener("progress",r,!1),s.onload=function(){var e=null;if(s.responseText)try{e=JSON.parse(s.responseText)}catch(e){}if(200==s.status){a.url=e.url,a.size=e.size,a.type=e.type,a.fileId=e.fileId,a.status="success";var t={data:{url:e.url,size:e.size,type:e.type},_buildfire:{aggregationValue:e.size}};"app"==window.siteConfig.scope?p.trackAction("app/publicFilesUpload",t):p.trackAction("cp/publicFilesUpload",t)}else a.status="failed",e.message?a.error=e.message:a.error="An error has occurred";u._onComplete&&u._onComplete(a),n(a)},s.onerror=function(){a.status="failed",u._onComplete&&u._onComplete(a),n(a)},s.timeout=6e4,s.open("POST",window.siteConfig.endPoints.publicFilesHost+"/file/upload/"),s.send(i)}})}authAPI.getCurrentUser(function(e,t){if(e)return i(e);t&&(u.currentUser=t),function(e){for(var t=0;t<e.length;t++){var n={fileId:t,filename:e[t].name};e[t].fileId=t,r.push(n),s.push(o(e[t],n))}Promise.all(s).then(function(e){i(null,e)}).catch(function(){i(!0,null)})}(n)})},onProgress:function(e){this._onProgress=e},onComplete:function(e){this._onComplete=e}};
