...
"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}"undefined"==typeof AiAPI&&(window.AiAPI=function(t){this.context=t}),AiAPI.prototype.chat=function(t,e){(t=!t||"object"!=_typeof(t)?{}:t).appId=window.appContext.currentApp.appId;t={url:"".concat(window.siteConfig.endPoints.gatewayHost,"/ai/chat"),headers:{"Content-Type":"application/json"},body:JSON.stringify(t),method:"POST"};fetch(t.url,{method:t.method,headers:t.headers,body:t.body}).then(function(t){return t.ok?t.json().then(function(t){return t}):t.json().then(function(t){var e=t.innerError||{},t={code:e.code,message:e.message,error:e.error};throw e.aiStatus&&(t.aiStatus=e.aiStatus),t})}).then(function(t){e(null,t)}).catch(function(t){t&&t.code&&t.message?e(t,null):e({code:"unknownError",message:"Unable to process your request"},null)})},AiAPI.prototype.showSeederMessagePrompt=function(t,e){var o=t.userMessage,t=t.showClearDataWarning;richModal.display({isContentHTML:!0,title:"Generate AI Data",richContent:"<p>You can customize the following AI request. ".concat(t?'<span class="text-warning">Warning:</span> Existing data will be cleared.':"",'</p><textarea class="form-control margin-top-ten" id="aiDataRequest">').concat(o,"</textarea>"),showDismissButton:!0,forceShow:!0,action:{title:"OK",handler:function(){var t=document.querySelector("#aiDataRequest");e(null,{userMessage:t.value})}}})},AiAPI.prototype.showSeederCSVPrompt=function(t,e){var o=t.sampleCSV,n=[{title:"OK",type:"success",handler:function(){var t=document.querySelector("#aiDataRequest");e(null,{sampleCSV:t.value,reset:!1})}}];t.showResetAndSaveButton&&n.unshift({type:"warning",title:"Reset And Save",handler:function(){var t=document.querySelector("#aiDataRequest");e(null,{sampleCSV:t.value,reset:!0})}}),richModal.display({isContentHTML:!0,title:"AI Import Data",richContent:'<p>I have the following comma separated records:</p><textarea class="form-control margin-top-ten" id="aiDataRequest">'.concat(o,"</textarea>"),showDismissButton:!0,forceShow:!0,action:n})};