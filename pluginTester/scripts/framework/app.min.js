...
"use strict";var imagePreviewerAPI={show:function(e,i){i=i||Function.prototype;var a=0<=e.index?e.index:0;e&&e.images&&e.images.length?(e.images=e.images.map(function(e){return{imageSrc:e}}),mediaPreviewerAPI.showMedia({media:e.images,index:a,enableDownload:!1,enableShare:!1},i)):i("Error: No images provided",null)}};
