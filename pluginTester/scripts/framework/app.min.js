...
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}"undefined"==typeof AiAPI&&(window.AiAPI=function(e){this.context=e}),AiAPI.prototype.chat=function(e,t){(e=!e||"object"!=_typeof(e)?{}:e).appId=window.appContext.currentApp.appId;e={url:"".concat(window.siteConfig.endPoints.gatewayHost,"/ai/chat"),headers:{"Content-Type":"application/json"},body:JSON.stringify(e),method:"POST"};fetch(e.url,{method:e.method,headers:e.headers,body:e.body}).then(function(e){return e.ok?e.json().then(function(e){return e}):e.json().then(function(e){var t=e.innerError||{},e={code:t.code,message:t.message,error:t.error};throw t.aiStatus&&(e.aiStatus=t.aiStatus),e})}).then(function(e){t(null,e)}).catch(function(e){e&&e.code&&e.message?t(e,null):t({code:"unknownError",message:"Unable to process your request"},null)})},AiAPI.prototype.showSeederMessagePrompt=function(e,n){var t=e.userMessage,e=e.showClearDataWarning;new DialogAPI(this.context)._show({isMessageHTML:!0,title:"Generate AI Data",message:"<p>You can customize the following AI request. ".concat(e?'<span class="text-warning">Warning:</span> Existing data will be cleared.':"",'</p><textarea style="text-wrap: nowrap;" class="form-control margin-top-ten" id="aiDataRequest">').concat(t,"</textarea>"),showCancelButton:!0,actionButtons:[{text:"Save",type:"success"}]},function(e,t){var o;return e?n(e):void("success"===(null==t||null===(o=t.selectedButton)||void 0===o?void 0:o.type)&&(o=document.querySelector("#aiDataRequest"),n(null,{userMessage:o.value})))})},AiAPI.prototype.showSeederCSVPrompt=function(e,n){var t=e.sampleCSV,o=e.showResetAndSaveButton,a=new DialogAPI(this.context),e=[{text:"Save",type:"success"}];o&&e.unshift({type:"warning",text:"Reset And Save"}),a._show({isMessageHTML:!0,title:"AI Import Data",message:'<p>I have the following comma separated records:</p><textarea style="text-wrap: nowrap;" class="form-control margin-top-ten" id="aiDataRequest">'.concat(t,"</textarea>"),showCancelButton:!0,actionButtons:e},function(e,t){var o;return e?n(e):void(["warning","success"].includes(null==t||null===(o=t.selectedButton)||void 0===o?void 0:o.type)&&(o=t.selectedButton.type,t=document.querySelector("#aiDataRequest"),n(null,{sampleCSV:t.value,reset:"warning"===o})))})};