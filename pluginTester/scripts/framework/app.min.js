...
"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}"undefined"==typeof AiAPI&&(window.AiAPI=function(t){this.context=t}),AiAPI.prototype.chat=function(t,e){(t=!t||"object"!=_typeof(t)?{}:t).appId=window.appContext.currentApp.appId;t={url:"".concat(window.siteConfig.endPoints.gatewayHost,"/ai/chat"),headers:{"Content-Type":"application/json"},body:JSON.stringify(t),method:"POST"};fetch(t.url,{method:t.method,headers:t.headers,body:t.body}).then(function(t){return t.ok?t.json().then(function(t){return t}):t.json().then(function(t){var e=t.innerError||{},t={code:e.code,message:e.message,error:e.error};throw e.aiStatus&&(t.aiStatus=e.aiStatus),t})}).then(function(t){e(null,t)}).catch(function(t){t&&t.code&&t.message?e(t,null):e({code:"unknownError",message:"Unable to process your request"},null)})},AiAPI.prototype.showSeederMessagePrompt=function(t,n){var e=t.userMessage,t=t.showClearDataWarning;new DialogAPI(this.context)._show({isMessageHTML:!0,title:"Generate AI Data",message:"<p>You can customize the following AI request. ".concat(t?'<span class="text-warning">Warning:</span> Existing data will be cleared.':"",'</p><textarea class="form-control margin-top-ten" id="aiDataRequest">').concat(e,"</textarea>"),showCancelButton:!0,actionButtons:[{text:"OK",type:"success"}]},function(t,e){var o;return t?n(t):void("success"===(null==e||null===(o=e.selectedButton)||void 0===o?void 0:o.type)&&(o=document.querySelector("#aiDataRequest"),n(null,{userMessage:o.value})))})},AiAPI.prototype.showSeederCSVPrompt=function(t,n){var e=t.sampleCSV,o=t.showResetAndSaveButton,a=new DialogAPI(this.context),t=[{text:"OK",type:"success"}];o&&t.unshift({type:"warning",text:"Reset And Save"}),a._show({isMessageHTML:!0,title:"AI Import Data",message:'<p>I have the following comma separated records:</p><textarea class="form-control margin-top-ten" id="aiDataRequest">'.concat(e,"</textarea>"),showCancelButton:!0,actionButtons:t},function(t,e){var o;return t?n(t):void(null!=e&&null!==(o=e.selectedButton)&&void 0!==o&&o.type&&(o=e.selectedButton.type,e=document.querySelector("#aiDataRequest"),n(null,{sampleCSV:e.value,reset:"warning"===o})))})};