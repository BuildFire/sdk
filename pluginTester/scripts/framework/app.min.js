...
"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}"undefined"==typeof AiAPI&&(window.AiAPI=function(t){this.context=t,this.transformVariables=function(e){var n={"[app-interests]":"[Travel planning]","[subject]":"[Travel planning]","[business-type]":"[Travel planning]","[app-name]":"[".concat(window.appContext.currentApp.appName,"]"),"[target-region]":"[San Diego]"};return Object.freeze(n),Object.keys(n).forEach(function(t){e=e.replaceAll(t,n[t])}),e}}),AiAPI.prototype.chat=function(t,e){(t=!t||"object"!=_typeof(t)?{}:t).appId=window.appContext.currentApp.appId;t={url:"".concat(window.siteConfig.endPoints.gatewayHost,"/ai/chat"),headers:{"Content-Type":"application/json"},body:JSON.stringify(t),method:"POST"};fetch(t.url,{method:t.method,headers:t.headers,body:t.body}).then(function(t){return t.ok?t.json().then(function(t){return t}):t.json().then(function(t){var e=t.innerError||{},t={code:e.code,message:e.message,error:e.error};throw e.aiStatus&&(t.aiStatus=e.aiStatus),t})}).then(function(t){e(null,t)}).catch(function(t){t&&t.message&&t.code&&"unknownerror"!==t.code.toLowerCase()?e(t,null):e({code:"unknownError",message:"Unable to process your request"},null)})},AiAPI.prototype.showSeederMessagePrompt=function(t,o){var e=t.userMessage,n=t.showClearDataWarning,a=t.hintText;if("string"!=typeof e)return o("Invalid parameter 'userMessage'. It must be a valid string.");t=new DialogAPI(this.context),e=this.transformVariables(e);t._show({isMessageHTML:!0,title:"Generate AI Data",message:"".concat(n?'<p class="info-note background-info margin-bottom-twenty"><span class="text-warning">Warning: Existing data will be overwritten</span></p>':"",'<p>You can customize the following AI request. </p><textarea style="text-wrap: nowrap;" class="form-control margin-top-ten" id="aiDataRequest">').concat(e,"</textarea> ").concat(a?'<span style="color: #b0b0b0;display: block;margin-top: 5px;margin-bottom: 10px; font-size: 12px;">'+a+"</span>":""),showCancelButton:!0,actionButtons:[{text:"Generate",type:"success"}]},function(t,e){var n;return t?o(t):void("success"===(null==e||null===(n=e.selectedButton)||void 0===n?void 0:n.type)&&(n=document.querySelector("#aiDataRequest"),o(null,{userMessage:n.value})))})},AiAPI.prototype.showSeederCSVPrompt=function(t,o){var e=t.sampleCSV,n=t.showResetAndSaveButton,a=t.hintText;if("string"!=typeof e)return o("Invalid parameter 'sampleCSV'. It must be a valid string.");var r=new DialogAPI(this.context),t=[{text:"Save",type:"success"}];n&&t.unshift({type:"warning",text:"Reset And Save"}),r._show({isMessageHTML:!0,title:"AI Import Data",message:'<p>I have the following comma separated records:</p><textarea style="text-wrap: nowrap; height: 175px;" class="form-control margin-top-ten" id="aiDataRequest">'.concat(e,"</textarea>").concat(a?'<span style="color: #b0b0b0;display: block;margin-top: 5px;margin-bottom: 10px; font-size: 12px;">'+a+"</span>":""),showCancelButton:!0,actionButtons:t},function(t,e){var n;return t?o(t):void(["warning","success"].includes(null==e||null===(n=e.selectedButton)||void 0===n?void 0:n.type)&&(n=e.selectedButton.type,e=document.querySelector("#aiDataRequest"),o(null,{sampleCSV:e.value,reset:"warning"===n})))})};