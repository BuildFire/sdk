...
"use strict";function PublicFilesAPI(e){this.context=e}PublicFilesAPI.prototype={showDialog:function(l,o){l||(l={});var a=this,i=[],s=[],u=null;function r(s,r){return new Promise(function(t,e){var n=!0;if(l.filter&&!function(e,t){for(var n=0;n<=t.length;n++)if(t[n]==e.type)return!0;return!1}(s,l.filter)&&(r.status="failed",r.error="invalid File Format",a._onComplete&&a._onComplete(r),n=!1,t(r)),1e7<s.size&&(r.status="failed",r.error="invalid File Size",a._onComplete&&a._onComplete(r),n=!1,t(r)),n){var o=new FormData;o.append("file",s),o.append("pluginId",a.context.pluginId),o.append("instanceId",a.context.instanceId),o.append("appId",a.context.appId),u&&u.accessToken&&o.append("accessToken",u.accessToken);var i=new XMLHttpRequest;i.upload.addEventListener("progress",function(e){if(e.lengthComputable){var t=Math.round(100*e.loaded/e.total);r.percentage=t,a._onProgress&&a._onProgress(r)}},!1),i.onload=function(){var e=null;i.responseText&&(e=JSON.parse(i.responseText)),200==i.status?(r.url=e.url,r.status="success"):(r.status="failed",e.message?r.error=e.message:r.error="An error has occurred"),a._onComplete&&a._onComplete(r),t(r)},i.onerror=function(){r.status="failed",a._onComplete&&a._onComplete(r),t(r)},i.timeout=6e4,i.open("POST",window.siteConfig.endPoints.publicFilesHost+"/publicFiles/upload/"),i.send(o)}})}function p(){!function(e){for(var t=0;t<e.length;t++){var n={fileId:t,filename:e[t].name};e[t].fileId=t,s.push(n),i.push(r(e[t],n))}Promise.all(i).then(function(e){console.log(e),o(null,e)})}(this.files)}window.authAPI.getCurrentUser(function(e,t){t&&(u=t);var n=document.createElement("input");n.setAttribute("type","file"),n.setAttribute("style","display:none"),n.setAttribute("id","publicFilesHiddenInput"+(new Date).toISOString()),document.body.appendChild(n),l&&l.allowMultipleFilesUpload&&(n.setAttribute("multiple",""),n.setAttribute("name","files[]")),l&&l.filter&&(n.accept=l.filter.join(",")),n.addEventListener("change",p,!1),setTimeout(function(){n.click()})})},onProgress:function(e){this._onProgress=e},onComplete:function(e){this._onComplete=e}};
"use strict";var imagePreviewerAPI={show:function(t,s){this.initialized||this.renderHTML();var o=document.querySelectorAll(".pswp")[0];s=s||Function.prototype;var i={index:0<=t.index?t.index:0,counterEl:!1,captionEl:!1,fullscreenEl:!1,zoomEl:!1,arrowEl:!1,preloaderEl:!1,shareEl:!1,tapToToggleControls:!1},p=PhotoSwipeUI_Default,e=[];t.images.forEach(function(t){var s=new Image,n=new Promise(function(n,e){s.src=t,s.addEventListener("load",function(){n(s)},!1)});e.push(n)}),Promise.all(e).then(function(n){var e=n.map(function(n,e){return{src:t.images[e],w:n.naturalWidth,h:n.naturalHeight}});window.pswp=new PhotoSwipe(o,p,e,i),window.pswp.listen("close",function(){window.pswp.destroy&&window.pswp.destroy(),s(null,null)}),window.pswp.init()})},renderHTML:function(){var n=document.createElement("div");n.style.position="relative",n.style.zIndex=99999999,n.innerHTML='\n    \x3c!-- Root element of PhotoSwipe. Must have class pswp. --\x3e\n    <div class="pswp" tabindex="-1" role="dialog" aria-hidden="true">\n\n        \x3c!-- Background of PhotoSwipe.\n             It\'s a separate element as animating opacity is faster than rgba(). --\x3e\n        <div class="pswp__bg"></div>\n\n        \x3c!-- Slides wrapper with overflow:hidden. --\x3e\n        <div class="pswp__scroll-wrap">\n\n            \x3c!-- Container that holds slides.\n                PhotoSwipe keeps only 3 of them in the DOM to save memory.\n                Don\'t modify these 3 pswp__item elements, data is added later on. --\x3e\n            <div class="pswp__container">\n                <div class="pswp__item"></div>\n                <div class="pswp__item"></div>\n                <div class="pswp__item"></div>\n            </div>\n\n            \x3c!-- Default (PhotoSwipeUI_Default) interface on top of sliding area. Can be changed. --\x3e\n            <div class="pswp__ui pswp__ui--hidden">\n\n                <div class="pswp__top-bar" style="background: transparent !important; padding-top: env(safe-area-inset-top); padding-top: const(safe-area-inset-top);">\n\n                    \x3c!--  Controls are self-explanatory. Order can be changed. --\x3e\n\n                    <div class="pswp__counter"></div>\n\n                    <span class="glyphicon glyphicon-remove pswp__button pswp__button--close" title="Close (Esc)" style="color: #FFF !important;font-size: 20pt;padding-top: 15px;">\n                    </span>\n\n                    <button class="pswp__button pswp__button--share" title="Share"></button>\n\n                    <button class="pswp__button pswp__button--fs" title="Toggle fullscreen"></button>\n\n                    <button class="pswp__button pswp__button--zoom" title="Zoom in/out"></button>\n\n                    \x3c!-- Preloader demo http://codepen.io/dimsemenov/pen/yyBWoR --\x3e\n                    \x3c!-- element will get class pswp__preloader--active when preloader is running --\x3e\n                    <div class="pswp__preloader">\n                        <div class="pswp__preloader__icn">\n                          <div class="pswp__preloader__cut">\n                            <div class="pswp__preloader__donut"></div>\n                          </div>\n                        </div>\n                    </div>\n                </div>\n\n                <div class="pswp__share-modal pswp__share-modal--hidden pswp__single-tap">\n                    <div class="pswp__share-tooltip"></div>\n                </div>\n\n                <button class="pswp__button pswp__button--arrow--left" title="Previous (arrow left)">\n                </button>\n\n                <button class="pswp__button pswp__button--arrow--right" title="Next (arrow right)">\n                </button>\n\n                <div class="pswp__caption">\n                    <div class="pswp__caption__center"></div>\n                </div>\n\n            </div>\n\n        </div>\n\n    </div>\n    ',0<=window.location.pathname.indexOf("pluginTester")?document.getElementById("app").appendChild(n):document.body.appendChild(n),this.initialized=!0}};
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};!function(e,t){"function"==typeof define&&define.amd?define(t):"object"==("undefined"==typeof exports?"undefined":_typeof(exports))?module.exports=t():e.PhotoSwipe=t()}(void 0,function(){return function(m,i,e,t){var f={features:null,bind:function(e,t,n,i){var o=(i?"remove":"add")+"EventListener";t=t.split(" ");for(var a=0;a<t.length;a++)t[a]&&e[o](t[a],n,!1)},isArray:function(e){return e instanceof Array},createEl:function(e,t){var n=document.createElement(t||"div");return e&&(n.className=e),n},getScrollY:function(){var e=window.pageYOffset;return void 0!==e?e:document.documentElement.scrollTop},unbind:function(e,t,n){f.bind(e,t,n,!0)},removeClass:function(e,t){var n=new RegExp("(\\s|^)"+t+"(\\s|$)");e.className=e.className.replace(n," ").replace(/^\s\s*/,"").replace(/\s\s*$/,"")},addClass:function(e,t){f.hasClass(e,t)||(e.className+=(e.className?" ":"")+t)},hasClass:function(e,t){return e.className&&new RegExp("(^|\\s)"+t+"(\\s|$)").test(e.className)},getChildByClass:function(e,t){for(var n=e.firstChild;n;){if(f.hasClass(n,t))return n;n=n.nextSibling}},arraySearch:function(e,t,n){for(var i=e.length;i--;)if(e[i][n]===t)return i;return-1},extend:function(e,t,n){for(var i in t)if(t.hasOwnProperty(i)){if(n&&e.hasOwnProperty(i))continue;e[i]=t[i]}},easing:{sine:{out:function(e){return Math.sin(e*(Math.PI/2))},inOut:function(e){return-(Math.cos(Math.PI*e)-1)/2}},cubic:{out:function(e){return--e*e*e+1}}},detectFeatures:function(){if(f.features)return f.features;var e=f.createEl().style,t="",n={};if(n.oldIE=document.all&&!document.addEventListener,n.touch="ontouchstart"in window,window.requestAnimationFrame&&(n.raf=window.requestAnimationFrame,n.caf=window.cancelAnimationFrame),n.pointerEvent=navigator.pointerEnabled||navigator.msPointerEnabled,!n.pointerEvent){var i=navigator.userAgent;if(/iP(hone|od)/.test(navigator.platform)){var o=navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/);o&&0<o.length&&1<=(o=parseInt(o[1],10))&&o<8&&(n.isOldIOSPhone=!0)}var a=i.match(/Android\s([0-9\.]*)/),r=a?a[1]:0;1<=(r=parseFloat(r))&&(r<4.4&&(n.isOldAndroid=!0),n.androidVersion=r),n.isMobileOpera=/opera mini|opera mobi/i.test(i)}for(var l,s,u=["transform","perspective","animationName"],c=["","webkit","Moz","ms","O"],d=0;d<4;d++){t=c[d];for(var p=0;p<3;p++)l=u[p],s=t+(t?l.charAt(0).toUpperCase()+l.slice(1):l),!n[l]&&s in e&&(n[l]=s);t&&!n.raf&&(t=t.toLowerCase(),n.raf=window[t+"RequestAnimationFrame"],n.raf&&(n.caf=window[t+"CancelAnimationFrame"]||window[t+"CancelRequestAnimationFrame"]))}if(!n.raf){var m=0;n.raf=function(e){var t=(new Date).getTime(),n=Math.max(0,16-(t-m)),i=window.setTimeout(function(){e(t+n)},n);return m=t+n,i},n.caf=function(e){clearTimeout(e)}}return n.svg=!!document.createElementNS&&!!document.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect,f.features=n}};f.detectFeatures(),f.features.oldIE&&(f.bind=function(e,t,n,i){t=t.split(" ");for(var o,a=(i?"detach":"attach")+"Event",r=function(){n.handleEvent.call(n)},l=0;l<t.length;l++)if(o=t[l])if("object"==(void 0===n?"undefined":_typeof(n))&&n.handleEvent){if(i){if(!n["oldIE"+o])return!1}else n["oldIE"+o]=r;e[a]("on"+o,n["oldIE"+o])}else e[a]("on"+o,n)});var h=this,y={allowPanToNext:!0,spacing:.12,bgOpacity:1,mouseUsed:!1,loop:!0,pinchToClose:!0,closeOnScroll:!0,closeOnVerticalDrag:!0,verticalDragRange:.75,hideAnimationDuration:333,showAnimationDuration:333,showHideOpacity:!1,focus:!0,escKey:!0,arrowKeys:!0,mainScrollEndFriction:.35,panEndFriction:.35,isClickableElement:function(e){return"A"===e.tagName},getDoubleTapZoom:function(e,t){return e?1:t.initialZoomLevel<.7?1:1.33},maxSpreadZoom:1.33,modal:!0,scaleMode:"fit"};f.extend(y,t);var s,o,a,x,r,l,u,c,d,v,p,g,w,b,I,C,D,S,T,M,A,E,O,k,R,Z,P,F,L,_,z,N,U,H,Y,W,B,G,X,V,K,q,$,j,J,Q,ee,te,ne,ie,oe,ae,re,le,se,n,ue={x:0,y:0},ce={x:0,y:0},de={x:0,y:0},pe={},me=0,fe={},he={x:0,y:0},ye=0,xe=!0,ve=[],ge={},we=!1,be=function(e,t){f.extend(h,t.publicMethods),ve.push(e)},Ie=function(e){var t=Nt();return t-1<e?e-t:e<0?t+e:e},Ce={},De=function(e,t){return Ce[e]||(Ce[e]=[]),Ce[e].push(t)},Se=function(e){var t=Ce[e];if(t){var n=Array.prototype.slice.call(arguments);n.shift();for(var i=0;i<t.length;i++)t[i].apply(h,n)}},Te=function(){return(new Date).getTime()},Me=function(e){le=e,h.bg.style.opacity=e*y.bgOpacity},Ae=function(e,t,n,i,o){(!we||o&&o!==h.currItem)&&(i/=o?o.fitRatio:h.currItem.fitRatio),e[E]=g+t+"px, "+n+"px"+w+" scale("+i+")"},Ee=function(e){ne&&(e&&(v>h.currItem.fitRatio?we||(Kt(h.currItem,!1,!0),we=!0):we&&(Kt(h.currItem),we=!1)),Ae(ne,de.x,de.y,v))},Oe=function(e){e.container&&Ae(e.container.style,e.initialPosition.x,e.initialPosition.y,e.initialZoomLevel,e)},ke=function(e,t){t[E]=g+e+"px, 0px"+w},Re=function(e,t){if(!y.loop&&t){var n=x+(he.x*me-e)/he.x,i=Math.round(e-ct.x);(n<0&&0<i||n>=Nt()-1&&i<0)&&(e=ct.x+i*y.mainScrollEndFriction)}ct.x=e,ke(e,r)},Ze=function(e,t){var n=dt[e]-fe[e];return ce[e]+ue[e]+n-n*(t/p)},Pe=function(e,t){e.x=t.x,e.y=t.y,t.id&&(e.id=t.id)},Fe=function(e){e.x=Math.round(e.x),e.y=Math.round(e.y)},Le=null,_e=function e(){Le&&(f.unbind(document,"mousemove",e),f.addClass(m,"pswp--has_mouse"),y.mouseUsed=!0,Se("mouseUsed")),Le=setTimeout(function(){Le=null},100)},ze=function(e,t){var n=Bt(h.currItem,pe,e);return t&&(te=n),n},Ne=function(e){return e||(e=h.currItem),e.initialZoomLevel},Ue=function(e){return e||(e=h.currItem),0<e.w?y.maxSpreadZoom:1},He=function(e,t,n,i){return i===h.currItem.initialZoomLevel?(n[e]=h.currItem.initialPosition[e],!0):(n[e]=Ze(e,i),n[e]>t.min[e]?(n[e]=t.min[e],!0):n[e]<t.max[e]&&(n[e]=t.max[e],!0))},Ye=function(e){var t="";y.escKey&&27===e.keyCode?t="close":y.arrowKeys&&(37===e.keyCode?t="prev":39===e.keyCode&&(t="next")),t&&(e.ctrlKey||e.altKey||e.shiftKey||e.metaKey||(e.preventDefault?e.preventDefault():e.returnValue=!1,h[t]()))},We=function(e){e&&(q||K||ie||B)&&(e.preventDefault(),e.stopPropagation())},Be=function(){h.setScrollOffset(0,f.getScrollY())},Ge={},Xe=0,Ve=function(e){Ge[e]&&(Ge[e].raf&&Z(Ge[e].raf),Xe--,delete Ge[e])},Ke=function(e){Ge[e]&&Ve(e),Ge[e]||(Xe++,Ge[e]={})},qe=function(){for(var e in Ge)Ge.hasOwnProperty(e)&&Ve(e)},$e=function(t,n,i,o,a,r,l){var s,u=Te();Ke(t),function e(){if(Ge[t]){if(s=Te()-u,o<=s)return Ve(t),r(i),void(l&&l());r((i-n)*a(s/o)+n),Ge[t].raf=R(e)}}()},je={shout:Se,listen:De,viewportSize:pe,options:y,isMainScrollAnimating:function(){return ie},getZoomLevel:function(){return v},getCurrentIndex:function(){return x},isDragging:function(){return X},isZooming:function(){return Q},setScrollOffset:function(e,t){fe.x=e,_=fe.y=t,Se("updateScrollOffset",fe)},applyZoomPan:function(e,t,n,i){de.x=t,de.y=n,v=e,Ee(i)},init:function(){if(!s&&!o){var e;h.framework=f,h.template=m,h.bg=f.getChildByClass(m,"pswp__bg"),P=m.className,s=!0,z=f.detectFeatures(),R=z.raf,Z=z.caf,E=z.transform,L=z.oldIE,h.scrollWrap=f.getChildByClass(m,"pswp__scroll-wrap"),h.container=f.getChildByClass(h.scrollWrap,"pswp__container"),r=h.container.style,h.itemHolders=C=[{el:h.container.children[0],wrap:0,index:-1},{el:h.container.children[1],wrap:0,index:-1},{el:h.container.children[2],wrap:0,index:-1}],C[0].el.style.display=C[2].el.style.display="none",function(){if(E){var e=z.perspective&&!k;return g="translate"+(e?"3d(":"("),w=z.perspective?", 0px)":")"}E="left",f.addClass(m,"pswp--ie"),ke=function(e,t){t.left=e+"px"},Oe=function(e){var t=1<e.fitRatio?1:e.fitRatio,n=e.container.style,i=t*e.w,o=t*e.h;n.width=i+"px",n.height=o+"px",n.left=e.initialPosition.x+"px",n.top=e.initialPosition.y+"px"},Ee=function(){if(ne){var e=ne,t=h.currItem,n=1<t.fitRatio?1:t.fitRatio,i=n*t.w,o=n*t.h;e.width=i+"px",e.height=o+"px",e.left=de.x+"px",e.top=de.y+"px"}}}(),d={resize:h.updateSize,orientationchange:function(){clearTimeout(N),N=setTimeout(function(){pe.x!==h.scrollWrap.clientWidth&&h.updateSize()},500)},scroll:Be,keydown:Ye,click:We};var t=z.isOldIOSPhone||z.isOldAndroid||z.isMobileOpera;for(z.animationName&&z.transform&&!t||(y.showAnimationDuration=y.hideAnimationDuration=0),e=0;e<ve.length;e++)h["init"+ve[e]]();i&&(h.ui=new i(h,f)).init(),Se("firstUpdate"),x=x||y.index||0,(isNaN(x)||x<0||x>=Nt())&&(x=0),h.currItem=zt(x),(z.isOldIOSPhone||z.isOldAndroid)&&(xe=!1),m.setAttribute("aria-hidden","false"),y.modal&&(xe?m.style.position="fixed":(m.style.position="absolute",m.style.top=f.getScrollY()+"px")),void 0===_&&(Se("initialLayout"),_=F=f.getScrollY());var n="pswp--open ";for(y.mainClass&&(n+=y.mainClass+" "),y.showHideOpacity&&(n+="pswp--animate_opacity "),n+=k?"pswp--touch":"pswp--notouch",n+=z.animationName?" pswp--css_animation":"",n+=z.svg?" pswp--svg":"",f.addClass(m,n),h.updateSize(),l=-1,ye=null,e=0;e<3;e++)ke((e+l)*he.x,C[e].el.style);L||f.bind(h.scrollWrap,c,h),De("initialZoomInEnd",function(){h.setContent(C[0],x-1),h.setContent(C[2],x+1),C[0].el.style.display=C[2].el.style.display="block",y.focus&&m.focus(),f.bind(document,"keydown",h),z.transform&&f.bind(h.scrollWrap,"click",h),y.mouseUsed||f.bind(document,"mousemove",_e),f.bind(window,"resize scroll orientationchange",h),Se("bindEvents")}),h.setContent(C[1],x),h.updateCurrItem(),Se("afterInit"),xe||(b=setInterval(function(){Xe||X||Q||v!==h.currItem.initialZoomLevel||h.updateSize()},1e3)),f.addClass(m,"pswp--visible")}},close:function(){s&&(o=!(s=!1),Se("close"),f.unbind(window,"resize scroll orientationchange",h),f.unbind(window,"scroll",d.scroll),f.unbind(document,"keydown",h),f.unbind(document,"mousemove",_e),z.transform&&f.unbind(h.scrollWrap,"click",h),X&&f.unbind(window,u,h),clearTimeout(N),Se("unbindEvents"),Ut(h.currItem,null,!0,h.destroy))},destroy:function(){Se("destroy"),Pt&&clearTimeout(Pt),m.setAttribute("aria-hidden","true"),m.className=P,b&&clearInterval(b),f.unbind(h.scrollWrap,c,h),f.unbind(window,"scroll",h),ft(),qe(),Ce=null},panTo:function(e,t,n){n||(e>te.min.x?e=te.min.x:e<te.max.x&&(e=te.max.x),t>te.min.y?t=te.min.y:t<te.max.y&&(t=te.max.y)),de.x=e,de.y=t,Ee()},handleEvent:function(e){e=e||window.event,d[e.type]&&d[e.type](e)},goTo:function(e){var t=(e=Ie(e))-x;ye=t,x=e,h.currItem=zt(x),me-=t,Re(he.x*me),qe(),ie=!1,h.updateCurrItem()},next:function(){h.goTo(x+1)},prev:function(){h.goTo(x-1)},updateCurrZoomItem:function(e){if(e&&Se("beforeChange",0),C[1].el.children.length){var t=C[1].el.children[0];ne=f.hasClass(t,"pswp__zoom-wrap")?t.style:null}else ne=null;te=h.currItem.bounds,p=v=h.currItem.initialZoomLevel,de.x=te.center.x,de.y=te.center.y,e&&Se("afterChange")},invalidateCurrItems:function(){I=!0;for(var e=0;e<3;e++)C[e].item&&(C[e].item.needsUpdate=!0)},updateCurrItem:function(e){if(0!==ye){var t,n=Math.abs(ye);if(!(e&&n<2)){h.currItem=zt(x),we=!1,Se("beforeChange",ye),3<=n&&(l+=ye+(0<ye?-3:3),n=3);for(var i=0;i<n;i++)0<ye?(t=C.shift(),C[2]=t,ke((++l+2)*he.x,t.el.style),h.setContent(t,x-n+i+1+1)):(t=C.pop(),C.unshift(t),ke(--l*he.x,t.el.style),h.setContent(t,x+n-i-1-1));if(ne&&1===Math.abs(ye)){var o=zt(D);o.initialZoomLevel!==v&&(Bt(o,pe),Kt(o),Oe(o))}ye=0,h.updateCurrZoomItem(),D=x,Se("afterChange")}}},updateSize:function(e){if(!xe&&y.modal){var t=f.getScrollY();if(_!==t&&(m.style.top=t+"px",_=t),!e&&ge.x===window.innerWidth&&ge.y===window.innerHeight)return;ge.x=window.innerWidth,ge.y=window.innerHeight,m.style.height=ge.y+"px"}if(pe.x=h.scrollWrap.clientWidth,pe.y=h.scrollWrap.clientHeight,Be(),he.x=pe.x+Math.round(pe.x*y.spacing),he.y=pe.y,Re(he.x*me),Se("beforeResize"),void 0!==l){for(var n,i,o,a=0;a<3;a++)n=C[a],ke((a+l)*he.x,n.el.style),o=x+a-1,y.loop&&2<Nt()&&(o=Ie(o)),(i=zt(o))&&(I||i.needsUpdate||!i.bounds)?(h.cleanSlide(i),h.setContent(n,o),1===a&&(h.currItem=i,h.updateCurrZoomItem(!0)),i.needsUpdate=!1):-1===n.index&&0<=o&&h.setContent(n,o),i&&i.container&&(Bt(i,pe),Kt(i),Oe(i));I=!1}p=v=h.currItem.initialZoomLevel,(te=h.currItem.bounds)&&(de.x=te.center.x,de.y=te.center.y,Ee(!0)),Se("resize")},zoomTo:function(t,e,n,i,o){e&&(p=v,dt.x=Math.abs(e.x)-de.x,dt.y=Math.abs(e.y)-de.y,Pe(ce,de));var a=ze(t,!1),r={};He("x",a,r,t),He("y",a,r,t);var l=v,s=de.x,u=de.y;Fe(r);var c=function(e){1===e?(v=t,de.x=r.x,de.y=r.y):(v=(t-l)*e+l,de.x=(r.x-s)*e+s,de.y=(r.y-u)*e+u),o&&o(e),Ee(1===e)};n?$e("customZoomTo",0,1,n,i||f.easing.sine.inOut,c):c(1)}},Je={},Qe={},et={},tt={},nt={},it=[],ot={},at=[],rt={},lt=0,st={x:0,y:0},ut=0,ct={x:0,y:0},dt={x:0,y:0},pt={x:0,y:0},mt=function(e,t){return rt.x=Math.abs(e.x-t.x),rt.y=Math.abs(e.y-t.y),Math.sqrt(rt.x*rt.x+rt.y*rt.y)},ft=function(){$&&(Z($),$=null)},ht={},yt=function(e,t){return ht.prevent=!function e(t,n){return!(!t||t===document)&&!(t.getAttribute("class")&&-1<t.getAttribute("class").indexOf("pswp__scroll-wrap"))&&(n(t)?t:e(t.parentNode,n))}(e.target,y.isClickableElement),Se("preventDragEvent",e,t,ht),ht.prevent},xt=function(e,t){return t.x=e.pageX,t.y=e.pageY,t.id=e.identifier,t},vt=function(e,t,n){n.x=.5*(e.x+t.x),n.y=.5*(e.y+t.y)},gt=function(){var e=de.y-h.currItem.initialPosition.y;return 1-Math.abs(e/(pe.y/2))},wt={},bt={},It=[],Ct=function(e){for(;0<It.length;)It.pop();return O?(n=0,it.forEach(function(e){0===n?It[0]=e:1===n&&(It[1]=e),n++})):-1<e.type.indexOf("touch")?e.touches&&0<e.touches.length&&(It[0]=xt(e.touches[0],wt),1<e.touches.length&&(It[1]=xt(e.touches[1],bt))):(wt.x=e.pageX,wt.y=e.pageY,wt.id="",It[0]=wt),It},Dt=function(e,t){var n,i,o,a,r=de[e]+t[e],l=0<t[e],s=ct.x+t.x,u=ct.x-ot.x;return n=r>te.min[e]||r<te.max[e]?y.panEndFriction:1,r=de[e]+t[e]*n,!y.allowPanToNext&&v!==h.currItem.initialZoomLevel||(ne?"h"!==oe||"x"!==e||K||(l?(r>te.min[e]&&(n=y.panEndFriction,te.min[e],i=te.min[e]-ce[e]),(i<=0||u<0)&&1<Nt()?(a=s,u<0&&s>ot.x&&(a=ot.x)):te.min.x!==te.max.x&&(o=r)):(r<te.max[e]&&(n=y.panEndFriction,te.max[e],i=ce[e]-te.max[e]),(i<=0||0<u)&&1<Nt()?(a=s,0<u&&s<ot.x&&(a=ot.x)):te.min.x!==te.max.x&&(o=r))):a=s,"x"!==e)?void(ie||j||v>h.currItem.fitRatio&&(de[e]+=t[e]*n)):(void 0!==a&&(Re(a,!0),j=a!==ot.x),te.min.x!==te.max.x&&(void 0!==o?de.x=o:j||(de.x+=t.x*n)),void 0!==a)},St=function(e){if(!("mousedown"===e.type&&0<e.button)){if(_t)return void e.preventDefault();if(!G||"mousedown"!==e.type){if(yt(e,!0)&&e.preventDefault(),Se("pointerDown"),O){var t=f.arraySearch(it,e.pointerId,"id");t<0&&(t=it.length),it[t]={x:e.pageX,y:e.pageY,id:e.pointerId}}var n=Ct(e),i=n.length;J=null,qe(),X&&1!==i||(X=ae=!0,f.bind(window,u,h),W=se=re=B=j=q=V=K=!1,oe=null,Se("firstTouchStart",n),Pe(ce,de),ue.x=ue.y=0,Pe(tt,n[0]),Pe(nt,tt),ot.x=he.x*me,at=[{x:tt.x,y:tt.y}],H=U=Te(),ze(v,!0),ft(),function e(){X&&($=R(e),Mt())}()),!Q&&1<i&&!ie&&!j&&(p=v,Q=V=!(K=!1),ue.y=ue.x=0,Pe(ce,de),Pe(Je,n[0]),Pe(Qe,n[1]),vt(Je,Qe,pt),dt.x=Math.abs(pt.x)-de.x,dt.y=Math.abs(pt.y)-de.y,ee=mt(Je,Qe))}}},Tt=function(e){if(e.preventDefault(),O){var t=f.arraySearch(it,e.pointerId,"id");if(-1<t){var n=it[t];n.x=e.pageX,n.y=e.pageY}}if(X){var i=Ct(e);if(oe||q||Q)J=i;else if(ct.x!==he.x*me)oe="h";else{var o=Math.abs(i[0].x-tt.x)-Math.abs(i[0].y-tt.y);10<=Math.abs(o)&&(oe=0<o?"h":"v",J=i)}}},Mt=function(){if(J){var e=J.length;if(0!==e)if(Pe(Je,J[0]),et.x=Je.x-tt.x,et.y=Je.y-tt.y,Q&&1<e){if(tt.x=Je.x,tt.y=Je.y,!et.x&&!et.y&&(s=J[1],u=Qe,s.x===u.x&&s.y===u.y))return;Pe(Qe,J[1]),K||(K=!0,Se("zoomGestureStarted"));var t=mt(Je,Qe),n=Rt(t);n>h.currItem.initialZoomLevel+h.currItem.initialZoomLevel/15&&(se=!0);var i=1,o=Ne(),a=Ue();if(n<o)if(y.pinchToClose&&!se&&p<=h.currItem.initialZoomLevel){var r=1-(o-n)/(o/1.2);Me(r),Se("onPinchClose",r),re=!0}else 1<(i=(o-n)/o)&&(i=1),n=o-i*(o/3);else a<n&&(1<(i=(n-a)/(6*o))&&(i=1),n=a+i*o);i<0&&(i=0),vt(Je,Qe,st),ue.x+=st.x-pt.x,ue.y+=st.y-pt.y,Pe(pt,st),de.x=Ze("x",n),de.y=Ze("y",n),W=v<n,v=n,Ee()}else{if(!oe)return;if(ae&&(ae=!1,10<=Math.abs(et.x)&&(et.x-=J[0].x-nt.x),10<=Math.abs(et.y)&&(et.y-=J[0].y-nt.y)),tt.x=Je.x,tt.y=Je.y,0===et.x&&0===et.y)return;if("v"===oe&&y.closeOnVerticalDrag&&"fit"===y.scaleMode&&v===h.currItem.initialZoomLevel){ue.y+=et.y,de.y+=et.y;var l=gt();return B=!0,Se("onVerticalDrag",l),Me(l),void Ee()}(function(e,t,n){if(50<e-H){var i=2<at.length?at.shift():{};i.x=t,i.y=n,at.push(i),H=e}})(Te(),Je.x,Je.y),q=!0,te=h.currItem.bounds,Dt("x",et)||(Dt("y",et),Fe(de),Ee())}}var s,u},At=function(e){if(z.isOldAndroid){if(G&&"mouseup"===e.type)return;-1<e.type.indexOf("touch")&&(clearTimeout(G),G=setTimeout(function(){G=0},600))}var t;if(Se("pointerUp"),yt(e,!1)&&e.preventDefault(),O){var n=f.arraySearch(it,e.pointerId,"id");-1<n&&(t=it.splice(n,1)[0],navigator.pointerEnabled?t.type=e.pointerType||"mouse":(t.type={4:"mouse",2:"touch",3:"pen"}[e.pointerType],t.type||(t.type=e.pointerType||"mouse")))}var i,o=Ct(e),a=o.length;if("mouseup"===e.type&&(a=0),2===a)return!(J=null);1===a&&Pe(nt,o[0]),0!==a||oe||ie||(t||("mouseup"===e.type?t={x:e.pageX,y:e.pageY,type:"mouse"}:e.changedTouches&&e.changedTouches[0]&&(t={x:e.changedTouches[0].pageX,y:e.changedTouches[0].pageY,type:"touch"})),Se("touchRelease",e,t));var r=-1;if(0===a&&(X=!1,f.unbind(window,u,h),ft(),Q?r=0:-1!==ut&&(r=Te()-ut)),ut=1===a?Te():-1,i=-1!==r&&r<150?"zoom":"swipe",Q&&a<2&&(Q=!1,1===a&&(i="zoomPointerUp"),Se("zoomGestureEnded")),J=null,q||K||ie||B)if(qe(),Y||(Y=Et()),Y.calculateSwipeSpeed("x"),B)if(gt()<y.verticalDragRange)h.close();else{var l=de.y,s=le;$e("verticalDrag",0,1,300,f.easing.cubic.out,function(e){de.y=(h.currItem.initialPosition.y-l)*e+l,Me((1-s)*e+s),Ee()}),Se("onVerticalDrag",1)}else{if((j||ie)&&0===a){if(kt(i,Y))return;i="zoomPointerUp"}if(!ie)return"swipe"!==i?void Zt():void(!j&&v>h.currItem.fitRatio&&Ot(Y))}},Et=function(){var t,n,i={lastFlickOffset:{},lastFlickDist:{},lastFlickSpeed:{},slowDownRatio:{},slowDownRatioReverse:{},speedDecelerationRatio:{},speedDecelerationRatioAbs:{},distanceOffset:{},backAnimDestination:{},backAnimStarted:{},calculateSwipeSpeed:function(e){1<at.length?(t=Te()-H+50,n=at[at.length-2][e]):(t=Te()-U,n=nt[e]),i.lastFlickOffset[e]=tt[e]-n,i.lastFlickDist[e]=Math.abs(i.lastFlickOffset[e]),20<i.lastFlickDist[e]?i.lastFlickSpeed[e]=i.lastFlickOffset[e]/t:i.lastFlickSpeed[e]=0,Math.abs(i.lastFlickSpeed[e])<.1&&(i.lastFlickSpeed[e]=0),i.slowDownRatio[e]=.95,i.slowDownRatioReverse[e]=1-i.slowDownRatio[e],i.speedDecelerationRatio[e]=1},calculateOverBoundsAnimOffset:function(t,e){i.backAnimStarted[t]||(de[t]>te.min[t]?i.backAnimDestination[t]=te.min[t]:de[t]<te.max[t]&&(i.backAnimDestination[t]=te.max[t]),void 0!==i.backAnimDestination[t]&&(i.slowDownRatio[t]=.7,i.slowDownRatioReverse[t]=1-i.slowDownRatio[t],i.speedDecelerationRatioAbs[t]<.05&&(i.lastFlickSpeed[t]=0,i.backAnimStarted[t]=!0,$e("bounceZoomPan"+t,de[t],i.backAnimDestination[t],e||300,f.easing.sine.out,function(e){de[t]=e,Ee()}))))},calculateAnimOffset:function(e){i.backAnimStarted[e]||(i.speedDecelerationRatio[e]=i.speedDecelerationRatio[e]*(i.slowDownRatio[e]+i.slowDownRatioReverse[e]-i.slowDownRatioReverse[e]*i.timeDiff/10),i.speedDecelerationRatioAbs[e]=Math.abs(i.lastFlickSpeed[e]*i.speedDecelerationRatio[e]),i.distanceOffset[e]=i.lastFlickSpeed[e]*i.speedDecelerationRatio[e]*i.timeDiff,de[e]+=i.distanceOffset[e])},panAnimLoop:function(){if(Ge.zoomPan&&(Ge.zoomPan.raf=R(i.panAnimLoop),i.now=Te(),i.timeDiff=i.now-i.lastNow,i.lastNow=i.now,i.calculateAnimOffset("x"),i.calculateAnimOffset("y"),Ee(),i.calculateOverBoundsAnimOffset("x"),i.calculateOverBoundsAnimOffset("y"),i.speedDecelerationRatioAbs.x<.05&&i.speedDecelerationRatioAbs.y<.05))return de.x=Math.round(de.x),de.y=Math.round(de.y),Ee(),void Ve("zoomPan")}};return i},Ot=function(e){return e.calculateSwipeSpeed("y"),te=h.currItem.bounds,e.backAnimDestination={},e.backAnimStarted={},Math.abs(e.lastFlickSpeed.x)<=.05&&Math.abs(e.lastFlickSpeed.y)<=.05?(e.speedDecelerationRatioAbs.x=e.speedDecelerationRatioAbs.y=0,e.calculateOverBoundsAnimOffset("x"),e.calculateOverBoundsAnimOffset("y"),!0):(Ke("zoomPan"),e.lastNow=Te(),void e.panAnimLoop())},kt=function(e,t){var n,i,o;if(ie||(lt=x),"swipe"===e){var a=tt.x-nt.x,r=t.lastFlickDist.x<10;30<a&&(r||20<t.lastFlickOffset.x)?i=-1:a<-30&&(r||t.lastFlickOffset.x<-20)&&(i=1)}i&&((x+=i)<0?(x=y.loop?Nt()-1:0,o=!0):x>=Nt()&&(x=y.loop?0:Nt()-1,o=!0),o&&!y.loop||(ye+=i,me-=i,n=!0));var l,s=he.x*me,u=Math.abs(s-ct.x);return n||s>ct.x==0<t.lastFlickSpeed.x?(l=0<Math.abs(t.lastFlickSpeed.x)?u/Math.abs(t.lastFlickSpeed.x):333,l=Math.min(l,400),l=Math.max(l,250)):l=333,lt===x&&(n=!1),ie=!0,Se("mainScrollAnimStart"),$e("mainScroll",ct.x,s,l,f.easing.cubic.out,Re,function(){qe(),ie=!1,lt=-1,(n||lt!==x)&&h.updateCurrItem(),Se("mainScrollAnimComplete")}),n&&h.updateCurrItem(!0),n},Rt=function(e){return 1/ee*e*p},Zt=function(){var e=v,t=Ne(),n=Ue();v<t?e=t:n<v&&(e=n);var i,o=le;return re&&!W&&!se&&v<t?h.close():(re&&(i=function(e){Me((1-o)*e+o)}),h.zoomTo(e,0,200,f.easing.cubic.out,i)),!0};be("Gestures",{publicMethods:{initGestures:function(){var e=function(e,t,n,i,o){S=e+t,T=e+n,M=e+i,A=o?e+o:""};(O=z.pointerEvent)&&z.touch&&(z.touch=!1),O?navigator.pointerEnabled?e("pointer","down","move","up","cancel"):e("MSPointer","Down","Move","Up","Cancel"):z.touch?(e("touch","start","move","end","cancel"),k=!0):e("mouse","down","move","up"),u=T+" "+M+" "+A,c=S,O&&!k&&(k=1<navigator.maxTouchPoints||1<navigator.msMaxTouchPoints),h.likelyTouchDevice=k,d[S]=St,d[T]=Tt,d[M]=At,A&&(d[A]=d[M]),z.touch&&(c+=" mousedown",u+=" mousemove mouseup",d.mousedown=d[S],d.mousemove=d[T],d.mouseup=d[M]),k||(y.allowPanToNext=!1)}}});var Pt,Ft,Lt,_t,zt,Nt,Ut=function(r,e,l,t){var s;Pt&&clearTimeout(Pt),Lt=_t=!0,r.initialLayout?(s=r.initialLayout,r.initialLayout=null):s=y.getThumbBoundsFn&&y.getThumbBoundsFn(x);var u,c,d=l?y.hideAnimationDuration:y.showAnimationDuration,p=function(){Ve("initialZoom"),l?(h.template.removeAttribute("style"),h.bg.removeAttribute("style")):(Me(1),e&&(e.style.display="block"),f.addClass(m,"pswp--animated-in"),Se("initialZoom"+(l?"OutEnd":"InEnd"))),t&&t(),_t=!1};if(!d||!s||void 0===s.x)return Se("initialZoom"+(l?"Out":"In")),v=r.initialZoomLevel,Pe(de,r.initialPosition),Ee(),m.style.opacity=l?0:1,Me(1),void(d?setTimeout(function(){p()},d):p());u=a,c=!h.currItem.src||h.currItem.loadError||y.showHideOpacity,r.miniImg&&(r.miniImg.style.webkitBackfaceVisibility="hidden"),l||(v=s.w/r.w,de.x=s.x,de.y=s.y-F,h[c?"template":"bg"].style.opacity=.001,Ee()),Ke("initialZoom"),l&&!u&&f.removeClass(m,"pswp--animated-in"),c&&(l?f[(u?"remove":"add")+"Class"](m,"pswp--animate_opacity"):setTimeout(function(){f.addClass(m,"pswp--animate_opacity")},30)),Pt=setTimeout(function(){if(Se("initialZoom"+(l?"Out":"In")),l){var t=s.w/r.w,n=de.x,i=de.y,o=v,a=le,e=function(e){1===e?(v=t,de.x=s.x,de.y=s.y-_):(v=(t-o)*e+o,de.x=(s.x-n)*e+n,de.y=(s.y-_-i)*e+i),Ee(),c?m.style.opacity=1-e:Me(a-e*a)};u?$e("initialZoom",0,1,d,f.easing.cubic.out,e,p):(e(1),Pt=setTimeout(p,d+20))}else v=r.initialZoomLevel,Pe(de,r.initialPosition),Ee(),Me(1),c?m.style.opacity=1:Me(1),Pt=setTimeout(p,d+20)},l?25:90)},Ht={},Yt=[],Wt={index:0,errorMsg:'<div class="pswp__error-msg"><a href="%url%" target="_blank">The image</a> could not be loaded.</div>',forceProgressiveLoading:!1,preload:[1,1],getNumItemsFn:function(){return Ft.length}},Bt=function(e,t,n){if(e.src&&!e.loadError){var i=!n;if(i&&(e.vGap||(e.vGap={top:0,bottom:0}),Se("parseVerticalMargin",e)),Ht.x=t.x,Ht.y=t.y-e.vGap.top-e.vGap.bottom,i){var o=Ht.x/e.w,a=Ht.y/e.h;e.fitRatio=o<a?o:a;var r=y.scaleMode;"orig"===r?n=1:"fit"===r&&(n=e.fitRatio),1<n&&(n=1),e.initialZoomLevel=n,e.bounds||(e.bounds={center:{x:0,y:0},max:{x:0,y:0},min:{x:0,y:0}})}if(!n)return;return s=(l=e).w*n,u=e.h*n,(c=l.bounds).center.x=Math.round((Ht.x-s)/2),c.center.y=Math.round((Ht.y-u)/2)+l.vGap.top,c.max.x=s>Ht.x?Math.round(Ht.x-s):c.center.x,c.max.y=u>Ht.y?Math.round(Ht.y-u)+l.vGap.top:c.center.y,c.min.x=s>Ht.x?0:c.center.x,c.min.y=u>Ht.y?l.vGap.top:c.center.y,i&&n===e.initialZoomLevel&&(e.initialPosition=e.bounds.center),e.bounds}var l,s,u,c;return e.w=e.h=0,e.initialZoomLevel=e.fitRatio=1,e.bounds={center:{x:0,y:0},max:{x:0,y:0},min:{x:0,y:0}},e.initialPosition=e.bounds.center,e.bounds},Gt=function(e,t,n,i,o,a){t.loadError||i&&(t.imageAppended=!0,Kt(t,i,t===h.currItem&&we),n.appendChild(i),a&&setTimeout(function(){t&&t.loaded&&t.placeholder&&(t.placeholder.style.display="none",t.placeholder=null)},500))},Xt=function(e){e.loading=!0,e.loaded=!1;var t=e.img=f.createEl("pswp__img","img"),n=function(){e.loading=!1,e.loaded=!0,e.loadComplete?e.loadComplete(e):e.img=null,t.onload=t.onerror=null,t=null};return t.onload=n,t.onerror=function(){e.loadError=!0,n()},t.src=e.src,t},Vt=function(e,t){if(e.src&&e.loadError&&e.container)return t&&(e.container.innerHTML=""),e.container.innerHTML=y.errorMsg.replace("%url%",e.src),!0},Kt=function(e,t,n){if(e.src){t||(t=e.container.lastChild);var i=n?e.w:Math.round(e.w*e.fitRatio),o=n?e.h:Math.round(e.h*e.fitRatio);e.placeholder&&!e.loaded&&(e.placeholder.style.width=i+"px",e.placeholder.style.height=o+"px"),t.style.width=i+"px",t.style.height=o+"px"}},qt=function(){if(Yt.length){for(var e,t=0;t<Yt.length;t++)(e=Yt[t]).holder.index===e.index&&Gt(e.index,e.item,e.baseDiv,e.img,0,e.clearPlaceholder);Yt=[]}};be("Controller",{publicMethods:{lazyLoadItem:function(e){e=Ie(e);var t=zt(e);t&&(!t.loaded&&!t.loading||I)&&(Se("gettingData",e,t),t.src&&Xt(t))},initController:function(){f.extend(y,Wt,!0),h.items=Ft=e,zt=h.getItemAt,Nt=y.getNumItemsFn,y.loop,Nt()<3&&(y.loop=!1),De("beforeChange",function(e){var t,n=y.preload,i=null===e||0<=e,o=Math.min(n[0],Nt()),a=Math.min(n[1],Nt());for(t=1;t<=(i?a:o);t++)h.lazyLoadItem(x+t);for(t=1;t<=(i?o:a);t++)h.lazyLoadItem(x-t)}),De("initialLayout",function(){h.currItem.initialLayout=y.getThumbBoundsFn&&y.getThumbBoundsFn(x)}),De("mainScrollAnimComplete",qt),De("initialZoomInEnd",qt),De("destroy",function(){for(var e,t=0;t<Ft.length;t++)(e=Ft[t]).container&&(e.container=null),e.placeholder&&(e.placeholder=null),e.img&&(e.img=null),e.preloader&&(e.preloader=null),e.loadError&&(e.loaded=e.loadError=!1);Yt=null})},getItemAt:function(e){return 0<=e&&void 0!==Ft[e]&&Ft[e]},allowProgressiveImg:function(){return y.forceProgressiveLoading||!k||y.mouseUsed||1200<screen.width},setContent:function(t,n){y.loop&&(n=Ie(n));var e=h.getItemAt(t.index);e&&(e.container=null);var i,o=h.getItemAt(n);if(o){Se("gettingData",n,o),t.index=n;var a=(t.item=o).container=f.createEl("pswp__zoom-wrap");if(!o.src&&o.html&&(o.html.tagName?a.appendChild(o.html):a.innerHTML=o.html),Vt(o),Bt(o,pe),!o.src||o.loadError||o.loaded)o.src&&!o.loadError&&((i=f.createEl("pswp__img","img")).style.opacity=1,i.src=o.src,Kt(o,i),Gt(0,o,a,i));else{if(o.loadComplete=function(e){if(s){if(t&&t.index===n){if(Vt(e,!0))return e.loadComplete=e.img=null,Bt(e,pe),Oe(e),void(t.index===x&&h.updateCurrZoomItem());e.imageAppended?!_t&&e.placeholder&&(e.placeholder.style.display="none",e.placeholder=null):z.transform&&(ie||_t)?Yt.push({item:e,baseDiv:a,img:e.img,index:n,holder:t,clearPlaceholder:!0}):Gt(0,e,a,e.img,0,!0)}e.loadComplete=null,e.img=null,Se("imageLoadComplete",n,e)}},f.features.transform){var r="pswp__img pswp__img--placeholder";r+=o.msrc?"":" pswp__img--placeholder--blank";var l=f.createEl(r,o.msrc?"img":"");o.msrc&&(l.src=o.msrc),Kt(o,l),a.appendChild(l),o.placeholder=l}o.loading||Xt(o),h.allowProgressiveImg()&&(!Lt&&z.transform?Yt.push({item:o,baseDiv:a,img:o.img,index:n,holder:t}):Gt(0,o,a,o.img,0,!0))}Lt||n!==x?Oe(o):(ne=a.style,Ut(o,i||o.img)),t.el.innerHTML="",t.el.appendChild(a)}else t.el.innerHTML=""},cleanSlide:function(e){e.img&&(e.img.onload=e.img.onerror=null),e.loaded=e.loading=e.img=e.imageAppended=!1}}});var $t,jt,Jt={},Qt=function(e,t,n){var i=document.createEvent("CustomEvent"),o={origEvent:e,target:e.target,releasePoint:t,pointerType:n||"touch"};i.initCustomEvent("pswpTap",!0,!0,o),e.target.dispatchEvent(i)};be("Tap",{publicMethods:{initTap:function(){De("firstTouchStart",h.onTapStart),De("touchRelease",h.onTapRelease),De("destroy",function(){Jt={},$t=null})},onTapStart:function(e){1<e.length&&(clearTimeout($t),$t=null)},onTapRelease:function(e,t){if(t&&!q&&!V&&!Xe){var n=t;if($t&&(clearTimeout($t),$t=null,i=n,o=Jt,Math.abs(i.x-o.x)<25&&Math.abs(i.y-o.y)<25))return void Se("doubleTap",n);if("mouse"===t.type)return void Qt(e,t,"mouse");if("BUTTON"===e.target.tagName.toUpperCase()||f.hasClass(e.target,"pswp__single-tap"))return void Qt(e,t);Pe(Jt,n),$t=setTimeout(function(){Qt(e,t),$t=null},300)}var i,o}}}),be("DesktopZoom",{publicMethods:{initDesktopZoom:function(){L||(k?De("mouseUsed",function(){h.setupDesktopZoom()}):h.setupDesktopZoom(!0))},setupDesktopZoom:function(e){jt={};var t="wheel mousewheel DOMMouseScroll";De("bindEvents",function(){f.bind(m,t,h.handleMouseWheel)}),De("unbindEvents",function(){jt&&f.unbind(m,t,h.handleMouseWheel)}),h.mouseZoomedIn=!1;var n,i=function(){h.mouseZoomedIn&&(f.removeClass(m,"pswp--zoomed-in"),h.mouseZoomedIn=!1),v<1?f.addClass(m,"pswp--zoom-allowed"):f.removeClass(m,"pswp--zoom-allowed"),o()},o=function(){n&&(f.removeClass(m,"pswp--dragging"),n=!1)};De("resize",i),De("afterChange",i),De("pointerDown",function(){h.mouseZoomedIn&&(n=!0,f.addClass(m,"pswp--dragging"))}),De("pointerUp",o),e||i()},handleMouseWheel:function(e){if(v<=h.currItem.fitRatio)return y.modal&&(!y.closeOnScroll||Xe||X?e.preventDefault():E&&2<Math.abs(e.deltaY)&&(a=!0,h.close())),!0;if(e.stopPropagation(),jt.x=0,"deltaX"in e)1===e.deltaMode?(jt.x=18*e.deltaX,jt.y=18*e.deltaY):(jt.x=e.deltaX,jt.y=e.deltaY);else if("wheelDelta"in e)e.wheelDeltaX&&(jt.x=-.16*e.wheelDeltaX),e.wheelDeltaY?jt.y=-.16*e.wheelDeltaY:jt.y=-.16*e.wheelDelta;else{if(!("detail"in e))return;jt.y=e.detail}ze(v,!0);var t=de.x-jt.x,n=de.y-jt.y;(y.modal||t<=te.min.x&&t>=te.max.x&&n<=te.min.y&&n>=te.max.y)&&e.preventDefault(),h.panTo(t,n)},toggleDesktopZoom:function(e){e=e||{x:pe.x/2+fe.x,y:pe.y/2+fe.y};var t=y.getDoubleTapZoom(!0,h.currItem),n=v===t;h.mouseZoomedIn=!n,h.zoomTo(n?h.currItem.initialZoomLevel:t,e,333),f[(n?"remove":"add")+"Class"](m,"pswp--zoomed-in")}}});var en,tn,nn,on,an,rn,ln,sn,un,cn,dn,pn,mn={history:!0,galleryUID:1},fn=function(){return dn.hash.substring(1)},hn=function(){en&&clearTimeout(en),nn&&clearTimeout(nn)},yn=function(){var e=fn(),t={};if(e.length<5)return t;var n,i=e.split("&");for(n=0;n<i.length;n++)if(i[n]){var o=i[n].split("=");o.length<2||(t[o[0]]=o[1])}if(y.galleryPIDs){var a=t.pid;for(n=t.pid=0;n<Ft.length;n++)if(Ft[n].pid===a){t.pid=n;break}}else t.pid=parseInt(t.pid,10)-1;return t.pid<0&&(t.pid=0),t},xn=function e(){if(nn&&clearTimeout(nn),Xe||X)nn=setTimeout(e,500);else{on?clearTimeout(tn):on=!0;var t=x+1,n=zt(x);n.hasOwnProperty("pid")&&(t=n.pid);var i=ln+"&gid="+y.galleryUID+"&pid="+t;sn||-1===dn.hash.indexOf(i)&&(cn=!0);var o=dn.href.split("#")[0]+"#"+i;pn?"#"+i!==window.location.hash&&history[sn?"replaceState":"pushState"]("",document.title,o):sn?dn.replace(o):dn.hash=i,sn=!0,tn=setTimeout(function(){on=!1},60)}};be("History",{publicMethods:{initHistory:function(){if(f.extend(y,mn,!0),y.history){dn=window.location,sn=un=cn=!1,ln=fn(),pn="pushState"in history,-1<ln.indexOf("gid=")&&(ln=(ln=ln.split("&gid=")[0]).split("?gid=")[0]),De("afterChange",h.updateURL),De("unbindEvents",function(){f.unbind(window,"hashchange",h.onHashChange)});var e=function(){rn=!0,un||(cn?history.back():ln?dn.hash=ln:pn?history.pushState("",document.title,dn.pathname+dn.search):dn.hash=""),hn()};De("unbindEvents",function(){a&&e()}),De("destroy",function(){rn||e()}),De("firstUpdate",function(){x=yn().pid});var t=ln.indexOf("pid=");-1<t&&"&"===(ln=ln.substring(0,t)).slice(-1)&&(ln=ln.slice(0,-1)),setTimeout(function(){s&&f.bind(window,"hashchange",h.onHashChange)},40)}},onHashChange:function(){return fn()===ln?(un=!0,void h.close()):void(on||(an=!0,h.goTo(yn().pid),an=!1))},updateURL:function(){hn(),an||(sn?en=setTimeout(xn,800):xn())}}}),f.extend(h,je)}});
