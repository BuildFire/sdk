...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};function HistoryAPI(t,s,e,i){if("object"==(void 0===t?"undefined":_typeof(t))){var o=t;this.appId=o.appId,this.pluginId=o.pluginId,this.instanceId=o.instanceId,this.liveMode=o.liveMode}else this.appId=t,this.pluginId=s,this.instanceId=e,this.liveMode=i}HistoryAPI.prototype={historyItems:[],push:function(t,s){if("undefined"==typeof emulatorSync){if("plugin"!=t.source){var e=-1;if(1<this.historyItems.length){for(var i=1;i<this.historyItems.length;i++)if("plugin"==this.historyItems[i].source&&"control"==this.historyItems[i-1].source){e=i;break}0<=e&&this.historyItems.splice(e)}}t.uid=(new Date).getTime(),this.historyItems.push(t);var o=new CustomEvent("historyOnPush",{detail:{pushedItem:t}});document.dispatchEvent(o);var n=new CustomEvent("historyOnUpdate",{detail:{historyItems:this.historyItems}});document.dispatchEvent(n)}else{var r=new Packet(null,"history.pushAppHistory",t);emulatorSync.sendMessage(r)}return s&&s(null,!0),this},get:function(t,s){if(t&&t.pluginBreadcrumbsOnly){for(var e=[],i=0;i<this.historyItems.length;i++)"plugin"==this.historyItems[i].source&&e.push(this.historyItems[i]);s(null,e)}else s(null,this.historyItems);return this},getNext:function(t){var s=null;if(this.historyItems)for(var e=0;e<this.historyItems.length;e++)if(this.historyItems[e]==t||this.historyItems[e].uid==t.uid){e<this.historyItems.length&&(s=this.historyItems[e+1]);break}return s},pop:function(t,s){if("undefined"==typeof emulatorSync){if(!t&&this.historyItems)if(1<this.historyItems.length){var e=this.historyItems[this.historyItems.length-1];e&&"plugin"==e.source&&(t=this.historyItems[this.historyItems.length-2])}else this.historyItems[0]&&"plugin"==this.historyItems[0].source&&(t=this.historyItems[0]);if(t){for(var i=-1,o=[],n=!1,r=0;r<this.historyItems.length;r++)if(this.historyItems[r]==t||this.historyItems[r].uid==t.uid){(i=r)+1<this.historyItems.length&&"plugin"==this.historyItems[r+1].source&&(n=!0);break}if(0<=i&&1<this.historyItems.length)for(var h=i+1;h<this.historyItems.length&&"plugin"===this.historyItems[h].source;h++)o.push(this.historyItems[h]);t.poppedBreadcrumbs=o,0<=i&&i<=this.historyItems.length&&this.historyItems.splice(i+1);var u=new CustomEvent("historyOnPop",{detail:{poppedItem:t}});document.dispatchEvent(u);var m=new CustomEvent("historyOnUpdate",{detail:{historyItems:this.historyItems}});if(document.dispatchEvent(m),(n||"plugin"==t.source)&&postMaster){var y=new Packet(null,"history.triggerOnPop",t);postMaster.widgetPluginAPI?postMaster.widgetPluginAPI.sendMessage(null,y):postMaster.launcherPluginAPI&&postMaster.launcherPluginAPI.sendMessage(null,y)}}else if(s)return s("breadcrumb not found"),this}else{y=new Packet(null,"history.popAppHistory",t);emulatorSync.sendMessage(y)}return s&&s(null,!0),this},popToHome:function(){if(this.historyItems&&1<this.historyItems.length)for(var t=1;t<this.historyItems.length;t++)"control"==this.historyItems[t].source&&this.pop(this.historyItems[t-1])},popToPlugin:function(){if(this.historyItems&&1<this.historyItems.length)for(var t=this.historyItems.length-1;1<t&&"plugin"==this.historyItems[t].source;t--)this.pop(this.historyItems[t-1])},clear:function(t,s){var e=this.historyItems[0];this.historyItems.splice(0),s&&s(null);var i=new CustomEvent("historyOnUpdate",{detail:{historyItems:this.historyItems}});if(document.dispatchEvent(i),e){var o=new CustomEvent("historyOnPop",{detail:{poppedItem:e}});document.dispatchEvent(o)}return this},triggerOnPop:function(t){var s=new CustomEvent("historyOnPop",{detail:{poppedItem:t}});return document.dispatchEvent(s),this},triggerOnUpdate:function(t){this.historyItems=t;var s=new CustomEvent("historyOnUpdate",{detail:{historyItems:t}});return document.dispatchEvent(s),this},onUpdate:function(s){var t=function(t){s&&s({historyItems:t.detail.historyItems})};return document.addEventListener("historyOnUpdate",t,!1),{clear:function(){document.removeEventListener("historyOnUpdate",t,!1)}}},onPop:function(s){var t=function(t){s&&s(t.detail)};return document.addEventListener("historyOnPop",t,!1),{clear:function(){document.removeEventListener("historyOnPop",t,!1)}}},onPush:function(s){var t=function(t){s&&s({historyItems:t.detail.historyItems,pushedItem:t.detail.pushedItem})};return document.addEventListener("historyOnPush",t,!1),{clear:function(){document.removeEventListener("historyOnPush",t,!1)}}}};
