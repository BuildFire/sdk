...
"use strict";function StripeAPI(e){if(this.context=e,!this.context)throw Error("stripeAPI: invalid context");this.context.apiKeys||(this.context.apiKeys={})}StripeAPI.prototype={_sendRequest:function(e,i,t,n,s){var o="",c=new XMLHttpRequest,a=window.siteConfig.endPoints.stripeHost+"/stripe/"+i;if("GET"===(e=e.toUpperCase())&&t){var r="?";for(var l in t)t.hasOwnProperty(l)&&void 0!==t[l]&&(r+=l+"="+encodeURIComponent(t[l])+"&");a+=r=r.slice(0,-1)}else o=JSON.stringify(t);if(c.open(e,a,!0),c.setRequestHeader("Content-Type","application/json"),n)for(var l in n)n.hasOwnProperty(l)&&c.setRequestHeader(l,n[l]);c.onreadystatechange=function(){var e=null;try{e=JSON.parse(c.responseText)}catch(e){}4==c.readyState&&(200===c.status?s&&s(null,e):s&&s(e))},c.send(o)},_loadScript:function(e,i){var t=document.createElement("script");if(t.type="text/javascript",t.readyState?t.onreadystatechange=function(){"loaded"!=t.readyState&&"complete"!=t.readyState||(t.onreadystatechange=null,i&&i())}:t.onload=function(){i&&i()},t.src=e.url,e.attr)for(var n in e.attr)t.setAttribute(n,e.attr[n]);for(var s=document.getElementsByTagName("script"),o=s.length;o--;)if(s[o].src==e.url)return i&&i(),!0;document.getElementsByTagName("head")[0].appendChild(t)},_guid:function(){function e(){return(65536*(1+Math.random())|0).toString(16).substring(1)}return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()},_openStripeCheckout:function(e,t){var i=e.items,n=e.successUrl,s=e.cancelUrl,o=e.submitType,c=e.sessionId,a=e.clientReferenceId,r=e.domain,l=e.events,u=this,p=null,d=!1,m=null;function y(e){e||(e={}),clearInterval(p),(e.invokeDismiss||void 0===e.invokeDismiss)&&window.richModal&&window.richModal.close(),m&&m.close(),l&&"function"==typeof l.onClose&&l.onClose()}function f(){u._sendRequest("GET","checkout/sessions",{session_id:c,client_reference_id:a},{"x-api-key":u.context.apiKeys.awsApiPublicKey},function(e,i){i&&(y(),t&&t(e,i))})}var h=r+"/payments/checkout?stripeKey="+u.context.apiKeys.stripePublicKey;c&&(h+="&sessionId="+encodeURIComponent(c)),a&&(h+="&clientReferenceId="+encodeURIComponent(a)),n&&(h+="&successUrl="+encodeURIComponent(n)),s&&(h+="&cancelUrl="+encodeURIComponent(s)),o&&(h+="&submitType="+encodeURIComponent(o)),i&&(h+="&items="+encodeURIComponent(JSON.stringify(i))),window.richModal&&window.richModal.display({title:"",showDismissButton:!1,richContent:"<div style='text-align:center;'>Payment in progress <br/> Please wait...</div>",action:{title:"Cancel",handler:function(){y({invokeDismiss:!1})}}}),l&&"function"==typeof l.onProgress&&l.onProgress(),m=window.open(h,"_blank","location=no"),p=setInterval(function(){"visible"==window.document.visibilityState?f():d||(d=!0,setTimeout(function(){d=!1,f()},6e4))},5e3),setTimeout(function(){y()},9e5)},pay:function(e,t){var n=this;n.context.apiKeys.stripePublicKey?n._loadScript({url:"https://checkout.stripe.com/checkout.js"},function(){var i=StripeCheckout.configure({key:n.context.apiKeys.stripePublicKey,image:"https://stripe.com/img/documentation/checkout/marketplace.png",locale:"auto",token:function(e){i.close(),t&&t(null,{sourceToken:e})}});i.open({}),window.addEventListener("popstate",function(){i.close()})}):t&&t("Missing stripePublicKey in context",null)},charge:function(n,s){var o=this;if(o.context.apiKeys.stripePublicKey)if(o.context.apiKeys.awsApiPublicKey)if(n)if(n.items&&0!=n.items.length){for(var e=[],i=0;i<n.items.length;i++){if(!n.items[i].name)return void(s&&s("Missing name in items index "+i,null));if(!n.items[i].amount)return void(s&&s("Missing amount in items index "+i,null));e.push({name:n.items[i].name,description:n.items[i].description||void 0,amount:n.items[i].amount,currency:n.items[i].currency||"usd",quantity:n.items[i].quantity||1})}var c=window.siteConfig.endPoints.appHost,a="app_id_"+o.context.appId+"_ref_id_"+o._guid(),t={type:"line_items",line_items:e,client_reference_id:a,success_url:c+"/payments/success",cancel_url:c+"/payments/cancel"};n.submitType&&(t.submit_type=n.submitType),o._sendRequest("POST","checkout/sessions",t,{"x-api-key":o.context.apiKeys.awsApiPublicKey},function(e,i){if(e)s&&s(e,i);else{var t=i.sessionId;o._openStripeCheckout({sessionId:t,clientReferenceId:a,domain:c,events:n.events},function(e,i){i&&s&&s(null,i)})}})}else s&&s("Missing items",null);else s&&s("invalid params",null);else s&&s("Missing awsApiPublicKey in context",null);else s&&s("Missing stripePublicKey in context",null)},subscribe:function(n,s){var o=this;if(o.context.apiKeys.stripePublicKey)if(o.context.apiKeys.awsApiPublicKey)if(n)if(n.items&&0!=n.items.length){for(var e=[],i=0;i<n.items.length;i++){if(!n.items[i].planId)return void(s&&s("Missing planId in items index "+i,null));e.push({plan_id:n.items[i].planId,quantity:n.items[i].quantity||1})}var c=window.siteConfig.endPoints.appHost,a="app_id_"+o.context.appId+"_ref_id_"+o._guid(),t={type:"subscription",subscription_data:e,client_reference_id:a,success_url:c+"/payments/success",cancel_url:c+"/payments/cancel"};n.trialPeriodDays&&(t.trial_period_days=n.trialPeriodDays),o._sendRequest("POST","checkout/sessions",t,{"x-api-key":o.context.apiKeys.awsApiPublicKey},function(e,i){if(e)s&&s(e,i);else{var t=i.sessionId;o._openStripeCheckout({sessionId:t,clientReferenceId:a,domain:c,events:n.events},function(e,i){i&&s&&s(null,i)})}})}else s&&s("Missing items",null);else s&&s("invalid params",null);else s&&s("Missing awsApiPublicKey in context",null);else s&&s("Missing stripePublicKey in context",null)},purchase:function(e,t){var i=this;if(i.context.apiKeys.stripePublicKey)if(i.context.apiKeys.awsApiPublicKey)if(e)if(e.items&&0!=e.items.length){for(var n=[],s=0;s<e.items.length;s++){if(!e.items[s].sku)return void(t&&t("Missing sku in items index "+s,null));n.push({sku:e.items[s].sku,quantity:e.items[s].quantity||1})}var o=window.siteConfig.endPoints.appHost,c={items:n,clientReferenceId:"app_id_"+i.context.appId+"_ref_id_"+i._guid(),successUrl:o+"/payments/success",cancelUrl:o+"/payments/cancel",submitType:e.submitType,domain:o,events:e.events};i._openStripeCheckout(c,function(e,i){i&&t&&t(null,i)})}else t&&t("Missing items",null);else t&&t("invalid params",null);else t&&t("Missing awsApiPublicKey in context",null);else t&&t("Missing stripePublicKey in context",null)}};
