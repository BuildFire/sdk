...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(i){return typeof i}:function(i){return i&&"function"==typeof Symbol&&i.constructor===Symbol&&i!==Symbol.prototype?"symbol":typeof i},imageTools={get ENUMS(){return{SIZES:{xxs:32,xs:64,s:128,m:200,l:304,xl:416,xxl:600,720:720,1080:1080,1440:1440,1920:1920,2560:2560,3840:3840,get full_width(){return this.findNearest(1)},get half_width(){return this.findNearest(2)},get third_width(){return this.findNearest(3)},get fourth_width(){return this.findNearest(4)},get fifth_width(){return this.findNearest(5)},get sixth_width(){return this.findNearest(6)},findNearest:function(i){for(var e=null,t=0;t<this.VALID_SIZES.length;t++){var n=this.VALID_SIZES[t];if(window.innerWidth/i<this[n]){e=n;break}}return this[e]},VALID_SIZES:["xxs","xs","s","m","l","xl","xxl","720","1080","1440","1920","2560","3840","full_width","half_width","third_width","quarter_width","fifth_width","sixth_width"]},ASPECT_RATIOS:{"1:1":1,"4:3":.75,"16:9":.5625,"9:16":1.77777778,"11:5":.45454545,"4:1":.25,"2.39:1":.41841004,VALID_RATIOS:["1:1","4:3","16:9","9:16","11:5","4:1","2.39:1"]}}},resizeImage:function(i,e,t,n){if(!i)return null;if(/\..{3,4}(?!.)/g.test(i)&&!/.(png|jpg|jpeg)(?!.)/gi.test(i)){var r=(/.{0,4}(?!.)/g.exec(i)||["Selected"])[0];return console.warn(r+" files are not supported by resizeImage. Returning original URL: "+i),i}if(e){if("object"!=(void 0===e?"undefined":_typeof(e)))throw"options not an object"}else e={width:window.innerWidth};if((o=e.disablePixelRation?1:window.devicePixelRatio)<1)var o=1;"full"==e.width&&(e.width=window.innerWidth),"full"==e.height&&(e.height=window.innerHeight);var s=window.siteConfig.endPoints.cloudImageHost,a=-1!==i.indexOf("?"),h=s+"/"+i+(a?"&":"?")+"func=bound";if(e.compression&&(h+="&q="+imageTools.getCompression(e.compression)),e.size&&e.aspect){if(this.ENUMS.SIZES.VALID_SIZES.indexOf(e.size)<0){var l=this.ENUMS.SIZES.VALID_SIZES.join(", ");return console.warn("Inavlid size. Availible options are "+l+". Returning original url"),i}if(this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.indexOf(e.aspect)<0){var d=this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.join(", ");return console.warn("Inavlid aspect ratio. Availible options are "+d+". Returning original url"),i}e.width=this.ENUMS.SIZES[e.size],e.height=e.width*this.ENUMS.ASPECT_RATIOS[e.aspect]}if(e.width&&!e.height)h+="&width="+Math.floor(e.width*o);else if(!e.width&&e.height){h+="&height="+Math.floor(e.height*o)}else if(e.width&&e.height){h+="&width="+Math.floor(e.width*o)+"&height="+Math.floor(e.height*o)}else h=i;return this._handleElement(t,h,n),h},cropImage:function(i,e,t,n){if(!i)return null;if(/\..{3,4}(?!.)/g.test(i)&&!/.(png|jpg|jpeg)(?!.)/gi.test(i)){var r=(/.{0,4}(?!.)/g.exec(i)||["Selected"])[0];return console.warn(r+" files are not supported by cropImage. Returning original URL: "+i),i}if(e||(e={}),"object"!=(void 0===e?"undefined":_typeof(e)))throw"options not an object";if(e.size&&e.aspect){if(this.ENUMS.SIZES.VALID_SIZES.indexOf(e.size)<0){var o=this.ENUMS.SIZES.VALID_SIZES.join(", ");return console.warn("Inavlid size. Availible options are "+o+". Returning original url"),i}if(this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.indexOf(e.aspect)<0){var s=this.ENUMS.ASPECT_RATIOS.VALID_RATIOS.join(", ");return console.warn("Inavlid aspect ratio. Availible options are "+s+". Returning original url"),i}e.width=this.ENUMS.SIZES[e.size],e.height=e.width*this.ENUMS.ASPECT_RATIOS[e.aspect]}if(e.width||e.height||(e={width:"full",height:"full"}),"full"==e.width&&(e.width=window.innerWidth),"full"==e.height&&(e.height=window.innerHeight),!e.width||!e.height)return console.warn("cropImage doenst have width or height please fix. returning original url"),i+"?h="+e.height+"&w="+e.width;var a=window.devicePixelRatio;e&&e.disablePixelRatio&&(a=e.disablePixelRatio);var h=window.siteConfig.endPoints.cloudImageHost,l=-1!==i.indexOf("?"),d=h+"/"+i+(l?"&":"?")+"func=crop";return e.compression&&(d+="&q="+imageTools.getCompression(e.compression)),d+="&width="+Math.floor(e.width*a)+"&height="+Math.floor(e.height*a),this._handleElement(t,d,n),d},_handleElement:function(t,n,i){if(t&&n){var e=this._getLocalPath(n);"IMG"===t.tagName?(t.style.setProperty("opacity","0","important"),t.src=e,t.onload=function(){t.style.removeProperty("opacity"),i&&i(e)},t.onerror=function(){bfUtils.isAppHtml5Version||imageCacheAPI.download(n,function(i,e){if(i)return t.src=n;t.src=e})}):this._handleBgImage(t,e,n,i)}},_handleBgImage:function(t,i,n,r){o(t,i);var e=new Image;function o(i,e){if(!e)return i.style.removeProperty("background-image");var t='url("'+e+'")';i.style.setProperty("background-image",t,"important")}e.src=i,e.onload=function(){r&&r(i)},e.onerror=function(){if(o(t),bfUtils.isAppHtml5Version)return o(t,n);imageCacheAPI.download(n,function(i,e){if(i)return r&&r(n),o(t,n);window.requestAnimationFrame(function(){o(t,e),r&&r(e)})})}},_getLocalPath:function(i){if(bfUtils.isAppHtml5Version)return i;var e=(i=i.replace(/(http|https):\/\/\S{0,8}.cloudimg.io\//g,"")).match(/(png|jpg|jpeg)/g)[0]||"";e=e?"."+e:"";var t=0;if(!i.length)return t;for(var n=0;n<i.length;n++){t=(t<<5)-t+i.charCodeAt(n),t|=0}return"cdvfile://localhost/persistent/imageCache/images/"+t+e},getCompression:function(i){return i=Number(i),isNaN(i)?console.warn("Disabling compression, must be an integer between 1-100"):(70<i&&(i=70,console.warn("Falling back to 70. Maximum allowed compression is 70.")),i)},isProdImageServer:function(i){return 0==i.indexOf("http://imageserver.prod.s3.amazonaws.com")||0==i.indexOf("https://imageserver.prod.s3.amazonaws.com")||0==i.indexOf("https://s3-us-west-2.amazonaws.com/imageserver.prod")}};
