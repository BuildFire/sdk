...
var inputAPI = {
  ...
  init: function init() {
    ...
    this.inputDialog.appendChild(this.currentUserContainer);
  ...
  renderStep: function renderStep(stepOptions, handleCancel, handleNext) {
    ...
    this.textarea.maxlength = stepOptions.maxLength || 10000;
    this.textarea.value = stepOptions.defaultValue || '';
    this.cancelButton.innerHTML = stepOptions.cancelText || 'Cancel';
    this.doneButton.innerHTML = stepOptions.saveText || stepOptions._buffer.length ? 'Next' : 'Done';
  ...
  showTextDialog: function showTextDialog(options, callback) {
    ...
    var handleNext = function handleNext(currentStepResults) {
      ...
      if (nextStep) {
        ...
        _this3.renderStep(nextStep, handleCancel, handleNext);
      } else {
        _this3.inputDialog.classList.remove('active');
