...
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}"undefined"==typeof AiAPI&&(window.AiAPI=function(e){this.context=e,this.transformVariables=function(t){var n={"[app-interests]":"[Travel planning]","[subject]":"[Travel planning]","[business-type]":"[Travel planning]","[app-name]":"[".concat(window.appContext.currentApp.appName,"]"),"[target-region]":"[San Diego]"};return Object.freeze(n),Object.keys(n).forEach(function(e){t=t.replaceAll(e,n[e])}),t}}),AiAPI.prototype.chat=function(e,t){(e=!e||"object"!=_typeof(e)?{}:e).appId=window.appContext.currentApp.appId;e={url:"".concat(window.siteConfig.endPoints.gatewayHost,"/ai/chat"),headers:{"Content-Type":"application/json"},body:JSON.stringify(e),method:"POST"};fetch(e.url,{method:e.method,headers:e.headers,body:e.body}).then(function(e){return e.ok?e.json().then(function(e){return e}):e.json().then(function(e){var t=e.innerError||{},e={code:t.code,message:t.message,error:t.error};throw t.aiStatus&&(e.aiStatus=t.aiStatus),e})}).then(function(e){t(null,e)}).catch(function(e){e&&e.message&&e.code&&"unknownerror"!==e.code.toLowerCase()?t(e,null):t({code:"unknownError",message:"Unable to process your request"},null)})},AiAPI.prototype.showSeederMessagePrompt=function(e,o){var t=e.userMessage,n=e.showClearDataWarning,a=e.hintText;if("string"!=typeof t)return o("Invalid parameter 'userMessage'. It must be a valid string.");e=new DialogAPI(this.context),t=this.transformVariables(t);e._show({isMessageHTML:!0,title:"Generate AI Data",message:"<p>You can customize the following AI request. ".concat(n?'<span class="text-warning">Warning:</span> Existing data will be cleared.':"",'</p><textarea style="text-wrap: nowrap;" class="form-control margin-top-ten" id="aiDataRequest">').concat(t,"</textarea> ").concat(a?'<span style="color: #b0b0b0;display: block;margin-top: 5px;margin-bottom: 10px; font-size: 12px;">'+a+"</span>":""),showCancelButton:!0,actionButtons:[{text:"Save",type:"success"}]},function(e,t){var n;return e?o(e):void("success"===(null==t||null===(n=t.selectedButton)||void 0===n?void 0:n.type)&&(n=document.querySelector("#aiDataRequest"),o(null,{userMessage:n.value})))})},AiAPI.prototype.showSeederCSVPrompt=function(e,o){var t=e.sampleCSV,n=e.showResetAndSaveButton,a=e.hintText;if("string"!=typeof t)return o("Invalid parameter 'sampleCSV'. It must be a valid string.");var r=new DialogAPI(this.context),e=[{text:"Save",type:"success"}];n&&e.unshift({type:"warning",text:"Reset And Save"}),r._show({isMessageHTML:!0,title:"AI Import Data",message:'<p>I have the following comma separated records:</p><textarea style="text-wrap: nowrap; height: 175px;" class="form-control margin-top-ten" id="aiDataRequest">'.concat(t,"</textarea>").concat(a?'<span style="color: #b0b0b0;display: block;margin-top: 5px;margin-bottom: 10px; font-size: 12px;">'+a+"</span>":""),showCancelButton:!0,actionButtons:e},function(e,t){var n;return e?o(e):void(["warning","success"].includes(null==t||null===(n=t.selectedButton)||void 0===n?void 0:n.type)&&(n=t.selectedButton.type,t=document.querySelector("#aiDataRequest"),o(null,{sampleCSV:t.value,reset:"warning"===n})))})};