...
"use strict";$app.controller("userProfileCtrl",["Upload","$scope",function(n,o){(window.authAPI.userProfileCtrlScope=o).user=null,o.userProfile=null,o.tempUser=null,o.tempUserProfile=null,o.editingProfile=!1,o.uploadProfileImage=null,o.uploadBackgroundImage=null,o.errors={},o._appRoot=window._appRoot;var r=window.appContext.currentApp.appId,t="appearance",e={appId:window.appContext.currentApp.appId,pluginId:t,instanceId:t},s=new AppDatastoreAPI(r),i=new window.DatastoreAPI(e);s.search({tag:"$$badges",obj:{sort:{rank:1}}},function(e,r){if(e)return console.error(e);o.badges=r,o.$$phase||o.$apply()});var a=function(e){var t=e.tags?e.tags[r]:[];if(!t.length)return[];var s=[];return o.badges.forEach(function(r){var e=t.find(function(e){return e.tagName===r.data.tag&&e.appliedCount>=r.data.tagCount});if(e){var n=Math.floor(e.appliedCount/r.data.tagCount);r.data.appliedCount=n,imageTools&&(r.data.imageUrl=imageTools.cropImage(r.data.imageUrl,{size:"xxs",aspect:"1:1",compression:80,disablePixelRatio:1})),s.push(r.data)}}),s},l=document.getElementsByClassName("profile-container")[0],u=function(){if(o.user.imageUrl)o.user.imageUrl=imageTools.cropImage(o.user.imageUrl,{size:"s",aspect:"1:1"});else{var e={id:1,method:"users/getUserImage",params:{userId:o.user._id,externalAppId:window.currentAppId}},r=window.siteConfig.endPoints.authHost+"/src/server.js?data="+encodeURIComponent(JSON.stringify(e));o.user.imageUrl=r}return o.user.imageUrl};o.getUserProfile=function(){var e={id:1,method:"users/getUserProfile",params:{userId:o.user._id}},r=window.siteConfig.endPoints.socialHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));window.bfUtils.http.jsonp(r,{bypassInterceptorForStatus:404}).success(function(e){e&&e.result&&(e.result.email=o.user.email,o.userProfile=e.result)}).error(function(e,r,n,t){o.invalidCredentials=!0,console.error(e)})},o.close=function(e){if(e||!o.busy){if(o.tempUser=null,o.tempUserProfile=null,o.editingProfile=!1,o.uploadProfileImage=null,o.uploadBackgroundImage=null,o.busy=!1,e)return o.user=null,void(o.userProfile=null);l.addEventListener("animationend",function(){o.user=null,o.userProfile=null,o.$$phase||o.$apply(function(){l.classList.remove("closing")})},{once:!0}),requestAnimationFrame(function(){l.classList.add("closing")})}},o.openProfile=function(){return!(window.location.hash="/editUserProfile")},o.openUrl=function(e){return e&&(e.toLowerCase().indexOf("http")<0&&(e="https://"+e),window.open(e,"_blank","location=yes,enableViewportScale=yes")),!1};var p=function(e,s){var r={id:1,method:"users/getPublicUser",params:{userId:e,externalAppId:window.currentAppId}},n=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(r));window.bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){e.result.badges=a(e.result),s(null,e)}).error(function(e,r,n,t){console.error(e),s(e,null)})},d=function(e,s){var r={id:1,method:"users/getUserByAccessToken",params:{accessToken:e,externalAppId:window.currentAppId}},n=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(r));window.bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.error)if(1311===e.error.code){window.openDialog({data:{title:"Login Required",body:"Please login again",disableCancel:!0}},function(){authAPI.logout()})}else 1309===e.error.code?authAPI.logout():(console.error(e.error),s(e.error,null));else e.result.badges=a(e.result),s(null,e)}).error(function(e,r,n,t){console.error(e),s(e,null)})},c=null,f=null;o.open=function(e){window.spinner.show(),c=e,f=authAPI.getCurrentUser(),c||f&&f._id&&(c=f._id),c&&i.get({tag:t,withDynamicData:!0},function(e,n){if(e)return console.error(e),void callback(e);n&&n.data&&n.data.customRegistration&&n.data.customRegistration.active&&"enterprise"===window.appContext.currentApp.config.type?(o.showCustomUserProfile=!0,f&&f._id==c?d(f.accessToken,function(e,r){r&&(o.user=r.result,window.spinner.hide(),f&&f._id==o.user._id&&(o.user.userToken=f.userToken),u(),m(n.data.customRegistration,r.result),o.customUserProfile=r.result,o.getUserProfile())}):p(c,function(e,r){r&&(o.user=r.result,window.spinner.hide(),u(),m(n.data.customRegistration,r.result),o.customUserProfile=r.result,o.getUserProfile())})):f&&f._id==c?d(f.accessToken,function(e,r){r&&(o.user=r.result,window.spinner.hide(),f&&f._id==o.user._id&&(o.user.userToken=f.userToken),u(),o.getUserProfile())}):p(c,function(e,r){r&&(o.user=r.result,window.spinner.hide(),u(),o.getUserProfile())})})};var m=function(e,r){customRegistration.getFields({defaults:r,isProfileMode:!0,customRegistrationSettings:e,refreshUI:function(){o.$$phase||o.$apply()}},function(e,r){r&&(o.customRegistrationFields=r.fields,o.customRegistration=r,o.initCustomRegistration=function(){r.initializers.forEach(function(e){e()})},o.$$phase||o.$apply())})};authAPI.onLogout(function(){o.user&&delete o.user.userToken,o.close(force)}),o.tempUser=null,o.tempUserProfile=null,o.busy=!1,o.cancelEdit=function(){return o.tempUser=null,o.tempUserProfile=null,o.editingProfile=null,o.uploadBackgroundImage=null,o.uploadProfileImage=null,window.spinner.hide(),w&&(clearInterval(w),w=null),o.$$phase||o.$apply(),!1};var g=function(r,s){var e={id:1,method:"users/update",params:r},n=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(angular.toJson(e));window.spinner.show(),window.bfUtils.http.jsonp(n).success(function(e){o.tempUser.lastUpdated=(new Date).toISOString(),userTags.setRegistrationTags(r.userProfile,!1,function(e,r){e&&console.log(e)}),s(null,e)}).error(function(e,r,n,t){console.error(e),o.busy=!1,s(e,null)}).finally(window.spinner.hide)};o.update=function(){o.tempUserProfile||(o.tempUserProfile={}),o.busy=!0,o.tempUser.displayName=o.tempUser.firstName+" "+o.tempUser.lastName,o.uploadImage(o.uploadProfileImage,function(e,r){r&&(o.tempUser.imageUrl=r.result),o.uploadImage(o.uploadBackgroundImage,function(e,r){r&&(o.tempUserProfile.backgroundImage=r.result),function(s){if(o.customRegistration)o.customRegistration.fetch({validateFields:!0,validateLinks:!1,mode:"edit"},function(e,r){if(e)o.busy=!1;else{for(var n in r.user)r.user.hasOwnProperty(n)&&(o.tempUser[n]=r.user[n]);var t=r.user;t._id=o.tempUser._id,t.userToken=o.tempUser.userToken,t.imageUrl=o.tempUser.imageUrl,t.externalAppId=window.appContext.currentApp.appId,g(t,s)}});else{var e={};e._id=o.tempUser._id,e.email=o.tempUser.email,e.userToken=o.tempUser.userToken,e.firstName=o.tempUser.firstName,e.lastName=o.tempUser.lastName,e.displayName=o.tempUser.displayName,e.imageUrl=o.tempUser.imageUrl,e.externalAppId=window.appContext.currentApp.appId,g(e,s)}}(function(){!function(s){var e=JSON.parse(JSON.stringify(o.tempUserProfile));e||(e={}),e.userId=o.tempUser._id,e.userToken=o.tempUser.userToken,e.email=o.tempUser.email,e.firstName=o.tempUser.firstName,e.lastName=o.tempUser.lastName,e.displayName=o.tempUser.displayName;var r={id:1,method:"users/saveUserProfile",params:e},n=window.siteConfig.endPoints.socialHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(r));window.bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){s(null,e)}).error(function(e,r,n,t){console.error(e),s(e,null)})}(function(){o.tempUser.badges=o.user.badges,o.user=o.tempUser,o.tempUser=null,o.userProfile=o.tempUserProfile,o.tempUserProfile=null,o.uploadBackgroundImage=null,o.uploadProfileImage=null,authAPI._setCurrentUser(o.user),authAPI.triggerOnUpdate(),o.editingProfile=!1,o.busy=!1})})})})};var w=null;o.uploadImage=function(e,s){if(e){var r=window.siteConfig.endPoints.authHost+"/src/server.js?method=users/uploadImage";window.spinner.show(),w=setInterval(function(){window.spinner.show()},10010),n.upload({url:r,data:{file:e,userToken:o.user.userToken,externalAppId:window.currentAppId}}).progress(function(e){o.progressMessage=!0;var r=parseInt(100*e.loaded/e.total);console.log("progress: "+r+"%")}).success(function(e,r,n,t){console.log("file uploaded."),s&&s(null,e)}).error(function(e){s&&s(e,null)}).finally(function(){w&&(clearInterval(w),w=null),window.spinner.hide()})}else s(null,null)},o.editProfile=function(){null!=f&&f._id&&(o.tempUser=f,o.currentUserEmail=f.email,o.tempUserProfile=o.userProfile,o.editingProfile=!0,o.busy=!1,o.$$phase||o.$apply())},(bfUtils.isIOS||bfUtils.isAndroid)&&(l.style.maxHeight=window.innerHeight+"px",l.style.minHeight=window.innerHeight+"px")}]),$app.filter("cropCoverImage",function(){return function(e){if(!e)return"";if(!imageTools||!/(https|http):\/\//g.test(e))return e;var r="full_width";return-1<window.location.href.indexOf("pluginTester")&&(r="xl"),imageTools.cropImage(e,{size:r,aspect:"16:9",compression:80})}});
...
"use strict";var richModal=function(){var g=document.createElement("div");g.id="richModal",g.className="hidden";var e=document.createElement("div");e.className="focus-screen hidden",g.appendChild(e),document.body.appendChild(g);var h=null,p=[];function f(){try{if(h)return;if(0<=window.location.hash.indexOf("accessCode"))return setTimeout(f,5e3);var e=document.getElementsByClassName("login-holder")[0];if(e&&-1===e.className.indexOf("ng-hide"))return setTimeout(f,5e3);var t=(h=p.shift()).options,n=h.callback;document.getElementById("richModal").className="";var i=document.getElementsByClassName("focus-screen")[0];i.className="focus-screen animated fadeInScreen",i.onclick=function(){b()};var a=document.createElement("div");if(a.className="detail-modal animated fadeInUp",t.title){var o=document.createElement("h1");if(30<t.title.length&&(t.title=t.title.substring(0,27).trim()+"..."),o.innerHTML=t.title,t.design){var s="";t.design.title&&t.design.title.align&&(s+="text-align: "+t.design.title.align+" !important;"),t.design.textColor&&(s+="color: "+t.design.textColor+" !important;"),o.setAttribute("style",s)}a.appendChild(o)}if(t.subtitle){var l=document.createElement("span");if(l.className="subtitle",l.innerHTML=t.subtitle,t.design){s="";t.design.subtitle&&t.design.subtitle.align&&(s+="text-align: "+t.design.subtitle.align+" !important;"),t.design.textColor&&(s+="color: "+t.design.textColor+" !important;"),l.setAttribute("style",s)}a.appendChild(l)}var c=document.createElement("div");c.className="rich-content",c.innerHTML=t.richContent||"",a.appendChild(c);var r=document.createElement("div");if(r.className="button-container",a.appendChild(r),t.showDismissButton||void 0===t.showDismissButton){var d=document.createElement("button");d.className=t.action?"dismiss-button primaryTheme":"dismiss-button dismiss-large primaryTheme",d.innerHTML="Dismiss",d.onclick=function(){b(),n&&n(null,{buttonType:"dismiss"})},r.appendChild(d)}var m="";t.design&&(t.design.fullScreen&&g.classList.add("fullScreen"),t.design.backgroundColor&&(m+="background : "+t.design.backgroundColor+" !important;"),t.design.textColor&&(m+="color : "+t.design.textColor+" !important"),a.setAttribute("style",m),d.setAttribute("style",m))}catch(e){console.error("Failed to render rich modal",e)}if(t.action)try{var u=document.createElement("button");!(u.className="action-button primaryTheme")===t.showDismissButton&&(u.className="action-button primaryTheme action-button-large"),t.action.title&&11<t.action.title.length&&(t.action.title=t.action.title.substring(0,8).trim()+"..."),u.innerHTML=t.action.title||"[ Click ]",u.onclick=function(){t.action.handler?t.action.handler():((new ActionItemsAPI).execute(t.action,function(e,t){}),n&&n(null,{buttonType:"action",value:t.action}));t.action.preventAutoClose||b()},t.design&&m&&u.setAttribute("style",m),r.appendChild(u)}catch(e){console.error("Failed to bind action to rich modal",e)}document.getElementById("richModal").appendChild(a)}function b(){var e=document.getElementsByClassName("focus-screen")[0];e&&(e.className="focus-screen animated fadeOutScreen");var t=document.getElementsByClassName("detail-modal")[0];t&&(t.className="detail-modal animated fadeOut");var n=document.getElementById("richModal");setTimeout(function(){t&&t.remove(),h=null,0<p.length?setTimeout(f,300):n&&(n.className="hidden")},700)}return{display:function(e,t){p.push({options:e,callback:t}),f()},close:function(){b()}}}();
