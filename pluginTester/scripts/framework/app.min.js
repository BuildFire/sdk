...
"use strict";var bfUtils={get deviceOnline(){return"undefined"==typeof navigator||(navigator.connection&&navigator.connection.type?"none"!=navigator.connection.type:void 0===navigator.onLine||navigator.onLine)},get isMobileDevice(){return window.location.protocol.indexOf("http")<0},get isAndroid(){return window.location.protocol.indexOf("http")<0&&"undefined"!=typeof device&&"Android"==device.platform},get isIOS(){return window.location.protocol.indexOf("http")<0&&"undefined"!=typeof device&&"iOS"==device.platform},get isPwaAndroid(){return!!navigator.userAgent.match(/Android/i)},get isPwaiOS(){return"standalone"in window.navigator&&!window.navigator.standalone},get isAppHtml5Version(){return window.self==window.top},get isEmulatorCP(){return window.top&&window.top!=window&&0==window.location.protocol.indexOf("http")},tryParseJSON:function(n){try{return JSON.parse(n)}catch(t){return void console.error("Cannot parse data :: "+n,t.message,t.stack)}},getCurrentUser:function(t,n){if(window.authAPI&&window.authAPI.getCurrentUser)return window.authAPI.getCurrentUser(t,n)},get http(){return window.$http?window.$http:window.httpClient}};
"use strict";var userTags={get isUserTaggingEnabled(){return window.appContext&&window.appContext.currentApp&&window.appContext.currentApp.config&&window.appContext.currentApp.config.userTagging&&"hidden"!=window.appContext.currentApp.config.userTagging&&"disabled"!=window.appContext.currentApp.config.userTagging},init:function(){setTimeout(function(){userTags.isUserTaggingEnabled&&userTags.refreshUserTags()},1e3)},refreshUserTags:function(){bfUtils.getCurrentUser(function(e,n){if(e)return console.error(e),void callback(e,null);if(n){var r={skip:0,limit:1,name:[]};r.name.push(n.email),bfUtils.http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/userSearch/"+window.appContext.currentApp.appId+"/",r).success(function(e){e.users[0]&&(n.tags=e.users[0].tags,authAPI._setCurrentUser(n))}).error(function(e){console.error(e)})}})},checkPluginAccessSettings:function(e,a){var o=e.accessSettings;!bfUtils.isEmulatorCP&&e.requiresLogin?bfUtils.getCurrentUser(function(e,n){if(e)return console.error(e),void a(e,null);if(n){if(!userTags.isUserTaggingEnabled||"enabled"!=window.appContext.currentApp.config.advancedPluginAccessSettings)return void a(null,!0);if(!o)return void a(null,!0);if(!o.requiresTags)return void a(null,!0);if(!o.requiredTags||0==o.requiredTags.length)return void a(null,!0);if(o.giveAccessWhen)if(n.tags&&n.tags[window.appContext.currentApp.appId]&&0<n.tags[window.appContext.currentApp.appId].length){var r=n.tags[window.appContext.currentApp.appId];if("matchAllTags"==o.giveAccessWhen){for(var i=0;i<o.requiredTags.length;i++){for(var t=!1,s=0;s<r.length;s++)if(r[s].tagName==o.requiredTags[i].name&&o.requiredTags[i].appliedCount<=r[s].appliedCount){t=!0;break}if(!t)return void a(null,!1)}a(null,!0)}else{for(i=0;i<o.requiredTags.length;i++)for(s=0;s<r.length;s++)if(r[s].tagName==o.requiredTags[i].name&&o.requiredTags[i].appliedCount<=r[s].appliedCount)return void a(null,!0);a(null,!1)}}else a(null,!1);else a(null,!1)}else a(null,!1)}):a(null,!0)},setBehavioralTags:function(r){bfUtils.isMobileDevice&&bfUtils.deviceOnline&&userTags.isUserTaggingEnabled&&bfUtils.getCurrentUser(null,function(e,n){e?console.log(e):n&&bfUtils.http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/app/"+window.appContext.currentApp.appId+"/user/assignBehavioralTag",{instanceId:r,userToken:n.userToken}).success(function(e){}).error(function(e){console.log(e)})})}};userTags.init();
...
"use strict";var inputAPI={initialized:!1,currentStepData:{},currentStepOptions:{},init:function(){var e=this;this.inputDialog?this.inputDialog.innerHTML="":(this.inputDialog=document.createElement("div"),this.inputDialog.style.display="none"),window.addEventListener("keyboardWillShow",function(){e.actionFooter.style.display="none"}),window.addEventListener("keyboardDidHide",function(){e.actionFooter.style.display="flex"}),0<=window.location.pathname.indexOf("pluginTester")?(this.inputDialog.style.height=document.getElementById("app").offsetHeight+"px",this.inputDialog.style.position="absolute"):(this.inputDialog.style.height="100vh",this.inputDialog.style.position="fixed"),this.inputDialog.id="inputDialog",this.inputDialog.className="primaryBackgroundTheme",this.inputDialog.className="backgroundColorTheme",this.dialogNav=document.createElement("div"),this.dialogNav.className="inputapi-nav titleBarBackgroundTheme",this.inputDialog.appendChild(this.dialogNav),this.dialogNavFlex=document.createElement("div"),this.dialogNavFlex.className="inputapi-nav-flex",this.dialogNav.appendChild(this.dialogNavFlex),this.currentUserContainer=document.createElement("div"),this.currentUserContainer.className="inputapi-user-container",this.inputDialog.appendChild(this.currentUserContainer),this.textarea=document.createElement("textarea"),this.textarea.className="inputapi-textarea",this.textarea.addEventListener("input",function(t){e.currentStepData.textValue=t.target.value,e.currentStepData.textValue.length>e.currentStepOptions.maxLength&&(e.currentStepData.textValue=e.currentStepData.textValue.substring(0,e.currentStepOptions.maxLength),t.target.value=e.currentStepData.textValue),e.doneButton.disabled=!(!e.currentStepOptions.required||e.currentStepData.textValue.length)}),this.textarea.onfocus=function(t){document.body.scrollTop=0},this.inputDialog.appendChild(this.textarea),this.imageGallery=document.createElement("div"),this.imageGallery.id="imageGallery",this.inputDialog.appendChild(this.imageGallery),this.cancelButton=document.createElement("button"),this.cancelButton.className="inputapi-cancel titleBarTextAndIcons",this.dialogNavFlex.appendChild(this.cancelButton),this.title=document.createElement("h1"),this.title.className="inputapi-nav-title titleBarTextAndIcons",this.dialogNavFlex.appendChild(this.title),this.doneButton=document.createElement("button"),this.doneButton.className="inputapi-done titleBarTextAndIcons",this.dialogNavFlex.appendChild(this.doneButton),this.actionFooter=document.createElement("div"),this.actionFooter.className="inputapi-footer",this.inputDialog.appendChild(this.actionFooter),this.cameraBtn=document.createElement("span"),this.cameraBtn.className="glyphicon glyphicon-camera",this.cameraBtn.onclick=function(t){return e.showFileDialog()},this.actionFooter.appendChild(this.cameraBtn),0<=window.location.pathname.indexOf("pluginTester")?document.getElementById("app").appendChild(this.inputDialog):document.body.appendChild(this.inputDialog),this.initialized=!0},showFileDialog:function(){var i=this,t=new PublicFilesAPI({appId:"testAppId"});t._onComplete=function(t){if("success"===t.status){if(6<=i.currentStepData.images.length)return;i.currentStepData.images.push(t.url),i.updateImageGallery()}else console.error("Image upload failed - inputAPI",t)},t._onProgress=function(){window.spinner&&window.spinner.show(),i.doneButton.disabled=!0},t.showDialog({},function(t,e){window.spinner&&setTimeout(window.spinner.hide.bind(null,!0),300),i.doneButton.disabled=!(!i.currentStepOptions.required||!i.currentStepData.textValue||i.currentStepData.textValue.length)})},updateImageGallery:function(){var t=this.currentStepData.images.length-1,e=this.currentStepData.images[t];this.addImageToGallery(e,t),this.currentStepData.images.length&&this.currentStepData.images.length<6?this.addPlusToGallery():this.removePlusBtn(),6<=this.currentStepData.images.length?this.cameraBtn.style.color="#555 !important":this.cameraBtn.style.color=""},removePlusBtn:function(){this.plusBtn&&this.plusBtn.parentNode&&this.plusBtn.parentNode.removeChild(this.plusBtn)},addPlusToGallery:function(){var e=this;this.plusBtn||(this.plusBtn=document.createElement("span"),this.plusBtn.className="glyphicon glyphicon-plus",this.plusBtn.onclick=function(t){return e.showFileDialog()},this.imageGallery.appendChild(this.plusBtn))},addImageToGallery:function(t,e){var i=this,n=document.createElement("div");n.className="img-gallery-container animated fadeInUp";var a=document.createElement("span");a.className="galery-delete glyphicon glyphicon-remove-sign",a.onclick=function(){i.currentStepData.images.splice(e,1),i.imageGallery.removeChild(i.imageGallery.children[e])},n.appendChild(a),this.plusBtn&&this.plusBtn.parentNode&&(this.plusBtn.parentNode.removeChild(this.plusBtn),delete this.plusBtn);var s=document.createElement("img");s.setAttribute("src","https://czi3m2qn.cloudimg.io/crop/100x100/q50/"+t),s.className="img-gallery-item",n.appendChild(s),this.imageGallery.appendChild(n),this.addPlusToGallery()},renderStep:function(t,e,i){var n=this;window.Keyboard&&window.Keyboard.shrinkView&&(window.Keyboard.shrinkView(!0),window.Keyboard.disableScrollingInShrinkView(!0)),this.currentStepData={textValue:t.defaultValue||"",images:[]},t.maxLength=t.maxLength||2e3,this.currentStepOptions=t,this.title.innerHTML=t.title||"",this.actionFooter.style.display=t.attachments?"flex":"none",!t.required||t.defaultValue&&0<t.defaultValue.length?this.doneButton.disabled=!1:this.doneButton.disabled=!0,this.cameraBtn.style.display=this.currentStepOptions.attachments&&this.currentStepOptions.attachments.images&&this.currentStepOptions.attachments.images.enable&&this.currentStepData.images.length<6?"block":"none",this.currentUserContainer.innerHTML="";var a=bfUtils.getCurrentUser();console.log("Renering inputAPI for user",a),this.userImage=document.createElement("img"),a&&a.imageUrl?this.userImage.src="https://czi3m2qn.cloudimg.io/crop/50x50/q70/"+a.imageUrl:this.userImage.src="https://pluginserver.buildfire.com/styles/media/avatar-placeholder.png",this.userImage.className="inputapi-user-image",this.currentUserContainer.appendChild(this.userImage),this.userTitle=document.createElement("h1"),this.userTitle.className="inputapi-user-title",a&&a.displayName&&(this.userTitle.innerHTML=a.displayName),this.currentUserContainer.appendChild(this.userTitle),this.textarea.placeholder=t.placeholder||"Type something...",this.textarea.maxLength=t.maxLength||2e3,this.textarea.value=t.defaultValue?t.defaultValue.substring(0,this.textarea.maxLength):"",this.cancelButton.innerHTML=t.cancelText||"Cancel",this.doneButton.innerHTML=t.saveText?t.saveText:t._buffer.length?"Next":"Done",this.doneButton.onclick=function(t){return i(n.currentStepData)},this.cancelButton.onclick=function(t){return e()}},showTextDialog:function(t,n){var a=this;if(t&&n){this.initialized||this.init();var s=Array.isArray(t)?t:[t],l=[],e=!1,i=!1,r=!1;if(s.forEach(function(t){t.cancelText&&9<t.cancelText.length&&(r=!0),t.saveText&&9<t.saveText.length&&(i=!0),t.title&&14<t.title.length&&(e=!0)}),e)return n(new Error("Title too long, max 14 chars"));if(i)return n(new Error("saveText too long, max 9 chars"));if(r)return n(new Error("cancelText too long, max 9 chars"));var o=function(){a.inputDialog.classList.remove("active"),n(null,{cancelled:!0,results:l}),setTimeout(c,600),setTimeout(function(){a.inputDialog.style.display="none",a.init()},500)},u=s.shift();u._buffer=s,this.renderStep(u,o,function t(e){l.push(e);var i=s.shift();i?(i._buffer=s,a.renderStep(i,o,t)):(a.inputDialog.classList.remove("active"),n(null,{cancelled:!1,results:l}),setTimeout(c,600),setTimeout(function(){a.inputDialog.style.display="none",a.init()},500))}),this.inputDialog.style.display="flex",setTimeout(function(){a.inputDialog.classList.add("active")},10)}function c(){window.Keyboard&&window.Keyboard.shrinkView&&(window.Keyboard.shrinkView(!1),window.Keyboard.disableScrollingInShrinkView(!1))}}};setTimeout(function(){inputAPI.init()},5e3);
"use strict";var bookmarkAPI={add:function(r,t){var e=window.appContext.currentPlugin.instanceId,n=bfUtils.getCurrentUser(),a=(n?n._id:"guest")+".bookmarks",o=localStorage.getItem(a)?JSON.parse(localStorage.getItem(a)):[];r.id=r.id||r.title,r.pluginInstanceId=e;var l=o.findIndex(function(t){var e=t.id===r.id,n=t.pluginInstanceId===r.pluginInstanceId;return e&&n});0<=l?o[l]=r:o.push(r),localStorage.setItem(a,JSON.stringify(o)),t(null,r)},delete:function(e,t){var n=bfUtils.getCurrentUser(),r=(n?n._id:"guest")+".bookmarks",a=localStorage.getItem(r)?JSON.parse(localStorage.getItem(r)):[],o=a.findIndex(function(t){return t.id===e});0<=o&&a.splice(o,1),localStorage.setItem(r,JSON.stringify(a)),t&&t(null,a)},deleteFromPlugin:function(e,t){window.appContext.currentPlugin.instanceId;var n=bfUtils.getCurrentUser(),r=(n?n._id:"guest")+".bookmarks",a=localStorage.getItem(r)?JSON.parse(localStorage.getItem(r)):[],o=a.findIndex(function(t){return t.id===e});0<=o&&a.splice(o,1),localStorage.setItem(r,JSON.stringify(a)),t(null,null)},loadBookmark:function(t,e){var n=t.pluginInstanceId,r=t.payload;if(n){var a=window.postMaster.launcherPluginAPI.navigation,o={instanceId:n,queryString:r};"function"!=typeof e&&(e=Function.prototype),a.navigateToPluginInstance(o,e)}},getAll:function(t){var e=bfUtils.getCurrentUser(),n=(e?e._id:"guest")+".bookmarks";t(null,localStorage.getItem(n)?JSON.parse(localStorage.getItem(n)):[])},getAllFromPlugin:function(t,e){var n=bfUtils.getCurrentUser(),r=n?n._id:"guest",a=window.appContext.currentPlugin.instanceId,o=r+".bookmarks";e(null,(localStorage.getItem(o)?JSON.parse(localStorage.getItem(o)):[]).filter(function(t){return t.pluginInstanceId===a}))}};
"use strict";$app.controller("authCtrl",["$rootScope","$scope","Upload","$sce",function(a,c,s,r){c._appRoot=window._appRoot,c.registerClick=!1;var l,d=void 0;window.appContext.currentApp&&window.appContext.currentApp.config&&(void 0===window.appContext.currentApp.config.userLoginDomainSettings?"enterprise"==window.appContext.currentApp.config.type&&(d="enabled"):d=window.appContext.currentApp.config.userLoginDomainSettings);var n="Password must be at least 8 characters long, contains an upper case letter, a lower case letter, a number and a symbol.";c.loginTranslation="Log In",c.registerTranslation="Register",c.emailDoesNotExistTxt="Email does not exist in system.",c.updateLoginTranslations=function(e){e.passwordAtLeast8ComplexChars&&(n=e.passwordAtLeast8ComplexChars),e.loginTranslation&&(c.loginTranslation=e.loginTranslation),e.registerTranslation&&(c.registerTranslation=e.registerTranslation),e.emailDoesNotExist&&(c.emailDoesNotExistTxt=e.emailDoesNotExist)};window.authAPI.authCtrlScope=c,a.allowCancel=void 0===a.allowCancel||a.allowCancel,a.authShown=!1,c.secretCodeProvider=null,c.refWindow=null,c.errors={},c.invalidCredentials=!1,c.invalidReset=!1,c.invalidRegister=!1,c.msgError=null,c.msgSuccess=null,c.enableFacebook=!0,c.enableTwitter=!0,c.password="",c.userObj={username:"",email:""},c.loginCallback=null;var u="",p="",i="",w="",f="",g="",m="",t=window.appContext.currentApp.appId,e=window.appContext.currentApp.keys.datastoreKey,o={appId:t,pluginId:"authSettings",instanceId:"authSettings",liveMode:window.appContext.liveMode,writeKey:e};function C(e){e&&(e=window.loginUI.convertToCss(e)||"*{}",localStorage.loginUI=e);var n=e||localStorage.getItem("loginUI_"+t),o=document.getElementById("custom-login-ui");if(!o){var r=document.getElementsByClassName("login-holder")[0];(o=document.createElement("style")).id="custom-login-ui",r.appendChild(o)}o.innerHTML=n}c.updateLoginCss=function(){C()},C();var h=new DatastoreAPI(o);function v(e){return"boolean"!=typeof e||e}function b(){var e=JSON.parse(window.localStorage.getItem("SSO_USER"));if(e){(new Date).getTime()/1e3>e.ssoExpiresAt&&(c.invalidCredentials=!0,a.allowCancel=!1,a.showMenu=!1,c.showLogin(function(e,n){authAPI._setCurrentUser(n),authAPI.triggerOnLogin(n),a.allowCancel=!0,a.showMenu=!0,c.hideLogin(),c.$$phase||c.$apply()}));var n=u;if("multipart/form-data"==m||"application/x-www-form-urlencoded"==m)var o={headers:{Authorization:"Bearer "+e.ssoUserToken,"Content-Type":"application/json"}};else{o={headers:{"Content-Type":"application/x-www-form-urlencoded"}};n=u+"?access_token="+e.ssoUserToken}window.bfUtils.http.get(n,o).success(function(e){console.log(e)}).error(function(e,n,o,r){c.invalidCredentials=!0,a.allowCancel=!1,a.showMenu=!1,c.showLogin(function(e,n){authAPI._setCurrentUser(n),authAPI.triggerOnLogin(n),a.allowCancel=!0,a.showMenu=!0,c.hideLogin(),c.$$phase||c.$apply()})})}}c.SSOLogin=!1,h.get({tag:"authSettings"},function(e,n){e?console.error(e):n&&n.data?("SSOLogin"==n.data.signOnStrategy&&(c.SSOLogin=!0,"application/x-www-form-urlencoded"==(m=n.data.contentType)||"multipart/form-data"==m?(u=window.siteConfig.endPoints.hopHost+n.data.accessTokenAPI,p=window.siteConfig.endPoints.hopHost+n.data.loginAPI):(u=n.data.accessTokenAPI,p=n.data.loginAPI),c.enableFacebook=n.data.enableFacebook,c.enableTwitter=n.data.enableTwitter,w=n.data.signOnStrategy,i=n.data.resetPasswordAPI,f=n.data.clientId,g=n.data.clientSecret,setInterval(b,9e5)),c.enableFacebook=v(n.data.enableFacebook),c.enableTwitter=v(n.data.enableTwitter),w=n.data.signOnStrategy,"enabled"==d&&(l=n.data.domain),c.emailInputType=l?"text":"email"):(c.enableFacebook=!0,c.enableTwitter=!0)}),c.closeLogin=function(){c.loginCallback&&c.loginCallback(),a.allowCancel?c.hideLogin():S()},c.reset=function(){c.errors={},c.showProgressMessage=!1,c.invalidCredentials=!1,c.invalidReset=!1,c.invalidRegister=!1,c.allowToRegister=!1,c.uploadFile=null,c.userObj.email=null,c.userObj.username=null,c.password=null,c.secretCode=null,c.newPassword=null,c.confirmPassword=null,c.msgError=null,c.msgSuccess=null,c.uploadFile=null,c.firstName=null,c.lastName=null,c.secretCodeProvider=null,c.refWindow=null,c.acceptTOS=null,c.acceptPP=null,c.acceptedAppTerms=null};var y=function(){c.successShown=!1,c.registrationShown=!1,c.loginShown=!1,c.forgetPasswordShown=!1,c.resetPasswordShown=!1};function S(){c.reset(),y(),a.allowCancel=!c.loginOptions||!1!==c.loginOptions.allowCancel,a.showMenuOnAuth=!c.loginOptions||!1!==c.loginOptions.showMenu,c.loginShown=!0,a.authShown=!0,c.$$phase||c.$apply()}y(),c.openTermsAndConditions=function(){return window.open("https://support.appdocumentation.com/terms/","_system"),!1},c.registerUser=function(){if(c.registerClick=!0,!c.frmAuthRegister.$invalid)if(window.validator.validatePassword(c.password))c.register(),c.registerClick=!1;else{var e={data:{title:" ",body:n,disableCancel:!0}};window.openDialog(e,function(){})}},c.hideLogin=function(){c.reset(),y(),a.authShown=!1,c.loginCallback=null},c.showRegistration=function(){c.reset(),y(),c.registrationShown=!0,a.authShown=!0},c.showForgetPassword=function(){c.reset(),y(),c.forgetPasswordShown=!0,a.authShown=!0},c.showSuccess=function(e){y(),c.msgSuccess=e,c.successShown=!0},c.showResetPassword=function(e){c.reset(),y(),c.resetPasswordShown=!0,a.authShown=!0,c.loginCallback=e},c.updateLogin=function(e){e&&C(e),c.loginCallback=function(e,n){n?(window.authAPI._setCurrentUser(n),window.authAPI.triggerOnLogin(n)):console.error("authCtrl loginCallback error",e),a.allowCancel=!0,a.showMenu=!0,c.hideLogin(),c.$$phase||c.$apply()},S()},c.updateLoginAuth=function(e){c.enableFacebook=v(e.enableFacebook),c.enableTwitter=v(e.enableTwitter),e.domain&&"enabled"==d&&(l=e.domain),c.$$phase||c.$apply()},c.returnToLogin=function(){c.showLogin(c.loginCallback)},c.showLogin=function(e){c.loginCallback=e,S()},c.resetPassword=function(){if(c.invalidReset=!1,c.msgError=null,c.newPassword!=c.confirmPassword)return c.invalidReset=!1,void(c.msgError="Make sure new password and confirm password are equal");var e={id:1,method:"users/changePassword",params:{email:c.email,secretCode:c.secretCode,password:c.newPassword}},n=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));window.bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result){c.showSuccess("Password reset successfully");var n={data:{title:" ",body:"Password reset successfully",disableCancel:!0}};window.openDialog(n,function(){})}else if(e&&e.error){n={data:{title:" ",body:e.error.message,disableCancel:!0}};window.openDialog(n,function(){}),console.error(e.error)}}).error(function(e,n,o,r){c.invalidCredentials=!0,console.error(e),callback&&callback(e,null)})},c.forgotPassword=function(e){if("SSOLogin"!=w){c.invalidCredentials=!1;var n={email:c.email,sendSecretCode:!0};e&&(n.email=e.email);var o={id:1,method:"users/forgotPassword",params:n},r=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(o));window.bfUtils.http.jsonp(r,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result)c.showResetPassword();else{var n={data:{title:" ",body:c.emailDoesNotExistTxt,disableCancel:!0}};window.openDialog(n,function(){}),e&&console.warn(e)}}).error(function(e,n,o,r){c.invalidCredentials=!0,console.error(e)})}else{var t=-1===i.indexOf("?")?"?":"&",s=i+t+"email="+c.email;window.bfUtils.http.get(s,{headers:{"Content-Type":"application/x-www-form-urlencoded"}}).success(function(){c.showLogin(function(e,n){authAPI._setCurrentUser(n),authAPI.triggerOnLogin(n),a.allowCancel=!0,a.showMenu=!0,c.hideLogin(),c.$$phase||c.$apply()})}).error(function(e,n,o,r){e&&console.error(e)})}},c.showBackLogin=function(){authAPI.login()},c.login=function(e,t){window.spinner&&window.spinner.show&&window.spinner.show(!0),"SSOLogin"!=w?function(e,t){if(window.appContext&&window.appContext.currentApp){c.invalidCredentials=!1,t||(t=c.loginCallback);var n=null;n="undefined"==typeof push?{}:push;var o=c.userObj.email;"enabled"==d&&l&&!o.includes("@")&&(o+=l),console.warn("email",o);var r={email:o,password:c.password,deviceId:n.deviceId,osType:n.platform?n.platform.toLowerCase():"web",externalAppId:window.appContext.currentApp.appId};e&&(r.email=e.email,r.password=e.password);var s={id:1,method:"users/login",params:r},i=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(s));window.bfUtils.http.jsonp(i,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result&&e.result.userToken)authAPI._setCurrentUser(e.result),a.$broadcast("loginSuccessfully",e.result),t&&t(null,e.result);else{c.invalidCredentials=!0;var n=null;e&&e.error&&(console.warn("login error: ",e.error),n=e.error),n&&n.message?c.msgError=n.message:c.msgError="Invalid Email or Password",t&&t(n,null)}}).error(function(e,n,o,r){c.invalidCredentials=!0,console.error(e),t&&t(e,null)})}else console.error("invalid appContext")}(e,function(e,n){if(e||!n){var o=null;if(e)switch(e.code){case 1303:o=e.message;break;default:o="Invalid Login"}else o="To log in, please make sure you have a valid connection.";var r={data:{title:" ",body:o,disableCancel:!0}};window.openDialog(r,function(){}),console.error(e),t&&t(e,null)}else t||(t=c.loginCallback),t&&t(null,n);window.spinner&&window.spinner.hide&&window.spinner.hide(!0)}):function(e,i){var n={headers:{"Content-Type":"application/x-www-form-urlencoded"}},o=c.userObj.username;if("enabled"==d&&l&&!o.includes("@")&&(o+=l),"application/x-www-form-urlencoded"==m)var r=encodeURIComponent("grant_type")+"="+encodeURIComponent("password")+"&"+encodeURIComponent("username")+"="+encodeURIComponent(o)+"&"+encodeURIComponent("password")+"="+encodeURIComponent(c.password)+"&"+encodeURIComponent("client_id")+"="+encodeURIComponent(f)+"&"+encodeURIComponent("client_secret")+"="+encodeURIComponent(g);else"multipart/form-data"==m?(n={transformRequest:angular.identity,headers:{"Content-Type":void 0}},(r=new FormData).append("username",o),r.append("password",c.password)):r={grant_type:"password",username:o,password:c.password,client_id:f};window.bfUtils.http.post(p,r,n).success(function(e){if(!(n=JSON.parse(window.localStorage.getItem("SSO_USER"))))var n={};if("string"==typeof e)try{e=JSON.parse(e)}catch(e){console.warn("Unexpected parsing issue",e)}e&&e.access_token?n.ssoUserToken=e.access_token:n.ssoUserToken=e.replace(/["]+/g,""),e&&e.expires_in&&e.issued_at?n.ssoExpiresAt=e.issued_at+e.expires_in:n.ssoExpiresAt=1902608081e3,window.localStorage.setItem("SSO_USER",JSON.stringify(n));var o=null;o="undefined"==typeof push?{}:push;var r=u.replace(window.siteConfig.endPoints.hopHost,""),t={id:1,method:"users/loginSSO",params:{accessToken:n.ssoUserToken,accessTokenAPI:r,deviceId:o.deviceId,osType:o.platform?o.platform.toLowerCase():"web",externalAppId:window.appContext.currentApp.appId,loginProviderType:"SSO",email:c.userObj.username,contentType:m}},s=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(t));window.bfUtils.http.jsonp(s,{bypassInterceptorForStatus:404}).success(function(e){e&&e.result?(authAPI._setCurrentUser(JSON.stringify(e.result)),a.$broadcast("loginSuccessfully",e.result),i(null,e.result)):(c.invalidRegister=!0,e&&e.error?(c.msgError=e.error.message,c.invalidCredentials=!0,console.error(e.error)):(e="Could not retrieve profile info.")&&(c.msgError=e,c.invalidCredentials=!0,console.error(e)))}).error(function(e,n,o,r){console.error(e),i&&i(e,null)})}).error(function(e,n,o,r){c.invalidCredentials=!0,e&&e.error_description?(console.error(e),c.msgError=e.error_description):c.msgError="Login Failed",i&&i("Login Failed",null)})}(0,function(e,n){if(e){console.error(e);window.openDialog({data:{title:" ",body:"Invalid Login",disableCancel:!0}},function(){}),t&&t(e,null)}else t||(t=c.loginCallback),t(null,n);window.spinner&&window.spinner.hide&&window.spinner.hide(!0)})};c.loadGDPR=function(n){var e=c.userObj.email,o=siteConfig.endPoints.crmHost+"/documents/"+n+"/check?userKey="+encodeURIComponent(e)+"&withDetails=true";bfUtils.http.get(o).success(function(e){e&&(e[n].isAccepted||(c.GDPR_title=r.trustAsHtml(e[n].title),c.GDPR_subtitle=r.trustAsHtml(e[n].subtitle),c.GDPR_details=r.trustAsHtml(e[n].details),c.showGDPR=!0,a.$broadcast("hideNav"),c.$$phase||c.$apply()))}).error(function(e){console.error(e)})},c.hideGDPR=function(){a.$broadcast("displayNav"),c.showGDPR=!1,c.GDPR_title=null,c.GDPR_subtitle=null,c.GDPR_details=null},c.showTermsOfService=function(){c.loadGDPR("bf_terms_and_conditions")},c.showPrivacyPolicy=function(){c.loadGDPR("bf_privacy_policy")},c.showAppTerms=function(){window.open(appContext.currentApp.config.TermsOfUse,"_system")},c.shouldShowAppTerms=!!(appContext.currentApp&&appContext.currentApp.config&&appContext.currentApp.config.TermsOfUse)&&appContext.currentApp.config.TermsOfUse.indexOf("appdocumentation.com")<0,c.saveGDPR=function(){var o;o=function(e,n){var o={};n&&(o=n),o.appId=appContext.currentApp.appId;var r=siteConfig.endPoints.crmHost+"/documents/bf_terms_and_conditions/accept",t=siteConfig.endPoints.crmHost+"/documents/bf_privacy_policy/accept";bfUtils.http.post(r,{userKey:c.userObj.email,info:o,source:"app"}).success(function(e){bfUtils.http.post(t,{userKey:c.userObj.email,info:o,source:"app"}).success(function(e){window.location.hash="htmlBody"}).error(function(e){console.error(e)})}).error(function(e){console.error(e)})},window.$http.get("https://ipapi.co/json/").success(function(e){if(e){var n={ipInfo:{city:e.city,country:e.country_name,countryCode:e.country,lat:e.latitude,lon:e.longitude,regionName:e.region,timezone:e.timezone,zip:e.postal,ip:e.ip}};o(null,n)}else o(null,null)}).error(function(e){o(null,null)})},c.register=function(e,l){if(window.appContext&&window.appContext.currentApp){c.invalidRegister=!1,l||(l=c.loginCallback);var n=null;n="undefined"==typeof push?{}:push;var d={firstName:c.firstName||c.userObj.email,lastName:c.lastName||"",email:c.userObj.email,password:c.password,deviceId:n.deviceId,osType:n.platform?n.platform.toLowerCase():"web",externalAppId:window.appContext.currentApp.appId};e&&(d.email=e.email,d.password=e.password,d.firstName=e.firstName,d.lastName=e.lastName,e.loginProviderType&&(d.loginProviderType=e.loginProviderType));var o={id:1,method:"users/register",params:d},r=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(o));window.bfUtils.http.jsonp(r,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result)c.saveGDPR(function(e){if(e)return console.error(e)}),c.login({email:d.email,password:d.password},function(e,n){n&&n.userToken&&(c.upload(c.uploadFile,function(e,n){if(e)l&&l(e,null);else{var o=bfUtils.getCurrentUser();if(n){var r={userToken:o.userToken,firstName:d.firstName,lastName:d.lastName,displayName:d.firstName+" "+d.lastName,imageUrl:n.result};s=l,i={id:1,method:"users/update",params:t=r},a=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(i)),window.bfUtils.http.jsonp(a,{bypassInterceptorForStatus:404}).success(function(e){if(e.error){var n=null;e&&e.error&&(console.error(e.error),n=e.error),s&&s(n,null)}else{var o=bfUtils.getCurrentUser();null!=o&&(o.firstName=t.firstName,o.lastName=t.lastName,o.displayName=t.displayName,o.imageUrl=t.imageUrl,authAPI._setCurrentUser(o)),s&&s(null,o)}}).error(function(e,n,o,r){console.error(e),s&&s(e,null)})}else l&&l(null,o)}var t,s,i,a}),authAPI.trackRegister(n))});else{c.invalidRegister=!0;if(e&&e.error){var n={data:{title:" ",body:e.error.message,disableCancel:!0}};window.openDialog(n,function(){}),console.warn(e.error),e.error}}}).error(function(e,n,o,r){console.error(e)})}else console.error("invalid appContext")},c.upload=function(e,t){var n=bfUtils.getCurrentUser();if(null!=n){var o=window.siteConfig.endPoints.authHost+"/src/server.js?method=users/uploadImage";if(e&&1==e.length){var r=e[0];s.upload({url:o,fields:{userToken:n.userToken},file:r}).progress(function(e){c.progressMessage=!0;var n=parseInt(100*e.loaded/e.total);console.log("progress: "+n+"% "+e.config.file.name)}).success(function(e,n,o,r){console.log("file "+r.file.name+"uploaded."),t&&t(null,e)}).error(function(e){c.msgError="",c.invalidRegister=!0,t&&t(e,null)})}else t&&t(null,null)}else t&&t({message:"Invalid user"},null)},c.requestLoginProvider=function(n){var e=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify({id:1,method:"secretCode/request",params:{}}));c.refWindow&&!c.refWindow.closed||window.bfUtils.http.jsonp(e,{bypassInterceptorForStatus:404}).success(function(e){if(null!=e&&null!=e.result&&e.result.code){c.secretCodeProvider=e.result.code,c.refWindow=window.open(window.siteConfig.endPoints.authHost+"/website/index.html?v=2.0&code="+encodeURIComponent(c.secretCodeProvider)+"&loginProviderType="+n,"_blank","location=no,enableViewportScale=yes"),c.refWindow&&c.refWindow.addEventListener&&c.refWindow.addEventListener("exit",function(){c.refWindow=null});setTimeout(P,1e3,120)}},function(e){console.log(JSON.stringify(e))})};var P=function o(r){if(window.appContext&&window.appContext.currentApp)if(0<r){var e={id:1,method:"users/secretCodeLogin",params:{code:c.secretCodeProvider,deviceId:push.deviceId,osType:push.platform?push.platform.toLowerCase():"web",externalAppId:window.appContext.currentApp.appId}},n=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));window.bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){if(e.error){var n=!1;1300==e.error.code&&(n=!0),1303==e.error.code&&(n=!0),n&&(c.secretCodeProvider=null)!=c.refWindow&&(c.refWindow.close(),c.refWindow=null)}else null!=e.result&&null!=e.result.userToken?(authAPI._setCurrentUser(e.result),null!=c.refWindow&&(c.refWindow.close(),c.refWindow=null),c.loginCallback&&c.loginCallback(null,bfUtils.getCurrentUser())):null!=c.refWindow&&c.refWindow.closed?(c.refWindow.close(),c.secretCodeProvider=null,c.refWindow=null):setTimeout(o,1e3,r-1)},function(e){console.log(JSON.stringify(e))})}else(c.secretCodeProvider=null)!=c.refWindow&&(c.refWindow.close(),c.refWindow=null),c.loginCallback&&(c.invalidCredentials=!0,c.msgError="Invalid Login",c.loginCallback(null,null));else console.error("invalid appContext")}}]);
"use strict";var authAPI={authCtrlScope:null,init:function(e){this.context=e},login:function(e,n){var t=this.getCurrentUser();t?(n&&n(null,t),authAPI.triggerOnLogin(t)):(authAPI.authCtrlScope.loginOptions=e,authAPI.authCtrlScope.showLogin(function(e,t){!e&&t&&(authAPI._setCurrentUser(t),authAPI.triggerOnLogin(t),authAPI._checkGDPR(t),authAPI.authCtrlScope.hideLogin(),authAPI.authCtrlScope.$$phase||authAPI.authCtrlScope.$apply()),n&&n(e,t)}),authAPI.authCtrlScope.$$phase||authAPI.authCtrlScope.$apply())},_setCurrentUser:function(e){localStorage.setItem("AUTH_CURRENT_USER",JSON.stringify(e))},secondaryUserLookup:function(){return null},getCurrentUser:function(e,t){"function"==typeof e&&(t=e);var n=authAPI.secondaryUserLookup();if(n||(n=localStorage.getItem("AUTH_CURRENT_USER"),n=JSON.parse(n)),n&&n.userToken||(n=null),!t)return n;t(null,n)},_checkGDPR:function(e){if(e){var t="bf_terms_and_conditions",n="bf_privacy_policy",r=siteConfig.endPoints.crmHost+"/documents/"+t+","+n+"/check?userKey="+encodeURIComponent(e.username);(bfUtils.isAppHtml5Version||bfUtils.isMobileDevice||bfUtils.isPwaAndroid||bfUtils.isPwaiOS)&&window.appContext&&1==window.appContext.liveMode&&bfUtils.http.get(r).success(function(e){e&&(e[t].isAccepted&&e[n].isAccepted||(window.location.hash="gdpr"))}).error(function(e){console.error(e)})}},logout:function(){this._setCurrentUser(null),authAPI.triggerOnLogout(null)},trackRegister:function(e){if(window.appContext&&window.appContext.liveMode){var t=new AnalyticsAPI(authAPI.context);t.setUserProperties({email:e.email,username:e.username,firstName:e.firstName,lastName:e.lastName}),t.trackAction("app/userRegistered");var n=localStorage.getItem("HISTORY_USERS");if(n){var r=JSON.parse(n);r.length&&-1==r.indexOf(e._id)&&(r.push(e._id),localStorage.setItem("HISTORY_USERS",JSON.stringify(r)))}else localStorage.setItem("HISTORY_USERS",JSON.stringify([e._id]))}},onLogin:function(e){document.addEventListener("AUTH_CURRENT_USER_ON_LOGIN",e,!1)},onLogout:function(e){document.addEventListener("AUTH_CURRENT_USER_ON_LOGOUT",e,!1)},onUpdate:function(e){document.addEventListener("AUTH_CURRENT_USER_ON_UPDATE",e,!1)},triggerOnUpdate:function(e){e||(e=bfUtils.getCurrentUser());var t=new CustomEvent("AUTH_CURRENT_USER_ON_UPDATE",{detail:e});document.dispatchEvent(t)},triggerOnLogin:function(e){var t=new CustomEvent("AUTH_CURRENT_USER_ON_LOGIN",{detail:e});document.dispatchEvent(t)},triggerOnLogout:function(){var e=new CustomEvent("AUTH_CURRENT_USER_ON_LOGOUT",{detail:null});document.dispatchEvent(e)},openProfile:function(e){window.location.hash="userProfile/"+e},getUserProfile:function(r,o){if(!r||!r.userId)throw new Error("userId have not been provided to getUserInfo");var s=null,e={id:1,method:"users/getPublicUser",params:{userId:r.userId}},t=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));bfUtils.http.jsonp(t,{bypassInterceptorForStatus:404}).success(function(e){var t,n;o&&(e&&e.result?(s=e.result,t={id:1,method:"users/getUserProfile",params:{userId:r.userId}},n=window.siteConfig.endPoints.socialHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(t)),bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){o&&(e&&e.result?(s=angular.extend({},e.result,s),o(null,s||null)):o(null,s))}).error(function(e,t,n,r){o&&o(e,null)})):o(null,null))}).error(function(e,t,n,r){console.error(e),o&&o(e,null)})},getUsersByEmail:function(r,o){if(!r||!r.emails)throw new Error("No emails have not been provided to getUserByEmail");var t=function(t){var e={id:1,method:"users/getUsersProfilesByEmail",params:{emails:r.emails}},n=window.siteConfig.endPoints.socialHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){o&&(e&&e.result?function(e,t){for(var n=0;n<e.length;n++)for(var r=0;r<t.length;r++)e[n].email==t[r].email&&(e[n].phone=t[r].phone);o(null,e)}(t,e.result):o(null,t))}).error(function(e,t,n,r){console.error(e),o&&o(e,null)})},e={id:1,method:"users/getUsersByEmail",params:{emails:r.emails}},n=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){o&&(e&&e.result?t(e.result):o(null,null))}).error(function(e,t,n,r){console.error(e),o&&o(e,null)})},getUserPictureUrl:function(e){var t=null,n=null;if(e||(e={}),e.userId&&(t="userId",n=e.userId),e.email&&(t="email",n=e.email),e.username&&(t="username",n=e.username),!t||!n)throw Error("Invalid user picture params");return window.siteConfig.endPoints.authHost+"/src/server.js/user/picture?"+t+"="+n}};
...
"use strict";function PushNotificationsAPI(t){this.context=t}PushNotificationsAPI.prototype={schedule:function(t,o){if(t&&t.text&&t.title)if(this.context&&this.context.instanceId){t.at||(t.at=new Date),t.groupName||(t.groupName="");var e={groupID:PushNotificationsAPI._getGroupID(this.context,t.groupName),users:t.users,userTags:t.userTags,title:t.title,message:t.text,sendAfter:t.at,source:"plugin",richMessage:t.inAppMessage||void 0};e.sourceId=window.appContext.currentApp.appId+"_"+this.context.instanceId+"_"+e.source,!1!==t.actionItem&&(t.actionItem?e.actionItem=t.actionItem:e.actionItem={title:"View",action:"linkToApp",instanceId:this.context.instanceId,queryString:t.queryString}),bfUtils.getCurrentUser(function(t,i){e.authCreatedBy=i&&i._id?i._id.toString():null,bfUtils.http.post(window.siteConfig.endPoints.pushV2+"/api/app/"+window.appContext.currentApp.appId+"/notification/",e).success(function(t){o&&o(null,t)}).error(function(t,i,e,n){o&&o(t)})})}else o&&o("instanceId is null, unable to build groupID");else o&&o("text or title is empty")},cancel:function(e,o){if(e)if(this.context&&this.context.instanceId){var n={source:"plugin"};n.sourceId=window.appContext.currentApp.appId+"_"+this.context.instanceId+"_"+n.source,bfUtils.getCurrentUser(function(t,i){n.authCanceledBy=i&&i._id?i._id.toString():null,bfUtils.http.post(window.siteConfig.endPoints.pushV2+"/api/app/"+window.appContext.currentApp.appId+"/notification/"+e+"/cancel",n).success(function(t){o&&o(null,!0)}).error(function(t,i,e,n){o&&o(t)})})}else o&&o("instanceId is null, unable to build groupID");else o&&o("id is empty")},subscribe:function(t,i){if(t||(t={}),t.groupName||(t.groupName=""),this.context&&this.context.instanceId){var e=PushNotificationsAPI._getGroupID(this.context,t.groupName);PushNotificationsAPI._subscribe({groupID:e},i)}else i&&i("instanceId is null, unable to build groupID")},unsubscribe:function(t,i){if(t||(t={}),t.groupName||(t.groupName=""),this.context&&this.context.instanceId){var e=PushNotificationsAPI._getGroupID(this.context,t.groupName);PushNotificationsAPI._unsubscribe({groupID:e},i)}else i&&i("instanceId is null, unable to build groupID")}},PushNotificationsAPI._getGroupID=function(t,i){return window.appContext.currentApp.appId+"_"+t.instanceId+"_"+i},PushNotificationsAPI._unsubscribe=function(e,o){window.push&&window.push.deviceId&&window.push.platform?(e||(e={}),e.groupID?bfUtils.getCurrentUser(function(t,i){e.deviceID=push.deviceId,e.os=window.push.platform?window.push.platform.toLowerCase():"",e.authUserId=i&&i._id?i._id.toString():null,bfUtils.http.post(window.siteConfig.endPoints.pushV2+"/api/app/"+window.appContext.currentApp.appId+"/unsubscribe/",e).success(function(t){o&&o(null,!0)}).error(function(t,i,e,n){o&&o(t)})}):o("groupID is not specified")):o&&o("Device not ready to get the deviceId")},PushNotificationsAPI._getSubscriptions=function(i){if(window.push&&window.push.deviceId&&window.push.platform){var t=window.siteConfig.endPoints.pushV2+"/api/app/"+window.appContext.currentApp.appId+"/subscriptions/",e={deviceID:push.deviceId,os:window.push.platform?window.push.platform.toLowerCase():""};bfUtils.http.post(t,e).success(function(t){return i(null,t)}).catch(function(t){return i(t,null)})}else i&&i("Device not ready to get the deviceId")},PushNotificationsAPI._subscribe=function(s,u){window.push&&window.push.deviceId&&window.push.platform?(s||(s={}),s.groupID||(s.groupID=""),bfUtils.getCurrentUser(function(t,i){var e="undefined"!=typeof PushNotification&&void 0!==PushNotification.listChannels,n=device.platform&&"android"===device.platform.toLowerCase()&&e;s.deviceID=push.deviceId,s.os=window.push.platform?window.push.platform.toLowerCase():"",s.authUserId=i&&i._id?i._id.toString():null,s.device="undefined"!=typeof device?device:null,s.deliveryMethod=n?"FCM":null;var o=localStorage.getItem("currentPushDeviceID");o&&o!==push.deviceId&&(s.oldDeviceID=o),bfUtils.http.post(window.siteConfig.endPoints.pushV2+"/api/app/"+window.appContext.currentApp.appId+"/subscribe/",s).success(function(t){localStorage.setItem("currentPushDeviceID",push.deviceId),u&&u(null,!0)}).error(function(t,i,e,n){u&&u(t)})})):u&&u("Device not ready to get the deviceId")},authAPI.onLogin(function(){setTimeout(function(){PushNotificationsAPI._subscribe()},2e3)}),authAPI.onLogout(function(){setTimeout(function(){PushNotificationsAPI._subscribe()},2e3)});
