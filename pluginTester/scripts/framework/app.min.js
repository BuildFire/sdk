...
"use strict";function NotificationsAPI(t){this.context=t}NotificationsAPI.prototype={alert:function(t,i){t||(t={}),t.message?(t.okButton||(t.okButton={text:"Ok"}),t.okButton.text||(t.okButton.text="Ok"),window.device&&"web"!=window.device.platform&&"undefined"!=typeof navigator&&navigator.notification&&navigator.notification.alert?navigator.notification.alert(t.message,i,t.title,t.okButton.text):(alert(t.message),i&&i())):i("invalid parameter, messing message")},confirm:function(t,i){if(t||(t={}),t.message)if(t.confirmButton||(t.confirmButton={text:"Confirm"}),t.confirmButton.text||(t.confirmButton.text="Confirm"),t.cancelButton||(t.cancelButton={text:"Cancel"}),t.cancelButton.text||(t.cancelButton.text="Cancel"),t.buttonLabels=[t.confirmButton.text,t.cancelButton.text],window.device&&"web"!=window.device.platform&&"undefined"!=typeof navigator&&navigator.notification&&navigator.notification.confirm)navigator.notification.confirm(t.message,i,t.title,t.buttonLabels);else{var n=confirm(t.message);i&&i(n)}else i("invalid parameter, missing message",null)},prompt:function(t,i){if(window.device&&"web"!=window.device.platform&&"undefined"!=typeof navigator&&navigator.notification&&navigator.notification.prompt)navigator.notification.prompt(t.message,i,t.title,t.buttonLabels,t.defaultText);else{var n=prompt(t.message);i&&i(n)}},beep:function(t,i){console.log("calling NotificationsAPI.beep ..."),window.device&&"web"!=window.device.platform&&"undefined"!=typeof navigator&&navigator.notification&&navigator.notification.beep&&navigator.notification.beep(t.times),i&&i()},vibrate:function(t,i){console.log("calling NotificationsAPI.vibrate ..."),window.device&&"web"!=window.device.platform&&"undefined"!=typeof navigator&&navigator.notification&&navigator.notification.vibrate&&navigator.notification.vibrate(t.milliseconds),i&&i()}};
function appAPI(e){this.appId=e.appId,this.liveMode=e.liveMode,this.appHost=e.endPoints.appHost,"undefined"==typeof CustomEvent&&console.warn("Browser doesnt support CustomEvent")}appAPI.prototype={getPluginInstances:function(e,n){var t=new DatastoreAPI(this.appId,"pluginInstances",1,this.liveMode,null);e||(e={}),e.pageIndex||(e.pageIndex=1);var a={obj:{filter:{"$json.title":{$regex:null!=e.title?e.title:""}},page:e.pageIndex-1,pageSize:e.pageSize,withDynamicData:!0,recordCount:!0},tag:""};t.search(a,function(e,t){e||n(null,{data:t.result,totals:t.totalRecord})})}};
