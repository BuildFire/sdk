...
"use strict";var customRegistration={googleMapServices:{},get wl_name(){var e="Full ";return e=appContext&&appContext.currentApp&&appContext.currentApp.config?appContext.currentApp.config.whitlabelName+" ":e},getFields:function(t,e){var r,o,a,s=t.customRegistrationSettings;s&&s.singlePage&&s.singlePage.formControls?(r=[],o={},a=[],s.singlePage.formControls.forEach(function(e,s){var i;"custom"!=e.type?(i={control:e,controlIndex:s,fields:r,rules:o,initializers:a,isProfileMode:t.isProfileMode,defaults:t.defaults,refreshUI:t.refreshUI},customRegistration.preparePresetField(i)):(s={control:e,controlIndex:s,fields:r,defaults:t.defaults},customRegistration.prepareCustomField(s))}),e(null,{fields:r,rules:o,initializers:a,fetch:function(s,e){var i=!1,t={},o=[];s&&s.validateFields&&r.forEach(function(e){if("edit"!==s.mode||"email"!==e.name&&"profilePicture"!==e.name?"multipleSelect"===e.type?e.validate(e.values):e.validate(e.value):e.error=null,e.error&&(i=!0),e.isCustom){if(e.value||e.values&&0<e.values.length)switch(e.type){case"singleSelect":o.push({id:e.id,type:"singleSelect",value:e.value,displayValue:e.displayValue});break;case"multipleSelect":o.push({id:e.id,type:"multipleSelect",values:e.values})}}else t[e.name]={value:e.value,extra:e.extra,messages:e.messages}}),i?e(!0,null):e(null,{user:{email:t.email.value,password:t.password?t.password.value:void 0,firstName:t.firstName?t.firstName.value:void 0,lastName:t.lastName?t.lastName.value:void 0,displayName:t.displayName?t.displayName.value:void 0,userProfile:{address:{fullAddress:t.address?t.address.value:void 0,customFields:{aptNo:t.aptNo?t.aptNo.value:void 0,zipCode:t.zipCode?t.zipCode.value:void 0},geoLocation:t.address&&t.address.extra?t.address.extra:void 0},bio:t.bio?t.bio.value:void 0,birthDate:t.birthDate?t.birthDate.value?new Date(t.birthDate.value):null:void 0,tel:t.tel?t.tel.value:void 0,customTypeFields:o}},messages:{emailAlreadyInUse:t.email.messages.emailAlreadyInUse},profilePictureFile:t.profilePicture?t.profilePicture.value:void 0})}})):e(null,null)},preparePresetField:function(a){var s,i,l=a.control,e=a.controlIndex,t=a.fields,o=a.rules,r=a.initializers;switch(l.id){case"fullName":l.active&&(l.settings.displayNameEnabled&&t.push({type:"text",viewType:"none",name:"displayName",order:e,label:l.options.fieldsLabels.displayName,iconClass:l.icon||"glyphicon glyphicon-font",validate:function(e){this.error=null,e&&e.trim().length||!l.settings.required||(this.error=l.options.errorMessages.fullNameRequired)},touch:function(e){this.validate(e)},messages:l.options.errorMessages,value:a.defaults?a.defaults.displayName:void 0}),l.settings.firstNameEnabled&&t.push({type:"text",viewType:"text",name:"firstName",order:e,label:l.options.fieldsLabels.firstName,iconClass:l.icon||"glyphicon glyphicon-font",validate:function(e){this.error=null,e&&e.trim().length||!l.settings.required||(this.error=l.options.errorMessages.fullNameRequired)},touch:function(e){this.validate(e)},messages:l.options.errorMessages,value:a.defaults?a.defaults.firstName:void 0}),l.settings.lastNameEnabled&&t.push({type:"text",viewType:"text",name:"lastName",order:e,label:l.options.fieldsLabels.lastName,iconClass:l.icon||"glyphicon glyphicon-font",validate:function(e){this.error=null,e&&e.trim().length||!l.settings.required||(this.error=l.options.errorMessages.fullNameRequired)},touch:function(e){this.validate(e)},messages:l.options.errorMessages,value:a.defaults?a.defaults.lastName:void 0}));break;case"email":t.push({type:"email",viewType:"email",name:"email",autocorrect:"off",autocapitalize:"none",order:e,label:l.options.fieldsLabels.email,info:l.options.infoMessages?l.options.infoMessages.assistiveText:void 0,iconClass:l.icon||"glyphicon glyphicon-send",validate:function(e){this.error=null,e&&e.trim().length?window.validator.validateEmail(e)?e&&e.trim().length||(this.error=l.options.errorMessages.emailAlreadyInUse):this.error=l.options.errorMessages.emailInvalidFormat:this.error=l.options.errorMessages.emailRequired},touch:function(e,s){!e&&s&&s.target&&(e=s.target.value),this.validate(e)},messages:l.options.errorMessages,value:a.defaults?a.defaults.email:void 0});break;case"address":l.active&&(s=l.options.addressGoogleApiKey,l.options.addressGoogleApiKey&&r.push(function(){setTimeout(function(){var e=document.getElementById("customRegistrationScript");e&&document.getElementsByTagName("head")[0].removeChild(e),customRegistration.googleMapServices.mapsApiKeyError=null,(e=document.createElement("script")).id="customRegistrationScript",e.src="https://maps.googleapis.com/maps/api/js?key=".concat(s,"&libraries=places&callback=googleMapsInitCallback"),e.type="text/javascript",document.getElementsByTagName("head")[0].appendChild(e),window.googleMapsInitCallback=function(){customRegistration.googleMapServices.autoAddressCompleteService=new google.maps.places.AutocompleteService,customRegistration.googleMapServices.addressGeocoder=new google.maps.Geocoder},a.refreshUI&&a.refreshUI()},0)}),l.settings.showFullAddress&&(t.push({type:"text",viewType:"text",name:"address",order:e,label:l.options.fieldsLabels.address,iconClass:l.icon||"glyphicon glyphicon-pushpin",change:function(e){var i=this;i.extra=null,customRegistration.googleMapServices.mapsApiKeyError&&(i.error=customRegistration.googleMapServices.mapsApiKeyError),customRegistration.googleMapServices.autoAddressCompleteService?(customRegistration.googleMapServices.checkMapsApiKeyErrors=!0,setTimeout(function(){customRegistration.googleMapServices.checkMapsApiKeyErrors=!1},3e3),customRegistration.googleMapServices.autoAddressCompleteService.getPlacePredictions({input:e},function(e,s){s!==google.maps.places.PlacesServiceStatus.OK&&(i.error=l.options.errorMessages.invalidGoogleAddress),i.suggestions=e,a.refreshUI&&a.refreshUI()})):i.error=l.options.errorMessages.invalidGoogleAddress},selectSuggestion:function(o){var r=this;r.error=null,r.suggestions=null,r.value=o.description,customRegistration.googleMapServices.addressGeocoder.geocode({placeId:o.place_id},function(e,s){var i,t;e&&e[0]&&e[0]?(i=e[0].geometry.location.lat(),t=e[0].geometry.location.lng(),l.settings.required&&(e[0].address_components.find(function(e){return e.types&&e.types.find(function(e){return"street_number"===e})})||(r.error=l.options.errorMessages.invalidGoogleAddress)),r.extra={lat:i,lng:t,place:o,addressComponents:e[0].address_components}):r.error=l.options.errorMessages.invalidGoogleAddress,a.refreshUI&&a.refreshUI()})},validate:function(e){this.error=null,e&&e.trim().length||!l.settings.required?this.extra||(this.error=l.options.errorMessages.invalidGoogleAddress):this.error=l.options.errorMessages.addressRequired},touch:function(e){this.suggestions||this.suggestions.length||this.validate(e)},messages:l.options.errorMessages,value:a.defaults&&a.defaults.userProfile&&a.defaults.userProfile.address?a.defaults.userProfile.address.fullAddress:void 0,extra:a.defaults&&a.defaults.userProfile&&a.defaults.userProfile.address?a.defaults.userProfile.address.geoLocation:void 0}),l.settings.showAptNo&&t.push({type:"text",viewType:"text",name:"aptNo",order:e,label:l.options.fieldsLabels.aptNo,iconClass:l.icon||"glyphicon glyphicon-pushpin",containerClass:"small-login-field",validate:function(e){this.error=null,e&&e.trim().length||!l.settings.required||(this.error=l.options.errorMessages.addressRequired)},touch:function(e){this.validate(e)},messages:l.options.errorMessages,value:a.defaults&&a.defaults.userProfile&&a.defaults.userProfile.address&&a.defaults.userProfile.address.customFields?a.defaults.userProfile.address.customFields.aptNo:void 0})),l.settings.showZipCode&&t.push({type:"text",viewType:"text",name:"zipCode",order:e,label:l.options.fieldsLabels.zipCode,iconClass:l.icon||"glyphicon glyphicon-pushpin",validate:function(e){this.error=null,e&&e.trim().length||!l.settings.required||(this.error=l.options.errorMessages.addressRequired)},touch:function(e){this.validate(e)},messages:l.options.errorMessages,value:a.defaults&&a.defaults.userProfile&&a.defaults.userProfile.address&&a.defaults.userProfile.address.customFields?a.defaults.userProfile.address.customFields.zipCode:void 0}));break;case"password":a.isProfileMode||(t.push({type:"password",name:"password",order:e,label:l.options.fieldsLabels.password,iconClass:l.icon||"glyphicon glyphicon-lock",togglePasswordVisibility:"showHidePassword"===l.settings.validation,info:"simple"===l.settings.passwordStrength?l.options.infoMessages.passwordSimpleRules:l.options.infoMessages.passwordRules,validate:function(e){this.error=null,"retypePassword"===l.settings.validation&&(t.find(function(e){return"retypePassword"===e.name}).error=null),e&&e.trim().length?window.validator.validatePassword(e,{simplePasswordValidation:"simple"===l.settings.passwordStrength})||(this.error="simple"===l.settings.passwordStrength?l.options.errorMessages.invalidPasswordSimpleRules:l.options.errorMessages.invalidPasswordRules):this.error=l.options.errorMessages.passwordRequired},touch:function(e){this.validate(e)},messages:l.options.errorMessages}),"retypePassword"===l.settings.validation&&t.push({type:"password",name:"retypePassword",order:e,label:l.options.fieldsLabels.retypePassword,iconClass:l.icon||"glyphicon glyphicon-lock",togglePasswordVisibility:"showHidePassword"===l.settings.validation,validate:function(e){var s=t.find(function(e){return"password"===e.name});this.error=null,e&&e.trim().length?s.value!==e&&(this.error=l.options.errorMessages.passwordsDontMatch):this.error=l.options.errorMessages.passwordRequired},touch:function(e){this.validate(e)},messages:l.options.errorMessages})),o.passwordStrength=l.settings.passwordStrength;break;case"bio":l.active&&t.push({type:"textarea",viewType:"multiline",name:"bio",order:e,label:l.options.fieldsLabels.bio,info:l.options.infoMessages?l.options.infoMessages.assistiveText:void 0,iconClass:l.icon||"glyphicon glyphicon-list-alt",validate:function(e){this.error=null,e&&e.trim().length||!l.settings.required||(this.error=l.options.errorMessages.bioRequired)},touch:function(e){this.validate(e)},messages:l.options.errorMessages,value:a.defaults&&a.defaults.userProfile?a.defaults.userProfile.bio:void 0});break;case"telephone":l.active&&t.push({type:"text",viewType:"text",name:"tel",order:e,label:l.options.fieldsLabels.tel,iconClass:l.icon||"glyphicon glyphicon-earphone",validate:function(e){this.error=null,e&&e.trim().length||!l.settings.required?e&&(/^(?:(?:\(?(?:00|\+)([1-4]\d\d|[1-9]\d?)\)?)?[\-\.\ \\\/]?)?((?:\(?\d{1,}\)?[\-\.\ \\\/]?){0,})(?:[\-\.\ \\\/]?(?:#|ext\.?|extension|x)[\-\.\ \\\/]?(\d+))?$/i.test(e)||(this.error=l.options.errorMessages.invalidEntry)):this.error=l.options.errorMessages.invalidEntry},info:l.settings.showReasonForTelephone?l.options.infoMessages.reasonForTelephone:null,touch:function(e){this.validate(e)},messages:l.options.errorMessages,value:a.defaults&&a.defaults.userProfile?a.defaults.userProfile.tel:void 0});break;case"birthDate":l.active&&(i=function(e){return e?moment(e).format("L"):null},t.push({type:"date",viewType:"text",name:"birthDate",order:e,label:l.options.fieldsLabels.dateBirth,info:l.options.infoMessages?l.options.infoMessages.assistiveText:void 0,minDate:l.settings.maxAgeIsRequired&&l.settings.maxAgeRequired?moment().subtract(l.settings.maxAgeRequired,"years").toDate():void 0,maxDate:l.settings.minAgeIsRequired&&l.settings.minAgeRequired?moment().subtract(l.settings.minAgeRequired,"years").toDate():void 0,iconClass:l.icon||"glyphicon glyphicon-calendar",displayValue:i(a.defaults&&a.defaults.userProfile?a.defaults.userProfile.birthDate:void 0),validate:function(e){this.error=null,e?(e=moment(e),e=moment().diff(e,"years"),l.settings.maxAgeIsRequired&&l.settings.maxAgeRequired&&e>l.settings.maxAgeRequired?this.error=l.options.errorMessages.maxAge+" "+l.settings.maxAgeRequired:l.settings.minAgeIsRequired&&l.settings.minAgeRequired&&e<l.settings.minAgeRequired&&(this.error=l.options.errorMessages.minAge+" "+l.settings.minAgeRequired)):l.settings.required&&(this.error=l.options.errorMessages.birthRequired)},change:function(e){this.validate(e),this.displayValue=i(e)},touch:function(e){this.validate(e)},messages:l.options.errorMessages,value:a.defaults&&a.defaults.userProfile?a.defaults.userProfile.birthDate?new Date(a.defaults.userProfile.birthDate):null:void 0}));break;case"profilePicture":l.active&&t.push({type:"image",name:"profilePicture",order:e,label:l.options.fieldsLabels.profilePicture,info:l.options.infoMessages.assistiveText,iconClass:l.icon||"icon icon-camera2",resetImage:function(){this.value=null},validate:function(e){this.error=null,!e&&l.settings.required&&(this.error=l.options.errorMessages.required)},messages:l.options.errorMessages})}},prepareCustomField:function(e){var s,i,t,o,r,a=e.control,l=e.controlIndex,n=e.fields;switch(a.customType){case"singleSelect":a.active&&(e.defaults&&e.defaults.userProfile&&e.defaults.userProfile.customTypeFields&&0<e.defaults.userProfile.customTypeFields.length&&((s=e.defaults.userProfile.customTypeFields.find(function(e){return e.id===a.id}))&&(r=a.selectOptions.find(function(e){return e.key===s.value})),t=s&&r?s.value:void 0,o=r?r.label:void 0),n.push({id:a.id,name:"singleSelect",type:"singleSelect",viewType:"multiline",isCustom:!0,order:l,display:a.settings.displayOption,label:a.options.fieldsLabels.singleSelect,info:a.options.infoMessages?a.options.infoMessages.assistiveText:void 0,iconClass:a.icon||"glyphicon glyphicon-th-list",selectOptions:a.selectOptions,value:t,displayValue:o,messages:a.options.errorMessages,validate:function(e){this.error=null,!e&&a.settings.required&&(this.error=a.options.errorMessages.required)},openDrawer:function(i){var t=this,o=new ComponentUIAPI,s=[];this.selectOptions.forEach(function(e){s.push({text:e.label,value:e.key})}),o.openDrawer({header:this.label,listItems:s},function(e,s){return e?console.error(e):(t.value=s.value,i.target.value=t.displayValue=s.text,t.validate(t.value),void o.closeDrawer())})}}));break;case"multipleSelect":a.active&&(i=function(e,t){var o="";return e.forEach(function(s,i){t.selectOptions.forEach(function(e){s.value===e.key&&(o+=0===i?e.label:", ".concat(e.label))})}),o},r=[],t="",e.defaults&&e.defaults.userProfile&&e.defaults.userProfile.customTypeFields&&0<e.defaults.userProfile.customTypeFields.length&&((r=(o=e.defaults.userProfile.customTypeFields.find(function(e){return e.id===a.id}))?o.values:[])&&0<r.length&&(r=r.filter(function(s){return void 0!==a.selectOptions.find(function(e){return e.key===s.value})}),t=i(r,a))),n.push({id:a.id,name:"multipleSelect",type:"multipleSelect",viewType:"multiline",isCustom:!0,order:l,display:a.settings.displayOption,label:a.options.fieldsLabels.multipleSelect,info:a.options.infoMessages?a.options.infoMessages.assistiveText:void 0,iconClass:a.icon||"glyphicon glyphicon-th-list",selectOptions:a.selectOptions,values:r,displayValue:t,messages:a.options.errorMessages,validate:function(e){this.error=null,e&&e.length<1&&a.settings.required&&(this.error=a.options.errorMessages.required)},updateCheckboxValue:function(s,e){e.target.checked?this.values.find(function(e){return e.value===s.key})||this.values.push({value:s.key,displayValue:s.label}):this.values=this.values.filter(function(e){return e.value!==s.key}),this.displayValue="",this.displayValue=i(this.values,a)},isSelected:function(s){return void 0!==this.values.find(function(e){return s.key===e.value})},openDrawer:function(o){var r=this,a=new ComponentUIAPI,e=[];this.selectOptions.forEach(function(s){r.values&&r.values.find(function(e){return s.key===e.value})?e.push({text:s.label,value:s.key,selected:!0}):e.push({text:s.label,value:s.key})}),a.openDrawer({header:this.label,listItems:e,multiSelection:!0},function(e,s){if(e)return console.error(e);var i=[],t="";s.forEach(function(e,s){t+=0===s?e.text:", ".concat(e.text),i.push({value:e.value,displayValue:e.text})}),r.values=i,o.target.value=r.displayValue=t,r.validate(r.values),a.closeDrawer()})}}))}}};function gm_authFailure(){customRegistration.googleMapServices.checkMapsApiKeyErrors&&(customRegistration.googleMapServices.mapsApiKeyError="There seems to be an issue with google maps key")}
"use strict";var userTags={get isUserTaggingEnabled(){return window.appContext&&window.appContext.currentApp&&window.appContext.currentApp.config&&window.appContext.currentApp.config.userTagging&&"hidden"!=window.appContext.currentApp.config.userTagging&&"disabled"!=window.appContext.currentApp.config.userTagging},init:function(){},checkPluginAccessSettings:function(e,i){var o=e.accessSettings;!bfUtils.isEmulatorCP&&e.requiresLogin?authAPI.getCurrentUser(function(e,n){if(e)return console.error(e),void i(e,null);if(n)if(userTags.isUserTaggingEnabled&&"enabled"==window.appContext.currentApp.config.advancedPluginAccessSettings)if(o)if(o.requiresTags)if(o.requiredTags&&0!=o.requiredTags.length)if(o.giveAccessWhen)if(n.tags&&n.tags[window.appContext.currentApp.appId]&&0<n.tags[window.appContext.currentApp.appId].length){var t=n.tags[window.appContext.currentApp.appId];if("matchAllTags"==o.giveAccessWhen){for(var s=0;s<o.requiredTags.length;s++){for(var r=!1,a=0;a<t.length;a++)if(t[a].tagName==o.requiredTags[s].name&&o.requiredTags[s].appliedCount<=t[a].appliedCount){r=!0;break}if(!r)return void i(null,!1)}i(null,!0)}else{for(s=0;s<o.requiredTags.length;s++)for(a=0;a<t.length;a++)if(t[a].tagName==o.requiredTags[s].name&&o.requiredTags[s].appliedCount<=t[a].appliedCount)return void i(null,!0);i(null,!1)}}else i(null,!1);else i(null,!1);else i(null,!0);else i(null,!0);else i(null,!0);else i(null,!0);else i(null,!1)}):i(null,!0)},setBehavioralTags:function(t){!bfUtils.isEmulatorCP&&bfUtils.deviceOnline&&userTags.isUserTaggingEnabled&&authAPI.getCurrentUser(null,function(e,n){e?console.log(e):n&&bfUtils.http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/app/"+window.appContext.currentApp.appId+"/user/assignBehavioralTag",{instanceId:t,accessToken:n.accessToken}).success(function(e){authAPI.refreshAndTriggerUpdate({updateType:"user_tags_updated"})}).error(function(e){console.log(e)})})},removeProfileTags:function(e,t){e=["$$profile_birth_year:","$$profile_birth_month:","$$profile_zip:","$$profile_city:","$$profile_state:","$$profile_town:","$$profile_country:","$$profile_picture"].concat(e);userTags.unassignUserTags(e,{isPrefix:!0,removeTag:!0},function(e,n){e?t(e,null):t(null,!0)})},setRegistrationTags:function(e,n,t){var r=[],a={},s=e?e.userProfile:null;AppearanceAPI.prototype.getAppearance(null,function(e,n){return e?console.error(e):void(n&&(a=n.customRegistration))});function i(e,n){for(var t=0;t<e.length;t++)if(e[t].types[0]==n)return e[t].short_name}var o,u,p,l;userTags.isUserTaggingEnabled&&(o=[],n&&(u=new Date,o.push("$$registered"),o.push("$$registered_year:"+u.getFullYear()),o.push("$$registered_month:"+(u.getMonth()+1))),s&&(s.birthDate&&(o.push("$$profile_birth_year:"+s.birthDate.getFullYear()),o.push("$$profile_birth_month:"+(s.birthDate.getMonth()+1))),s.address&&s.address.customFields&&s.address.customFields.zipCode&&o.push("$$profile_zip:"+s.address.customFields.zipCode),s.address&&s.address.geoLocation&&s.address.geoLocation.addressComponents&&((l=i(s.address.geoLocation.addressComponents,"country"))&&o.push("$$profile_country:"+l.replace(/ /g,"_")),(l=i(s.address.geoLocation.addressComponents,"administrative_area_level_1"))&&o.push("$$profile_state:"+l.replace(/ /g,"_")),(l=i(s.address.geoLocation.addressComponents,"administrative_area_level_2"))&&o.push("$$profile_city:"+l.replace(/ /g,"_")),(l=i(s.address.geoLocation.addressComponents,"locality"))&&o.push("$$profile_town:"+l.replace(/ /g,"_"))),s.customTypeFields&&0<s.customTypeFields.length&&(p=[],(l=authAPI.getCurrentUser())&&l.tags&&window.appContext&&window.appContext.currentApp&&window.appContext.currentApp.appId&&(p=l.tags[window.appContext.currentApp.appId]),s.customTypeFields.forEach(function(t){var s=a.singlePage.formControls.find(function(e){return e.id===t.id});if(s&&s.active)switch(s.customType){case"singleSelect":p.find(function(e){return e.tagName==="$$profile_".concat(s.uniqueId)})||o.push("$$profile_".concat(s.uniqueId)),t.value&&(p.find(function(e){return e.tagName==="$$profile_".concat(s.uniqueId,":").concat(t.value)})||o.push("$$profile_".concat(s.uniqueId,":").concat(t.value)));break;case"multipleSelect":p.find(function(e){return e.tagName==="$$profile_".concat(s.uniqueId)})||o.push("$$profile_".concat(s.uniqueId)),t.values.forEach(function(n){p.find(function(e){return e.tagName==="$$profile_".concat(s.uniqueId,":").concat(n.value)})||o.push("$$profile_".concat(s.uniqueId,":").concat(n.value))})}p.forEach(function(n){if(n.tagName.startsWith("$$profile_".concat(s.uniqueId,":")))switch(s.customType){case"singleSelect":n.tagName!=="$$profile_".concat(s.uniqueId,":").concat(t.value)&&r.push(n.tagName);break;case"multipleSelect":t.values.find(function(e){return n.tagName==="$$profile_".concat(s.uniqueId,":").concat(e.value)})||r.push(n.tagName)}})}))),e&&e.imageUrl&&o.push("$$profile_picture"),n?userTags.assignUserTags(o,t):userTags.removeProfileTags(r,function(e,n){e?t(e):userTags.assignUserTags(o,t)}))},assignUserTags:function(t,s){"string"==typeof t&&(t=t.split(",")),authAPI.getCurrentUser(function(e,n){e?(console.log(e),s(e,null)):n&&bfUtils.http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/app/"+window.appContext.currentApp.appId+"/user/assign",{tags:t,accessToken:n.accessToken}).success(function(e){authAPI.refreshAndTriggerUpdate({updateType:"user_tags_updated"}),s(null,!0)}).error(function(e){console.log(e),s(e)})})},unassignUserTags:function(t,s,r){"string"==typeof t&&(t=t.split(",")),authAPI.getCurrentUser(function(e,n){e?(console.log(e),r(e,null)):n&&bfUtils.http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/app/"+window.appContext.currentApp.appId+"/user/unassign",{tags:t,isPrefix:s.isPrefix||!1,accessToken:n.accessToken,removeTag:s.removeTag||!1}).success(function(e){authAPI.refreshAndTriggerUpdate({updateType:"user_tags_updated"}),r(null,!0)}).error(function(e){console.log(e),r(e,null)})})}};userTags.init();
