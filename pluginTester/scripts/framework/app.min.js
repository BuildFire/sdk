...
"use strict";function AppearanceAPI(e){this.pluginAPI=e}AppearanceAPI.prototype={getCSSFiles:function(e,n){return n(null,["https://bootswatch.com/cerulean/bootstrap.css"]),this},autosizeContainer:function(e,n){this.autosizeContainerHandler(e.height),n(null,null)},autosizeContainerHandler:function(){},setHeaderVisibility:function(e){var n=document.getElementById("pluginControlHeader"),t=document.getElementById("pluginControlHeaderTabs");n&&(e?n.classList.remove("hidden"):n.classList.add("hidden")),t&&(e?t.classList.remove("hidden"):t.classList.add("hidden"))},beforeUpdate:function(e){document.addEventListener("appearanceBeforeUpdate",e,!1)},triggerBeforeUpdate:function(e){var n=new CustomEvent("appearanceBeforeUpdate");document.dispatchEvent(n)},onUpdate:function(e){document.addEventListener("appearanceOnUpdate",e,!1)},triggerOnUpdate:function(e){var n=new CustomEvent("appearanceOnUpdate");document.dispatchEvent(n)},applyToScope:function(e,n,t,o){var a=void 0;(a=angular.element(e).scope())[n]=t,a.$$phase||(a.$apply(),o&&o())},getScope:function(e){return angular.element(e).scope()},applyScopeFunction:function(e,n,t){var o=void 0;"function"==typeof(o=angular.element(e).scope())[n]&&o[n](),t&&t()},applyToRootScope:function(e,n,t){var o=void 0;(o=angular.element(document.body).scope().$root)[e]=n,o.$$phase||(o.$apply(),t&&t())},getRootScope:function(){return angular.element(document.body).scope().$root},getFooterMenu:function(e,n){"function"==typeof e&&(n=e);var t=localStorage.getItem("footerMenu"),o={};t&&(o=JSON.parse(t)),n(null,o)},titlebar:{show:function(e,n){AppearanceAPI.prototype.titlebar.toggleVisibility(!0,"showNavigationBar",n)},hide:function(e,n){AppearanceAPI.prototype.titlebar.toggleVisibility(!1,"showNavigationBar",n)},toggleVisibility:function(e){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"showNavigationBar",t=arguments[2],o=document.getElementsByClassName("pluginFrame"),a=!o.length,p=0,i=function(e){p+=e},r=function(){0==--p&&t&&t()};if(a){var c=document.getElementById("launcherPlugin");i(2),AppearanceAPI.prototype.applyToScope(c,"disableAutomaticNavigationBar",!0,r),AppearanceAPI.prototype.applyToScope(c,n,e,r)}else{i(2*o.length);for(var l=0;l<o.length;l++)AppearanceAPI.prototype.applyToScope(o[l],"disableAutomaticNavigationBar",!0,r),AppearanceAPI.prototype.applyToScope(o[l],n,e,r)}},isVisible:function(){var e=0==postMaster.isLauncherPluginActive()||-1==["","#/","#"].indexOf(window.location.hash),n=document.getElementById("launcherPlugin"),t=angular.element(n).scope(),o=t.showNavigationBar;return!0===t.disableAutomaticNavigationBar?o:e}},navbar:{show:function(e,n){AppearanceAPI.prototype.navbar.toggleVisibility(!0,"isFooterMenuHidden",n)},hide:function(e,n){AppearanceAPI.prototype.navbar.toggleVisibility(!1,"isFooterMenuHidden",n)},toggleVisibility:function(e,n,t){var o=document.getElementsByClassName("pluginFrame"),a=!o.length,p=document.getElementById("footerMenuParent"),i=0,r=function(e){i+=e},c=function(){0==--i&&t&&t()};if(a){var l=document.getElementById("launcherPlugin");r(2),AppearanceAPI.prototype.applyToScope(p,n,!e,c),AppearanceAPI.prototype.applyToScope(l,n,!e,c)}else{r(2*o.length);for(var u=0;u<o.length;u++)AppearanceAPI.prototype.applyToScope(p,n,!e,c),AppearanceAPI.prototype.applyToScope(o[u],n,!e,c)}},isVisible:function(){return AppearanceAPI.prototype.getRootScope().turnOnFooterMenu}},fullScreenMode:{enable:function(e,n){AppearanceAPI.prototype.fullScreenMode.toggle(!1,n)},disable:function(e,n){AppearanceAPI.prototype.fullScreenMode.toggle(!0,n)},toggle:function(e,n){var t=3,o=function(){0==--t&&n&&n()};if(!document.getElementsByClassName("pluginFrame").length){var a=document.getElementById("launcherPlugin");AppearanceAPI.prototype.applyToScope(a,"isInFullScreenMode",e)}AppearanceAPI.prototype.titlebar.toggleVisibility(e,"isInFullScreenMode",o),AppearanceAPI.prototype.sideMenu.toggleIconVisibility(e,"isInFullScreenMode",o),AppearanceAPI.prototype.navbar.toggleVisibility(e,"isInFullScreenMode",o)}},sideMenu:{show:function(e,n){AppearanceAPI.prototype.sideMenu.toggleIconVisibility(!0,"isMenuIconHidden",n)},hide:function(e,n){AppearanceAPI.prototype.sideMenu.toggleIconVisibility(!1,"isMenuIconHidden",n)},toggleIconVisibility:function(e,n,t){var o=document.getElementById("menu-location");if(!document.getElementsByClassName("pluginFrame").length){var a=document.getElementById("launcherPlugin");AppearanceAPI.prototype.applyToScope(a,n,!e)}AppearanceAPI.prototype.applyToScope(o,n,!e,t)},open:function(e,n){cpSync.menu.showSideMenu(),n&&n()},close:function(e,n){var t=document.getElementById("sideMenuCloseButton");AppearanceAPI.prototype.applyScopeFunction(t,"closeMenu",n)}},ready:function(){var e=document.getElementsByClassName("pluginFrame");if(!e.length){var n=document.getElementById("launcherPlugin");AppearanceAPI.prototype.applyToScope(n,"readyToShow",!0)}else for(var t=0;t<e.length;t++)AppearanceAPI.prototype.applyToScope(e[t],"readyToShow",!0);window.spinner&&window.spinner.hide()}},document.addEventListener("launcherOnReactivated",function(){console.log("APPEARANCE PLUGIN REACTIVATED SUCCESS");var e=document.getElementById("launcherPlugin"),n=AppearanceAPI.prototype.getScope(e),t=n.isMenuIconHidden,o=n.isInFullScreenMode,a=n.isFooterMenuHidden;console.log({isMenuIconHidden:t,isInFullScreenMode:o,isFooterMenuHidden:a}),t?AppearanceAPI.prototype.sideMenu.hide():AppearanceAPI.prototype.sideMenu.show(),o?AppearanceAPI.prototype.fullScreenMode.enable():AppearanceAPI.prototype.fullScreenMode.disable(),a?AppearanceAPI.prototype.navbar.hide():AppearanceAPI.prototype.navbar.show()}),document.addEventListener("pluginOnActivated",function(){AppearanceAPI.prototype.fullScreenMode.disable(),AppearanceAPI.prototype.navbar.show(),AppearanceAPI.prototype.sideMenu.show()});
