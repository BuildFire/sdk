...
"use strict";$app.controller("authCtrl",["$rootScope","$scope","Upload","$sce","StringResource",function(a,d,r,s,e){d._appRoot=window._appRoot,d.registerClick=!1;document.addEventListener("appThemeOnUpdate",function(){var e,n,o=document.querySelector(".form.registration").querySelectorAll("input[type=date]");e=o,n=tinycolor(PluginAPI.appTheme.colors.backgroundColor).isDark(),e.forEach(function(e){n?e.classList.add("inverted-input"):e.classList.remove("inverted-input")})},!1);var l,c=void 0;window.appContext.currentApp&&window.appContext.currentApp.config&&(void 0===window.appContext.currentApp.config.userLoginDomainSettings?"enterprise"==window.appContext.currentApp.config.type&&(c="enabled"):c=window.appContext.currentApp.config.userLoginDomainSettings);var n="Password must be at least 8 characters long, contains an upper case letter, a lower case letter, a number and a symbol.";d.loginTranslation="Log In",d.registerTranslation="Register",d.emailDoesNotExistTxt="Email does not exist in system.",d.updateLoginTranslations=function(e){e.passwordAtLeast8ComplexChars&&(n=e.passwordAtLeast8ComplexChars),e.loginTranslation&&(d.loginTranslation=e.loginTranslation),e.registerTranslation&&(d.registerTranslation=e.registerTranslation),e.emailDoesNotExist&&(d.emailDoesNotExistTxt=e.emailDoesNotExist)},e.getData().then(function(e){e&&(d.loginButtonTitle=e.logIn)});var o=function(){var e="appearance",n={appId:window.appContext.currentApp.appId,pluginId:e,instanceId:e};new window.DatastoreAPI(n).get({tag:e,withDynamicData:!0},function(e,n){if(e)return console.error(e),void callback(e);n&&n.data&&n.data.customRegistration&&t(n.data.customRegistration,null,n.data.colors),n&&n.data&&n.data&&d.setThemeType(n.data)})};o();var t=function(e,s,n){if(e&&e.active&&-1<["enterprise","professional"].indexOf(window.appContext.currentApp.config.type)){var r=n||(PluginAPI&&PluginAPI.appTheme&&PluginAPI.appTheme.colors?PluginAPI.appTheme.colors:null);customRegistration.getFields({customRegistrationSettings:e,refreshUI:function(){d.$$phase||d.$apply()},openGDPRContent:function(e){d.loadGDPR(e.key)}},function(e,n){if(n){d.showCustomRegistration=!0,d.showDefaultTermsAndConditions=!0,d.showDefaultPrivacyPolicy=!0;var o=null,t=null;n.gdprLinks&&n.gdprLinks.forEach(function(e){"termsAndConditions"===e.name?(d.showDefaultTermsAndConditions=!1,o=e.key):"privacyPolicy"===e.name&&(d.showDefaultPrivacyPolicy=!1,t=e.key)}),d.customRegistrationSubmit=function(){n.fetch({validateFields:!0,validateLinks:!0},function(e,n){e||(n.customTermsAndConditionsKey=o,n.customPrivacyPolicyKey=t,d.register(n))})},n.fields&&n.fields.forEach(function(e){e&&"tel"===e.name&&(e.type="tel"),e&&"date"===e.type&&r&&r.backgroundColor&&tinycolor(r.backgroundColor).isDark()&&(e.class="inverted-input")}),d.customRegistrationFields=n.fields,d.customRegistrationRules=n.rules,d.customRegistrationGdprLinks=n.gdprLinks,d.initCustomRegistration=function(){n.initializers.forEach(function(e){e()})},s&&s(null,null),d.$$phase||d.$apply()}})}else d.showCustomRegistration=!1,d.$$phase||d.$apply()};window.authAPI.authCtrlScope=d,a.allowCancel=void 0===a.allowCancel||a.allowCancel,a.authShown=!1,d.secretCodeProvider=null,d.refWindow=null,d.errors={},d.invalidCredentials=!1,d.invalidReset=!1,d.invalidRegister=!1,d.msgError=null,d.msgSuccess=null,d.enableFacebook=!0,d.enableTwitter=!0,d.enableGoogle=!0,d.enableApple=!0,d.enablePasswordBasedAuth=!0,d.password="",d.userObj={username:"",email:""},d.loginCallback=null;var u="",i="",p="",g="",w="",f="",m="",h="",C="",v=window.appContext.currentApp.appId;function b(e){e&&(e=window.loginUI.convertToCss(e)||"*{}",localStorage.loginUI=e);var n=e||localStorage.getItem("loginUI_"+v),o=document.getElementById("custom-login-ui");if(!o){var t=document.getElementsByClassName("login-holder")[0];(o=document.createElement("style")).id="custom-login-ui",t.appendChild(o)}o.innerHTML=n}function y(e){return"boolean"!=typeof e||e}function S(){var e=JSON.parse(window.localStorage.getItem("SSO_USER"));if(e){(new Date).getTime()/1e3>e.ssoExpiresAt&&(d.invalidCredentials=!0,a.allowCancel=!1,a.showMenu=!1,d.showLogin(function(e,n){authAPI._setCurrentUser(n),authAPI.triggerOnLogin(n),a.allowCancel=!0,a.showMenu=!0,d.hideLogin(),d.$$phase||d.$apply()}));var n=u;if("multipart/form-data"==C||"application/x-www-form-urlencoded"==C)var o={headers:{Authorization:"Bearer "+e.ssoUserToken,"Content-Type":"application/json"}};else{o={headers:{"Content-Type":"application/x-www-form-urlencoded"}};n=u+"?access_token="+e.ssoUserToken}window.bfUtils.http.get(n,o).success(function(e){console.log(e)}).error(function(e,n,o,t){d.invalidCredentials=!0,a.allowCancel=!1,a.showMenu=!1,d.showLogin(function(e,n){authAPI._setCurrentUser(n),authAPI.triggerOnLogin(n),a.allowCancel=!0,a.showMenu=!0,d.hideLogin(),d.$$phase||d.$apply()})})}}d.updateLoginCss=function(){b()},d.updateSSORegistrationFormStatus=function(e){/htt(p|ps):\/\//g.test(I.src)&&(window.spinner&&window.spinner.hide(),d.ssoRegistrationFormStatus=e,d.$$phase||d.$apply())},b(),d.SSOLogin=!1,authAPI.getAuthSettings(null,function(e,n){e?console.error(e):n&&n.data?("SSOLogin"==n.data.signOnStrategy&&(d.SSOLogin=!0,C=n.data.contentType,i="application/x-www-form-urlencoded"==C||"multipart/form-data"==C?(u=window.siteConfig.endPoints.hopHost+n.data.accessTokenAPI,window.siteConfig.endPoints.hopHost+n.data.loginAPI):(u=n.data.accessTokenAPI,n.data.loginAPI),d.signOnStrategy=f=n.data.signOnStrategy,p=n.data.resetPasswordAPI,g=n.data.resetPasswordMessage,d.registerUrl=w=n.data.registerUrl,m=n.data.clientId,h=n.data.clientSecret,setInterval(S,9e5)),d.enableFacebook=y(n.data.enableFacebook),d.enableTwitter=y(n.data.enableTwitter),d.enableGoogle=y(n.data.enableGoogle),d.enablePasswordBasedAuth=y(n.data.enablePasswordBasedAuth),d.enableFacebook||d.enableTwitter||void 0!==n.data.enableApple?d.enableApple=y(n.data.enableApple):d.enableApple=!1,f=n.data.signOnStrategy,"enabled"==c&&(l=n.data.domain),d.emailInputType=l?"text":"email"):(d.enableFacebook=!0,d.enableTwitter=!0,d.enableGoogle=!0,d.enableApple=!0,d.enablePasswordBasedAuth=!0)}),d.closeLogin=function(){d.loginCallback&&d.loginCallback(),a.allowCancel?d.hideLogin():A()},d.reset=function(){d.errors={},d.showProgressMessage=!1,d.invalidCredentials=!1,d.invalidReset=!1,d.invalidRegister=!1,d.allowToRegister=!1,d.uploadFile=null,d.userObj.email=null,d.userObj.username=null,d.password=null,d.secretCode=null,d.newPassword=null,d.confirmPassword=null,d.msgError=null,d.msgSuccess=null,d.uploadFile=null,d.firstName=null,d.lastName=null,d.secretCodeProvider=null,d.refWindow=null,d.acceptTOS=null,d.acceptPP=null,d.acceptedAppTerms=null,d.customRegistrationGdprLinks&&d.customRegistrationGdprLinks.forEach(function(e){e.value=void 0,e.error=void 0}),d.customRegistrationFields&&d.customRegistrationFields.forEach(function(e){e.value=void 0,e.error=void 0,"date"===e.type&&tinycolor(PluginAPI.appTheme.colors.backgroundColor).isDark()?e.class="inverted-input":e.class=e.class?e.class.replace("inverted-input",""):""})};var P=function(){d.successShown=!1,d.registrationShown=!1,d.loginShown=!1,d.forgetPasswordShown=!1,d.resetPasswordShown=!1,(I=I||document.getElementById("frmExternalRegistrationForm")).src="",d.externalRegister=!1,d.ssoRegistrationFormStatus=null};P(),d.openTermsAndConditions=function(){return window.open("https://learn.appdocumentation.com/en/collections/1618556-terms-conditions-and-privacy-policy","_system"),!1},d.registerUser=function(){if(d.registerClick=!0,!d.frmAuthRegister.$invalid)if(window.validator.validatePassword(d.password))d.register(),d.registerClick=!1;else{var e={data:{title:" ",body:n,disableCancel:!0}};window.openDialog(e,function(){})}},d.hideLogin=function(){d.reset(),P(),a.authShown=!1,d.loginCallback=null};var I=document.getElementById("frmExternalRegistrationForm");function A(){d.reset(),P(),a.allowCancel=!d.loginOptions||!1!==d.loginOptions.allowCancel,a.showMenuOnAuth=!d.loginOptions||!1!==d.loginOptions.showMenu,d.loginShown=!0,a.authShown=!0,d.$$phase||d.$apply()}function R(e,s){var n=JSON.parse(window.localStorage.getItem("SSO_USER"));if(n||(n={}),"string"==typeof e)try{e=JSON.parse(e)}catch(e){console.warn("Unexpected parsing issue",e)}e&&e.access_token?n.ssoUserToken=e.access_token:n.ssoUserToken=e.replace(/["]+/g,""),e&&e.expires_in&&e.issued_at?n.ssoExpiresAt=e.issued_at+e.expires_in:n.ssoExpiresAt=1902608081e3,window.localStorage.setItem("SSO_USER",JSON.stringify(n));var o=null;o="undefined"==typeof push?{}:push;var t=u.replace(window.siteConfig.endPoints.hopHost,""),r={id:1,method:"users/loginSSO",params:{accessToken:n.ssoUserToken,accessTokenAPI:t,deviceId:o.deviceId,osType:o.platform?o.platform.toLowerCase():"web",externalAppId:window.appContext.currentApp.appId,loginProviderType:"SSO",email:d.userObj.username,contentType:C}},i=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(r));window.bfUtils.http.jsonp(i,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result)authAPI._setCurrentUser(e.result),a.$broadcast("loginSuccessfully",e.result),s(null,e.result),bfUtils.isEmulatorCP&&cpSync.SSO.log("Succeed...");else{d.invalidRegister=!0;var n=null;e&&e.error?(d.msgError=e.error.message,d.invalidCredentials=!0,console.error(e.error),n=e.error,bfUtils.isEmulatorCP&&cpSync.SSO.log(e.error)):(e=n=d.msgError="Could not retrieve profile data",d.invalidCredentials=!0,console.error(e),bfUtils.isEmulatorCP&&cpSync.SSO.log(e)),s&&s(n,null)}}).error(function(e,n,o,t){console.error(e),s&&s(e,null),bfUtils.isEmulatorCP&&cpSync.SSO.log("Error while testing SSO Login..")})}d.showRegistration=function(e,t){if(d.scrolling=bfUtils.isIOS?"no":"auto","SSOLogin"==f&&w){window.spinner.show(),d.externalRegister=!0,d.ssoRegistrationFormStatus="loading",(I=I||document.getElementById("frmExternalRegistrationForm")).src=w,window.addEventListener("message",function e(n){if(n&&-1<w.indexOf(n.origin)&&n.data){var o=null;try{o=JSON.parse(n.data)}catch(e){}o&&("success"===o.status&&(o.user&&o.user.username&&(d.userObj.username=o.user.username),window.spinner&&window.spinner.show&&window.spinner.show(!0),R(o.user,function(e,n){e?(console.error(e),window.openDialog({data:{title:" ",body:"Invalid Login",disableCancel:!0}},function(){}),t&&t(e,null)):(t||(t=d.loginCallback),t&&t(null,n)),window.spinner&&window.spinner.hide&&window.spinner.hide(!0)})),window.removeEventListener("message",e,!1),I.src="",d.externalRegister=!1,d.ssoRegistrationFormStatus=null,d.$$phase||d.$apply())}},!1)}else d.reset(),P(),d.registrationShown=!0,a.authShown=!0},d.showForgetPassword=function(){d.reset(),P(),d.forgetPasswordShown=!0,a.authShown=!0},d.showSuccess=function(e){P(),d.msgSuccess=e,d.successShown=!0},d.showResetPassword=function(e){d.reset(),P(),d.resetPasswordShown=!0,a.authShown=!0,d.loginCallback=e},d.updateLogin=function(e){e&&"SSOForgetPassword"!=e&&b(e),d.loginCallback=function(e,n){n?(window.authAPI._setCurrentUser(n),window.authAPI.triggerOnLogin(n)):console.error("authCtrl loginCallback error",e),a.allowCancel=!0,a.showMenu=!0,d.hideLogin(),d.$$phase||d.$apply()},A(),e&&"SSOForgetPassword"==e&&(d.showForgetPassword(),d.$apply()),o()},d.updateRegistration=function(e){d.reset(),P(),d.registrationShown=!0,a.authShown=!0,e&&t(e,function(){d.initCustomRegistration()}),d.$$phase||d.$apply()},d.updateLoginAuth=function(e){d.enableFacebook=y(e.enableFacebook),d.enableTwitter=y(e.enableTwitter),d.enableGoogle=y(e.enableGoogle),d.enableApple=y(e.enableApple),d.enablePasswordBasedAuth=y(e.enablePasswordBasedAuth),e.domain&&"enabled"==c&&(l=e.domain),d.$$phase||d.$apply()},d.returnToLogin=function(){d.showLogin(d.loginCallback)},d.showLogin=function(e){d.loginCallback=e,A()},d.resetPassword=function(){if(d.invalidReset=!1,d.msgError=null,d.newPassword!=d.confirmPassword)return d.invalidReset=!1,void(d.msgError="Make sure new password and confirm password are equal");var e={id:1,method:"users/changePassword",params:{email:d.email,secretCode:d.secretCode,password:d.newPassword,passwordStrength:d.customRegistrationRules?d.customRegistrationRules.passwordStrength:null,externalAppId:window.currentAppId}},n=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));window.bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result){d.showSuccess("Password reset successfully");var n={data:{title:" ",body:"Password reset successfully",disableCancel:!0}};window.openDialog(n,function(){})}else if(e&&e.error){n={data:{title:" ",body:e.error.message,disableCancel:!0}};window.openDialog(n,function(){}),console.error(e.error)}}).error(function(e,n,o,t){d.invalidCredentials=!0,console.error(e),callback&&callback(e,null)})},d.forgotPassword=function(e){if("SSOLogin"!=f){d.invalidCredentials=!1;var n={email:d.email,sendSecretCode:!0,externalAppId:window.currentAppId};e&&(n.email=e.email);var o={id:1,method:"users/forgotPassword",params:n},t=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(o));window.bfUtils.http.jsonp(t,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result)d.showResetPassword(d.loginCallback);else{var n={data:{title:" ",body:d.emailDoesNotExistTxt,disableCancel:!0}};window.openDialog(n,function(){}),e&&console.warn(e)}}).error(function(e,n,o,t){d.invalidCredentials=!0,console.error(e)})}else{var s=-1===p.indexOf("?")?"?":"&",r=p+s+"email="+d.email;window.bfUtils.http.get(r,{headers:{"Content-Type":"application/x-www-form-urlencoded"}}).success(function(){var e={data:{title:" ",body:g||"An email has been sent, please check your email.",disableCancel:!0}};window.openDialog(e,function(){d.showLogin(function(e,n){authAPI._setCurrentUser(n),authAPI.triggerOnLogin(n),a.allowCancel=!0,a.showMenu=!0,d.hideLogin(),d.$$phase||d.$apply()})}),cpSync.SSO.log("Succeed...")}).error(function(e,n,o,t){e&&console.error(e),bfUtils.isEmulatorCP&&(e||"0"!=n?(n&&cpSync.SSO.log("Error status:"+n),e&&cpSync.SSO.log("Error details:"+JSON.stringify(e))):cpSync.SSO.log("Error while testing SSO Login , CORS policy .."))})}},d.showBackLogin=function(){authAPI.login(null,function(){a.$broadcast("displayNav")})},d.login=function(e,s){window.spinner&&window.spinner.show&&window.spinner.show(!0),"SSOLogin"!=f?function(e,s){if(window.appContext&&window.appContext.currentApp){d.invalidCredentials=!1,s||(s=d.loginCallback);var n=null;n="undefined"==typeof push?{}:push;var o=d.userObj.email;o||(o=e.email),d.password||(d.password=e.password),"enabled"==c&&l&&!o.includes("@")&&(o+=l),console.warn("email",o);var t={email:o,password:d.password,deviceId:n.deviceId,osType:n.platform?n.platform.toLowerCase():"web",externalAppId:window.appContext.currentApp.appId};e&&(t.email=e.email,t.password=e.password);var r={id:1,method:"users/login",params:t},i=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(r));window.bfUtils.http.jsonp(i,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result&&e.result.userToken)authAPI._setCurrentUser(e.result),a.$broadcast("loginSuccessfully",e.result),s&&s(null,e.result);else{d.invalidCredentials=!0;var n=null;e&&e.error&&(console.warn("login error: ",e.error),n=e.error),n&&n.message?d.msgError=n.message:d.msgError="Invalid Email or Password",s&&s(n,null)}}).error(function(e,n,o,t){d.invalidCredentials=!0,console.error(e),s&&s(e,null)})}else console.error("invalid appContext")}(e,function(e,n){if(e||!n){var o=null;if(e)switch(e.code){case 1303:o=e.message;break;default:o="Invalid Login"}else o="To log in, please make sure you have a valid connection.";var t={data:{title:" ",body:o,disableCancel:!0}};window.openDialog(t,function(){}),console.error(e),s&&s(e,null)}else s||(s=d.loginCallback),s&&s(null,n);window.spinner&&window.spinner.hide&&window.spinner.hide(!0)}):function(e,s){var n={headers:{"Content-Type":"application/x-www-form-urlencoded"}},o=d.userObj.username;if("enabled"==c&&l&&!o.includes("@")&&(o+=l),"application/x-www-form-urlencoded"==C)var t=encodeURIComponent("grant_type")+"="+encodeURIComponent("password")+"&"+encodeURIComponent("username")+"="+encodeURIComponent(o)+"&"+encodeURIComponent("password")+"="+encodeURIComponent(d.password)+"&"+encodeURIComponent("client_id")+"="+encodeURIComponent(m)+"&"+encodeURIComponent("client_secret")+"="+encodeURIComponent(h);else"multipart/form-data"==C?(n={transformRequest:angular.identity,headers:{"Content-Type":void 0}},(t=new FormData).append("username",o),t.append("password",d.password)):t={grant_type:"password",username:o,password:d.password,client_id:m};window.bfUtils.http.post(i,t,n).success(function(e){R(e,s)}).error(function(e,n,o,t){d.invalidCredentials=!0,e&&e.error_description?(console.error(e),d.msgError=e.error_description):d.msgError="Login Failed",s&&s("Login Failed",null),bfUtils.isEmulatorCP&&(e||"0"!=n?(n&&cpSync.SSO.log("Error status:"+n),e&&cpSync.SSO.log("Error details:"+JSON.stringify(e))):cpSync.SSO.log("Error while testing SSO Login , CORS policy .."))})}(0,function(e,n){if(e){console.error(e);var o=null;if(e)switch(e.code){case 1303:case 1301:case 1312:o=e.message;break;default:o="Invalid Login"}else o="To log in, please make sure you have a valid connection.";var t={data:{title:" ",body:o,disableCancel:!0}};window.openDialog(t,function(){}),s&&s(e,null)}else s||(s=d.loginCallback),s(null,n);window.spinner&&window.spinner.hide&&window.spinner.hide(!0)})};d.getGDPR=function(o,t){var e=d.userObj.email,n=siteConfig.endPoints.crmHost+"/documents/"+o.key+"/check?userKey="+encodeURIComponent(e)+"&withDetails=true";bfUtils.http.get(n).success(function(e){var n={};n.title=s.trustAsHtml(e[o.key].title),n.subtitle=s.trustAsHtml(e[o.key].subtitle),n.details=s.trustAsHtml(e[o.key].details),t(null,n)}).error(function(e){console.error(e),t(e,null)})},d.loadGDPR=function(e){d.getGDPR({key:e},function(e,n){n&&(d.GDPR_content=n,d.showGDPR=!0,a.$broadcast("hideNav"),d.$$phase||d.$apply())})},d.hideGDPR=function(){a.$broadcast("displayNav"),d.showGDPR=!1,d.GDPR_content=null},d.showTermsOfService=function(){d.loadGDPR("bf_terms_and_conditions")},d.showPrivacyPolicy=function(){d.loadGDPR("bf_privacy_policy")},d.showAppTerms=function(){window.open(appContext.currentApp.config.TermsOfUse,"_system")},d.shouldShowAppTerms=!!(appContext.currentApp&&appContext.currentApp.config&&appContext.currentApp.config.TermsOfUse)&&appContext.currentApp.config.TermsOfUse.indexOf("appdocumentation.com")<0&&appContext.currentApp.config.TermsOfUse.indexOf("buildfire.com")<0,d.saveGDPR=function(s,r){var o;o=function(e,n){var t={};n&&(t=n),t.appId=appContext.currentApp.appId;var o=["bf_terms_and_conditions","bf_privacy_policy"];s.customTermsAndConditionsKey&&o.push(s.customTermsAndConditionsKey),s.customPrivacyPolicyKey&&o.push(s.customPrivacyPolicyKey),function(e,n){if(e){var o=siteConfig.endPoints.crmHost+"/documents/"+e+"/accept";bfUtils.http.post(o,{userKey:s?s.email.toLowerCase():d.userObj.email.toLowerCase(),info:t,source:"app"}).success(function(e){n(null,e)}).error(function(e){n(e),console.error(e)})}else n(null,null)}(o.join(","),function(){r&&r()})},window.$http.get("https://ipapi.co/json/").success(function(e){if(e){var n={ipInfo:{city:e.city,country:e.country_name,countryCode:e.country,lat:e.latitude,lon:e.longitude,regionName:e.region,timezone:e.timezone,zip:e.postal,ip:e.ip}};o(null,n)}else o(null,null)}).error(function(e){o(null,null)})},d.register=function(s,l){if(window.appContext&&window.appContext.currentApp){d.invalidRegister=!1,l||(l=d.loginCallback);var e=null;e="undefined"==typeof push?{}:push;var c=(s?s.user:void 0)||{firstName:d.firstName||d.userObj.email,lastName:d.lastName||"",email:d.userObj.email,password:d.password};c.deviceId=e.deviceId,c.osType=e.platform?e.platform.toLowerCase():"web",c.passwordStrength=d.customRegistrationRules?d.customRegistrationRules.passwordStrength:null,c.externalAppId=window.appContext.currentApp.appId;var n={id:1,method:"users/register",params:c},o=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(angular.toJson(n));d.isRegistering=!0,window.bfUtils.http.jsonp(o,{bypassInterceptorForStatus:404}).success(function(e){if(e&&e.result){var n={email:c.email};s&&(n.customTermsAndConditionsKey=s.customTermsAndConditionsKey,n.customPrivacyPolicyKey=s.customPrivacyPolicyKey),d.saveGDPR(n,function(){d.login({email:c.email,password:c.password},function(e,n){c.userProfile&&userTags.setRegistrationTags(c.userProfile,!0,function(e,n){e&&console.log(e)}),n&&n.userToken?(d.upload(d.uploadFile,function(e,n){if(e)d.isRegistering=!1,l&&l(e,null);else{var o=authAPI.getCurrentUser();if(n){var t={userToken:o.userToken,firstName:c.firstName,lastName:c.lastName,displayName:c.firstName+" "+c.lastName,imageUrl:n.result,externalAppId:window.currentAppId};r=function(e,n){d.isRegistering=!1,l&&l(e,n)},i={id:1,method:"users/update",params:s=t},a=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(i)),window.bfUtils.http.jsonp(a,{bypassInterceptorForStatus:404}).success(function(e){if(e.error){var n=null;e&&e.error&&(console.error(e.error),n=e.error),r&&r(n,null)}else{var o=authAPI.getCurrentUser();null!=o&&(o.firstName=s.firstName,o.lastName=s.lastName,o.displayName=s.displayName,o.imageUrl=s.imageUrl,authAPI._setCurrentUser(o)),r&&r(null,o)}}).error(function(e,n,o,t){console.error(e),r&&r(e,null)})}else d.isRegistering=!1,l&&l(null,o)}var s,r,i,a}),authAPI.trackRegister(n)):d.isRegistering=!1})})}else{d.isRegistering=!1,d.invalidRegister=!0;if(e&&e.error){var o=e.error.message;1301===e.error.code&&s&&s.messages&&s.messages.emailAlreadyInUse&&(o=s.messages.emailAlreadyInUse);var t={data:{title:" ",body:o,disableCancel:!0}};window.openDialog(t,function(){}),console.warn(e.error),e.error}}}).error(function(e,n,o,t){console.error(e),d.isRegistering=!1})}else console.error("invalid appContext")},d.upload=function(e,s){var n=authAPI.getCurrentUser();if(null!=n){var o=window.siteConfig.endPoints.authHost+"/src/server.js?method=users/uploadImage";if(e&&1==e.length){var t=e[0];r.upload({url:o,fields:{userToken:n.userToken,externalAppId:window.currentAppId},file:t}).progress(function(e){d.progressMessage=!0;var n=parseInt(100*e.loaded/e.total);console.log("progress: "+n+"% "+e.config.file.name)}).success(function(e,n,o,t){console.log("file "+t.file.name+"uploaded."),s&&s(null,e)}).error(function(e){d.msgError="",d.invalidRegister=!0,s&&s(e,null)})}else s&&s(null,null)}else s&&s({message:"Invalid user"},null)},d.requestLoginProvider=function(n){var e={id:1,method:"secretCode/request",params:{externalAppId:window.currentAppId}},o=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));d.refWindow&&!d.refWindow.closed||window.bfUtils.http.jsonp(o,{bypassInterceptorForStatus:404}).success(function(e){if(null!=e&&null!=e.result&&e.result.code){d.secretCodeProvider=e.result.code,d.refWindow="apple"===n?window.open(window.siteConfig.endPoints.authHost+"/api/sso/apple?code="+encodeURIComponent(d.secretCodeProvider)+"&externalAppId="+encodeURIComponent(window.currentAppId),"_blank","location=no,enableViewportScale=yes"):window.open(window.siteConfig.endPoints.authHost+"/website/index.html?v=2.0&code="+encodeURIComponent(d.secretCodeProvider)+"&loginProviderType="+n+"&externalAppId="+encodeURIComponent(window.currentAppId),"_blank","location=no,enableViewportScale=yes"),d.refWindow&&d.refWindow.addEventListener&&d.refWindow.addEventListener("exit",function(){d.refWindow=null});setTimeout(k,1e3,120)}},function(e){console.log(JSON.stringify(e))})};var k=function s(r){if(window.appContext&&window.appContext.currentApp)if(0<r){var e={id:1,method:"users/secretCodeLogin",params:{code:d.secretCodeProvider,deviceId:push.deviceId,osType:push.platform?push.platform.toLowerCase():"web",externalAppId:window.appContext.currentApp.appId}},n=window.siteConfig.endPoints.authHost+"/src/server.js?callback=JSON_CALLBACK&data="+encodeURIComponent(JSON.stringify(e));window.bfUtils.http.jsonp(n,{bypassInterceptorForStatus:404}).success(function(e){if(e.error){var n=!1;1300==e.error.code&&(n=!0),1303==e.error.code&&(n=!0),n&&(d.secretCodeProvider=null)!=d.refWindow&&(d.refWindow.close(),d.refWindow=null)}else if(null!=e.result&&null!=e.result.userToken){authAPI._setCurrentUser(e.result);var o=new Date;o.setMinutes(o.getMinutes()-5);var t=new Date(e.result.createdOn);t&&t.getTime()>=o.getTime()&&userTags.setRegistrationTags(null,!0,function(e,n){e&&console.log(e)}),null!=d.refWindow&&(d.refWindow.close(),d.refWindow=null),d.loginCallback&&d.loginCallback(null,authAPI.getCurrentUser())}else null!=d.refWindow&&d.refWindow.closed?(d.refWindow.close(),d.secretCodeProvider=null,d.refWindow=null):setTimeout(s,1e3,r-1)},function(e){console.log(JSON.stringify(e))})}else(d.secretCodeProvider=null)!=d.refWindow&&(d.refWindow.close(),d.refWindow=null),d.loginCallback&&(d.invalidCredentials=!0,d.msgError="Invalid Login",d.loginCallback(null,null));else console.error("invalid appContext")};d.setThemeType=function(e){e||(e={});var n,o,t,s,r=null;(e.customLoginUI&&e.customLoginUI.background&&e.customLoginUI.background.active&&e.customLoginUI.background.activeColor?e.customLoginUI.background.color&&"solid"===e.customLoginUI.background.color.colorType&&(r=e.customLoginUI.background.color.solid.colorHex):e.colors&&e.colors.backgroundColor&&(r=e.colors.backgroundColor),r)&&(t=r.match(/^rgb/)?(n=(r=r.match(/^rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*(\d+(?:\.\d+)?))?\)$/))[1],o=r[2],r[3]):(n=(r=+("0x"+r.slice(1).replace(r.length<5&&/./g,"$&$&")))>>16,o=r>>8&255,255&r),s=Math.sqrt(n*n*.299+o*o*.587+t*t*.114),d.themeType=127.5<s?"light":"dark")}}]);
