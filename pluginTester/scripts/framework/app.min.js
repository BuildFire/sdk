...
"use strict";var richModal=function(){var u=document.createElement("div");u.id="richModal",u.className="hidden";var e=document.createElement("div");e.className="focus-screen hidden",u.appendChild(e),document.body.appendChild(u);var g=null,h=[];function p(){try{if(g)return;if(0<=window.location.hash.indexOf("accessCode"))return setTimeout(p,5e3);var e=document.getElementsByClassName("login-holder")[0];if(e&&-1===e.className.indexOf("ng-hide"))return setTimeout(p,5e3);var t=(g=h.shift()).options,n=g.callback;document.getElementById("richModal").className="",document.getElementsByClassName("focus-screen")[0].className="focus-screen animated fadeInScreen";var i=document.createElement("div");if(i.className="detail-modal animated fadeInUp",t.title){var a=document.createElement("h1");if(30<t.title.length&&(t.title=t.title.substring(0,27).trim()+"..."),a.innerHTML=t.title,t.design){var s="";t.design.title&&t.design.title.align&&(s+="text-align: "+t.design.title.align+" !important;"),t.design.textColor&&(s+="color: "+t.design.textColor+" !important;"),a.setAttribute("style",s)}i.appendChild(a)}if(t.subtitle){var o=document.createElement("span");if(o.className="subtitle",o.innerHTML=t.subtitle,t.design){s="";t.design.subtitle&&t.design.subtitle.align&&(s+="text-align: "+t.design.subtitle.align+" !important;"),t.design.textColor&&(s+="color: "+t.design.textColor+" !important;"),o.setAttribute("style",s)}i.appendChild(o)}var l=document.createElement("div");l.className="rich-content",l.innerHTML=t.richContent,i.appendChild(l);var c=document.createElement("div");if(c.className="button-container",i.appendChild(c),t.showDismissButton||void 0===t.showDismissButton){var d=document.createElement("button");d.className=t.action?"dismiss-button":"dismiss-button dismiss-large",d.innerHTML="Dismiss",d.onclick=function(){f(),n&&n(null,{buttonType:"dismiss"})},c.appendChild(d)}var r="";t.design&&(t.design.fullScreen&&u.classList.add("fullScreen"),t.design.backgroundColor&&(r+="background : "+t.design.backgroundColor+" !important;"),t.design.textColor&&(r+="color : "+t.design.textColor+" !important"),i.setAttribute("style",r),d.setAttribute("style",r))}catch(e){console.error("Failed to render rich modal",e)}if(t.action)try{var m=document.createElement("button");!(m.className="action-button")===t.showDismissButton&&(m.className="action-button action-button-large"),t.action.title&&11<t.action.title.length&&(t.action.title=t.action.title.substring(0,8).trim()+"..."),m.innerHTML=t.action.title||"[ Click ]",m.onclick=function(){t.action.handler?t.action.handler():((new ActionItemsAPI).execute(t.action,function(e,t){}),n&&n(null,{buttonType:"action",value:t.action}));t.action.preventAutoClose||f()},t.design&&r&&m.setAttribute("style",r),c.appendChild(m)}catch(e){console.error("Failed to bind action to rich modal",e)}document.getElementById("richModal").appendChild(i)}function f(){var e=document.getElementsByClassName("focus-screen")[0];e&&(e.className="focus-screen animated fadeOutScreen");var t=document.getElementsByClassName("detail-modal")[0];t&&(t.className="detail-modal animated fadeOut");var n=document.getElementById("richModal");setTimeout(function(){t&&t.remove(),g=null,0<h.length?setTimeout(p,300):n&&(n.className="hidden")},700)}return{display:function(e,t){h.push({options:e,callback:t}),p()},close:function(){f()}}}();
...
"use strict";function ComponentUIAPI(e){this.context=e,this.DRAWER_UI_ID="bottomDrawerContainer",this.SNACKBAR_UI_ID="snackbarhero",this.init()}ComponentUIAPI.prototype={init:function(){},closeDrawer:function(e,t){e||(e={});var s=document.getElementById(this.DRAWER_UI_ID);s&&(e.force?s.remove():(s.classList.add("closing"),setTimeout(function(){s.remove()},300)))},openBottomDrawer:function(e,i){var t=this;e||(e={});var s=document.createElement("div");s.id=this.DRAWER_UI_ID,s.className="bottom-drawer-container",s.innerHTML='<div class="bottom-drawer-backdrop"></div>\n<div class="bottom-drawer-holder"><div class="bottom-drawer backgroundColorTheme"></div></div>\n';var a=s.querySelector(".backgroundColorTheme");if(s.querySelector(".bottom-drawer-backdrop").onclick=function(){t.closeDrawer()},e.header){var n=document.createElement("div");n.className="bottom-drawer-header primaryBackgroundTheme",n.innerHTML=e.header,a.appendChild(n)}function r(e){var t=document.createElement("ul");function s(e,t){e.onclick=function(){i(null,t)}}t.classList.add("action-list");for(var a=0;a<e.length;a++)if(e[a].text){var n=document.createElement("li");n.innerHTML='<div class="item-icon"><span class="icon hide"></span></div>\n<span>'+e[a].text+"</span>",s(n,e[a]),t.appendChild(n)}return t}if(e.richContent){var c=document.createElement("div");c.className="drawer-content",c.innerHTML=e.richContent,a.appendChild(c)}else if(e.listItems)a.appendChild(r(e.listItems));else if(e.tabs&&e.tabs){var o=document.createElement("div");o.className="md-tabs-scroll";for(var d="",l=0;l<e.tabs.length;l++)d+='<button class="btn-tab-drawer-'+l+(0==l?" md-tab active":" md-tab")+'">\n'+e.tabs[l].text+'<div class="active-indicator primaryBackgroundTheme"></div></button>';d='<div class="md-tabs">'+d+"</div>",o.innerHTML=d;var m=0,u=[],h=o.querySelectorAll("button");h.forEach(function(t){t.setAttribute("data-tabindex",m),t.onclick=function(){h.forEach(function(e){e.classList.remove("active")}),t.classList.add("active");var e=t.getAttribute("data-tabindex");u.forEach(function(e){e.classList.add("hide")}),u[e].classList.remove("hide")},m++}),a.appendChild(o);for(var v=0;v<e.tabs.length;v++){if(e.tabs[v].listItems)u.push(r(e.tabs[v].listItems));else{var b=document.createElement("div");b.className="drawer-content",b.innerHTML=e.tabs[v].richContent,u.push(b)}0<v&&u[v].classList.add("hide"),a.appendChild(u[u.length-1])}}this.closeDrawer({force:!0}),(document.getElementById("appBody")||document.getElementById("app")).appendChild(s)},showToastMessage:function(e,t){var s=this;e||(e={});var a=document.getElementById(this.SNACKBAR_UI_ID);a.querySelector(".snackbar-message").innerText=e.text;var n=a.querySelector(".snackbar-actions"),i=n.querySelector(".snackbar-action");e.action&&e.action.title?(i.querySelector("span").innerText=e.action.title,i.classList.remove("hide"),i.onclick=function(){t&&t(null,e.action)}):i.classList.add("hide"),e.hideDismiss?n.querySelector(".dismiss").classList.add("hide"):(n.querySelector(".dismiss").classList.remove("hide"),n.querySelector(".dismiss").onclick=function(){s.closeToastMessage({force:!0})}),a.classList.remove("hide"),a.querySelector(".snackbar").classList.add("open"),this.closeToastMessage()},closeToastMessage:function(e,t){e||(e={});var s=document.getElementById(this.SNACKBAR_UI_ID);e.force?(s.querySelector(".snackbar").classList.remove("closing"),s.querySelector(".snackbar").classList.remove("open"),s.classList.add("hide")):(s.querySelector(".snackbar").classList.add("closing"),setTimeout(function(){s.querySelector(".snackbar").classList.remove("closing"),s.querySelector(".snackbar").classList.remove("open"),s.classList.add("hide")},8e3))}};