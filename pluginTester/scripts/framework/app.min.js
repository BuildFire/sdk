...
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function ownKeys(o,e){var r,n=Object.keys(o);return Object.getOwnPropertySymbols&&(r=Object.getOwnPropertySymbols(o),e&&(r=r.filter(function(e){return Object.getOwnPropertyDescriptor(o,e).enumerable})),n.push.apply(n,r)),n}function _objectSpread(o){for(var e=1;e<arguments.length;e++){var r=null!=arguments[e]?arguments[e]:{};e%2?ownKeys(Object(r),!0).forEach(function(e){_defineProperty(o,e,r[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(o,Object.getOwnPropertyDescriptors(r)):ownKeys(Object(r)).forEach(function(e){Object.defineProperty(o,e,Object.getOwnPropertyDescriptor(r,e))})}return o}function _defineProperty(e,o,r){return o in e?Object.defineProperty(e,o,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[o]=r,e}function _readOnlyError(e){throw new TypeError('"'+e+'" is read-only')}!function(p){function r(){p._LTracker=p._LTracker||[],p._LTracker.push({logglyKey:y.token,sendConsoleErrors:!1,tag:y.stringTags}),y.levels.forEach(function(e){switch(e){case"info":i="info",s=console.info,console.info=function(){for(var e={level:i,category:u[i].console},o=arguments.length,r=new Array(o),n=0;n<o;n++)r[n]=arguments[n];v.apply(void 0,[e].concat(r)),s.apply(void 0,r)};break;case"log":l=console.log,console.log=function(){for(var e={level:"log",category:u.log.console},o=arguments.length,r=new Array(o),n=0;n<o;n++)r[n]=arguments[n];v.apply(void 0,[e].concat(r)),l.apply(void 0,r)};break;case"warn":c=console.warn,console.warn=function(){for(var e={level:"warn",category:u.warn.console},o=arguments.length,r=new Array(o),n=0;n<o;n++)r[n]=arguments[n];v.apply(void 0,[e].concat(r)),c.apply(void 0,r)};break;case"error":t="error",a=console.error,console.error=function(){for(var e={level:t,category:u[t].console},o=arguments.length,r=new Array(o),n=0;n<o;n++)r[n]=arguments[n];v.apply(void 0,[e].concat(r)),a.apply(void 0,r)},p.addEventListener("error",function(e){var o={level:t,category:u[t].exception,exception:{colno:e.colno,lineno:e.lineno,message:e.message,stack:e.error&&e.error.stack?e.error&&e.error.stack:"n/a",url:e.filename}};v(o,e.message)})}var t,a,c,l,i,s}),f=!0}function g(){y.context||(y.context={});var e=_objectSpread(_objectSpread({},y.context),{},{appId:p.appContext.currentApp.appId||"",appName:p.appContext.currentApp.appName||""}),o=authAPI.getCurrentUser();return o&&(e.userId=o.userId,e.email=o.email,e.userToken=o.userToken),e}var f=!1,y={tags:[],token:"",levels:[],stringTags:"",context:{}},n=["info","log","warn","error"],u={info:{console:"ConsoleInfo"},log:{console:"ConsoleLog"},warn:{console:"ConsoleWarn"},error:{console:"ConsoleError",exception:"BrowserJsException"}},d=function(e){return(e=(e=e||[]).filter(function(e){return e.trim()})).join(",")},v=function(e){if(f){for(var o=e=e||{},r=o.message,n=o.data,t=o.context,a=o.level,c=o.category,e=o.exception,o=o.tags,l=arguments.length,i=new Array(1<l?l-1:0),s=1;s<l;s++)i[s-1]=arguments[s];r||(i&&i.length&&i[0],_readOnlyError("message")),n||(i&&1<i.length&&_objectSpread({},i),_readOnlyError("data"));c={message:r,data:n,context:g(),level:a,category:c,location:{origin:p.location.origin,href:p.location.href}};t&&"object"==_typeof(t)&&(c.context=_objectSpread(_objectSpread({},c.context),t)),e&&(c.exception=e),o&&o.length||_readOnlyError("tags"),p.appContext&&p.appContext.environment&&o.push(p.appContext.environment),function(e){e=d(e);e&&p._LTracker.push({logglyKey:y.token,sendConsoleErrors:!1,tag:e})}(o),p._LTracker&&p._LTracker.push(c)}else console.warn("Logger not initialized: Unable to log messages.")};p.loggerAPI={init:function(e){var o;f?console.error("Logger already initialized. Cannot initialize multiple times."):(e=(y=(y=e)||{}).levels,o=!0,(e=e||[]).forEach(function(e){n.includes(e)||(console.error('Failed to initialize logger: Invalid log level - "'.concat(e,'". Allowed levels are: ').concat(n,".")),o=!1)}),o&&((y.token||"").trim()?r():console.error("Failed to initialize logger: Invalid token.")))},log:function(e){v(e)},setContext:function(e){try{y.context=JSON.parse(JSON.stringify(e))}catch(e){console.error("Failed to set logger context: Invalid context object.",e)}}},p.appContext&&p.appContext.environment&&"prod"==p.appContext.environment&&p.loggerAPI.init({token:"93cbe5ea-7286-486c-bedd-791d44aa7d95",levels:["error"]})}(window,document);