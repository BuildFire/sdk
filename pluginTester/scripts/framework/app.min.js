...
"use strict";var bookmarkAPI={add:function(t,e){var r=window.appContext.currentPlugin.instanceId,n=authAPI.getCurrentUser(),a=(n?n._id:"guest")+".bookmarks",l=localStorage.getItem(a)?JSON.parse(localStorage.getItem(a)):[];t.id=t.id||t.title,t.pluginInstanceId=r,l.push(t),localStorage.setItem(a,JSON.stringify(l)),e(null,t)},delete:function(e,t){var r=authAPI.getCurrentUser(),n=(r?r._id:"guest")+".bookmarks",a=localStorage.getItem(n)?JSON.parse(localStorage.getItem(n)):[],l=a.findIndex(function(t){return t.id===e});a.splice(l,1),localStorage.setItem(n,JSON.stringify(a)),t&&t(null,a)},deleteFromPlugin:function(e,t){var r=authAPI.getCurrentUser(),n=(r?r._id:"guest")+".bookmarks",a=localStorage.getItem(n)?JSON.parse(localStorage.getItem(n)):[],l=a.findIndex(function(t){return t.id===e&&"131231"===t.pluginInstanceId});a.splice(l,1),localStorage.setItem(n,JSON.stringify(a)),t(null,null)},loadBookmark:function(){},getAll:function(t){var e=authAPI.getCurrentUser(),r=(e?e._id:"guest")+".bookmarks";t(null,localStorage.getItem(r)?JSON.parse(localStorage.getItem(r)):{})},getAllFromPlugin:function(t){var e=authAPI.getCurrentUser(),r=e?e._id:"guest",n=window.currentPlugin.instanceId,a=r+".bookmarks";t(null,(localStorage.getItem(a)?JSON.parse(localStorage.getItem(a)):[]).filter(function(t){return t.pluginInstanceId=n}))}};
