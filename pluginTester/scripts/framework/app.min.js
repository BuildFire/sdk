...
"use strict";"undefined"==typeof AiAPI&&(window.AiAPI=function(t){this.context=t}),AiAPI.prototype.chat=function(t,n){t={url:"".concat(window.siteConfig.endPoints.gatewayHost,"/ai/chat"),headers:{"Content-Type":"application/json"},body:JSON.stringify(t),method:"POST"};fetch(t.url,{method:t.method,headers:t.headers,body:t.body}).then(function(t){return t.json()}).then(function(t){n(null,t)}).catch(function(t){n(t,null)})};