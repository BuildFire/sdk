...
"use strict";var bookmarkAPI={add:function(t,e){var r=window.appContext.currentPlugin.instanceId,a=authAPI.getCurrentUser(),o=(a?a._id:"guest")+".bookmarks",l=localStorage.getItem(o)?JSON.parse(localStorage.getItem(o)):[];t.id=t.id||t.title,t.pluginInstanceId=r;var i=n.id===t.id,u=n.pluginInstanceId===t.pluginInstanceId,g=l.findIndex(function(t){return i&&u});0<=g?l[g]=t:l.push(t),localStorage.setItem(o,JSON.stringify(l)),e(null,t)},delete:function(e,t){var n=authAPI.getCurrentUser(),r=(n?n._id:"guest")+".bookmarks",a=localStorage.getItem(r)?JSON.parse(localStorage.getItem(r)):[],o=a.findIndex(function(t){return t.id===e});a.splice(o,1),localStorage.setItem(r,JSON.stringify(a)),t&&t(null,a)},deleteFromPlugin:function(e,t){var n=window.currentPlugin.instanceId,r=authAPI.getCurrentUser(),a=(r?r._id:"guest")+".bookmarks",o=localStorage.getItem(a)?JSON.parse(localStorage.getItem(a)):[],l=o.findIndex(function(t){return t.id===e&&t.pluginInstanceId===n});o.splice(l,1),localStorage.setItem(a,JSON.stringify(o)),t(null,null)},loadBookmark:function(t){var e=t.pluginInstanceId;if(e){var n=window.postMaster.launcherPluginAPI.navigation,r={instanceId:e},a=Function.prototype;n.navigateToPluginInstance(r,a)}},getAll:function(t){var e=authAPI.getCurrentUser(),n=(e?e._id:"guest")+".bookmarks";t(null,localStorage.getItem(n)?JSON.parse(localStorage.getItem(n)):[])},getAllFromPlugin:function(t){var e=authAPI.getCurrentUser(),n=e?e._id:"guest",r=window.currentPlugin.instanceId,a=n+".bookmarks";t(null,(localStorage.getItem(a)?JSON.parse(localStorage.getItem(a)):[]).filter(function(t){return t.pluginInstanceId=r}))}};
