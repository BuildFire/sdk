...
"use strict";function ownKeys(t,e){var s,n=Object.keys(t);return Object.getOwnPropertySymbols&&(s=Object.getOwnPropertySymbols(t),e&&(s=s.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),n.push.apply(n,s)),n}function _objectSpread(t){for(var e=1;e<arguments.length;e++){var s=null!=arguments[e]?arguments[e]:{};e%2?ownKeys(Object(s),!0).forEach(function(e){_defineProperty(t,e,s[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(s)):ownKeys(Object(s)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(s,e))})}return t}function _defineProperty(e,t,s){return t in e?Object.defineProperty(e,t,{value:s,enumerable:!0,configurable:!0,writable:!0}):e[t]=s,e}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function AnalyticsAPI(e,t,s,n,i){var o;this.analyticsHostUrl=siteConfig.endPoints.analyticsHost,"object"==_typeof(e)?(this.appId=(o=e).appId,this.pluginId=o.pluginId,this.instanceId=o.instanceId,this.liveMode=o.liveMode,this.developerId=o.developerId):(this.appId=e,this.pluginId=t,this.instanceId=s,this.liveMode=n,this.developerId=i),this.source=window.siteConfig&&"app"===window.siteConfig.scope?"app":"web",this.secondLevelEmailVerificationEnabled=!1,window.whitelabelContext&&window.whitelabelContext.whitelabelId&&(this.whitelabelId=window.whitelabelContext.whitelabelId,window.whitelabelContext.selfProvSettings&&(this.secondLevelEmailVerificationEnabled=window.whitelabelContext.selfProvSettings.secondLevelEmailVerificationEnabled)),this._user=this._getUser(),this.firebase.init(),window.appContext&&window.appContext.liveMode&&this.appId&&this._trackInstall()}AnalyticsAPI.prototype={_getIpInfo:function(e){function t(){var e=new XMLHttpRequest;e.open("GET",window.siteConfig.endPoints.crmHost+"/ipinfo",!0),e.onreadystatechange=function(){if(4==e.readyState){if(200<=e.status&&e.status<400){if(e.responseText){var t={};try{t=JSON.parse(e.responseText)}catch(e){t={}}}t=t,!0&&(t={data:t,lastSyncDate:new Date},localStorage.setItem("analyticsUserIpInfo",JSON.stringify(t)))}AnalyticsAPI.IPInfoCalled=!1}},e.send(null)}var s,n,i=localStorage.getItem("analyticsUserIpInfo");if(i){try{i=JSON.parse(i)}catch(e){i=null}var o=new Date,a=i&&i.lastSyncDate?new Date(i.lastSyncDate):new Date;n=o,s=(s=a).getTime(),n=n.getTime(),s=Math.abs(n-s),Math.round(s/864e5)<=30&&i&&i.data?e&&e(i.data):(e&&e(i?i.data:null),AnalyticsAPI.IPInfoCalled||(AnalyticsAPI.IPInfoCalled=!0,t()))}else e&&e(),AnalyticsAPI.IPInfoCalled||(AnalyticsAPI.IPInfoCalled=!0,t())},_updateMetadata:function(e){var t,s=null;"undefined"==typeof authAPI||(t=authAPI.getCurrentUser())&&t._id&&(s={userId:t._id,username:t.username,email:t.email||t.username,displayName:t.displayName,firstName:t.firstName,lastName:t.lastName}),e.user=s,"undefined"!=typeof push&&null!=push.deviceId&&(e.deviceId=push.deviceId)},_getUser:function(){if("undefined"==typeof authAPI)return this._getAnonymousUser();var e=authAPI.getCurrentUser();return e&&e.username?{userId:e.username,isValidEmail:this.secondLevelEmailVerificationEnabled?e.isValidEmail:1}:"undefined"!=typeof push&&null!=push.deviceId?{userId:push.deviceId}:this._getAnonymousUser()},_getAnonymousUser:function(){var e,t,s=localStorage.getItem("analyticsUser");if(s)try{i=JSON.parse(s)}catch(e){console.log(e)}if(!i){s=this._getCookie("ajs_anonymous_id");if(s)i={anonymousId:s.replace("%22","").replace("%22","")};else{var n=1,i={anonymousId:(e=new Date,t=e.getMilliseconds()+"",++e+t+(1e4==++n?n=1:n))};try{localStorage.setItem("analyticsUser",JSON.stringify(i))}catch(e){console.log(e)}}}return i},_getBrowserInfo:function(){return{path:document.location.pathname,referrer:document.referrer,url:document.location.href,title:document.title,platform:window.device&&window.device.platform?window.device.platform.toLowerCase():""}},_getCookie:function(e){for(var t=e+"=",s=document.cookie.split(";"),n=0;n<s.length;n++){for(var i=s[n];" "==i.charAt(0);)i=i.substring(1);if(0==i.indexOf(t))return i.substring(t.length,i.length)}return""},_trackInstall:function(){localStorage.getItem("INSTALL_TRACKED")||(this.trackAction("app/installed",{appId:this.appId}),localStorage.setItem("INSTALL_TRACKED","true"))},firebase:{_plugin:void 0,_analytics:void 0,_userId:null,_isEnabled:!1,init:function(){this._isEnabled&&(this._plugin="undefined"!=typeof cordova&&cordova.plugins&&cordova.plugins.firebase&&cordova.plugins.firebase?cordova.plugins.firebase:null,this._analytics=this._plugin?this._plugin.analytics:null)},logEvent:function(e,t){this._analytics&&(e=this._sanitizeKey(e),t=this._sanitizeMetadata(t),this._analytics.logEvent(e,t))},setScreenName:function(e){this._analytics&&(e=this._sanitizeKey(e),this._analytics.setScreenName(e))},_syncUserId:function(){this._user&&!this._user.userId&&this._userId!==this._user.userId&&(this._userId=this._user.userId,this._analytics.setUserId(this._user.userId))},_setUserProperties:function(){if(this._user)for(var e in this._user)this._user.hasOwnProperty(e)&&this._analytics.setUserProperty(e,this._user[e])},_sanitizeKey:function(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:40;return"string"!=typeof e?e:e.replace(/[\W_]+/g,"_").slice(0,t)},_sanitizeMetadata:function(e){var o=this,s=function s(n){var i={};return Object.keys(n).forEach(function(e){var t=n[e];"object"!==_typeof(t)||null===t||Array.isArray(t)?["string","number"].includes(_typeof(t))&&(i[o._sanitizeKey(e)]=o._sanitizeKey(t,100)):Object.assign(i,s(t))}),i}(e);return Object.keys(s).slice(0,25).reduce(function(e,t){return e[t]=s[t],e},{})}},trackAction:function(t,s,n){var i,o=this;if(s){var e,a=this._getBrowserInfo();for(e in a)s[e]=a[e]}return(s=s||this._getBrowserInfo()).source=this.source,this._updateMetadata(s),this.analyticsHostUrl&&t&&(i=!!s&&s.forceSync,s&&delete s.forceSync,o.firebase.logEvent(t,s),this._getIpInfo(function(e){e&&e.country&&(s.ipInfo=e),o._httpPost(o.analyticsHostUrl+"/event",{type:"action",value:t,metadata:s,context:{whitelabelId:o.whitelabelId,appId:o.appId,pluginId:o.pluginId,instanceId:o.instanceId,liveMode:o.liveMode,developerId:o.developerId||void 0},user:o._user},!i,function(e,t){n&&n(e,t)})})),this},trackView:function(t,s,n){var e,i,o=this;if(s){var a,r=this._getBrowserInfo();for(a in r)s[a]=r[a]}return(s=s||this._getBrowserInfo()).source=this.source,this._updateMetadata(s),this.analyticsHostUrl&&t&&((e=this._getCookie("_ga"))&&((i={}).clientId=e.substr(6)),this.firebase.setScreenName(t),this._getIpInfo(function(e){e&&(s.ipInfo=e),o._httpPost(o.analyticsHostUrl+"/event",{type:"view",value:t,metadata:s,context:{whitelabelId:o.whitelabelId,appId:o.appId,pluginId:o.pluginId,instanceId:o.instanceId,liveMode:o.liveMode,developerId:o.developerId||void 0},segmentContext:{"Google Analytics":i},user:o._user},!0,function(e,t){n&&n()})})),this},registerPluginEvent:function(n,i){var s,e,o;"cp"==window.siteConfig.scope||"sdk"==window.siteConfig.scope?n?(n.data||(n.data={}),n.options||(n.options={}),(s=n.data).key?s.title?(s._titleLowerCase=s.title.toLowerCase(),e=this.instanceId+"_pluginEvents",(o=new DatastoreAPI(this.appId,this.pluginId,e,this.liveMode)).searchAndUpdate({tag:"events",obj:{$set:s},search:{key:s.key}},function(e,t){null==e&&t&&0==t.nModified?o.insert({tag:"events",obj:s,checkDuplicate:!1},function(e,t){var s=new CustomEvent("pluginAnalyticsRegisterEvent",{detail:{data:n.data,options:n.options}});document.dispatchEvent(s),i&&i(e,t)}):i&&i(e,t)})):i&&i("Missing event title",null):i&&i("Missing event key",null)):i&&i("invalid params",null):i&&i("This method works only on Control Side",null)},unregisterPluginEvent:function(e,n){var t,i;e&&e.key?(t=this.instanceId+"_pluginEvents",(i=new DatastoreAPI(this.appId,this.pluginId,t,this.liveMode)).search({tag:"events",obj:{filter:{"$json.key":e.key}}},function(e,t){if(!e&&t&&0<t.length)for(var s=0;s<t.length;s++)i.delete({tag:"events",id:t[s].id},function(e,t){n&&n(e,t)});else n&&n(e,t)})):n&&n("Missing event key",null)},getPluginEvents:function(e,s){var t=this.instanceId+"_pluginEvents",t=new DatastoreAPI(this.appId,this.pluginId,t,this.liveMode);(e=e||{}).skip=e.skip||0,e.limit=e.limit||50,t.search({tag:"events",obj:e},function(e,t){s&&s(e,t)})},setUsername:function(e){this._user.userId=e,this._user.anonymousId&&(this._user.updateIdentity=!0)},setUserProperties:function(e){this._user.properties=e,this._user.updateIdentity=!0},_httpPost:function(e,t,s,n){if(!window.__$haultEvents){var i=new XMLHttpRequest;i.open("POST",e,s),i.setRequestHeader("Content-type","application/JSON");var o=this;t.user&&t.user.userId&&t.user.userId.userId&&(t.user=a(t.user),localStorage.setItem("analyticsUser",JSON.stringify(t.user))),i.onreadystatechange=function(){4==i.readyState&&(200<=i.status&&i.status<400?(o._user&&o._user.userId&&o._user.userId.userId&&(o._user=a(o._user)),o._user.updateIdentity&&(delete o._user.updateIdentity,delete o._user.properties,delete o._user.anonymousId),localStorage.setItem("analyticsUser",JSON.stringify(o._user)),n(null,i.responseText)):0==i.status?(n(i.status),window.__$haultEvents=!0):n(i.status))};s=null;try{s=JSON.stringify(t)}catch(e){console.error("error stringifying analytics data",t.context,t.type+":"+t.value,t.metadata,t,e)}if(s)try{i.send(s)}catch(e){e.code&&console.error("error sending analytics",e,t,t.context,t.type+":"+t.value,t.metadata,s,e)}}function a(e){return e&&"object"==_typeof(e.userId)?a(e.userId):e}},session:{_sessionsObject:{},init:function(){this._sessionsObject=JSON.parse(localStorage.getItem(window.appContext.currentApp.appId+"-sessions")),this._sessionsObject?(this._sessionsObject.appSession&&(this._sessionsObject.appSession.terminationReason="appUnload",this._syncApp()),this._sessionsObject.pluginSession&&(this._sessionsObject.pluginSession.terminationReason="appUnload",this._sessionsObject.pluginSession.old=!0,this._syncPlugin())):this._sessionsObject={},this._trackAppSession(),bfUtils.isMobileDevice?(document.addEventListener("deviceAppResumed",this.onDeviceResumed.bind(this),!1),document.addEventListener("deviceAppBackgrounded",this.onDeviceBackground.bind(this),!1)):document.addEventListener("sessionActivity",this._handleUserActivity.bind(this),!1)},_updateLocalStorage:function(){localStorage.setItem(window.appContext.currentApp.appId+"-sessions",JSON.stringify(this._sessionsObject))},_handleUserActivity:function(){!bfUtils.isMobileDevice&&this._sessionsObject&&(this._sessionsObject.appSession&&(300<this._getTimeDifference(new Date,new Date(this._sessionsObject.appSession.lastPulseTime))?(this._sessionsObject.appSession.terminationReason="inactivity",this._updateLocalStorage(),this.startAppSession()):(this._sessionsObject.appSession.lastPulseTime=new Date,this._updateLocalStorage())),this._sessionsObject.pluginSession&&(300<this._getTimeDifference(new Date,new Date(this._sessionsObject.pluginSession.lastPulseTime))?(this._sessionsObject.pluginSession.terminationReason="inactivity",this._sessionsObject.pluginSession.old=!0,this._updateLocalStorage(),this.startPluginSession()):(this._sessionsObject.pluginSession.lastPulseTime=new Date,this._updateLocalStorage())))},_getTimeDifference:function(e,t){return Math.ceil((e.getTime()-t.getTime())/1e3)},_syncApp:function(){var e;this._sessionsObject.appSession&&((e={}).session=JSON.parse(JSON.stringify(this._sessionsObject.appSession)),e.actionName="app/appSession",this._sessionsObject.appSession=null,this._updateLocalStorage(),this._saveSession(e))},_syncPlugin:function(){var e,t;this._sessionsObject.pluginSession&&(e={},(t=JSON.parse(JSON.stringify(this._sessionsObject.pluginSession))).lastPulseTime=t.old?t.lastPulseTime:new Date,t.terminationReason||(t.terminationReason="pluginNavigation"),e.session=t,e.actionName="app/pluginSession",this._sessionsObject.pluginSession=null,this._updateLocalStorage(),this._saveSession(e))},_trackAppSession:function(){this._handleUserActivity(),this.startAppSession()},trackPluginSession:function(e){this.pluginContext=e.context,this._handleUserActivity(),this.startPluginSession()},_saveSession:function(e){var t,s=e.session,n={appId:window.appContext.currentApp.appId,pluginId:s.pluginId,instanceId:s.instanceId,liveMode:window.appContext.liveMode},i=this._getTimeDifference(new Date(s.lastPulseTime),new Date(s.startSessionTime));i<=0||10800<i||(t={pluginTitle:s.pluginTitle,pluginId:s.pluginId,instanceId:s.instanceId,startSessionTime:s.startSessionTime,endSessionTime:s.lastPulseTime,sessionDurationSeconds:i,terminationReason:s.terminationReason,_buildfire:{aggregationValue:i}},setTimeout(function(){new AnalyticsAPI(n).trackAction(e.actionName,t,function(e,t){e&&console.error("Error: could not track the app action")})},3e3))},createSessionObject:function(e){var t={};return t.lastPulseTime=new Date,t.startSessionTime=new Date,e&&"plugin"==e.type&&(t.pluginId=e.context&&e.context.pluginId,t.instanceId=e.context&&e.context.instanceId,t.pluginTitle=e.context&&e.context.title),t},startAppSession:function(){var e=this;this.endAppSession(),this._syncApp();var t=this.createSessionObject();this._sessionsObject.appSession=t,this._updateLocalStorage(),bfUtils.isMobileDevice&&(this.appSessionInterval=setInterval(function(){t.lastPulseTime=new Date,e._updateLocalStorage()},1e4))},startPluginSession:function(){var e=this;this.endPluginSession(),this._syncPlugin();var t=this.createSessionObject({type:"plugin",context:this.pluginContext});this._sessionsObject.pluginSession=t,this._updateLocalStorage(),bfUtils.isMobileDevice&&(this.pluginSessionInterval=setInterval(function(){t.lastPulseTime=new Date,e._updateLocalStorage()},1e4))},endAppSession:function(){this.appSessionInterval&&(clearInterval(this.appSessionInterval),this.appSessionInterval=void 0)},endPluginSession:function(){this.pluginSessionInterval&&(clearInterval(this.pluginSessionInterval),this.pluginSessionInterval=void 0)},suspendAppSession:function(){this.endAppSession()},suspendPluginSession:function(){this.endPluginSession()},onDeviceResumed:function(){this._sessionsObject&&this._sessionsObject.appSession&&(this._sessionsObject.appSession.terminationReason="paused"),this._sessionsObject&&this._sessionsObject.pluginSession&&(this._sessionsObject.pluginSession.terminationReason="paused",this._sessionsObject.pluginSession.old=!0),this.startAppSession(),this.startPluginSession(),console.log("App resumed")},onDeviceBackground:function(){this.suspendAppSession(),this.suspendPluginSession(),console.log("App on hold")}},_trackPerformanceMetrics:function(){if(bfUtils.isIOS||bfUtils.isAndroid){var e=localStorage.getItem("$$performance_log");if(e)try{var t=JSON.parse(e),s=t.loaderStart,n=t.connectionType,i=t.freshInstall,o=t.manifestResponseTime,a=t.manifestUpdateStart,r=t.manifestUpdateFinish,l=t.manifestComponentsDownloaded,c=localStorage.getItem("$$index_page_start"),u=localStorage.getItem("$$launcher_loaded"),p=localStorage.getItem("$$launcher_splash_hidden"),d=c-s,h=u-c,g=u-s,f=p-s,_=r-a,I=l&&0<l.length;I&&(l=l.map(function(e){var t=e.downloadFinishedAt-e.downloadStartedAt,s=e.unzipFinishedAt-e.downloadFinishedAt,n=e.unzipFinishedAt-e.downloadStartedAt;return _objectSpread(_objectSpread({},e),{},{downloadSpeed:t,unzipSpeed:s,total:n})}).sort(function(e,t){return t-e}));var y,S={indexPageSpeed:d,launcherIndexLoadTime:h,launcherTotalLoadTime:g,total:f,connectionType:n,freshInstall:i,manifestResponseTime:o,contentManagerUpdateSpeed:_},v=JSON.parse(localStorage.getItem("$$launch_logs_all")||"[]"),m=JSON.parse(localStorage.getItem("$$launch_logs_slow")||"[]");v&&(3<=v.length&&v.pop(),v.unshift(S),localStorage.setItem("$$launch_logs_all",JSON.stringify(v))),(I?2e4<=f:1e4<=f)&&(m&&(3<=m.length&&m.pop(),m.unshift(S),localStorage.setItem("$$launch_logs_slow",JSON.stringify(m))),y=I?"APP: loading with updates took longer than usual":"APP: loading took longer than usual",atatusAPI.log(y,[],_objectSpread(_objectSpread({},S),{},{manifestComponentsDownloaded:l})));var b=I?"app/load_speed_update":"app/load_speed";console.log(b),this.trackAction(b,_objectSpread(_objectSpread({},S),{},{_buildfire:{aggregationValue:f}}))}catch(e){console.error(e)}finally{localStorage.removeItem("$$performance_log"),localStorage.removeItem("$$index_page_start"),localStorage.removeItem("$$launcher_loaded"),localStorage.removeItem("$$launcher_splash_hidden")}}}},setTimeout(function(){window.appContext&&window.appContext.liveMode&&AnalyticsAPI.prototype.session.init()},3e3),bfUtils.isMobileDevice&&appState.subscribe({state:appState.RUNNING},function(){Array.isArray(window.appLoadTimeouts)&&(window.appLoadTimeouts.forEach(function(e){return clearTimeout(e)}),window.appLoadTimeouts=null)});
