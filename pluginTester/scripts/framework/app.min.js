...
"use strict";var Dynamic={_sendPacketToInstance:function(e,n){var t=e.instanceId,s=e.packet;t?null!==(e=postMaster.widgetPluginAPI)&&void 0!==e&&e.context&&postMaster.widgetPluginAPI.context.instanceId===t?postMaster.widgetPluginAPI.sendMessage(null,s,n):null!==(e=postMaster.launcherPluginAPI)&&void 0!==e&&e.context&&postMaster.launcherPluginAPI.context.instanceId===t?postMaster.launcherPluginAPI.sendMessage(null,s,n):console.error("Cannot find the required plugin"):n("Plugin's instanceId was not provided")},triggerRequestWidgetContext:function(e,n){var t={packet:new Packet(null,"dynamic.onReceivedWidgetContextRequest",null==e?void 0:e.request),instanceId:null==e||null===(t=e.request)||void 0===t?void 0:t.instanceId};Dynamic._sendPacketToInstance(t,n)},expressions:{triggerRequestCustomExpressions:function(e,n){var t={packet:new Packet(null,"dynamic.expressions.onReceivedCustomExpressionsRequest",null==e?void 0:e.request),instanceId:null==e||null===(t=e.request)||void 0===t?void 0:t.instanceId};Dynamic._sendPacketToInstance(t,n)}}};