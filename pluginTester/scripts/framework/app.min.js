...
"use strict";var imageCacheAPI={timer:null,get ENUMS(){return{CACHE_ROOT:"cdvfile://localhost/persistent",CACHE_PATH:"/imageCache/images",CACHE_CTRL_FILE:"cacheControl.json",CACHE_CTRL_PATH:"/imageCache",CACHE_CTRL_DEFAULT_DATA:'{ "cacheSize": 0, "images": {} }',MAX_CACHE_SIZE:1e8}},download:function(e,t){var n=this,i=this.getHash(e),a=(e.match(/(png|jpg|jpeg)/g)||[])[0]||"";i+=a=a?"."+a:"";var r=this.ENUMS.CACHE_PATH,o={path:r,uri:e,fileName:i};fileManagerAPI.download(o,function(e){if(e)throw e;t(null,""+n.ENUMS.CACHE_ROOT+r+"/"+i),n.update()})},update:function(){var e=this;this.timer&&(clearTimeout(this.timer),this.timer=null),this.timer=setTimeout(function(){return e.updateIndex()},500)},updateIndex:function(){var n=this;this.getIndex().then(function(a){fileManagerAPI._getFolder(n.ENUMS.CACHE_PATH,function(e,t){if(e)throw e;t.createReader().readEntries(function(e){var t=e.map(function(e){var i=e.name;return new Promise(function(n){if(a.images[i]||(a.images[i]={lastAccessed:Date.now()}),a.images[i].size)return n(a.images[i].size);e.getMetadata(function(e){var t=e.size;a.images[i].size=t,n(t)})})});Promise.all(t).then(function(e){a.cacheSize=e.length?e.reduce(function(e,t){return e+t}):0,n.saveIndex(a)},console.error)},console.error)})})},saveIndex:function(e){var t=this,n={path:this.ENUMS.CACHE_CTRL_PATH,fileName:this.ENUMS.CACHE_CTRL_FILE,append:!1,content:JSON.stringify(e)};fileManagerAPI.writeFileAsText(n,function(){e.cacheSize>t.ENUMS.MAX_CACHE_SIZE&&t.clearCache()})},getIndex:function(){var a=this;return new Promise(function(n,i){fileManagerAPI._getFile(a.ENUMS.CACHE_CTRL_PATH,a.ENUMS.CACHE_CTRL_FILE,!0,function(e,t){if(e)throw e;t.file(function(e){var t=new FileReader;t.onloadend=function(){var e=t.result||a.ENUMS.CACHE_CTRL_DEFAULT_DATA;n(JSON.parse(e))},t.readAsText(e)},i)})})},clearCache:function(){var t=this;this.getIndex().then(function(e){t.removeImages().then(function(){e.cacheSize=0,e.images={},t.saveIndex(e)})})},removeImages:function(){var e=this;return new Promise(function(n,i){fileManagerAPI._getFolder(e.ENUMS.CACHE_PATH,function(e,t){t.removeRecursively(n,i)})})},getHash:function(e){var t=0;if(!(e=e.replace(/(http|https):\/\/\S{0,8}.cloudimg.io\//g,"")).length)return t;for(var n=0;n<e.length;n++){t=(t<<5)-t+e.charCodeAt(n),t|=0}return t}};
