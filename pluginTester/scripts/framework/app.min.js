...
"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}"undefined"==typeof AiAPI&&(window.AiAPI=function(t){this.context=t,this.transformVariables=function(r,p){new DatastoreAPI(window.appContext.currentApp.appId,"$$appRecipe","$$appRecipe").get("$$appRecipe",function(t,e){var n,o,a,i,s={appName:window.appContext.currentApp.appName};e&&e.data&&(s.industry=(null===(n=e.data)||void 0===n||null===(o=n.contactInfo)||void 0===o?void 0:o.industry)||null,s.appType=(null===(e=e.data)||void 0===e||null===(a=e.contactInfo)||void 0===a?void 0:a.industry)||null),i={"[app-interests]":"[".concat((s=s).appType||s.industry||"Travel planning","]"),"[business-type]":"[".concat(s.industry||"Travel planning","]"),"[app-name]":"[".concat(s.appName,"]"),"[target-region]":"[".concat(s.region||"San Diego","]")},Object.freeze(i),Object.keys(i).forEach(function(t){r=r.replaceAll(t,i[t])}),p(null,r)})}}),AiAPI.prototype.chat=function(t,e){var n=t=!t||"object"!=_typeof(t)?{}:t,o=n.messages,t=n.jsonTemplate,a=n.hideAiAnimation,t={messages:o,jsonTemplate:t,appId:window.appContext.currentApp.appId},t={url:"".concat(window.siteConfig.endPoints.gatewayHost,"/ai/chat"),headers:{"Content-Type":"application/json"},body:JSON.stringify(t),method:"POST"};!a&&AiAPI.startLoadingAnimation&&AiAPI.startLoadingAnimation({lockCP:!1}),fetch(t.url,{method:t.method,headers:t.headers,body:t.body}).then(function(t){return t.ok?t.json().then(function(t){return t}):t.json().then(function(t){var e=t.innerError||{},t={code:e.code,message:e.message,error:e.error};throw e.aiStatus&&(t.aiStatus=e.aiStatus),t})}).then(function(t){!a&&AiAPI.stopLoadingAnimation&&AiAPI.stopLoadingAnimation(),e(null,t)}).catch(function(t){!a&&AiAPI.stopLoadingAnimation&&AiAPI.stopLoadingAnimation(),t&&t.message&&t.code&&"unknownerror"!==t.code.toLowerCase()?e(t,null):e({code:"unknownError",message:"Unable to process your request"},null)})},AiAPI.prototype.showSeederMessagePrompt=function(t,o){var e=t.userMessage,n=t.showClearDataWarning,a=t.hintText;if("string"!=typeof e)return o("Invalid parameter 'userMessage'. It must be a valid string.");var i=new DialogAPI(this.context);this.transformVariables(e,function(t,e){i._show({isMessageHTML:!0,title:"Generate AI Data",message:"".concat(n?'<p class="info-note background-info margin-bottom-twenty"><span class="text-warning">Warning: Existing data will be overwritten</span></p>':"",'<p>You can customize the following AI request. </p><textarea style="text-wrap: nowrap;" class="form-control margin-top-ten" id="aiDataRequest">').concat(e,"</textarea> ").concat(a?'<span style="color: #b0b0b0;display: block;margin-top: 5px;margin-bottom: 10px; font-size: 12px;">'+a+"</span>":""),showCancelButton:!0,actionButtons:[{text:"Generate",type:"success"}]},function(t,e){var n;return t?o(t):void("success"===(null==e||null===(n=e.selectedButton)||void 0===n?void 0:n.type)&&(n=document.querySelector("#aiDataRequest"),o(null,{userMessage:n.value})))})})},AiAPI.prototype.showSeederCSVPrompt=function(t,o){var e=t.sampleCSV,n=t.showResetAndSaveButton,a=t.hintText;if("string"!=typeof e)return o("Invalid parameter 'sampleCSV'. It must be a valid string.");var i=new DialogAPI(this.context),t=[{text:"Save",type:"success"}];n&&t.unshift({type:"warning",text:"Reset And Save"}),i._show({isMessageHTML:!0,title:"AI Import Data",message:'<p>I have the following comma separated records:</p><textarea style="text-wrap: nowrap; height: 175px;" class="form-control margin-top-ten" id="aiDataRequest">'.concat(e,"</textarea>").concat(a?'<span style="color: #b0b0b0;display: block;margin-top: 5px;margin-bottom: 10px; font-size: 12px;">'+a+"</span>":""),showCancelButton:!0,actionButtons:t},function(t,e){var n;return t?o(t):void(["warning","success"].includes(null==e||null===(n=e.selectedButton)||void 0===n?void 0:n.type)&&(n=e.selectedButton.type,e=document.querySelector("#aiDataRequest"),o(null,{sampleCSV:e.value,reset:"warning"===n})))})},AiAPI.prototype.getAppRecipe=function(t,n){var e,o,a;"function"==typeof n&&(e=window.appContext.currentApp.appId,o=window.appContext.liveMode,a=window.appContext.currentApp.keys.datastoreKey,new DatastoreAPI({appId:e,pluginId:"$$appRecipe",instanceId:"$$appRecipe",liveMode:o,writeKey:a}).get("$$appRecipe",function(t,e){t?n(t):n(null,e)}))};
"use strict";function ownKeys(o,e){var r,n=Object.keys(o);return Object.getOwnPropertySymbols&&(r=Object.getOwnPropertySymbols(o),e&&(r=r.filter(function(e){return Object.getOwnPropertyDescriptor(o,e).enumerable})),n.push.apply(n,r)),n}function _objectSpread(o){for(var e=1;e<arguments.length;e++){var r=null!=arguments[e]?arguments[e]:{};e%2?ownKeys(Object(r),!0).forEach(function(e){_defineProperty(o,e,r[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(o,Object.getOwnPropertyDescriptors(r)):ownKeys(Object(r)).forEach(function(e){Object.defineProperty(o,e,Object.getOwnPropertyDescriptor(r,e))})}return o}function _defineProperty(e,o,r){return o in e?Object.defineProperty(e,o,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[o]=r,e}!function(g,r){function n(e){return(e=(e=e||[]).filter(function(e){return e.trim()})).join(",")}function l(e){(e=n(e))&&g._LTracker.push({logglyKey:c.token,sendConsoleErrors:!1,tag:e})}function t(){g._LTracker=g._LTracker||[],g._LTracker.push({logglyKey:c.token,sendConsoleErrors:!1,tag:c.stringTags}),c.levels.forEach(function(e){switch(e){case"info":i="info",s=console.info,console.info=function(){for(var e={level:i,category:p[i].console},o=arguments.length,r=new Array(o),n=0;n<o;n++)r[n]=arguments[n];d.apply(void 0,[e].concat(r)),s.apply(void 0,r)};break;case"log":l=console.log,console.log=function(){for(var e={level:"log",category:p.log.console},o=arguments.length,r=new Array(o),n=0;n<o;n++)r[n]=arguments[n];d.apply(void 0,[e].concat(r)),l.apply(void 0,r)};break;case"warn":c=console.warn,console.warn=function(){for(var e={level:"warn",category:p.warn.console},o=arguments.length,r=new Array(o),n=0;n<o;n++)r[n]=arguments[n];d.apply(void 0,[e].concat(r)),c.apply(void 0,r)};break;case"error":t="error",a=console.error,console.error=function(){for(var e={level:t,category:p[t].console},o=arguments.length,r=new Array(o),n=0;n<o;n++)r[n]=arguments[n];d.apply(void 0,[e].concat(r)),a.apply(void 0,r)},g.addEventListener("error",function(e){var o={level:t,category:p[t].exception,exception:{colno:e.colno,lineno:e.lineno,message:e.message,stack:e.error&&e.error.stack?e.error&&e.error.stack:"n/a",url:e.filename}};d(o,e.message)})}var t,a,c,l,i,s}),s=!0}function i(){c.context||(c.context={});var e=_objectSpread(_objectSpread({},c.context),{},{appId:g.appContext.currentApp.appId||"",appName:g.appContext.currentApp.appName||""}),o=authAPI.getCurrentUser();return o&&(e.userId=o.userId,e.email=o.email,e.userToken=o.userToken),e}var s=!1,c={tags:[],token:"",levels:[],stringTags:"",context:{}},a=["info","log","warn","error"],p={info:{console:"ConsoleInfo"},log:{console:"ConsoleLog"},warn:{console:"ConsoleWarn"},error:{console:"ConsoleError",exception:"BrowserJsException"}},d=function(e){for(var o,r,n=arguments.length,t=new Array(1<n?n-1:0),a=1;a<n;a++)t[a-1]=arguments[a];s?t&&t.length&&(o=e.level,r=e.category,e=e.exception,l(c.tags),r={message:t[0],data:1<t.length?_objectSpread({},t):void 0,context:i(),level:o,category:r,location:{origin:g.location.origin,href:g.location.href}},e&&(r.exception=e),g._LTracker&&g._LTracker.push(r)):console.warn("Logger not initialized: Unable to log messages.")};g.loggerAPI={init:function(e){var o;s?console.error("Logger already initialized. Cannot initialize multiple times."):(e=n((c=(c=e)||{}).tags))?(c.stringTags=e,e=c.levels,o=!0,(e=e||[]).forEach(function(e){a.includes(e)||(console.error('Failed to initialize logger: Invalid log level - "'.concat(e,'". Allowed levels are: ').concat(a,".")),o=!1)}),o&&((c.token||"").trim()?((e=r.createElement("script")).type="text/javascript",e.src="https://cloudfront.loggly.com/js/loggly.tracker-2.2.4.min.js",e.onload=function(){t()},r.head.appendChild(e)):console.error("Failed to initialize logger: Invalid token."))):console.error("Failed to initialize logger: Invalid tags.")},log:function(e){var o,r,n,t,a,c;e=e||{},s?(o=(a=e).message,r=a.data,n=a.context,t=a.level,c=a.category,e=a.exception,(a=a.tags)&&a.length&&a.includes("sdk")&&a.push(g.appContext.environment),l(a),c={message:o,data:r,context:_objectSpread(_objectSpread({},i()),n),level:t||"info",category:c,location:{origin:g.location.origin,href:g.location.href}},e&&(c.exception=e),g._LTracker&&g._LTracker.push(c)):console.warn("Logger not initialized: Unable to log messages.")},setContext:function(e){try{c.context=JSON.parse(JSON.stringify(e))}catch(e){console.error("Failed to set logger context: Invalid context object.",e)}}},"prod"==g.appContext.environment&&g.loggerAPI.init({tags:["app",g.appContext.environment],token:"93cbe5ea-7286-486c-bedd-791d44aa7d95",levels:["error"]})}(window,document);