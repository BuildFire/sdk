...
function UsersLibAPI(e){var s="";window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&(s=window.siteConfig.endPoints.appHost),this.templateUrl=s+"/pages/common/userSearch.html",this.controller="userSearchDialogCtrl",this.context={},angular.copy(e,this.context),this.init()}UsersLibAPI.prototype={init:function(){},showSearchDialog:function(e,i){var s={templateUrl:this.templateUrl,controller:this.controller,size:"lg",data:{appId:this.context.appId,source:"sdk"}};window.openDialog(s,function(e){if(e){if(e){if(e.users&&0<e.users.length)for(var s=0;s<e.users.length;s++)e.users[s]={firstName:e.users[s].firstName||null,lastName:e.users[s].lastName||null,displayName:e.users[s].displayName||null,username:e.users[s].username||null,isActive:e.users[s].isActive,userProfile:e.users[s].userProfile||null,imageUrl:e.users[s].imageUrl||null};delete e.criteria,delete e.criteriaTanslation,delete e.selectAll}i(null,e)}else i(null,null)})}};
$app.controller("userSearchDialogCtrl",["$scope","$dialog",function(e,t){t.options&&t.options.data&&t.options.data.source&&(e.source=t.options.data.source),e.isPopupUserSearch=!0,e.close=function(){t.close(null)},e.returnSearchResult=function(e){t.close(e)}}]),$app.controller("userSearchCtrl",["$scope","$rootScope",function(i,e){i.activeAll=!0,i.activeRange=!1,i.errors={},i.tagsHave=!0,i.tagsAll=!0,i.activeType=function(e){i.activeAll=!1,i.activeRange=!1,void 0!==e&&(i[e]=!0)},i.export=function(){i.exporting=!0;var e=t();delete e.skip,delete e.limit,$http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/userExport/"+window.appContext.currentApp.appId+"/",e).success(function(e){i.exporting=!1;var t=document.createElement("a");t.setAttribute("href","data:text/csv;charset=utf-8,"+encodeURIComponent(e)),t.setAttribute("download","users.csv"),t.click()}).error(function(e){i.exporting=!1,console.error(e),window.toast("Search Error","danger")})},e.$on("searchUsers",function(e,t){i.searchUsers()}),i.selectTagHave=function(e){i.tagsHave=e};var t=function(){var e={filter:{},skip:(i.pageIndex-1)*i.pageSize,limit:i.pageSize},t=[];if(i.searchName){var r=[];i.searchName.split(",").forEach(function(e){var t,s;e=e.trim(),s=!1,(0===(t=e).indexOf("facebook")||0===t.indexOf("twitter")||/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z\-0-9]{2,}))$/.test(t))&&(s=!0),s?r.push({email:e.toLowerCase()}):e&&r.push({displayName:{$regex:e,$options:"-i"}},{email:{$regex:e,$options:"-i"}})}),t.push({$or:r})}if(-1!=i.currentUserStatusFilter&&(e.isActive=1==i.currentUserStatusFilter),i.showAdvancedSearch){i.searchFromDate&&(e.signupDateFrom=i.searchFromDate),i.searchToDate&&(e.signupDateTo=i.searchToDate);var s=[];if(i.searchTags&&i.searchTags.length){for(var a=0;a<i.searchTags.length;a++)s.push(i.searchTags[a].tagName);if(i.tagsHave)if(i.tagsAll)for(a=0;a<s.length;a++)t.push({tags:{$elemMatch:{tagName:s[a]}}});else t.push({tags:{$elemMatch:{tagName:{$in:s}}}});else if(i.tagsAll)for(a=0;a<s.length;a++)t.push({tags:{$not:{$elemMatch:{tagName:s[a]}}}});else{var n=[];for(a=0;a<s.length;a++)n.push({tags:{$not:{$elemMatch:{tagName:s[a]}}}});t.push({$or:n})}}}return i.sortBy&&(e.sort=i.sortBy),i.isReversed&&(e.isReversed=i.isReversed),0<t.length&&(e.filter.$and=t),e};i.getUsers=function(){i.searching=!0;var a=t();$http.post(window.siteConfig.endPoints.appHost+"/api/userTagging/userSearch/"+window.appContext.currentApp.appId+"/",a).success(function(e){i.totalItems=e.usersCount,i.searching=!1;for(var t=0;t<e.users.length;t++){var s=e.users[t];if(i.users.push(s),i.selectedUsers&&i.selectedUsers.length)for(var r=0;r<i.selectedUsers.length;r++)i.selectedUsers[r]._id==s._id&&(s.selected=!0)}delete a.isReversed,delete a.limit,delete a.skip,delete a.sort,0<e.users.length&&(i.busy=!1),i.currentSearchCriteria=a,i.loading=!1}).error(function(e){i.searching=!1,i.busy=!1,console.error(e),window.toast("Search Error","danger")}).finally(function(){})},i.getUserStatus=function(e){var t=e.externalApps[window.appContext.currentApp.appId].isActive;return void 0===t?"Active":t?"Active":"Banned"},i.setStatusFilter=function(e){"-1"==(i.currentUserStatusFilter=e)?i.currentUserStatusFilterText="All":"0"==e?i.currentUserStatusFilterText="Banned":"1"==e&&(i.currentUserStatusFilterText="Active")},i.showHideAdvancedSearch=function(){i.showAdvancedSearch=!i.showAdvancedSearch},i.setPage=function(){i.busy||(i.busy=!0,i.pageIndex+=1,i.getUsers())},i.managUser=function(e){window.location.hash="appUserManagement?email="+encodeURIComponent(e.email)},i.uploadFile=function(){},i.init=function(){i.appConfig=window.appContext.currentApp.config,i.showDuplicateWarning=!1,i.totalItems=100,i.pageIndex=0,i.pageSize=10,i.maxSize=10,i.username=null,i.sortColumn="",i.currentUserStatusFilter="-1",i.currentUserStatusFilterText="All",i.searchText="",i.showAdvancedSearch=!0,i.currentUserStatusFilter="-1",i.currentUserStatusFilterText="All",i.sortBy="displayName",i.isReversed=!0,i.selectedUsers=null,i.busy=!1,i.users=[],i.loading=!0,i.setPage()},i.init();i.returnSearchResult=function(){var e={criteria:JSON.stringify(i.currentSearchCriteria),criteriaTanslation:function(){var e="";if(i.searchName&&(e="name or email in ("+i.searchName,e+=")"),-1!=i.currentUserStatusFilter&&(0<e.length&&(e+=" and "),1==i.currentUserStatusFilter&&(e+="Active"),0==i.currentUserStatusFilter&&(e+="Banned")),i.showAdvancedSearch){i.searchFromDate&&(0<e.length&&(e+=" and "),e+="Signup date <  "+i.searchFromDate.toLocaleString()),i.searchToDate&&(0<e.length&&(e+=" and "),e+="Signup date <  "+i.searchToDate.toLocaleString());var t=[];if(i.searchTags&&i.searchTags.length){0<e.length&&(e+=" and ");for(var s=0;s<i.searchTags.length;s++)t.push(i.searchTags[s].tagName);i.tagsHave?i.tagsAll?e+="has these tags ("+t.toString(",")+")":e+="has some of these tags ("+t.toString(",")+")":i.tagsAll?e+="does not have these tags ("+t.toString(",")+")":e+="does not have some of these tags ("+t.toString()+")"}}return e}()};if(e.users=i.selectedUsers,e.selectAll=!0,e.userIds=null,i.selectedUsers){e.selectAll=!1,e.userIds=[];for(var t=0;t<e.users.length;t++)e.userIds.push(e.users[t]._id)}i.$parent.returnSearchResult(e)},i.loadTags=function(t){return $http.get(window.siteConfig.endPoints.appHost+"/api/userTagging/getTags/"+window.appContext.currentApp.appId+"/",null).then(function(e){return e.data.filter(function(e){return-1!=e.tagName.toLowerCase().indexOf(t.toLowerCase())})})},i.changeUserSelection=function(e){if(i.selectedUsers||(i.selectedUsers=[]),e.selected)i.selectedUsers.push(e);else for(var t=0;i.selectedUsers&&t<i.selectedUsers.length;t++)i.selectedUsers[t]._id==e._id&&(i.selectedUsers.splice(t,1),i.selectedUsers.length||(i.selectedUsers=null))},i.searchUsers=function(){i.loading=!0,i.users=[],i.busy=!1,i.pageIndex=0,i.setPage()}}]);