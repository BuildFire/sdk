...
var PopupLibAPI={confirm:function(t,e){t||(t={}),!1!==t.allowHtml&&(t.allowHtml=!0),t.message?(t.confirmButton||(t.confirmButton={text:"Confirm",type:"primary"}),t.confirmButton.text||(t.confirmButton.text="Confirm"),t.confirmButton.type||(t.confirmButton.type="primary"),t.cancelButton||(t.cancelButton={text:"Cancel",type:"default"}),t.cancelButton.text||(t.cancelButton.text="Cancel"),t.cancelButton.type||(t.cancelButton.type="default"),PopupLibAPI.showDialog({title:t.title||"Are you sure?",message:t.message,buttons:[t.confirmButton,t.cancelButton],size:t.size})):e("invalid parameter, missing message",null)},alert:function(t,e){t||(t={}),!1!==t.allowHtml&&(t.allowHtml=!0),t.message?(t.okButton||(t.okButton={text:"Ok",type:"primary"}),t.okButton.text||(t.okButton.text="Ok"),t.okButton.type||(t.okButton.type="primary"),PopupLibAPI.showDialog({title:t.title||"Alert",message:t.message,buttons:[t.okButton],size:t.size})):e("invalid parameter, messing message",null)},showDialog:function(t,e){if(t||(t={}),!1!==t.allowHtml&&(t.allowHtml=!0),t.title){if(t.buttons&&0<t.buttons.length)for(var o=0;o<t.buttons.length;o++){if(!t.buttons[o].text)return void e("invalid parameter, missing text button");t.buttons[o].type||(t.buttons[o].type="default")}else t.buttons=[];var n="";window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&(n=window.siteConfig.endPoints.appHost);var l={templateUrl:n+"/pages/popupLib/popupLib.html",controller:"popupLibCtrl",size:t.size||"sm",data:t};window.openDialog(l,function(t){e&&e(null,t)})}else e("invalid parameter, messing title",null)}};$app.controller("popupLibCtrl",["$scope","$dialog","$data","$sce",function(t,e,o,n){t.allowHtml=o.allowHtml,t.popupData=o,t.popupData.message=n.trustAsHtml(o.message),t.message=o.message,t.title=o.title,t.buttons=o.buttons,t.size=o.size,t.closeDialog=function(){e.close(null)},t.selectedButton=function(t){e.close({selectedButton:{text:t}})}}]);
