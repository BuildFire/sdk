...
"use strict";$app.controller("pluginInstanceDialog",["$scope","$data","$dialog",function(t,e,n){t.showPluginInstances=!0,t.showAddPlugin=!1,t.hideAddPlugin=!1,t.skipPluginInstances=!1,t.hideAddToSideMenuCheckbox=!1,t.selectedPluginsInstances=[],e&&e.options&&(e.options.skipPluginInstances&&(t.showPluginInstances=!1,t.showAddPlugin=!0,t.skipPluginInstances=!0),e.options.hideAddPlugin&&(t.hideAddPlugin=e.options.hideAddPlugin),e.options.hideAddToSideMenuCheckbox&&(t.hideAddToSideMenuCheckbox=e.options.hideAddToSideMenuCheckbox)),t.cancel=function(){n.close(null)},t.close=function(e){n.close(e)},t.goToPluginInstances=function(){var e=(0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}).selectedPluginInstance,n=void 0===e?null:e;t.showAddPlugin=!1,t.showPluginInstances=!0,n&&t.selectedPluginsInstances.push(n)},t.goToAddPluginDialog=function(){t.showPluginInstances=!1,t.showAddPlugin=!0},t.refreshPluginInstances=function(){t.$broadcast("searchPluginInstances",{})}}]),$app.controller("pluginInstanceSearchCtrl",["$scope","$rootScope","$analytics","commonPluginService",function(p,e,n,t){var a={controller:"pluginInstanceDialog",appId:window.appContext.currentApp.appId,liveMode:window.appContext.currentApp.liveMode,pluginId:"pluginInstances",instanceId:1,writeKey:appContext.currentApp.keys.datastoreKey};p.tools=ImageLibAPI.tools,appContext.currentApp.config&&(p.marketplaceButton=appContext.currentApp.config.marketplaceButton),p.data={},p.tools=ImageLibAPI.tools;new DatastoreAPI(appContext.currentApp.appId,"pluginInstances",1,0,appContext.currentApp.keys.datastoreKey);var l=new PluginInstanceAPI(a);function i(){if(p.$parent&&p.$parent.selectedPluginsInstances&&0<p.$parent.selectedPluginsInstances.length){var t=p.$parent.selectedPluginsInstances.map(function(e){return e.instanceId});p.getPluginInstances({instanceIds:t},p.pageSize,p.pageIndex,function(e,n){n&&0<n.length&&p.pluginInstances.forEach(function(e,n){-1<t.indexOf(e.data.instanceId)&&(e.selected=!0,p.selectInstance(e),p.pluginInstances.splice(n,1),p.pluginInstances.unshift(e))})})}}p.getPluginInstances=function(e,n,t,i){var a=e.searchName,s=e.instanceIds;p.searching=!0;var o={pageSize:n,pageIndex:t-1};a&&(o.title=a),s&&0<s.length&&(o.instanceIds=s),l.search(o,function(e,n){if(e)i&&i(e);else if(p.pluginInstances||(p.pluginInstances=[]),n.result&&0!=n.result.length?p.lastPageIndex=p.pageIndex:p.pageIndex=p.lastPageIndex,n.result){for(var t=n.result.filter(function(n){return!p.pluginInstances.find(function(e){return e.data.instanceId===n.data.instanceId})}),a=0;a<t.length;a++)t[a]&&t[a].data&&t[a].data.instanceId&&null!=p.instances[t[a].data.instanceId]&&(t[a].selected=!0);p.pluginInstances=p.pluginInstances.concat(t),i&&i(e,n.result)}p.searching=!1,p.pluginInstanceReady=!0})},p.save=function(){var e=[];for(var n in p.instances)p.instances.hasOwnProperty(n)&&e.push(p.instances[n]);p.close(e)},p.search=function(e){p.pageIndex=1,p.pluginInstances=null,p.pluginInstanceReady=!1,p.lastPageIndex=1,p.getPluginInstances({searchName:p.pluginTitle},p.pageSize,p.pageIndex,e)},p.clone=function(e){t.clone({allowSingletonRedirection:!1},e,function(e){p.search()})},p.selectInstance=function(e){var n=e.data.instanceId,t=e.data.iconUrl,a=e.data._buildfire.pluginType.result[0].token,i=e.data._buildfire.pluginType.result[0].folderName,s=e.data._buildfire.pluginType.result[0].name,o=e.data.title,l=e.data.iconClassName;if(e.selected){var d={instanceId:n,iconUrl:t,title:o,pluginTypeId:a,pluginTypeName:s,folderName:i,iconClassName:l};p.instances[d.instanceId]=d}else delete p.instances[n]},p.setPage=function(){p.searching||(p.lastPageIndex=p.pageIndex,p.pageIndex++,p.getPluginInstances({searchName:p.pluginTitle},p.pageSize,p.pageIndex))},p.init=function(){p.instances={},p.pageIndex=1,p.pageSize=20,p.maxSize=20,p.pluginTitle=null,p.search(function(){i()})},p.init(),e.$on("plugin-instance-created",function(e,n){p.search(function(){i()})})}]),$app.controller("addPluginInstanceCtrl",["$scope","$rootScope","$http","$analytics","commonPluginService",function(l,n,d,p,c){l.pluginHost=window.siteConfig.endPoints.pluginHost,l.tools=ImageLibAPI.tools;var u=new DatastoreAPI(appContext.currentApp.appId,"pluginInstances",1,0,appContext.currentApp.keys.datastoreKey),a=new DatastoreAPI(appContext.currentApp.appId,"sideMenu",1,0,appContext.currentApp.keys.datastoreKey),e=function(e,n,t){var a=window.siteConfig.endPoints.appHost+"/api/appPluginTypes/search",i=localStorage.getItem("user");i?(i=JSON.parse(i),d.get(a,{headers:{auth:i.auth,userToken:i.userToken},params:{appId:window.appContext.currentApp.appId,pluginTypeName:e,pageSize:n,pageIndex:t}}).success(function(e){l.plugins=e.data,l.totalItems=e.total})):(l.plugins=[],l.totalItems=0)};l.openAddPageDialog=function(o){if(o){var i=function(n){"addPage"==n.operation&&null!=n.title&&d.get("/api/appPluginTypes/validateToAdd",{params:{appId:window.appContext.currentApp.appId,token:o.token}}).success(function(e){e&&e.isActive?t(n):toast("Invalid to add, the plugin is inactive","danger")})},t=function(e){if("addPage"==e.operation&&null!=e.title){var n=e.title,a=e.addToSideMenu,i=(window.appContext.currentApp.appId,o.token,e.title,o.folderName,o.token+"-"+Date.now()),s={tag:"",obj:{pluginTypeId:o.pluginTypeId,token:o.token,title:n,instanceId:i,refId:i,iconUrl:window.siteConfig.endPoints.pluginHost+"/"+o.folderName+"/resources/icon.png",_buildfire:{pluginType:{dataType:"pluginType",data:o.token}}}};u.insert(s,function(e,n){if(e)console.log(e);else{p.eventTrack("cp/pluginInstanceAdded",{pluginTypeId:o.pluginTypeId,pluginTypeName:o.pluginTypeName,marketItemId:o.marketItemId});var t={instanceId:i,iconUrl:window.siteConfig.endPoints.pluginHost+"/"+o.folderName+"/resources/icon.png",title:s.obj.title,pluginTypeId:o.token,pluginTypeName:o.pluginTypeName,folderName:o.folderName,iconClassName:null};a&&(l.hideAddToSideMenuCheckbox||l.addToSideMenu(t)),l.close([t])}})}},s={templateUrl:"addPage.html",controller:"addPageDialogCtrl",size:"sm",data:{options:{hideAddToSideMenuCheckbox:l.hideAddToSideMenuCheckbox}}},e={domain:window.siteConfig.endPoints.datastoreHost,appId:appContext.currentApp.appId,folderName:o.folderName,pluginTypeId:o.pluginTypeId,lastUpdatedOn:o.lastUpdatedOn};c.instanceExists(e,function(e,n){if(e)console.error(e);else if(n.isInUse){var t=n.matches[0].data,a={token:t.token,pluginInstanceId:t.instanceId,pluginTitle:t.title,folderName:t._buildfire.pluginType.result[0].folderName};l.close(),toast("Singleton. Redirecting to instance.","warning"),c.redirectToInstance(a)}else window.openDialog(s,i)})}},l.setPage=function(){e(l.pluginTypeName,l.pageSize,l.pageIndex)},l.addToSideMenu=function(e){l.sideMenu.result.push({id:e.instanceId,data:e}),l.sideMenu.data.push(e.instanceId),t(l.sideMenu)};var t=function(e){if(null!=e){var n={_buildfire:{sideMenu:e}},t=n._buildfire.sideMenu.result;n._buildfire.sideMenu.result&&delete n._buildfire.sideMenu.result,a.save({tag:"",obj:n},function(e,n){e||!n?alert(JSON.stringify(e)):(emulatorSync.triggerSideMenuOnUpdate(n),console.log("data saved"))}),e.result=t}};l.init=function(){l.totalItems=100,l.pageIndex=1,l.pageSize=10,l.maxSize=5,e(l.pluginTypeName,l.pageSize,l.pageIndex),l.sideMenu={dataType:"pluginInstance",data:[]},a.get({withDynamicData:!0},function(e,n){if(n){if(n.data&&n.data._buildfire&&n.data._buildfire.sideMenu){var t=n.data._buildfire.sideMenu;t.content&&t.content.loadAllPlugins||(t.result=(a=t.result,i=t.data,a.sort(function(e,n){var t=i.indexOf(e.data.instanceId),a=i.indexOf(n.data.instanceId);return a<t?1:t<a?-1:0}),a)),l.sideMenu=t}l.id=n.id,l.$$phase||l.$digest()}var a,i})},l.onCreateNewPlugin=function(e){if(e&&e.obj&&e.obj.instanceId)l.$parent&&l.$parent.goToPluginInstances&&(l.$parent.goToPluginInstances({selectedPluginInstance:{title:e.obj.title,instanceId:e.obj.instanceId}}),n.$broadcast("plugin-instance-created",{}));else{window.openDialog({templateUrl:"addPage.html",controller:"addPageDialogCtrl",size:"sm"}),l.$$phase||l.$digest()}},l.onCreateSingletonPlugin=function(){window.PopupLibAPI.alert({title:"Singleton Feature",message:"Singleton feature already exist!"},function(e,n){})},l.init()}]),$app.controller("addPageDialogCtrl",["$scope","$dialog",function(e,n){e.addPage=function(){n.close({operation:"addPage",title:e.title})},e.closeDialog=function(){n.close({operation:"close",title:""})}}]);
