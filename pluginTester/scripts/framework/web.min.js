...
"use strict";function _createForOfIteratorHelper(t,n){var e="undefined"!=typeof Symbol&&t[Symbol.iterator]||t["@@iterator"];if(!e){if(Array.isArray(t)||(e=_unsupportedIterableToArray(t))||n&&t&&"number"==typeof t.length){e&&(t=e);var i=0,n=function(){};return{s:n,n:function(){return i>=t.length?{done:!0}:{done:!1,value:t[i++]}},e:function(t){throw t},f:n}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var r,o=!0,a=!1;return{s:function(){e=e.call(t)},n:function(){var t=e.next();return o=t.done,t},e:function(t){a=!0,r=t},f:function(){try{o||null==e.return||e.return()}finally{if(a)throw r}}}}function _unsupportedIterableToArray(t,n){if(t){if("string"==typeof t)return _arrayLikeToArray(t,n);var e=Object.prototype.toString.call(t).slice(8,-1);return"Map"===(e="Object"===e&&t.constructor?t.constructor.name:e)||"Set"===e?Array.from(t):"Arguments"===e||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)?_arrayLikeToArray(t,n):void 0}}function _arrayLikeToArray(t,n){(null==n||n>t.length)&&(n=t.length);for(var e=0,i=new Array(n);e<n;e++)i[e]=t[e];return i}"undefined"!=typeof AnalyticsAPI&&function(){AnalyticsAPI.prototype.registerPluginEvent=function(e,i){var r,t,o;e?(e.data||(e.data={}),e.options||(e.options={}),(r=e.data).key?r.title?(AnalyticsAPI.prototype._prepareEvent(r),t=this.instanceId+"_pluginEvents",(o=new DatastoreAPI(this.appId,this.pluginId,t,this.liveMode)).searchAndUpdate({tag:"events",obj:{$set:r},search:{key:r.key}},function(t,n){null==t&&n&&0==n.nModified?o.insert({tag:"events",obj:r,checkDuplicate:!1},function(t,n){AnalyticsAPI.prototype._dispatchEvent(e.data,e.options),i&&i(t,n)}):i&&i(t,n)})):i&&i("Missing event title",null):i&&i("Missing event key",null)):i&&i("invalid params",null)},AnalyticsAPI.prototype.bulkRegisterPluginEvents=function(r,o){var a,n,t;r&&r.events&&Array.isArray(r.events)&&r.events.length?(r.options||(r.options={}),(a=r.events).every(function(t){return t.key})?a.every(function(t){return t.title})?(t=this.instanceId+"_pluginEvents",n=new DatastoreAPI(this.appId,this.pluginId,t,this.liveMode),t=a.map(function(t){return t.key}),this.bulkUnregisterPluginEvents({keys:t},function(t,e){var i;t?o&&o(t,null):(i=(a=a.map(function(t){return AnalyticsAPI.prototype._prepareEvent(t),t})).filter(function(n){return!e.some(function(t){return t.data.key===n.key})}),n.bulkInsert({tag:"events",obj:a},function(t,n){t?o&&o(t,null):(i.forEach(function(t){AnalyticsAPI.prototype._dispatchEvent(t,r.options)}),o&&o(null,a))}))})):o&&o("Missing event title",null):o&&o("Missing event key",null)):o&&o("invalid params",null)},AnalyticsAPI.prototype.unregisterPluginEvent=function(t,i){var n,r;t&&t.key?(n=this.instanceId+"_pluginEvents",(r=new DatastoreAPI(this.appId,this.pluginId,n,this.liveMode)).search({tag:"events",obj:{filter:{"$json.key":t.key}}},function(t,n){if(!t&&n&&0<n.length)for(var e=0;e<n.length;e++)r.delete({tag:"events",id:n[e].id},function(t,n){i&&i(t,n)});else i&&i(t,n)})):i&&i("Missing event key",null)},AnalyticsAPI.prototype.bulkUnregisterPluginEvents=function(t,e){var n,a,s,l,u;t&&t.keys&&Array.isArray(t.keys)&&t.keys.length?t.keys.every(function(t){return t})?(n=this.instanceId+"_pluginEvents",a=new DatastoreAPI(this.appId,this.pluginId,n,this.liveMode),s=50,l=t.keys,u=[],function e(i,r,o){a.search({obj:{limit:s,skip:r,sort:{title:1},filter:{"$json.key":{$in:l}}},tag:"events"},function(t,n){t?o&&o(t,null):(u=u.concat(n),n&&n.length>=s?e(i+1,r+s,o):o(null,u))})}(0,0,function(t,n){t?e&&e(t,null):a.bulkDelete({tag:"events",ids:u.map(function(t){return t.id})},function(t,n){t?e&&e(t,null):e(null,u)})})):e&&e("Missing event key",null):e&&e("invalid params",null)},AnalyticsAPI.prototype.showReports=function(t,n){var e="";window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&"sdk"==window.siteConfig.scope&&(e=window.siteConfig.endPoints.appHost);var i=this.pluginId,r=this.instanceId,o=t||{},t=o.eventKey,o=o.aggregates;if(Array.isArray(o)){var a,s=["avg","sum","min","max"],l=_createForOfIteratorHelper(o);try{for(l.s();!(a=l.n()).done;){var u=a.value;if(!s.includes(u.toLowerCase()))return n('"'.concat(u,'" is not a valid aggregation option. Supported options are: ').concat(s.join(", ")))}}catch(t){l.e(t)}finally{l.f()}}window.openDialog({templateUrl:e+"/pages/plugins/pluginControl/analytics/pluginAnalyticsPopup.html",controller:"pluginAnalyticsPopupCtrl",size:"lg",data:{pluginId:i,instanceId:r,series:o,activeEvent:t}},function(t){}),n(null,!0)};var t=AnalyticsAPI.prototype.trackAction.bind(AnalyticsAPI.prototype),n=AnalyticsAPI.prototype.trackView.bind(AnalyticsAPI.prototype);AnalyticsAPI.prototype.trackAction=function(){t.apply(void 0,arguments),"undefined"!=typeof dataLayer&&dataLayer.push&&arguments&&arguments[0]&&window.dataLayer.push({event:"custom_page_view",custom_title:arguments[0]})},AnalyticsAPI.prototype.trackView=function(){n.apply(void 0,arguments),"undefined"!=typeof dataLayer&&dataLayer.push&&arguments&&arguments[0]&&window.dataLayer.push({event:"custom_page_view",custom_title:arguments[0]})},AnalyticsAPI.prototype._prepareEvent=function(t){t._titleLowerCase=t.title.toLowerCase()},AnalyticsAPI.prototype._dispatchEvent=function(t,n){n=new CustomEvent("pluginAnalyticsRegisterEvent",{detail:{data:t,options:n}});document.dispatchEvent(n)}}();
"use strict";function UsersLibAPI(e){this.context={},angular.copy(e,this.context),this.init()}UsersLibAPI.prototype={init:function(){},showSearchDialog:function(e,i){var s="",s={templateUrl:(s=window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&"sdk"==window.siteConfig.scope?window.siteConfig.endPoints.appHost:s)+"/pages/common/userSearch.html",controller:"userSearchDialogCtrl",size:"lg",data:{appId:this.context.appId,source:"sdk",responseType:"users"}};window.openDialog(s,function(e){if(e){if(e,e.users&&0<e.users.length)for(var s=0;s<e.users.length;s++)e.users[s]={userId:e.users[s]._id,firstName:e.users[s].firstName||null,lastName:e.users[s].lastName||null,displayName:e.users[s].displayName||null,username:e.users[s].username||null,isActive:e.users[s].isActive,userProfile:e.users[s].userProfile||null,imageUrl:e.users[s].imageUrl||null};delete e.criteria,delete e.criteriaTranslation,delete e.selectAll,i&&i(null,e)}else i&&i(null,null)})},showTagsSearchDialog:function(e,s){var i="",i={templateUrl:(i=window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&"sdk"==window.siteConfig.scope?window.siteConfig.endPoints.appHost:i)+"/pages/common/tagSearch.html",controller:"tagSearchDialogCtrl",size:"lg",data:{appId:this.context.appId}};window.openDialog(i,function(e){s&&s(null,e)})}};
