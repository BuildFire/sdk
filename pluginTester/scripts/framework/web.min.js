...
function usersLibAPI(e){this.templateUrl="/pages/common/userSearch.html",this.controller="userSearchDialogCtrl",this.context={},angular.copy(e,this.context),this.init()}usersLibAPI.prototype={init:function(){},showDialog:function(e,t){console.log("source sdk");var s={templateUrl:this.templateUrl,controller:this.controller,size:"lg",data:{appId:this.context.appId,source:"sdk"}};window.openDialog(s,function(e){if(e){if(e){if(e.users&&0<e.users.length)for(var s=0;s<e.users.length;s++){var l={firstName:e.users[s].firstName||null,lastName:e.users[s].lastName||null,displayName:e.users[s].displayName||null,username:e.users[s].username||null,isActive:e.users[s].isActive,userProfile:e.users[s].userProfile||null,imageUrl:e.users[s].imageUrl||null};e.users[s]=l}delete e.criteria,delete e.criteriaTanslation,delete e.selectAll}t(null,e)}else t(null,null)})},onChange:function(e){this._onChange=e}};
