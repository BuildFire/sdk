...
"use strict";"undefined"==typeof loggerAPI&&(window.loggerAPI={}),window.loggerAPI.log=function(){var g=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};window.loggingTracker&&(g.tags&&g.tags.length&&g.tags.includes("sdk")&&g.tags.push(window.appContext.environment),window.loggingTracker.log(g))};
