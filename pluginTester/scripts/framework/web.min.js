...
"use strict";$app.factory("upgradePlanService",["$http","authManager",function(e,n){var t={appId:window.appContext.currentApp.appId,pluginId:"publishingInfo",instanceId:"publishingInfo",liveMode:0,writeKey:window.appContext.currentApp.keys.datastoreKey};new DatastoreAPI(t);return{getUpgradeUrl:function(){return"http://".concat(whitelabelContext.cpDomain,"/app/").concat(encodeURIComponent(window.appContext.currentApp.appId),"/payments/upgrade")},upgrade:function(){n.getCurrentUser()?(crm&&(crm.set({clickedOnUpgrade:Date.now()}),crm.set({clickedOnUpgradeCount:1})),window.location.href="/app/".concat(encodeURIComponent(window.appContext.currentApp.appId),"/payments/upgrade")):n.logout()},renewSubscription:function(){n.getCurrentUser()?window.location.href="/app/".concat(encodeURIComponent(window.appContext.currentApp.appId),"/payments/upgrade"):n.logout()}}}]);
