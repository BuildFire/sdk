...
"use strict";var PopupLibAPI={confirm:function(t,e){t||(t={}),!1!==t.allowHtml&&(t.allowHtml=!0),t.message?(t.confirmButton||(t.confirmButton={text:"Confirm",type:"primary",key:"confirm"}),t.confirmButton.text||(t.confirmButton.text="Confirm"),t.confirmButton.key||(t.confirmButton.key="confirm"),t.confirmButton.type||(t.confirmButton.type="primary"),t.cancelButton||(t.cancelButton={text:"Cancel",type:"default",key:"cancel"}),t.cancelButton.text||(t.cancelButton.text="Cancel"),t.cancelButton.key||(t.cancelButton.key="cancel"),t.cancelButton.type||(t.cancelButton.type="default"),PopupLibAPI.showDialog({title:t.title||"Are you sure?",message:t.message,buttons:[t.confirmButton,t.cancelButton],size:t.size},e)):e("invalid parameter, missing message",null)},alert:function(t,e){t||(t={}),!1!==t.allowHtml&&(t.allowHtml=!0),t.message?(t.okButton||(t.okButton={text:"Ok",type:"primary",key:"ok"}),t.okButton.text||(t.okButton.text="Ok"),t.okButton.key||(t.okButton.key="ok"),t.okButton.type||(t.okButton.type="primary"),PopupLibAPI.showDialog({title:t.title||"Alert",message:t.message,buttons:[t.okButton],size:t.size},e)):e("invalid parameter, messing message",null)},showDialog:function(t,e){if(t||(t={}),!1!==t.allowHtml&&(t.allowHtml=!0),t.title){if(t.buttons&&0<t.buttons.length)for(var o=0;o<t.buttons.length;o++){if(!t.buttons[o].text)return void e("invalid parameter, missing text button");if(!t.buttons[o].key)return void e("invalid parameter, missing key button");t.buttons[o].type||(t.buttons[o].type="default")}else t.buttons=[];var n="";window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&(n=window.siteConfig.endPoints.appHost);var i={templateUrl:n+"/pages/popupLib/popupLib.html",controller:"popupLibCtrl",size:t.size||"sm",data:t};window.openDialog(i,function(t){e&&e(null,t)})}else e("invalid parameter, messing title",null)}};$app.controller("popupLibCtrl",["$scope","$dialog","$data","$sce",function(t,o,e,n){t.allowHtml=e.allowHtml,t.popupData=e,t.popupData.message=n.trustAsHtml(e.message),t.message=e.message,t.title=e.title,t.buttons=e.buttons,t.size=e.size,t.subtitle=e.subtitle,t.hideCloseIcon=e.hideCloseIcon,console.log("DATA",e),t.closeDialog=function(){o.close(null)},t.selectedButton=function(t){var e={};t&&(e.selectedButton=angular.copy(t)),o.close(e)}}]);
"use strict";function DialogAPI(t){this.context=t,this.componentUI=null}DialogAPI.prototype={loadXSSLibrary:function(t){if("undefined"==typeof filterXSS){var e=document.createElement("script");window._appRoot?e.src=window._appRoot+"scripts/lib/xss.min.js":e.src="/scripts/lib/xss.min.js",e.type="text/javascript",e.onload=function(){t&&t()},document.getElementsByTagName("head")[0].appendChild(e)}else t&&t()},sanitizeMessage:function(t){return filterXSS(t)},confirm:function(t,e){var n=this;return this.loadXSSLibrary(function(){return n._confirm(t,e)})},_confirm:function(t,n){if(t||(t={}),t.message){t.title||(t.title="Are you sure?"),t.confirmButton||(t.confirmButton={text:"Confirm"}),t.cancelButtonText||(t.cancelButtonText="Cancel"),t.isMessageHTML?t.message=this.sanitizeMessage(t.message):t.isMessageHTML=!1;var e={title:t.title,subtitle:t.subtitle,richContent:""+t.message,isContentHTML:t.isMessageHTML,action:{title:t.confirmButton.text,type:t.confirmButton.type||"primary"},dismissButtonText:t.cancelButtonText,forceAction:!0};richModal.display(e,function(t,e){return t?n(t):e&&"action"===e.buttonType?n(null,!0):n(null,!1)})}else n("invalid parameter, missing message",null)},alert:function(t,e){var n=this;return this.loadXSSLibrary(function(){return n._alert(t,e)})},_alert:function(t,e){if(t||(t={}),t.message){t.title||(t.title="Alert"),t.okButtonText||(t.okButtonText="Ok"),t.isMessageHTML?t.message=this.sanitizeMessage(t.message):t.isMessageHTML=!1;var n={title:t.title,subtitle:t.subtitle,richContent:""+t.message,isContentHTML:t.isMessageHTML,action:{title:t.okButtonText,type:"success"},showDismissButton:!1};richModal.display(n,function(t){return e(t)})}else e("invalid parameter, missing message",null)},show:function(t,e){var n=this;return this.loadXSSLibrary(function(){return n._show(t,e)})},_show:function(t,i){if(t||(t={}),t.title){if(!t.actionButtons)return i("`actionButtons` are required",null);if(t.message||(t.message=""),t.cancelButtonText||(t.cancelButtonText="Cancel"),t.isMessageHTML?t.message=this.sanitizeMessage(t.message):t.isMessageHTML=!1,t.design&&t.design.backgroundColor&&!t.design.textColor)return i("'textColor' is required when 'backgroundColor' is present",null);if(t.design&&t.design.textColor&&!t.design.backgroundColor)return i("'backgroundColor' is required when 'textColor' is present",null);var e={title:t.title,subtitle:t.subtitle,richContent:""+t.message,action:t.actionButtons.map(function(t){var e=t.text,n=t.type;return{title:e,handler:function(){i(null,{selectedButton:{text:e,type:n}})},type:n}}),showDismissButton:t.showCancelButton,dismissButtonText:t.cancelButtonText||"Cancel",forceAction:t.forceAction,design:t.design,isContentHTML:t.isMessageHTML};richModal.display(e,function(t,e){return t?i(t):(e&&"dismiss"===e.buttonType&&(e.buttonType="cancel"),e&&e.value&&(e.value={text:e.value.title,action:e.value.handler}),i(null,e))})}else i("invalid parameter, missing title",null)},hide:function(){richModal.close()},toast:function(t,n){var i=this;if(this.componentUI||(this.componentUI=new ComponentUIAPI(this.context)),t||(t={}),t.message){var e={text:t.message,hideDismiss:t.hideDismissButton,duration:t.duration,type:t.type};t.actionButton&&(e.action={title:t.actionButton.text,action:t.actionButton.action}),this.componentUI.showToastMessage(e,function(t,e){return t?n(t):(e&&e.action&&"function"==typeof e.action&&(e.action(),i.componentUI.closeToastMessage({force:!0})),n(t,e))})}else n("invalid parameter, missing message",null)}};
