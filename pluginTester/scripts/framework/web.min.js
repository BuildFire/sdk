...
"use strict";function _typeof(n){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(n){return typeof n}:function(n){return n&&"function"==typeof Symbol&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n})(n)}"undefined"==typeof AiAPI&&(window.AiAPI=function(n){this.context=n,this._loadingContainer=null}),AiAPI.prototype.showGenerateTextDialog=function(n,t){window.openDialog({templateUrl:"pages/share/aiTextGenerator/aiTextGenerator.html",controller:"aiTextGeneratorCtrl",size:"md",data:n},function(n){t&&t(null,n)})},AiAPI.startLoadingAnimation=function(n){var t=this,i=(n=!n||"object"!=_typeof(n)?{}:n).lockCP;this.lockCP=i,this._loadingContainer||((n=document.createElement("div")).id="aiLoadingAnimationContainer",document.body.appendChild(n),n.innerHTML='<div class="loading-holder d-flex justify-center text-center flex flex-align-center flex-justify-center h-100">\n            <div class="ai-animation">\n                <div class="blob"></div>\n                <div class="blob1"></div>\n                <div class="blob2"></div>\n                <div class="blob3">\n                </div>  \n            </div>\n        </div>',this._loadingContainer=n,document.addEventListener("click",function(n){t.lockCP||t._loadingContainer.contains(n.target)||AiAPI.stopLoadingAnimation()})),this._loadingContainer.style.zIndex=i?1050:0,this._loadingContainer.classList.remove("stop"),document.body.style.position="fixed"},AiAPI.stopLoadingAnimation=function(){this._loadingContainer&&(this._loadingContainer.classList.add("stop"),document.body.style.position="relative")};
