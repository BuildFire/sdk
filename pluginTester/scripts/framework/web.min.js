...
"use strict";function UsersLibAPI(e){this.context={},angular.copy(e,this.context),this.init()}UsersLibAPI.prototype={init:function(){},showSearchDialog:function(e,i){var s="";window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&"sdk"==window.siteConfig.scope&&(s=window.siteConfig.endPoints.appHost);var n={templateUrl:s+"/pages/common/userSearch.html",controller:"userSearchDialogCtrl",size:"lg",data:{appId:this.context.appId,source:"sdk"}};window.openDialog(n,function(e){if(e){if(e){if(e.users&&0<e.users.length)for(var s=0;s<e.users.length;s++)e.users[s]={userId:e.users[s]._id,firstName:e.users[s].firstName||null,lastName:e.users[s].lastName||null,displayName:e.users[s].displayName||null,username:e.users[s].username||null,isActive:e.users[s].isActive,userProfile:e.users[s].userProfile||null,imageUrl:e.users[s].imageUrl||null};delete e.criteria,delete e.criteriaTranslation,delete e.selectAll}i&&i(null,e)}else i&&i(null,null)})},showTagsSearchDialog:function(e,s){var i="";window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&"sdk"==window.siteConfig.scope&&(i=window.siteConfig.endPoints.appHost);var n={templateUrl:i+"/pages/common/tagSearch.html",controller:"tagSearchDialogCtrl",size:"lg",data:{appId:this.context.appId,source:"sdk"}};window.openDialog(n,function(e){s&&s(null,e)})}};
"use strict";$app.controller("userSearchDialogCtrl",["$scope","$dialog",function(e,t){t.options&&t.options.data&&t.options.data.source&&(e.source=t.options.data.source),e.isPopupUserSearch=!0,e.close=function(){t.close(null)},e.returnSearchResult=function(e){t.close(e)}}]),$app.controller("userSearchCtrl",["$scope","$rootScope","userService",function(o,e,s){o.activeAll=!0,o.activeRange=!1,o.errors={},o.tagsHave=!0,o.tagsAll=!0,o.activeType=function(e){o.activeAll=!1,o.activeRange=!1,void 0!==e&&(o[e]=!0)},o.export=function(){o.exporting=!0;var e=r();delete e.skip,delete e.limit;var t="";window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&"sdk"==window.siteConfig.scope&&(t=window.siteConfig.endPoints.appHost),$http.post(t+"/api/userTagging/userExport/"+window.appContext.currentApp.appId+"/",e).success(function(e){o.exporting=!1;var t=document.createElement("a");t.setAttribute("href","data:text/csv;charset=utf-8,"+encodeURIComponent(e)),t.setAttribute("download","users.csv"),t.click()}).error(function(e){o.exporting=!1,console.error(e),window.toast("Search Error","danger")})},e.$on("searchUsers",function(e,t){o.searchUsers()}),o.selectTagHave=function(e){o.tagsHave=e};var r=function(){var e={filter:{},skip:(o.pageIndex-1)*o.pageSize,limit:o.pageSize},t=[];if(o.searchName){var r=[];o.searchName.split(",").forEach(function(e){var t,s;e=e.trim(),s=!1,(0===(t=e).indexOf("facebook")||0===t.indexOf("twitter")||/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z\-0-9]{2,}))$/.test(t))&&(s=!0),s?r.push({email:e.toLowerCase()}):e&&r.push({displayName:{$regex:e,$options:"-i"}},{email:{$regex:e,$options:"-i"}})}),t.push({$or:r})}if(-1!=o.currentUserStatusFilter&&(e.isActive=1==o.currentUserStatusFilter),o.showAdvancedSearch){o.searchFromDate&&(e.signupDateFrom=o.searchFromDate),o.searchToDate&&(e.signupDateTo=o.searchToDate);var s=[];if(o.searchTags&&o.searchTags.length){for(var a=0;a<o.searchTags.length;a++)s.push(o.searchTags[a].tagName);if(o.tagsHave)if(o.tagsAll)for(a=0;a<s.length;a++)t.push({tags:{$elemMatch:{tagName:s[a]}}});else t.push({tags:{$elemMatch:{tagName:{$in:s}}}});else if(o.tagsAll)for(a=0;a<s.length;a++)t.push({tags:{$not:{$elemMatch:{tagName:s[a]}}}});else{var n=[];for(a=0;a<s.length;a++)n.push({tags:{$not:{$elemMatch:{tagName:s[a]}}}});t.push({$or:n})}}}return o.sortBy&&(e.sort=o.sortBy),o.isReversed&&(e.isReversed=o.isReversed),0<t.length&&(e.filter.$and=t),e};o.getUsers=function(){o.searching=!0;var a=r(),e="";window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&"sdk"==window.siteConfig.scope&&(e=window.siteConfig.endPoints.appHost),$http.post(e+"/api/userTagging/userSearch/"+window.appContext.currentApp.appId+"/",a).success(function(e){o.totalItems=e.usersCount,o.searching=!1;for(var t=0;t<e.users.length;t++){var s=e.users[t];if(o.users.push(s),o.selectedUsers&&o.selectedUsers.length)for(var r=0;r<o.selectedUsers.length;r++)o.selectedUsers[r]._id==s._id&&(s.selected=!0)}delete a.isReversed,delete a.limit,delete a.skip,delete a.sort,0<e.users.length&&(o.busy=!1),o.currentSearchCriteria=a,o.hasSearchCriteria=!(!o.currentSearchCriteria||!(1<Object.keys(o.currentSearchCriteria).length)&&n(o.currentSearchCriteria.filter)),o.loading=!1,o.sortLoading=!1}).error(function(e){o.searching=!1,o.busy=!1,console.error(e),window.toast("Search Error","danger")}).finally(function(){})},o.changeSorting=function(e){o.sortBy===e?o.isReversed=!o.isReversed:(o.sortBy=e,o.isReversed=!1),o.sortLoading=!0,o.users=[],o.busy=!1,o.pageIndex=0,o.setPage()},o.getUserStatus=function(e){var t=e.externalApps[window.appContext.currentApp.appId].isActive;return t||void 0===t?"Active":"Banned"},o.setUserStatus=function(e,t){var s=e.externalApps[window.appContext.currentApp.appId].isActive;void 0===s&&t||s===t||(e.externalApps[window.appContext.currentApp.appId].isActive=t,o.updateUserStatus(e))},o.updateUserStatus=function(e){var t={isActive:e.externalApps[window.userContext.currentApp.appId].isActive};$http.post("/api/userTagging/updateUserStatus/"+window.userContext.currentApp.appId+"/"+e._id,t).success(function(e){window.toast("Saved","success")}).error(function(e){window.toast("save error","danger")})},o.setStatusFilter=function(e){"-1"==(o.currentUserStatusFilter=e)?o.currentUserStatusFilterText="All":"0"==e?o.currentUserStatusFilterText="Banned":"1"==e&&(o.currentUserStatusFilterText="Active")},o.showHideAdvancedSearch=function(){o.showAdvancedSearch=!o.showAdvancedSearch},o.setPage=function(){o.busy||(o.busy=!0,o.pageIndex+=1,o.getUsers())},o.managUser=function(e){window.location.hash="appUserManagement?email="+encodeURIComponent(e.email)},o.resetPassword=function(e){var t={templateUrl:"userManagementResetPassword.html",controller:"userManagementResetPasswordCtrl",size:"md",data:{user:e}};window.openDialog(t,function(){})};o.uploadFile=function(){},o.init=function(){o.appConfig=window.appContext.currentApp.config,o.showDuplicateWarning=!1,o.totalItems=100,o.pageIndex=0,o.pageSize=10,o.maxSize=10,o.username=null,o.sortColumn="",o.currentUserStatusFilter="-1",o.currentUserStatusFilterText="All",o.searchText="",o.showAdvancedSearch=!0,o.currentUserStatusFilter="-1",o.currentUserStatusFilterText="All",o.sortBy="createdOn",o.isReversed=!1,o.selectedUsers=null,o.hasSearchCriteria=!1,o.busy=!1,o.users=[],o.loading=!0,o.sortLoading=!1,o.scopeLoading=!1,o.isNonFederatedApp=!1,o.setPage(),function(){o.scopeLoading=!0;var e="";window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&"sdk"==window.siteConfig.scope&&(e=window.siteConfig.endPoints.appHost),$http.get(e+"/api/app/"+appContext.currentApp.appId+"/users/scope").success(function(e){o.scopeLoading=!1,o.isNonFederatedApp=!(!e||!e.scope)}).error(function(e){o.scopeLoading=!1,console.error(e)})}()},o.init();o.returnSearchResult=function(){var e={};if(o.currentSearchCriteria&&n(o.currentSearchCriteria.filter)&&delete o.currentSearchCriteria.filter,n(o.currentSearchCriteria)||(e.criteria=JSON.stringify(o.currentSearchCriteria),e.criteriaTranslation=function(){var e="";if(o.searchName&&(e="name or email in ("+o.searchName,e+=")"),-1!=o.currentUserStatusFilter&&(0<e.length&&(e+=" and "),1==o.currentUserStatusFilter&&(e+="Active"),0==o.currentUserStatusFilter&&(e+="Banned")),o.showAdvancedSearch){o.searchFromDate&&(0<e.length&&(e+=" and "),e+="Signup date <  "+o.searchFromDate.toLocaleString()),o.searchToDate&&(0<e.length&&(e+=" and "),e+="Signup date <  "+o.searchToDate.toLocaleString());var t=[];if(o.searchTags&&o.searchTags.length){0<e.length&&(e+=" and ");for(var s=0;s<o.searchTags.length;s++)t.push(o.searchTags[s].tagName);o.tagsHave?o.tagsAll?e+="has these tags ("+t.toString(",")+")":e+="has some of these tags ("+t.toString(",")+")":o.tagsAll?e+="does not have these tags ("+t.toString(",")+")":e+="does not have some of these tags ("+t.toString()+")"}}return e}()),e.users=o.selectedUsers,e.selectAll=!0,e.userIds=null,o.selectedUsers){e.selectAll=!1,e.userIds=[];for(var t=0;t<e.users.length;t++)e.userIds.push(e.users[t]._id)}o.$parent.returnSearchResult(e)};var n=function(e){return!e||!Object.keys(e).length};o.loadTags=function(e){var t={filter:{tagName:e},skip:0,limit:20};return s.searchTags(t).then(function(e){return e.tags})},o.changeUserSelection=function(e){if(o.selectedUsers||(o.selectedUsers=[]),e.selected)o.selectedUsers.push(e);else for(var t=0;o.selectedUsers&&t<o.selectedUsers.length;t++)o.selectedUsers[t]._id==e._id&&(o.selectedUsers.splice(t,1),o.selectedUsers.length||(o.selectedUsers=null))},o.searchUsers=function(){o.loading=!0,o.users=[],o.busy=!1,o.pageIndex=0,o.setPage()}}]),$app.controller("userManagementResetPasswordCtrl",["$scope","$dialog","$http","$data",function(t,e,s,r){t.passwordPattern=validator.passwordPattern,t.user=r.user,t.errorMessage="",t.newPassword="",t.confirmPassword="",t.loading=!1,t.closeDialog=function(){e.close()},t.resetPassword=function(){t.errorMessage="",t.newPassword&&t.confirmPassword&&validator.validatePassword(t.newPassword)&&t.newPassword===t.confirmPassword&&(t.loading=!0,s.post("api/app/"+appContext.currentApp.appId+"/user/"+t.user._id+"/resetPassword",{password:t.newPassword,email:t.user.email}).success(function(e){window.toast("Reset password successfully"),t.loading=!1,t.closeDialog()}).error(function(e){t.errorMessage=e.message,t.loading=!1}))}}]);
"use strict";$app.controller("tagSearchDialogCtrl",["$scope","$dialog",function(e,t){t.options&&t.options.data&&t.options.data.source&&(e.source=t.options.data.source),e.close=function(){t.close(null)},e.returnSearchResult=function(e){t.close(e)}}]),$app.controller("tagSearchCtrl",["$scope","$http","$rootScope",function(u,s,e){u.getTags=function(e){u.searching=!0;var t="";window.siteConfig&&window.siteConfig.endPoints&&window.siteConfig.endPoints.appHost&&"sdk"==window.siteConfig.scope&&(t=window.siteConfig.endPoints.appHost),s.get(t+"/api/userTagging/searchTags/"+window.appContext.currentApp.appId+"/",{params:e}).success(function(e){e||(e={tags:[],tagsCount:0}),u.totalItems=e.tagsCount,e.tags=0<e.tagsCount?e.tags:[];var t=!0,s=!1,a=void 0;try{for(var r,n=e.tags[Symbol.iterator]();!(t=(r=n.next()).done);t=!0){var o=r.value;if(u.tags.push(o),u.selectedTags&&u.selectedTags.length){var i=!0,g=!1,c=void 0;try{for(var l,d=u.selectedTags[Symbol.iterator]();!(i=(l=d.next()).done);i=!0){l.value._id==o._id&&(o.selected=!0)}}catch(e){g=!0,c=e}finally{try{!i&&d.return&&d.return()}finally{if(g)throw c}}}}}catch(e){s=!0,a=e}finally{try{!t&&n.return&&n.return()}finally{if(s)throw a}}0<e.tags.length&&(u.busy=!1),u.searching=!1,u.sortLoading=!1,u.loading=!1}).finally(function(){u.loading=!1})},u.search=function(e){u.pageIndex=void 0===e?1:e;var t={filter:{},skip:(u.pageIndex-1)*u.pageSize,limit:u.pageSize,sortBy:u.sortBy,sort:u.reverse?1:-1};u.searchText&&(t.filter.tagName=u.searchText.trim()),u.getTags(t)},u.getDataPage=function(e){var t=[];if(u.searchText)for(var s in e)-1<e[s].tagName.toLowerCase().indexOf(u.searchText.toLowerCase())&&t.push(e[s]);else t=e;return t},u.setSort=function(e,t){u.sortCriteria=e,u.reverse=t,u.sort()},u.sort=function(){switch(u.sortCriteria){case"Newest First":u.sortBy="createdOn",u.reverse=!1;break;case"Oldest First":u.sortBy="createdOn",u.reverse=!0;break;case"Tag Name A-Z":u.sortBy="tagName",u.reverse=!0;break;case"Tag Name Z-A":u.sortBy="tagName",u.reverse=!1}u.sortLoading=!0,u.tags=[],u.busy=!1,u.pageIndex=0,u.setPage()},u.changeTagSelection=function(e){if(u.selectedTags||(u.selectedTags=[]),e.selected)u.selectedTags.push({id:e._id,tagName:e.tagName});else for(var t=0;u.selectedTags&&t<u.selectedTags.length;t++)u.selectedTags[t]&&u.selectedTags[t].id==e._id&&(u.selectedTags.splice(t,1),u.selectedTags.length||(u.selectedTags=null))},u.returnSearchResult=function(){u.$parent.returnSearchResult(u.selectedTags)},u.searchTags=function(){u.loading=!0,u.tags=[],u.busy=!1,u.pageIndex=0,u.setPage()},u.setPage=function(){u.busy||(u.busy=!0,u.pageIndex+=1,u.search(u.pageIndex))},u.init=function(){u.tags=[],u.currentPageTags=[],u.loading=!0,u.pageIndex=0,u.pageSize=20,u.sortColumn="",u.currentUserStatusFilter="-1",u.currentUserStatusFilterText="All",u.searchText="",u.sortCriteria="Newest First",u.sortBy="createdOn",u.reverse=!1,u.busy=!1,u.setPage()},u.init()}]);
"use strict";$app.factory("addPluginService",["$rootScope","$http","$q","$analytics","pluginManager","promoService","marketplaceServices","$searchEngineService",function(p,l,n,c,i,t,g,f){var m={};m.miniSearchLoaded=!1,m.currencyToInt=function(e,n){return parseInt((100*e).toFixed())},m.sortResults=function(e,a){return e.sort(function(e,n){var t=a.indexOf(e.data.instanceId),i=a.indexOf(n.data.instanceId);return i<t?1:t<i?-1:0}),e},m.getMarketplaceSettings=function(e){e(null,{showDevInfo:whitelabelContext.showDevInfo})},m.isPluginFree=function(e){return g.isPluginFree(e)},m.markPurchased=function(e){return g.markPurchased(e)},m.addLicense=function(e,n){var t={clientReferenceId:e.clientReferenceId,pluginId:e.pluginId,appId:e.appId,userId:e.userId,email:e.email};l.post("/api/stripe/charge",t).then(function(){i.removeRevokedPlugin(e.pluginId),n(null)},function(e){n(e)})},m.isPluginLicenseActive=function(e,n){l.get("/api/appPluginTypes/validateToAdd",{params:{appId:e.appId,token:e.pluginToken}}).success(function(e){e&&e.isActive?n(null,!0):n(null,!1)})},m.trackPluginAdded=function(e){c.eventTrack("cp/pluginInstanceAdded",{pluginTypeId:e.pluginTypeId,pluginTypeName:e.pluginTypeName,marketItemId:e.marketItemId})};var e=new DatastoreAPI(appContext.currentApp.appId,"sideMenu",1,0,appContext.currentApp.keys.datastoreKey);return m.addToSideMenu=function(i,a){var r,l,s=new DatastoreAPI(appContext.currentApp.appId,"sideMenu",1,0,appContext.currentApp.keys.datastoreKey);r=function(e,t){if(e)a&&a(e);else if(t&&t.result){t.result.push({id:i.instanceId,data:i}),t.data||(t.data=[]),t.data.push(i.instanceId);var n={_buildfire:{sideMenu:t}};n._buildfire.sideMenu.result&&delete n._buildfire.sideMenu.result,s.save({tag:"",obj:n},function(e,n){e||!n?(console.error(e),a&&a(e)):(a&&a(null,t),window.dispatchEvent(new CustomEvent("SideMenuUpdated",{detail:n})),emulatorSync.triggerSideMenuOnUpdate(n))})}},l={dataType:"pluginInstance",data:[],content:{securedFeaturesOption:"enable"},result:[]},e.get({withDynamicData:!0},function(e,n){if(n&&n.data){var t=n.data._buildfire&&n.data._buildfire.sideMenu;t&&t.content?t.content.loadAllPlugins||(t.result=(i=t.result,a=t.data,i.sort(function(e,n){var t=a.indexOf(e.data.instanceId),i=a.indexOf(n.data.instanceId);return i<t?1:t<i?-1:0}),i)):t=l,l=t}var i,a;r(null,l)})},m.addPluginToDataStore=function(u,o,d){u||(u={}),u.pluginHost=window.siteConfig.endPoints.pluginHost.replace("http:","https:");var e=u.pluginHost+"/"+o.folderName+"/plugin.json?v="+(o.lastUpdatedOn?o.lastUpdatedOn:"");n.all([l.get(e),l.get("/api/appPluginTypes/validateToAdd",{params:{appId:u.appId,token:o.token}})]).then(function(e){var n,t,i,a,r,l,s=!1;e&&e[0].data&&(n=e[0].data)&&n.requireLogin&&(s=!0),e&&e[1].data&&(t=e[1].data),t&&t.isActive?(i=s,a=new DatastoreAPI(u.appId,"pluginInstances",1,0,appContext.currentApp.keys.datastoreKey),r=o.token+"-"+Date.now(),l={tag:"",obj:{pluginTypeId:o.pluginTypeId,token:o.token,title:u.title,instanceId:r,refId:r,iconUrl:u.pluginHost+"/"+o.folderName+"/resources/icon.png",_buildfire:{pluginType:{dataType:"pluginType",data:o.token}}}},i&&(l.obj.requiresLogin=!0,l.obj._forceRequireLoginInEmulator=!0),a.insert(l,function(e){if(e)d(e),console.log(e);else{c.eventTrack("cp/pluginInstanceAdded",{pluginTypeId:o.pluginTypeId,pluginTypeName:o.pluginTypeName,marketItemId:o.marketItemId}),window.pluginInstancesManager.events.added(o),g._trackAction("cp/marketplace/pluginInstall",null,o.token,{plugin:{pluginTypeId:o.pluginTypeId,pluginTypeName:o.pluginTypeName,marketItemId:o.marketItemId}}),p.$broadcast("pluginInserted",o.token);var n={instanceId:r,iconUrl:u.pluginHost+"/"+o.folderName+"/resources/icon.png",title:l.obj.title,pluginTypeId:o.token,pluginTypeName:o.pluginTypeName,folderName:o.folderName,iconClassName:null};f.savePluginTitle({instanceId:r,pluginId:o.token,title:l.obj.title},function(e,n){e&&console.error("addPluginCtrl","add plugin title to searchEngineAPI",e)}),u.addToSideMenu?m.addToSideMenu(n,function(){d(null,{pluginInstance:l,folderName:o.folderName})}):d(null,{pluginInstance:l,folderName:o.folderName})}})):d("plugin_inactive")})},m.getMarketPlacePlugins=function(e,n,t){return l.get("/api/marketplace/search",{params:{appId:n,search:e,whitelabelId:t}})},m.formatPluginLicenses=function(e){if(e)for(var n=0;n<e.length;n++)e[n]&&e[n].license&&(e[n].license=e[n].license.replace(/.(?=.{4})/g,"x"))},m.logToCrm=function(e,n,t){var i=e.length?e.length:"0";crm&&1==t&&n&&(crm.set({lastPluginSearchOn:Date.now(),lastPluginSearchFor:n,lastPluginSearchFound:i}),0==i&&(crm.set({lastPluginSearchMissOn:Date.now(),lastPluginSearchMissFor:n}),crm.inc({pluginSearchMissCount:1})),crm.log("Searched for plugin: "+n+": "+i+" plugins found"))},m.checkAndSaveMissedKeywords=function(e,n){var t={totalScore:0,highestScore:0,searchResult:[],averageScore:0,threshold:10,totalResult:n&&n.length?n.length:0,exactMatch:!1,missedKeyword:!1,query:e};if(n&&0<n.length){for(var i=0;i<n.length;i++){for(var a=0;a<n[i].terms.length;a++)n[i].terms[a]==e.toLowerCase()&&(t.exactMatch=!0);if(0==i&&(t.highestScore=n[i].score),t.totalScore+=n[i].score,t.searchResult.push({name:n[i].pluginTypeName,pluginTypeId:n[i].pluginTypeId,terms:n[i].terms,isBuildFirePlugin:!!n[i].author&&"buildfire"===n[i].author.toLowerCase()}),3<=t.searchResult.length)break}t.averageScore=t.totalScore/n.length,t.highestScore-t.averageScore>t.threshold&&(t.missedKeyword=!0)}else t.missedKeyword=!0;g&&g._trackAction&&g._trackAction("cp/marketplace/search",null,null,{result:t})},m.searchAppPluginTypes=function(t,i){var l=t.pluginTypeName,e=t.appId,n=t.whitelabelId;function a(r){m.getMarketPlacePlugins("",e,n).then(function(e){var n=e.data[0];m.formatPluginLicenses(n),m.logToCrm(n,l,1);var t,i,a={plugins:n};t=a.plugins,i=new Set(["and","or","to","in","a","the","you","is","are"]),m.miniSearch=new MiniSearch({fields:["pluginTypeName","keywords","description"],storeFields:["pluginTypeId","description","author","awsAPIPublicKey","createdOn","folderName","lastUpdatedOn","license","marketplacepluginTypeId","pluginTypeId","pluginTypeName","price","publishableKey","stripePlan","supportEmail","supportLink","useCount","keywords","token"],boost:{pluginTypeName:3,keywords:2},idField:"pluginTypeId",prefix:!0,processTerm:function(e,n){return i.has(e)?null:e.toLowerCase()},searchOptions:{fuzzy:.3}}),m.miniSearch.addAll(t),m.miniSearchLoaded=!0,r(null,a)})}function r(){var e={prefix:!0};t.fields&&(e.fields=t.fields),void 0!==t.fuzzy&&(e.fuzzy=t.fuzzy),void 0!==t.prefix&&(e.prefix=t.prefix),void 0!==t.filter&&(e.filter=t.filter);var n=m.miniSearch.search(l,e);m.checkAndSaveMissedKeywords(l,n),i(null,{plugins:n})}l&&m.miniSearchLoaded?t.reload?a(function(){r()}):r():a(l?function(){r()}:i)},m.instanceExists=function(i,a){var e=window.siteConfig.endPoints.pluginHost+"/"+i.folderName+"/plugin.json?v="+(i.lastUpdatedOn?i.lastUpdatedOn:""),r={isInUse:!1};l.get(e).success(function(e){e.singleton?t.getPluginInstances(i,function(e,n){if(e)a(e);else{var t=n.filter(function(e){return e.data.pluginTypeId==i.pluginTypeId});0<t.length&&(r.isInUse=!0,r.matches=t),a(null,r)}}):a(null,r)}).error(function(e){a(e)})},m.getPlanType=function(e){var n=null;if(e.stripePlan)try{n=JSON.parse(e.stripePlan)}catch(e){}switch(n.type){case"subscriptions":return"subscriptions";case"onetime":case e.price&&0<e.price:return"onetime";default:return"free"}},m}]);
...
"use strict";$app.factory("upgradePlanService",["$http","authManager",function(e,n){var t={appId:window.appContext.currentApp.appId,pluginId:"publishingInfo",instanceId:"publishingInfo",liveMode:0,writeKey:window.appContext.currentApp.keys.datastoreKey},a=(new DatastoreAPI(t),function(e,n,t){var a=new RegExp("([?|&])"+n+"=.*?(&|#|$)","i");if(e.match(a))return e.replace(a,"$1"+n+"="+t+"$2");var r="";-1!==e.indexOf("#")&&(r=e.replace(/.*#/,"#"),e=e.replace(/#.*/,""));var o=-1!==e.indexOf("?")?"&":"?";return e+o+n+"="+t+r});return{upgrade:function(){var t=n.getCurrentUser();t?(e({method:"GET",url:"/api/whitelabel/"+window.whitelabelContext.whitelabelId+"/plans/public"}).then(function(e){if(e.data.builtInPricePage){if(!window.whitelabelContext.selfProvDomain)return void window.toast("upgrade domain not setup","danger");window.location.href="//"+window.whitelabelContext.selfProvDomain+"/upgrade.html#/app/"+window.appContext.currentApp.appId+"/"+t.username}else{if(!e.data.pricePageUrl)return void window.toast("no pricing page configured","danger");var n=a(e.data.pricePageUrl,"appId",encodeURIComponent(window.appContext.currentApp.appId));n=a(n,"username",encodeURIComponent(t.username)),window.location.href=n}},function(e){window.toast("no upgrade plans configured","danger")}).finally(function(){}),crm&&(crm.set({clickedOnUpgrade:Date.now()}),crm.set({clickedOnUpgradeCount:1}))):n.logout()}}}]);
