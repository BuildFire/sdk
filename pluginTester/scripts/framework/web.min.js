...
"use strict";function DialogAPI(t){this.context=t,this.componentUI=null}DialogAPI.prototype={loadXSSLibrary:function(t){if("undefined"==typeof filterXSS){var e=document.createElement("script");"sdk"==window.siteConfig.scope?e.src="/scripts/xss.min.js":window._appRoot?e.src=window._appRoot+"scripts/lib/xss.min.js":e.src="/app/scripts/lib/xss.min.js",e.type="text/javascript",e.onload=function(){t&&t()},document.getElementsByTagName("head")[0].appendChild(e)}else t&&t()},sanitizeMessage:function(t){return filterXSS(t)},confirm:function(t,e){var n=this;return this.loadXSSLibrary(function(){return n._confirm(t,e)})},_confirm:function(n,s){if(n||(n={}),n.message){n.title||(n.title="Are you sure?"),n.confirmButton||(n.confirmButton={text:"Confirm"}),n.cancelButtonText||(n.cancelButtonText="Cancel"),n.isMessageHTML?n.message=this.sanitizeMessage(n.message):n.isMessageHTML=!1;var t={title:n.title,subtitle:n.subtitle,richContent:""+n.message,isContentHTML:n.isMessageHTML,action:{title:n.confirmButton.text,type:n.confirmButton.type||"primary"},dismissButtonText:n.cancelButtonText,forceAction:!0};richModal.display(t,function(t,e){if(s)return t?s(t):e&&e.selectedButton?e.selectedButton.text==n.confirmButton.text?s(null,!0):s(null,!1):e&&"action"===e.buttonType?s(null,!0):s(null,!1)})}else s("invalid parameter, missing message",null)},alert:function(t,e){var n=this;return this.loadXSSLibrary(function(){return n._alert(t,e)})},_alert:function(t,e){if(t||(t={}),t.message){t.title||(t.title="Alert"),t.okButtonText||(t.okButtonText="Ok"),t.isMessageHTML?t.message=this.sanitizeMessage(t.message):t.isMessageHTML=!1;var n={title:t.title,subtitle:t.subtitle,richContent:""+t.message,isContentHTML:t.isMessageHTML,action:{title:t.okButtonText,type:"success"},showDismissButton:!1};richModal.display(n,function(t){return e(t)})}else e("invalid parameter, missing message",null)},show:function(t,e){var n=this;return this.loadXSSLibrary(function(){return n._show(t,e)})},_show:function(t,s){if(t||(t={}),t.title){if(!t.actionButtons)return s("`actionButtons` are required",null);if(t.message||(t.message=""),t.cancelButtonText||(t.cancelButtonText="Cancel"),t.isMessageHTML?t.message=this.sanitizeMessage(t.message):t.isMessageHTML=!1,t.design&&t.design.backgroundColor&&!t.design.textColor)return s("'textColor' is required when 'backgroundColor' is present",null);if(t.design&&t.design.textColor&&!t.design.backgroundColor)return s("'backgroundColor' is required when 'textColor' is present",null);var e={title:t.title,subtitle:t.subtitle,richContent:""+t.message,action:t.actionButtons.map(function(t){var e=t.text,n=t.type;return{title:e,handler:function(){s(null,{selectedButton:{text:e,type:n}})},type:n}}),showDismissButton:t.showCancelButton,dismissButtonText:t.cancelButtonText||"Cancel",forceAction:t.forceAction,design:t.design,isContentHTML:t.isMessageHTML};richModal.display(e,function(t,e){return t?s(t):(e&&"dismiss"===e.buttonType&&(e.buttonType="cancel"),e&&e.value&&(e.value={text:e.value.title,action:e.value.handler}),s(null,e))})}else s("invalid parameter, missing title",null)},hide:function(){richModal.close()},toast:function(t,n){var s=this;if(this.componentUI||(this.componentUI=new ComponentUIAPI(this.context)),t||(t={}),t.message&&(t.message=t.message.trim()),t.message){var e={text:t.message,hideDismiss:t.hideDismissButton,duration:t.duration,type:t.type};t.actionButton&&(e.action={title:t.actionButton.text,action:t.actionButton.action}),this.componentUI.showToastMessage(e,function(t,e){return t?n(t):(e&&e.action&&"function"==typeof e.action&&(e.action(),s.componentUI.closeToastMessage({force:!0})),n(t,e))})}else n("invalid parameter, missing message",null)}};
